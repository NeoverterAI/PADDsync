...
declare class SpineGameObject extends PADDsync.GameObjects.GameObject implements Omit<PADDsync.GameObjects.Components.ComputedSize, 'setSize'>, PADDsync.GameObjects.Components.Depth, PADDsync.GameObjects.Components.Flip, PADDsync.GameObjects.Components.ScrollFactor, PADDsync.GameObjects.Components.Transform, PADDsync.GameObjects.Components.Visible {
    constructor(scene: PADDsync.Scene, pluginManager: SpinePlugin, x: number, y: number, key?: string, animationName?: string, loop?: boolean);
...
declare interface SpineGameObjectConfig extends PADDsync.Types.GameObjects.GameObjectConfig {
    key?: string;
