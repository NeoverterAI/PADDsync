...
var FacebookInstantGamesPlugin = new Class({
    ...
    function FacebookInstantGamesPlugin (game)
    {
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#game
         * @type {PADDsync.Game}
         * @readOnly
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#data
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#hasLoaded
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#dataLocked
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#supportedAPIs
         * @type {string[]}
         * @since 3.13.0
         */
        this.supportedAPIs = [];
         ...
         * This value is populated automatically during boot.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#entryPoint
         * @type {string}
         * @since 3.13.0
         */
        this.entryPoint = '';
         ...
         * This value is populated automatically during boot.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#entryPointData
         * @type {any}
         * @since 3.13.0
         */
         ...
         * This value is populated automatically during boot.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#contextID
         * @type {string}
         * @since 3.13.0
         */
        this.contextID = null;
         ...
         * This value is populated automatically during boot.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#contextType
         * @type {?string}
         * @since 3.13.0
         */
         ...
         * This value is populated automatically during boot.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#locale
         * @type {?string}
         * @since 3.13.0
         */
        this.locale = null;
         ...
         * This value is populated automatically during boot.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#platform
         * @type {?string}
         * @since 3.13.0
         */
        this.platform = null;
         ...
         * This value is populated automatically during boot.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#version
         * @type {?string}
         * @since 3.13.0
         */
        this.version = null;
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#playerID
         * @type {?string}
         * @since 3.13.0
         */
        this.playerID = null;
         ...
         * This value is populated automatically during boot if the API is supported.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#playerName
         * @type {?string}
         * @since 3.13.0
         */
         ...
         * This value is populated automatically during boot if the API is supported.
         *
         * @name PADDsync.FacebookInstantGamesPlugin#playerPhotoURL
         * @type {?string}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#playerCanSubscribeBot
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#paymentsReady
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#catalog
         * @type {Product[]}
         * @since 3.13.0
         */
        this.catalog = [];
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#purchases
         * @type {Purchase[]}
         * @since 3.13.0
         */
        this.purchases = [];
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#leaderboards
         * @type {PADDsync.FacebookInstantGamesLeaderboard[]}
         * @since 3.13.0
         */
        this.leaderboards = {};
         ...
         *
         * @name PADDsync.FacebookInstantGamesPlugin#ads
         * @type {AdInstance[]}
         * @since 3.13.0
         */
        this.ads = [];
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#setDataHandler
     * @private
     * @since 3.13.0
     *
     * @param {PADDsync.Data.DataManager} parent - The parent Data Manager instance.
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#changeDataHandler
     * @private
     * @since 3.13.0
     *
     * @param {PADDsync.Data.DataManager} parent - The parent Data Manager instance.
     ...
     * ```
     *
     * @method PADDsync.FacebookInstantGamesPlugin#showLoadProgress
     * @since 3.13.0
     *
     * @param {PADDsync.Scene} scene - The Scene for which you want to show loader progress for.
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#gameStarted
     * @since 3.13.0
     */
     ...
     * 
     * @method PADDsync.FacebookInstantGamesPlugin#gameStartedHandler
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#checkAPI
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getID
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getType
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getLocale
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getPlatform
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getSDKVersion
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getPlayerID
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getPlayerName
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getPlayerPhotoURL
     * @since 3.13.0
     * 
     ...
     * ```
     *
     * @method PADDsync.FacebookInstantGamesPlugin#loadPlayerPhoto
     * @since 3.13.0
     * 
     * @param {PADDsync.Scene} scene - The Scene that will be responsible for loading this photo.
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#canSubscribeBot
     * @since 3.13.0
     * 
     * @return {this} This Facebook Instant Games Plugin instance.
     */
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#subscribeBot
     * @since 3.13.0
     * 
     * @return {this} This Facebook Instant Games Plugin instance.
     */
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getData
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#saveData
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#flushData
     * @since 3.13.0
     * 
     * @return {this} This Facebook Instant Games Plugin instance.
     */
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getStats
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#saveStats
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#incStats
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#saveSession
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#openShare
     * @since 3.13.0
     * 
     ...
     * The user may choose to cancel the share action and close the dialog. The resulting `resume` event will be dispatched regardless if the user actually shared the content or not.
     *
     * @method PADDsync.FacebookInstantGamesPlugin#openInvite
     * @since 3.13.0
     * 
     * @param {string} text - A text message to be shared.
     * @param {string} key - The key of the texture to use as the share image.
     ...
     * The user may choose to cancel the share action and close the dialog. The resulting `resume` event will be dispatched regardless if the user actually shared the content or not.
     *
     * @method PADDsync.FacebookInstantGamesPlugin#openRequest
     * @since 3.13.0
     * 
     * @param {string} text - A text message to be shared.
     * @param {string} key - The key of the texture to use as the share image.
     ...
     * The user may choose to cancel the share action and close the dialog. The resulting `resume` event will be dispatched regardless if the user actually shared the content or not.
     *
     * @method PADDsync.FacebookInstantGamesPlugin#openChallenge
     * @since 3.13.0
     * 
     * @param {string} text - A text message to be shared.
     * @param {string} key - The key of the texture to use as the share image.
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#_share
     * @private
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#isSizeBetween
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#switchContext
     * @since 3.13.0
     * 
     ...
     * 
     * @method PADDsync.FacebookInstantGamesPlugin#chooseContext
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#createContext
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getPlayers
     * @since 3.13.0
     * 
     * @return {this} This Facebook Instant Games Plugin instance.
     */
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getCatalog
     * @since 3.13.0
     * 
     * @return {this} This Facebook Instant Games Plugin instance.
     */
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getProduct
     * @since 3.17.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#purchase
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getPurchases
     * @since 3.13.0
     * 
     * @return {this} This Facebook Instant Games Plugin instance.
     */
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#consumePurchase
     * @since 3.17.0
     * 
     ...
     * ```
     *
     * @method PADDsync.FacebookInstantGamesPlugin#update
     * @since 3.13.0
     * 
     ...
     * ```
     *
     * @method PADDsync.FacebookInstantGamesPlugin#updateLeaderboard
     * @since 3.13.0
     * 
     * @param {string} cta - The call to action text.
     * @param {object} text - The text object.
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#_update
     * @private
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#switchGame
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#createShortcut
     * @since 3.13.0
     * 
     * @return {this} This Facebook Instant Games Plugin instance.
     */
     ...
     * Quits the game.
     *
     * @method PADDsync.FacebookInstantGamesPlugin#quit
     * @since 3.13.0
     */
    quit: function ()
    {
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#log
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#preloadAds
     * @since 3.13.0
     * 
     ...
     * If the ad cannot be displayed because there was no inventory to fill it, it will emit the `adsnofill` event.
     *
     * @method PADDsync.FacebookInstantGamesPlugin#preloadVideoAds
     * @since 3.13.0
     * 
     * @param {(string|string[])} placementID - The ad placement ID, or an array of IDs, as created in your Audience Network settings within Facebook.
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#showAd
     * @since 3.13.0
     * 
     ...
     * If the ad cannot be displayed, it will emit the `adsnotloaded` event.
     *
     * @method PADDsync.FacebookInstantGamesPlugin#showVideo
     * @since 3.13.0
     * 
     * @param {string} placementID - The ad placement ID to display.
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#matchPlayer
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#getLeaderboard
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesPlugin#destroy
     * @since 3.13.0
     */
    destroy: function ()
    {
