 ...
 * @since 3.13.0
 * 
 * @param {PADDsync.FacebookInstantGamesPlugin} plugin - A reference to the Facebook Instant Games Plugin.
...
var Leaderboard = new Class({
    ...
    function Leaderboard (plugin, data)
    {
         ...
         *
         * @name PADDsync.FacebookInstantGamesLeaderboard#plugin
         ...
         *
         * @name PADDsync.FacebookInstantGamesLeaderboard#ref
         * @type {any}
         * @since 3.13.0
         */
        this.ref = data;
         ...
         *
         * @name PADDsync.FacebookInstantGamesLeaderboard#name
         * @type {string}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.FacebookInstantGamesLeaderboard#contextID
         * @type {string}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.FacebookInstantGamesLeaderboard#entryCount
         * @type {integer}
         * @since 3.13.0
         */
        this.entryCount = 0;
         ...
         *
         * @name PADDsync.FacebookInstantGamesLeaderboard#playerScore
         ...
         *
         * @name PADDsync.FacebookInstantGamesLeaderboard#scores
         * @type {LeaderboardScore[]}
         * @since 3.13.0
         */
        this.scores = [];
     ...
     *
     * @method PADDsync.FacebookInstantGamesLeaderboard#getEntryCount
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesLeaderboard#setScore
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesLeaderboard#getPlayerScore
     * @since 3.13.0
     * 
     * @return {this} This Leaderboard instance.
     */
     ...
     *
     * @method PADDsync.FacebookInstantGamesLeaderboard#getScores
     * @since 3.13.0
     * 
     ...
     *
     * @method PADDsync.FacebookInstantGamesLeaderboard#getConnectedScores
     * @since 3.16.0
     * 
     * @return {this} This Leaderboard instance.
     */
