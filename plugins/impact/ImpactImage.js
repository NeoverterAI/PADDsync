 ...
 *
 * @param {PADDsync.Physics.Impact.World} world - The physics world of the Impact physics system.
...
var ImpactImage = new Class({
    ...
    function ImpactImage (world, x, y, texture, frame)
    {
         ...
         *
         * @name PADDsync.Physics.Impact.ImpactImage#body
         ...
         *
         * @name PADDsync.Physics.Impact.ImpactImage#size
         ...
         *
         * @name PADDsync.Physics.Impact.ImpactImage#offset
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Impact.ImpactImage#vel
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Impact.ImpactImage#accel
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Impact.ImpactImage#friction
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Impact.ImpactImage#maxVel
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
