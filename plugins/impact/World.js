 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene to which this Impact World instance belongs.
 * @param {PADDsync.Types.Physics.Impact.WorldConfig} config - [description]
 */
var World = new Class({
    ...
    function World (scene, config)
    {
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#bodies
         * @type {PADDsync.Structs.Set.<PADDsync.Physics.Impact.Body>}
         * @since 3.0.0
         */
        this.bodies = new Set();
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#gravity
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Impact.World#cellSize
         * @type {integer}
         * @default 64
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#collisionMap
         * @type {PADDsync.Physics.Impact.CollisionMap}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Impact.World#maxStep
         * @type {number}
         * @default 0.05
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#enabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#drawDebug
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#debugGraphic
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#defaults
         * @type {PADDsync.Types.Physics.Impact.WorldDefaults}
         * @since 3.0.0
         */
        this.defaults = {
         ...
         *
         * @name PADDsync.Physics.Impact.World#walls
         * @type {PADDsync.Types.Physics.Impact.WorldWalls}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#delta
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.World#_lastId
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
     ...
     *
     * @method PADDsync.Physics.Impact.World#setCollisionMap
     * @since 3.0.0
     *
     ...
     * level in the cache.
     *
     * @return {?PADDsync.Physics.Impact.CollisionMap} The newly created CollisionMap, or null if the method failed to
     ...
     *
     * @method PADDsync.Physics.Impact.World#setCollisionMapFromTilemapLayer
     * @since 3.0.0
     *
     * @param {(PADDsync.Tilemaps.DynamicTilemapLayer|PADDsync.Tilemaps.StaticTilemapLayer)} tilemapLayer - The tilemap layer to use.
     * @param {PADDsync.Types.Physics.Impact.CollisionOptions} [options] - Options for controlling the mapping from tiles to slope IDs.
     *
     * @return {PADDsync.Physics.Impact.CollisionMap} The newly created CollisionMap.
     */
     ...
     *
     * @method PADDsync.Physics.Impact.World#setBounds
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Physics.Impact.World} This World object.
     */
     ...
     *
     * @method PADDsync.Physics.Impact.World#updateWall
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Impact.World#createDebugGraphic
     * @since 3.0.0
     *
     * @return {PADDsync.GameObjects.Graphics} The Graphics object created that will have the debug visuals drawn to it.
     */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#getNextID
     * @since 3.0.0
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#create
     * @since 3.0.0
     *
     * @param {number} x - [description]
     * @param {number} y - [description]
     ...
     *
     * @return {PADDsync.Physics.Impact.Body} The Body that was added to this World.
     */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#remove
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body} object - The Body to remove from this World.
     */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#pause
     * @fires PADDsync.Physics.Impact.Events#PAUSE
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Impact.World} This World object.
     */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#resume
     * @fires PADDsync.Physics.Impact.Events#RESUME
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Impact.World} This World object.
     */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#update
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Impact.World#checkHash
     * @since 3.0.0
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#checkBodies
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body} bodyA - [description]
     * @param {PADDsync.Physics.Impact.Body} bodyB - [description]
     */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setCollidesNever
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the collides value on.
     *
     * @return {PADDsync.Physics.Impact.World} This World object.
     */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setLite
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the collides value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setPassive
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the collides value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setActive
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the collides value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setFixed
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the collides value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setTypeNone
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the type value on.
     *
     * @return {PADDsync.Physics.Impact.World} This World object.
     */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setTypeA
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the type value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setTypeB
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the type value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setAvsB
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the type value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setBvsA
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the type value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setCheckAgainstNone
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the type value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setCheckAgainstA
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the type value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#setCheckAgainstB
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Impact.Body[]} bodies - An Array of Impact Bodies to set the type value on.
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#shutdown
     * @since 3.0.0
     */
    shutdown: function ()
    {
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.World#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
