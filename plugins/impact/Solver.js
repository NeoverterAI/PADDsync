 ...
 *
 * @function PADDsync.Physics.Impact.Solver
 * @fires PADDsync.Physics.Impact.Events#COLLIDE
 * @since 3.0.0
 *
 * @param {PADDsync.Physics.Impact.World} world - The Impact simulation to run the solver in.
 * @param {PADDsync.Physics.Impact.Body} bodyA - The first body in the collision.
 * @param {PADDsync.Physics.Impact.Body} bodyB - The second body in the collision.
 */
