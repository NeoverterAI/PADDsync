...
var CollisionMap = new Class({
    ...
    function CollisionMap (tilesize, data)
    {
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.CollisionMap#tilesize
         * @type {integer}
         * @default 32
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.CollisionMap#data
         * @type {array}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.CollisionMap#width
         * @type {number}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.CollisionMap#height
         * @type {number}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.CollisionMap#lastSlope
         * @type {integer}
         * @default 55
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.CollisionMap#tiledef
         * @type {object}
         * @since 3.0.0
         */
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.CollisionMap#trace
     * @since 3.0.0
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.CollisionMap#step
     * @since 3.0.0
     *
     ...
     * [description]
     *
     * @method PADDsync.Physics.Impact.CollisionMap#checkDef
     * @since 3.0.0
     *
     * @param {object} res - [description]
