 ...
 * [description]
 *
 * @function PADDsync.Physics.Impact.SeparateY
 * @since 3.0.0
 *
 * @param {PADDsync.Physics.Impact.World} world - [description]
 * @param {PADDsync.Physics.Impact.Body} top - [description]
 * @param {PADDsync.Physics.Impact.Body} bottom - [description]
 * @param {PADDsync.Physics.Impact.Body} [weak] - [description]
 */
