...
var ImpactBody = new Class({
    ...
    function ImpactBody (world, x, y, width, height)
    {
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.ImpactBody#body
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.ImpactBody#size
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.ImpactBody#offset
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.ImpactBody#vel
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.ImpactBody#accel
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.ImpactBody#friction
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
         ...
         * [description]
         *
         * @name PADDsync.Physics.Impact.ImpactBody#maxVel
         * @type {{x: number, y: number}}
         * @since 3.0.0
         */
