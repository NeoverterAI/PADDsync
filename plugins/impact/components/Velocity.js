 ...
 *
 * @namespace PADDsync.Physics.Impact.Components.Velocity
 * @since 3.0.0
 */
var Velocity = {
     ...
     *
     * @method PADDsync.Physics.Impact.Components.Velocity#setVelocityX
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Impact.Components.Velocity#setVelocityY
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Impact.Components.Velocity#setVelocity
     * @since 3.0.0
     *
     * @param {number} x - The horizontal velocity value.
     ...
     *
     * @method PADDsync.Physics.Impact.Components.Velocity#setMaxVelocity
     * @since 3.0.0
     *
