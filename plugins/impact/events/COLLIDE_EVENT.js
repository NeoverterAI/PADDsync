 ...
 *
 * @event PADDsync.Physics.Impact.Events#COLLIDE
 * @since 3.0.0
 * 
 * @param {PADDsync.Physics.Impact.Body} bodyA - The first body involved in the collision.
 * @param {PADDsync.Physics.Impact.Body} bodyB - The second body involved in the collision.
