 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Physics.Impact.World} world - A reference to the Impact Physics world.
 */
var Factory = new Class({
    ...
    function Factory (world)
    {
         ...
         *
         * @name PADDsync.Physics.Impact.Factory#world
         ...
         *
         * @name PADDsync.Physics.Impact.Factory#sys
     ...
     *
     * @method PADDsync.Physics.Impact.Factory#body
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Physics.Impact.ImpactBody} The ImpactBody object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Impact.Factory#existing
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to receive the physics body.
     *
     * @return {PADDsync.GameObjects.GameObject} The Game Object.
     */
     ...
     *
     * @method PADDsync.Physics.Impact.Factory#image
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Physics.Impact.ImpactImage} The ImpactImage object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Impact.Factory#sprite
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this Game Object in the world.
     * @param {number} y - The vertical position of this Game Object in the world.
     ...
     * @param {(string|integer)} [frame] - An optional frame from the Texture this Game Object is rendering with.
     *
     * @return {PADDsync.Physics.Impact.ImpactSprite} The ImpactSprite object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Impact.Factory#destroy
     * @since 3.5.0
     */
    destroy: function ()
    {
