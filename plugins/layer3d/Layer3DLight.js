...
var Layer3DLight = new Class({
    ...
    function Layer3DLight (layer, x, y, z)
    {
         ...
         *
         * @name PADDsync.GameObjects.Layer3DLight#layer
         ...
         *
         * @name PADDsync.GameObjects.Layer3DLight#position
         ...
         *
         * @name PADDsync.GameObjects.Layer3DLight#ambient
         ...
         *
         * @name PADDsync.GameObjects.Layer3DLight#diffuse
         * @type {PADDsync.Display.RGB}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3DLight#specular
         * @type {PADDsync.Display.RGB}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3DLight#dirtyCache
         * @type {number[]}
         * @private
         * @since 3.50.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Layer3DLight#isDirty
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer3DLight#setPosition
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer3DLight#setAmbient
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer3DLight#setDiffuse
     * @since 3.50.0
     *
     * @param {number} r - The red color value. Between 0 and 1.
     * @param {number} g - The green color value. Between 0 and 1.
     ...
     *
     * @method PADDsync.GameObjects.Layer3DLight#setSpecular
     * @since 3.50.0
     *
     * @param {number} r - The red color value. Between 0 and 1.
     * @param {number} g - The green color value. Between 0 and 1.
     ...
     *
     * @name PADDsync.GameObjects.Layer3DLight#x
     * @type {number}
     * @since 3.50.0
     */
    x: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DLight#y
     * @type {number}
     * @since 3.50.0
     */
    y: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DLight#z
     * @type {number}
     * @since 3.50.0
     */
    z: {
     ...
     *
     * @method PADDsync.GameObjects.Layer3DLight#destroy
     * @since 3.50.0
     */
    destroy: function ()
    {
