...
var Layer3D = new Class({
    ...
    function Layer3D (scene, x, y)
    {
         ...
         *
         * @name PADDsync.GameObjects.Layer3D#camera
         * @type {PADDsync.GameObjects.Layer3DCamera}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3D#light
         * @type {PADDsync.GameObjects.Layer3DLight}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3D#fogColor
         * @type {PADDsync.Display.RGB}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3D#fogNear
         * @type {number}
         * @since 3.50.0
         */
        this.fogNear = 0;
         ...
         *
         * @name PADDsync.GameObjects.Layer3D#fogFar
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3D#models
         * @type {PADDsync.Geom.Mesh.Model[]}
         * @since 3.50.0
         */
        this.models = [];
         ...
         *
         * @name PADDsync.GameObjects.Layer3D#_prevWidth
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal cached value.
         *
         * @name PADDsync.GameObjects.Layer3D#_prevHeight
         * @type {number}
         * @private
         * @since 3.50.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#clearModels
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#addModel
     * @since 3.50.0
     *
     * @param {number} verticesCount - The total number of vertices this model can contain.
     * @param {string|PADDsync.Textures.Texture} [texture] - The key, or instance of the Texture this model will use to render with, as stored in the Texture Manager.
     ...
     *
     * @return {PADDsync.Geom.Mesh.Model} The model instance that was created.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#addModelFromOBJ
     * @since 3.50.0
     *
     ...
     *
     * @return {PADDsync.Geom.Mesh.Model|PADDsync.Geom.Mesh.Model[]} The Model instance that was created. If the OBJ contained multiple models then an array of Model instances is returned.
     */
     ...
     *
     * ```javascript
     * const data = PADDsync.Geom.Mesh.ParseObj(rawData, flipUV);
     *
     ...
     * use them to offset the base values.
     *
     * @method PADDsync.GameObjects.Layer3D#addModelFromData
     * @since 3.50.0
     *
     ...
     * @param {number} [originZ=0] - The z origin of the model vertices during creation.
     *
     * @return {PADDsync.Geom.Mesh.Model|PADDsync.Geom.Mesh.Model[]} The Model instance that was created. If the data contained multiple models then an array of Model instances is returned.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#addModelFromVertices
     * @since 3.50.0
     *
     ...
     * @param {string|PADDsync.Textures.Texture} [texture] - The key, or instance of the Texture the model will use to render with, as stored in the Texture Manager.
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#setFog
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#disableFog
     * @since 3.50.0
     *
     * @return {this} This Layer3D Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#preUpdate
     * @protected
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#resetDirtyFlags
     * @protected
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer3D#preDestroy
     * @private
     * @since 3.50.0
     */
    preDestroy: function ()
