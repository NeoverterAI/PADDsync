...
var Layer3DCamera = new Class({
    ...
    function Layer3DCamera (layer, fov, x, y, z, near, far)
    {
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#layer
         * @type {PADDsync.GameObjects.Layer3D}
         * @since 3.50.0
         */
        this.layer = layer;
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#input
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#dirtyView
         * @type {boolean}
         * @since 3.50.0
         */
        this.dirtyView = true;
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#dirtyProjection
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         * Internal fov value.
         *
         * @name PADDsync.GameObjects.Layer3DCamera#_fov
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal near value.
         *
         * @name PADDsync.GameObjects.Layer3DCamera#_near
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal far value.
         *
         * @name PADDsync.GameObjects.Layer3DCamera#_far
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#aspectRatio
         * @type {number}
         * @since 3.50.0
         */
        this.aspectRatio = 1;
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#position
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#rotation
         * @type {PADDsync.Math.Vector3}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#forward
         ...
         * Calculated and updated automatically when the view matrix changes.
         *
         * @name PADDsync.GameObjects.Layer3DCamera#up
         * @type {PADDsync.Math.Vector4}
         * @since 3.50.0
         */
        this.up = new Vector4();
         ...
         * Calculated and updated automatically when the view matrix changes.
         *
         * @name PADDsync.GameObjects.Layer3DCamera#right
         * @type {PADDsync.Math.Vector4}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#matrix
         ...
         * Calculated and updated automatically when the camera is dirty.
         *
         * @name PADDsync.GameObjects.Layer3DCamera#viewMatrix
         * @type {PADDsync.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         * Calculated and updated automatically when the camera is dirty.
         *
         * @name PADDsync.GameObjects.Layer3DCamera#projectionMatrix
         * @type {PADDsync.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         * Calculated and updated automatically when the camera is dirty.
         *
         * @name PADDsync.GameObjects.Layer3DCamera#viewProjectionMatrix
         * @type {PADDsync.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#mode
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#rotateSpeed
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#panSpeed
         * @type {number}
         * @since 3.50.0
         */
        this.panSpeed = 4;
         ...
         *
         * @name PADDsync.GameObjects.Layer3DCamera#zoomSpeed
         * @type {number}
         * @since 3.50.0
         */
        this.zoomSpeed = 3;
     ...
     *
     * @method PADDsync.GameObjects.Layer3DCamera#panX
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer3DCamera#panY
     * @since 3.50.0
     *
     * @param {number} v - The amount to pan by.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer3DCamera#panZ
     * @since 3.50.0
     *
     * @param {number} v - The amount to pan by.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer3DCamera#update
     * @since 3.50.0
     */
    update: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.Layer3DCamera#updateViewMatrix
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer3DCamera#updateProjectionMatrix
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer3DCamera#updateDirection
     * @since 3.50.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#fov
     * @type {number}
     * @since 3.50.0
     */
    fov: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#near
     * @type {number}
     * @since 3.50.0
     */
    near: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#far
     * @type {number}
     * @since 3.50.0
     */
    far: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#x
     * @type {number}
     * @since 3.50.0
     */
    x: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#y
     * @type {number}
     * @since 3.50.0
     */
    y: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#z
     * @type {number}
     * @since 3.50.0
     */
    z: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#rotationX
     * @type {number}
     * @since 3.50.0
     */
    rotationX: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#rotationY
     * @type {number}
     * @since 3.50.0
     */
    rotationY: {
     ...
     *
     * @name PADDsync.GameObjects.Layer3DCamera#rotationZ
     * @type {number}
     * @since 3.50.0
     */
    rotationZ: {
     ...
     *
     * @method PADDsync.GameObjects.Layer3DCamera#destroy
     * @since 3.50.0
     */
    destroy: function ()
    {
