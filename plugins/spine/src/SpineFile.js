...
/**
 * @typedef {object} PADDsync.Loader.FileTypes.SpineFileConfig
 *
 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#spine method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#spine.
 *
 * @class SpineFile
 ...
 * @param {(string|PADDsync.Loader.FileTypes.SpineFileConfig)} key - The key to use for this file, or a file configuration object.
...
var SpineFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.SpineFile#onFileComplete
     * @since 3.19.0
     *
     ...
     *
     * @method PADDsync.Loader.FileTypes.SpineFile#addToCache
     * @since 3.19.0
     */
    addToCache: function ()
    {
