 ...
 * You can only create them if the Spine plugin has been loaded into PADDsync.
 *
 ...
 * @since 3.19.0
 *
 * @param {PADDsync.Scene} scene - A reference to the Scene that this Game Object belongs to.
