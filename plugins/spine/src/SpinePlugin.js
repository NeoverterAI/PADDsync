 ...
 *
 * @class SpinePlugin
 * @extends PADDsync.Plugins.ScenePlugin
 * @constructor
 * @since 3.19.0
 *
...
var SpinePlugin = new Class({
     ...
     * ```
     *
     * See the documentation for `PADDsync.Types.Loader.FileTypes.SpineFileConfig` for more details.
     *
     ...
     *
     * Note: The ability to load this type of file will only be available if the Spine Plugin has been built or loaded into PADDsync.
     *
     * @method PADDsync.Loader.LoaderPlugin#spine
     ...
     * @param {PADDsync.Types.Loader.XHRSettingsObject} [textureXhrSettings] - An XHR Settings configuration object for the Spine json file. Used in replacement of the Loaders default XHR Settings.
     * @param {PADDsync.Types.Loader.XHRSettingsObject} [atlasXhrSettings] - An XHR Settings configuration object for the Spine atlas file. Used in replacement of the Loaders default XHR Settings.
     * @param {object} [settings] - An external Settings configuration object { prefix: '' }
     *
     * @return {PADDsync.Loader.LoaderPlugin} The Loader instance.
     */
