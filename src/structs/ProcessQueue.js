...
var ProcessQueue = new Class({
    ...
    function ProcessQueue ()
    {
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name PADDsync.Structs.ProcessQueue#_pending
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.0.0
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name PADDsync.Structs.ProcessQueue#_active
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.0.0
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name PADDsync.Structs.ProcessQueue#_destroy
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Structs.ProcessQueue#_toProcess
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Structs.ProcessQueue#checkQueue
         * @type {boolean}
         * @since 3.50.0
         */
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#isActive
     * @since 3.60.0
     *
     * @genericUse {T} - [item]
     * @genericUse {PADDsync.Structs.ProcessQueue.<T>} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#isPending
     * @since 3.60.0
     *
     * @genericUse {T} - [item]
     * @genericUse {PADDsync.Structs.ProcessQueue.<T>} - [$return]
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#isDestroying
     * @since 3.60.0
     *
     * @genericUse {T} - [item]
     * @genericUse {PADDsync.Structs.ProcessQueue.<T>} - [$return]
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#add
     * @since 3.0.0
     *
     * @genericUse {T} - [item]
     * @genericUse {PADDsync.Structs.ProcessQueue.<T>} - [$return]
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#remove
     * @since 3.0.0
     *
     * @genericUse {T} - [item]
     * @genericUse {PADDsync.Structs.ProcessQueue.<T>} - [$return]
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#removeAll
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#update
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#getActive
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @name PADDsync.Structs.ProcessQueue#length
     * @type {number}
     * @readonly
     * @since 3.20.0
     */
     ...
     *
     * @method PADDsync.Structs.ProcessQueue#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
