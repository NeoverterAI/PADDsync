...
var Size = new Class({
    ...
    function Size (width, height, aspectMode, parent)
    {
         ...
         *
         * @name PADDsync.Structs.Size#_width
         * @type {number}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Structs.Size#_height
         * @type {number}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Structs.Size#_parent
         * @type {any}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Structs.Size#aspectMode
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Structs.Size#aspectRatio
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Structs.Size#minWidth
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         * This value is read-only. To change it see the `setMin` method.
         *
         * @name PADDsync.Structs.Size#minHeight
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Structs.Size#maxWidth
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         * This value is read-only. To change it see the `setMax` method.
         *
         * @name PADDsync.Structs.Size#maxHeight
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Structs.Size#snapTo
     ...
     *
     * @method PADDsync.Structs.Size#setAspectMode
     * @since 3.16.0
     *
     ...
     * Calling this method automatically recalculates the `width` and the `height`, if required.
     *
     * @method PADDsync.Structs.Size#setSnap
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#setParent
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#setMin
     * @since 3.16.0
     *
     ...
     * _can_ be exceed in some situations.
     *
     * @method PADDsync.Structs.Size#setMax
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#setSize
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#setAspectRatio
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#resize
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#getNewWidth
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#getNewHeight
     * @since 3.16.0
     *
     * @param {number} value - The value to clamp and check.
     * @param {boolean} [checkParent=true] - Check the given value against the parent, if set.
     ...
     *
     * @method PADDsync.Structs.Size#constrain
     * @since 3.16.0
     *
     * @param {number} [width=0] - The new width of the Size component.
     ...
     * it cannot exceed that of the parent.
     *
     * @method PADDsync.Structs.Size#fitTo
     * @since 3.16.0
     *
     * @param {number} [width=0] - The new width of the Size component.
     * @param {number} [height] - The new height of the Size component. If not given, it will use the width value.
     ...
     * on the longest axis.
     *
     * @method PADDsync.Structs.Size#envelop
     * @since 3.16.0
     *
     * @param {number} [width=0] - The new width of the Size component.
     * @param {number} [height] - The new height of the Size component. If not given, it will use the width value.
     ...
     *
     * @method PADDsync.Structs.Size#setWidth
     * @since 3.16.0
     *
     * @param {number} width - The new width of the Size component.
     *
     ...
     *
     * @method PADDsync.Structs.Size#setHeight
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#toString
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#setCSS
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Structs.Size#copy
     * @since 3.16.0
     *
     * @param {PADDsync.Structs.Size} destination - The Size component to copy the values to.
     *
     * @return {PADDsync.Structs.Size} The updated destination Size component.
     */
     ...
     *
     * @method PADDsync.Structs.Size#destroy
     * @since 3.16.0
     */
    destroy: function ()
    {
     ...
     *
     * @name PADDsync.Structs.Size#width
     * @type {number}
     * @since 3.16.0
     */
    width: {
     ...
     *
     * @name PADDsync.Structs.Size#height
     * @type {number}
     * @since 3.16.0
     */
    height: {
 ...
 *
 * @name PADDsync.Structs.Size.NONE
 * @constant
 * @type {number}
 * @since 3.16.0
 */
 ...
 *
 * @name PADDsync.Structs.Size.WIDTH_CONTROLS_HEIGHT
 * @constant
 * @type {number}
 * @since 3.16.0
 */
 ...
 *
 * @name PADDsync.Structs.Size.HEIGHT_CONTROLS_WIDTH
 * @constant
 * @type {number}
 * @since 3.16.0
 */
 ...
 *
 * @name PADDsync.Structs.Size.FIT
 * @constant
 * @type {number}
 * @since 3.16.0
 */
 ...
 *
 * @name PADDsync.Structs.Size.ENVELOP
 * @constant
 * @type {number}
 * @since 3.16.0
 */
