...
var List = new Class({
    ...
    function List (parent)
    {
         ...
         *
         * @name PADDsync.Structs.List#parent
         * @type {*}
         * @since 3.0.0
         */
        this.parent = parent;
         ...
         * @genericUse {T[]} - [$type]
         *
         * @name PADDsync.Structs.List#list
         * @type {Array.<*>}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Structs.List#position
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Structs.List#addCallback
         * @type {function}
         * @since 3.4.0
         */
         ...
         *
         * @name PADDsync.Structs.List#removeCallback
         * @type {function}
         * @since 3.4.0
         */
         ...
         *
         * @name PADDsync.Structs.List#_sortKey
         * @type {string}
         * @since 3.4.0
         */
        this._sortKey = '';
     ...
     *
     * @method PADDsync.Structs.List#add
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Structs.List#addAt
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Structs.List#getAt
     * @since 3.0.0
     *
     * @genericUse {T} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#getIndex
     * @since 3.0.0
     *
     * @genericUse {T} - [child]
     *
     ...
     *
     * @method PADDsync.Structs.List#sort
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Structs.List} This List object.
     */
     ...
     *
     * @method PADDsync.Structs.List#getByName
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Structs.List#getRandom
     * @since 3.0.0
     *
     * @genericUse {T | null} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#getFirst
     * @since 3.0.0
     *
     * @genericUse {T | null} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#getAll
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#count
     * @since 3.0.0
     *
     * @genericUse {T} - [value]
     *
     ...
     *
     * @method PADDsync.Structs.List#swap
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Structs.List#moveTo
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Structs.List#moveAbove
     * @since 3.55.0
     *
     * @genericUse {T} - [child1,child2]
     *
     ...
     *
     * @method PADDsync.Structs.List#moveBelow
     * @since 3.55.0
     *
     * @genericUse {T} - [child1,child2]
     *
     ...
     *
     * @method PADDsync.Structs.List#remove
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Structs.List#removeAt
     * @since 3.0.0
     *
     * @genericUse {T} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#removeBetween
     * @since 3.0.0
     *
     * @genericUse {T[]} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#removeAll
     * @since 3.0.0
     *
     * @param {boolean} [skipCallback=false] - Skip calling the List.removeCallback.
     *
     ...
     *
     * @method PADDsync.Structs.List#bringToTop
     * @since 3.0.0
     *
     * @genericUse {T} - [child,$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#sendToBack
     * @since 3.0.0
     *
     * @genericUse {T} - [child,$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#moveUp
     * @since 3.0.0
     *
     * @genericUse {T} - [child,$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#moveDown
     * @since 3.0.0
     *
     * @genericUse {T} - [child,$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#reverse
     * @since 3.0.0
     *
     * @genericUse {PADDsync.Structs.List.<T>} - [$return]
     *
     * @return {PADDsync.Structs.List} This List object.
     */
    reverse: function ()
     ...
     *
     * @method PADDsync.Structs.List#shuffle
     * @since 3.0.0
     *
     * @genericUse {PADDsync.Structs.List.<T>} - [$return]
     *
     ...
     *
     * @method PADDsync.Structs.List#replace
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Structs.List#exists
     * @since 3.0.0
     *
     * @genericUse {T} - [child]
     *
     ...
     *
     * @method PADDsync.Structs.List#setAll
     * @since 3.0.0
     *
     * @genericUse {T} - [value]
     *
     ...
     *
     * @method PADDsync.Structs.List#each
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Structs.List#shutdown
     * @since 3.0.0
     */
    shutdown: function ()
    {
     ...
     * Destroys this List.
     *
     * @method PADDsync.Structs.List#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     *
     * @name PADDsync.Structs.List#length
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Structs.List#first
     * @genericUse {T} - [$type]
     * @type {*}
     * @readonly
     * @since 3.0.0
     ...
     *
     * @name PADDsync.Structs.List#last
     * @genericUse {T} - [$type]
     * @type {*}
     * @readonly
     * @since 3.0.0
     ...
     *
     * @name PADDsync.Structs.List#next
     * @genericUse {T} - [$type]
     * @type {*}
     * @readonly
     * @since 3.0.0
     ...
     *
     * @name PADDsync.Structs.List#previous
     * @genericUse {T} - [$type]
     * @type {*}
     * @readonly
     * @since 3.0.0
