...
var BaseCache = new Class({
    ...
    function BaseCache ()
    {
         ...
         *
         * @name PADDsync.Cache.BaseCache#entries
         * @type {PADDsync.Structs.Map.<String, *>}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cache.BaseCache#events
     ...
     *
     * @method PADDsync.Cache.BaseCache#add
     * @fires PADDsync.Cache.Events#ADD
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cache.BaseCache#has
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cache.BaseCache#exists
     * @since 3.7.0
     *
     * @param {string} key - The unique key of the item to be checked in this cache.
     *
     ...
     *
     * @method PADDsync.Cache.BaseCache#get
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cache.BaseCache#remove
     * @fires PADDsync.Cache.Events#REMOVE
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cache.BaseCache#getKeys
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Cache.BaseCache#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
