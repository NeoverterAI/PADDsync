 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Physics.Arcade.World} world - The Arcade physics World that will manage the collisions.
...
var Collider = new Class({
    ...
    function Collider (world, overlapOnly, object1, object2, collideCallback, processCallback, callbackContext)
    {
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#world
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#name
         * @type {string}
         * @since 3.1.0
         */
        this.name = '';
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#active
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#overlapOnly
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#object1
         * @type {PADDsync.Types.Physics.Arcade.ArcadeColliderType}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#object2
         * @type {PADDsync.Types.Physics.Arcade.ArcadeColliderType}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#collideCallback
         * @type {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#processCallback
         * @type {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Collider#callbackContext
         * @type {object}
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Physics.Arcade.Collider#setName
     * @since 3.1.0
     *
     * @param {string} name - The name to assign to the Collider.
     *
     * @return {PADDsync.Physics.Arcade.Collider} This Collider instance.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Collider#update
     * @since 3.0.0
     */
    update: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Arcade.Collider#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
