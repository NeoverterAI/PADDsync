 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene that this Plugin belongs to.
 */
var ArcadePhysics = new Class({
    ...
    function ArcadePhysics (scene)
    {
         ...
         *
         * @name PADDsync.Physics.Arcade.ArcadePhysics#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         * The Scene's Systems.
         *
         * @name PADDsync.Physics.Arcade.ArcadePhysics#systems
         ...
         *
         * @name PADDsync.Physics.Arcade.ArcadePhysics#config
         * @type {PADDsync.Types.Physics.Arcade.ArcadeWorldConfig}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.ArcadePhysics#world
         ...
         *
         * @name PADDsync.Physics.Arcade.ArcadePhysics#add
         * @type {PADDsync.Physics.Arcade.Factory}
         * @since 3.0.0
         */
        this.add;
         ...
         *
         * @name PADDsync.Physics.Arcade.World#_category
         * @private
         * @type {number}
         * @since 3.70.0
         */
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#boot
     * @private
     * @since 3.5.1
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#start
     * @private
     * @since 3.5.0
     */
    start: function ()
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#enableUpdate
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#disableUpdate
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#getConfig
     * @since 3.0.0
     *
     * @return {PADDsync.Types.Physics.Arcade.ArcadeWorldConfig} The physics configuration.
     */
    getConfig: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#nextCategory
     * @since 3.70.0
     *
    ...
    /**
     * Tests if Game Objects overlap. See {@link PADDsync.Physics.Arcade.World#overlap}
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#overlap
     * @since 3.0.0
     *
     ...
     * require a high level of stability please consider using an alternative physics system, such as Matter.js.
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#collide
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object or array of objects to check.
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} [object2] - The second object or array of objects to check, or `undefined`.
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#collideTiles
     ...
     * you should filter them before passing them to this method.
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#overlapTiles
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#pause
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Arcade.World} The simulation.
     */
    pause: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#resume
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Arcade.World} The simulation.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#accelerateTo
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - Any Game Object with an Arcade Physics body.
     ...
     * Note: The game object doesn't stop moving once it reaches the destination coordinates.
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#accelerateToObject
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - Any Game Object with an Arcade Physics body.
     * @param {PADDsync.GameObjects.GameObject} destination - The Game Object to move towards. Can be any object but must have visible x/y properties.
     * @param {number} [speed=60] - The acceleration (change in speed) in pixels per second squared.
     * @param {number} [xSpeedMax=500] - The maximum x velocity the game object can reach.
     * @param {number} [ySpeedMax=500] - The maximum y velocity the game object can reach.
     *
     ...
     * is returned.
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#closest
     * @since 3.0.0
     *
     * @generic {PADDsync.Physics.Arcade.Body|PADDsync.Physics.Arcade.StaticBody|PADDsync.GameObjects.GameObject} Target
     * @param {PADDsync.Types.Math.Vector2Like} source - Any object with public `x` and `y` properties, such as a Game Object or Geometry object.
     ...
     * is returned.
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#furthest
     * @since 3.0.0
     *
     * @param {any} source - Any object with public `x` and `y` properties, such as a Game Object or Geometry object.
     * @param {(PADDsync.Physics.Arcade.Body[]|PADDsync.Physics.Arcade.StaticBody[]|PADDsync.GameObjects.GameObject[])} [targets] - The targets.
     *
     * @return {?(PADDsync.Physics.Arcade.Body|PADDsync.Physics.Arcade.StaticBody|PADDsync.GameObjects.GameObject)} The target farthest from the given source point.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#moveTo
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - Any Game Object with an Arcade Physics body.
     ...
     * Note: Doesn't take into account acceleration, maxVelocity or drag (if you've set drag or acceleration too high this object may not move at all)
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#moveToObject
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - Any Game Object with an Arcade Physics body.
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#velocityFromAngle
     * @since 3.0.0
     *
     * @param {number} angle - The angle in degrees calculated in clockwise positive direction (down = 90 degrees positive, right = 0 degrees positive, up = 90 degrees negative)
     * @param {number} [speed=60] - The speed it will move, in pixels per second squared.
     * @param {PADDsync.Math.Vector2} [vec2] - The Vector2 in which the x and y properties will be set to the calculated velocity.
     *
     * @return {PADDsync.Math.Vector2} The Vector2 that stores the velocity.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#velocityFromRotation
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#overlapRect
     * @since 3.17.0
     *
     ...
     *
     * @return {(PADDsync.Physics.Arcade.Body[]|PADDsync.Physics.Arcade.StaticBody[])} An array of bodies that overlap with the given area.
     */
     ...
     * otherwise the search is O(N) for Dynamic Bodies.
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#overlapCirc
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#shutdown
     * @since 3.0.0
     */
    shutdown: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Arcade.ArcadePhysics#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
