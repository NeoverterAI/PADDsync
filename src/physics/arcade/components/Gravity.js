 ...
 *
 * @namespace PADDsync.Physics.Arcade.Components.Gravity
 * @since 3.0.0
 */
var Gravity = {
     ...
     *
     * @method PADDsync.Physics.Arcade.Components.Gravity#setGravity
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.Components.Gravity#setGravityX
     * @since 3.0.0
     *
     * @param {number} x - The gravitational force to be applied to the X-axis.
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.Components.Gravity#setGravityY
     * @since 3.0.0
     *
