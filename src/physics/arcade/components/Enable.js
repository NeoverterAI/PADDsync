 ...
 *
 * @namespace PADDsync.Physics.Arcade.Components.Enable
 * @since 3.0.0
 */
var Enable = {
     ...
     *
     * @method PADDsync.Physics.Arcade.Components.Enable#setDirectControl
     * @since 3.70.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.Components.Enable#enableBody
     * @since 3.0.0
     *
     ...
     * @return {this} This Game Object.
     *
     * @see PADDsync.Physics.Arcade.Body#enable
     * @see PADDsync.Physics.Arcade.StaticBody#enable
     * @see PADDsync.Physics.Arcade.Body#reset
     * @see PADDsync.Physics.Arcade.StaticBody#reset
     * @see PADDsync.GameObjects.GameObject#active
     * @see PADDsync.GameObjects.GameObject#visible
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Components.Enable#disableBody
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.Components.Enable#refreshBody
     * @since 3.1.0
     *
     * @return {this} This Game Object.
     *
