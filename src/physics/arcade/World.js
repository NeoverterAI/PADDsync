 ...
 *
 * An instance of the World belongs to a PADDsync.Scene and is accessed via the property `physics.world`.
 *
 * @class World
 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene to which this World instance belongs.
 * @param {PADDsync.Types.Physics.Arcade.ArcadeWorldConfig} config - An Arcade Physics Configuration object.
 */
var World = new Class({
    ...
    function World (scene, config)
    {
         ...
         *
         * @name PADDsync.Physics.Arcade.World#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Physics.Arcade.World#bodies
         * @type {PADDsync.Structs.Set.<PADDsync.Physics.Arcade.Body>}
         * @since 3.0.0
         */
        this.bodies = new Set();
         ...
         *
         * @name PADDsync.Physics.Arcade.World#staticBodies
         * @type {PADDsync.Structs.Set.<PADDsync.Physics.Arcade.StaticBody>}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#pendingDestroy
         * @type {PADDsync.Structs.Set.<(PADDsync.Physics.Arcade.Body|PADDsync.Physics.Arcade.StaticBody)>}
         * @since 3.1.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#colliders
         * @type {PADDsync.Structs.ProcessQueue.<PADDsync.Physics.Arcade.Collider>}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#gravity
         ...
         *
         * @name PADDsync.Physics.Arcade.World#bounds
         ...
         *
         * @name PADDsync.Physics.Arcade.World#checkCollision
         * @type {PADDsync.Types.Physics.Arcade.CheckCollisionObject}
         * @since 3.0.0
         */
        this.checkCollision = {
         ...
         *
         * @name PADDsync.Physics.Arcade.World#fps
         * @readonly
         * @type {number}
         * @default 60
         * @since 3.10.0
         ...
         *
         * @name PADDsync.Physics.Arcade.World#fixedStep
         * @type {boolean}
         * @default true
         * @since 3.23.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#_elapsed
         * @private
         * @type {number}
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#_frameTime
         * @private
         * @type {number}
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#_frameTimeMS
         * @private
         * @type {number}
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#stepsLastFrame
         * @readonly
         * @type {number}
         * @since 3.10.0
         */
         ...
         * - 0.5 = double speed
         *
         * @name PADDsync.Physics.Arcade.World#timeScale
         * @type {number}
         * @default 1
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#OVERLAP_BIAS
         * @type {number}
         * @default 4
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#TILE_BIAS
         * @type {number}
         * @default 16
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#forceX
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#isPaused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#_total
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Physics.Arcade.World#drawDebug
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#debugGraphic
         ...
         *
         * @name PADDsync.Physics.Arcade.World#defaults
         * @type {PADDsync.Types.Physics.Arcade.ArcadeWorldDefaults}
         * @since 3.0.0
         */
        this.defaults = {
         ...
         *
         * @name PADDsync.Physics.Arcade.World#maxEntries
         * @type {number}
         * @default 16
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#useTree
         * @type {boolean}
         * @default true
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#tree
         * @type {PADDsync.Structs.RTree}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#staticTree
         * @type {PADDsync.Structs.RTree}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#treeMinMax
         * @type {PADDsync.Types.Physics.Arcade.ArcadeWorldTreeMinMax}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#_tempMatrix
         ...
         * A temporary Transform Matrix used by bodies for calculations without them needing their own local copy.
         *
         * @name PADDsync.Physics.Arcade.World#_tempMatrix2
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.World#tileFilterOptions
         * @type {PADDsync.Types.Tilemaps.FilteringOptions}
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#enable
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[]|PADDsync.GameObjects.Group|PADDsync.GameObjects.Group[])} object - The object, or objects, on which to create the bodies.
     ...
     * method to have their bodies created.
     *
     * @method PADDsync.Physics.Arcade.World#enableBody
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} object - The Game Object on which to create the body.
     * @param {number} [bodyType] - The type of Body to create. Either `DYNAMIC_BODY` or `STATIC_BODY`.
     *
     * @return {PADDsync.GameObjects.GameObject} The Game Object on which the body was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#add
     * @since 3.10.0
     *
     * @param {(PADDsync.Physics.Arcade.Body|PADDsync.Physics.Arcade.StaticBody)} body - The Body to be added to the simulation.
     *
     * @return {(PADDsync.Physics.Arcade.Body|PADDsync.Physics.Arcade.StaticBody)} The Body that was added to the simulation.
     */
    add: function (body)
    {
     ...
     *
     * @method PADDsync.Physics.Arcade.World#disable
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[]|PADDsync.GameObjects.Group|PADDsync.GameObjects.Group[])} object - The object, or objects, on which to disable the bodies.
     */
     ...
     * means you can re-enable it again at any point by passing it to enable `World.enable` or `World.add`.
     *
     * @method PADDsync.Physics.Arcade.World#disableBody
     * @since 3.0.0
     *
     * @param {(PADDsync.Physics.Arcade.Body|PADDsync.Physics.Arcade.StaticBody)} body - The Body to be disabled.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#remove
     * @since 3.0.0
     *
     * @param {(PADDsync.Physics.Arcade.Body|PADDsync.Physics.Arcade.StaticBody)} body - The body to be removed from the simulation.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#createDebugGraphic
     * @since 3.0.0
     *
     * @return {PADDsync.GameObjects.Graphics} The Graphics object that was created for use by the World.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#setBounds
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Physics.Arcade.World} This World object.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#setBoundsCollision
     * @since 3.0.0
     *
     ...
     * checks.
     *
     * @method PADDsync.Physics.Arcade.World#pause
     * @fires PADDsync.Physics.Arcade.Events#PAUSE
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Arcade.World} This World object.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#resume
     * @fires PADDsync.Physics.Arcade.Events#RESUME
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Arcade.World} This World object.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#addCollider
     * @since 3.0.0
     * @see PADDsync.Physics.Arcade.World#collide
     *
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object to check for collision.
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object2 - The second object to check for collision.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - The callback to invoke when the two objects collide.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - The callback to invoke when the two objects collide. Must return a boolean.
     * @param {*} [callbackContext] - The scope in which to call the callbacks.
     *
     * @return {PADDsync.Physics.Arcade.Collider} The Collider that was created.
     */
     ...
     * as it will be handled for you automatically.
     *
     * @method PADDsync.Physics.Arcade.World#addOverlap
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object to check for overlap.
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object2 - The second object to check for overlap.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - The callback to invoke when the two objects overlap.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - The callback to invoke when the two objects overlap. Must return a boolean.
     * @param {*} [callbackContext] - The scope in which to call the callbacks.
     *
     * @return {PADDsync.Physics.Arcade.Collider} The Collider that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#removeCollider
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Arcade.Collider} collider - The Collider to remove from the simulation.
     *
     * @return {PADDsync.Physics.Arcade.World} This World object.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.World#setFPS
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.World#update
     * @fires PADDsync.Physics.Arcade.Events#WORLD_STEP
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.World#step
     * @fires PADDsync.Physics.Arcade.Events#WORLD_STEP
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.World#singleStep
     * @fires PADDsync.Physics.Arcade.Events#WORLD_STEP
     * @since 3.70.0
     */
    singleStep: function ()
     ...
     *
     * @method PADDsync.Physics.Arcade.World#postUpdate
     * @since 3.0.0
     */
    postUpdate: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Arcade.World#updateMotion
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Arcade.Body} body - The Body to be updated.
     ...
     *
     * @method PADDsync.Physics.Arcade.World#computeAngularVelocity
     * @since 3.10.0
     *
     * @param {PADDsync.Physics.Arcade.Body} body - The Body to compute the velocity for.
     ...
     *
     * @method PADDsync.Physics.Arcade.World#computeVelocity
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Arcade.Body} body - The Body to compute the velocity for.
     * @param {number} delta - The delta value to be used in the calculation, in seconds.
     ...
     *
     * @method PADDsync.Physics.Arcade.World#separate
     * @fires PADDsync.Physics.Arcade.Events#COLLIDE
     * @fires PADDsync.Physics.Arcade.Events#OVERLAP
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Arcade.Body} body1 - The first Body to be separated.
     * @param {PADDsync.Physics.Arcade.Body} body2 - The second Body to be separated.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - The process callback.
     ...
     *
     * @method PADDsync.Physics.Arcade.World#separateCircle
     * @fires PADDsync.Physics.Arcade.Events#COLLIDE
     * @fires PADDsync.Physics.Arcade.Events#OVERLAP
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.World#intersects
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Arcade.Body} body1 - The first body to check.
     * @param {PADDsync.Physics.Arcade.Body} body2 - The second body to check.
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.World#circleBodyIntersects
     * @since 3.0.0
     *
     * @param {PADDsync.Physics.Arcade.Body} circle - The circular body to test.
     * @param {PADDsync.Physics.Arcade.Body} body - The rectangular body to test.
     *
     * @return {boolean} True if the two bodies intersect, otherwise false.
     */
     ...
     *
     * See details in {@link PADDsync.Physics.Arcade.World#collide}.
     *
     * @method PADDsync.Physics.Arcade.World#overlap
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object or array of objects to check.
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} [object2] - The second object or array of objects to check, or `undefined`.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [overlapCallback] - An optional callback function that is called if the objects overlap.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they overlap. If this is set then `overlapCallback` will only be called if this callback returns `true`.
     ...
     *
     * If you don't require separation then use {@link PADDsync.Physics.Arcade.World#overlap} instead.
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.World#collide
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object or array of objects to check.
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} [object2] - The second object or array of objects to check, or `undefined`.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects collide.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
    ...
    /**
     * Internal helper function. Please use PADDsync.Physics.Arcade.World#collide instead.
     *
     * @method PADDsync.Physics.Arcade.World#collideObjects
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object to check for collision.
    ...
    /**
     * Internal helper function. Please use PADDsync.Physics.Arcade.World#collide and PADDsync.Physics.Arcade.World#overlap instead.
     *
     * @method PADDsync.Physics.Arcade.World#collideHandler
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Arcade.ArcadeColliderType} object1 - The first object or array of objects to check.
     ...
     *
     * @method PADDsync.Physics.Arcade.World#canCollide
     * @since 3.70.0
     *
     * @param {PADDsync.Types.Physics.Arcade.ArcadeCollider} body1 - The first body to check.
     * @param {PADDsync.Types.Physics.Arcade.ArcadeCollider} body2 - The second body to check.
     *
     ...
     * Please use PADDsync.Physics.Arcade.World#collide instead.
     *
     * @method PADDsync.Physics.Arcade.World#collideSpriteVsSprite
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} sprite1 - The first object to check for collision.
     * @param {PADDsync.GameObjects.GameObject} sprite2 - The second object to check for collision.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects collide.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} [callbackContext] - The context in which to run the callbacks.
     * @param {boolean} overlapOnly - Whether this is a collision or overlap check.
     ...
     * Please use PADDsync.Physics.Arcade.World#collide instead.
     *
     * @method PADDsync.Physics.Arcade.World#collideSpriteVsGroup
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} sprite - The first object to check for collision.
     * @param {PADDsync.GameObjects.Group} group - The second object to check for collision.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} collideCallback - The callback to invoke when the two objects collide.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} processCallback - The callback to invoke when the two objects collide. Must return a boolean.
     * @param {any} callbackContext - The scope in which to call the callbacks.
     * @param {boolean} overlapOnly - Whether this is a collision or overlap check.
     ...
     * Please use PADDsync.Physics.Arcade.World#collide instead.
     *
     * @method PADDsync.Physics.Arcade.World#collideGroupVsTilemapLayer
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Group} group - The first object to check for collision.
     * @param {PADDsync.Tilemaps.TilemapLayer} tilemapLayer - The second object to check for collision.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} collideCallback - An optional callback function that is called if the objects collide.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} processCallback - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} callbackContext - The context in which to run the callbacks.
     * @param {boolean} overlapOnly - Whether this is a collision or overlap check.
     ...
     *
     * @method PADDsync.Physics.Arcade.World#collideTiles
     * @fires PADDsync.Physics.Arcade.Events#TILE_COLLIDE
     * @since 3.17.0
     *
     * @param {PADDsync.GameObjects.GameObject} sprite - The first object to check for collision.
     * @param {PADDsync.Tilemaps.Tile[]} tiles - An array of Tiles to check for collision against.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects collide.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} [callbackContext] - The context in which to run the callbacks.
     *
     ...
     * This method does not factor in the Collision Mask or Category.
     *
     * @method PADDsync.Physics.Arcade.World#overlapTiles
     * @fires PADDsync.Physics.Arcade.Events#TILE_OVERLAP
     * @since 3.17.0
     *
     * @param {PADDsync.GameObjects.GameObject} sprite - The first object to check for collision.
     * @param {PADDsync.Tilemaps.Tile[]} tiles - An array of Tiles to check for collision against.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [overlapCallback] - An optional callback function that is called if the objects overlap.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `overlapCallback` will only be called if this callback returns `true`.
     * @param {any} [callbackContext] - The context in which to run the callbacks.
     *
     * @return {boolean} True if any objects overlap (with `overlapOnly`); or true if any overlapping objects were separated.
     */
     ...
     * Please use PADDsync.Physics.Arcade.World#collide instead.
     *
     * @method PADDsync.Physics.Arcade.World#collideSpriteVsTilemapLayer
     * @fires PADDsync.Physics.Arcade.Events#TILE_COLLIDE
     * @fires PADDsync.Physics.Arcade.Events#TILE_OVERLAP
     * @since 3.0.0
     *
     ...
     * Please use PADDsync.Physics.Arcade.World#collide instead.
     *
     * @method PADDsync.Physics.Arcade.World#collideSpriteVsTilesHandler
     * @fires PADDsync.Physics.Arcade.Events#TILE_COLLIDE
     * @fires PADDsync.Physics.Arcade.Events#TILE_OVERLAP
     * @private
     * @since 3.17.0
     ...
     * Please use PADDsync.Physics.Arcade.World#collide instead.
     *
     * @method PADDsync.Physics.Arcade.World#collideGroupVsGroup
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Group} group1 - The first object to check for collision.
     * @param {PADDsync.GameObjects.Group} group2 - The second object to check for collision.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [collideCallback] - An optional callback function that is called if the objects collide.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two objects if they collide. If this is set then `collideCallback` will only be called if this callback returns `true`.
     * @param {any} [callbackContext] - The context in which to run the callbacks.
     * @param {boolean} overlapOnly - Whether this is a collision or overlap check.
    ...
    /**
     * Wrap an object's coordinates (or several objects' coordinates) within {@link PADDsync.Physics.Arcade.World#bounds}.
     *
     * If the object is outside any boundary edge (left, top, right, bottom), it will be moved to the same offset from the opposite edge (the interior).
     *
     * @method PADDsync.Physics.Arcade.World#wrap
     * @since 3.3.0
     *
    ...
    /**
     * Wrap each object's coordinates within {@link PADDsync.Physics.Arcade.World#bounds}.
     *
     * @method PADDsync.Physics.Arcade.World#wrapArray
     * @since 3.3.0
     *
    ...
    /**
     * Wrap an object's coordinates within {@link PADDsync.Physics.Arcade.World#bounds}.
     *
     * @method PADDsync.Physics.Arcade.World#wrapObject
     * @since 3.3.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.World#shutdown
     * @since 3.0.0
     */
    shutdown: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Arcade.World#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
