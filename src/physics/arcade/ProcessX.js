 ...
 *
 * This method is called by `PADDsync.Physics.Arcade.SeparateX` and should not be
 * called directly.
 *
 * @function PADDsync.Physics.Arcade.ProcessX.Set
 * @ignore
 * @since 3.50.0
 *
 * @param {PADDsync.Physics.Arcade.Body} b1 - The first Body to separate.
 * @param {PADDsync.Physics.Arcade.Body} b2 - The second Body to separate.
 ...
 *
 * @function PADDsync.Physics.Arcade.ProcessX.BlockCheck
 * @ignore
 * @since 3.50.0
 *
 * @return {number} The BlockCheck result. 0 = not blocked. 1 = Body 1 blocked. 2 = Body 2 blocked.
 ...
 *
 * @function PADDsync.Physics.Arcade.ProcessX.Check
 * @ignore
 * @since 3.50.0
 *
 ...
 * The main check function. Runs through one of the four possible tests and returns the results.
 *
 * @function PADDsync.Physics.Arcade.ProcessX.Run
 * @ignore
 * @since 3.50.0
 *
 ...
 *
 * @function PADDsync.Physics.Arcade.ProcessX.RunImmovableBody1
 * @ignore
 * @since 3.50.0
 *
 ...
 *
 * @function PADDsync.Physics.Arcade.ProcessX.RunImmovableBody2
 * @ignore
 * @since 3.50.0
 *
 * @param {number} blockedState - The block state value.
...
/**
 * @namespace PADDsync.Physics.Arcade.ProcessX
 * @ignore
 */
