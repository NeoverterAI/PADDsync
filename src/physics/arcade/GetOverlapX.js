 ...
 *
 * @function PADDsync.Physics.Arcade.GetOverlapX
 * @since 3.0.0
 *
 * @param {PADDsync.Physics.Arcade.Body} body1 - The first Body to separate.
 * @param {PADDsync.Physics.Arcade.Body} body2 - The second Body to separate.
