 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Physics.Arcade.World} world - The Arcade Physics World instance.
 */
var Factory = new Class({
    ...
    function Factory (world)
    {
         ...
         *
         * @name PADDsync.Physics.Arcade.Factory#world
         ...
         *
         * @name PADDsync.Physics.Arcade.Factory#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Factory#sys
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#collider
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#overlap
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#existing
     * @since 3.0.0
     *
     * @generic {PADDsync.GameObjects.GameObject} G - [gameObject,$return]
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - A Game Object.
     * @param {boolean} [isStatic=false] - Create a Static body (true) or Dynamic body (false).
     *
     * @return {PADDsync.Types.Physics.Arcade.GameObjectWithBody} The Game Object.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#staticImage
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Types.Physics.Arcade.ImageWithStaticBody} The Image object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#image
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this Game Object in the world.
     * @param {number} y - The vertical position of this Game Object in the world.
     ...
     * @param {(string|number)} [frame] - An optional frame from the Texture this Game Object is rendering with.
     *
     * @return {PADDsync.Types.Physics.Arcade.ImageWithDynamicBody} The Image object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#staticSprite
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this Game Object in the world.
     * @param {number} y - The vertical position of this Game Object in the world.
     ...
     * @param {(string|number)} [frame] - An optional frame from the Texture this Game Object is rendering with.
     *
     * @return {PADDsync.Types.Physics.Arcade.SpriteWithStaticBody} The Sprite object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#sprite
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this Game Object in the world.
     * @param {number} y - The vertical position of this Game Object in the world.
     ...
     * @param {(string|number)} [frame] - An optional frame from the Texture this Game Object is rendering with.
     *
     * @return {PADDsync.Types.Physics.Arcade.SpriteWithDynamicBody} The Sprite object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#staticGroup
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Physics.Arcade.StaticGroup} The Static Group object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#group
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject[]|PADDsync.Types.Physics.Arcade.PhysicsGroupConfig|PADDsync.Types.GameObjects.Group.GroupCreateConfig)} [children] - Game Objects to add to this group; or the `config` argument.
     * @param {PADDsync.Types.Physics.Arcade.PhysicsGroupConfig|PADDsync.Types.GameObjects.Group.GroupCreateConfig} [config] - Settings for this group.
     *
     * @return {PADDsync.Physics.Arcade.Group} The Group object that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#body
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.Physics.Arcade.Body} The Body that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#staticBody
     * @since 3.60.0
     *
     * @param {number} x - The horizontal position of this Body in the physics world.
     * @param {number} y - The vertical position of this Body in the physics world.
     ...
     * @param {number} [height=64] - The height of the Body in pixels. Cannot be negative or zero.
     *
     * @return {PADDsync.Physics.Arcade.StaticBody} The Static Body that was created.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Factory#destroy
     * @since 3.5.0
     */
    destroy: function ()
    {
