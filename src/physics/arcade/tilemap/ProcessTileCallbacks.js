 ...
 *
 * @function PADDsync.Physics.Arcade.Tilemap.ProcessTileCallbacks
 * @since 3.0.0
 *
 * @param {PADDsync.Tilemaps.Tile} tile - The Tile to process.
 * @param {PADDsync.GameObjects.Sprite} sprite - The Game Object to process with the Tile.
 *
