 ...
 * Groups {@link PADDsync.Physics.Arcade.Group#defaults default values}.
 *
 ...
 *
 * If you wish to create a Group filled with Static Bodies, please see {@link PADDsync.Physics.Arcade.StaticGroup}.
 *
 * @class Group
...
var PhysicsGroup = new Class({
    ...
    function PhysicsGroup (world, scene, children, config)
    {
         ...
         *
         * @name PADDsync.Physics.Arcade.Group#world
         ...
         *
         * This should be either `PADDsync.Physics.Arcade.Image`, `PADDsync.Physics.Arcade.Sprite`, or a class extending one of those.
         *
         * @name PADDsync.Physics.Arcade.Group#classType
         * @type {function}
         ...
         *
         * @name PADDsync.Physics.Arcade.Group#physicsType
         * @type {number}
         ...
         *
         * @name PADDsync.Physics.Arcade.Group#collisionCategory
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Group#collisionMask
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name PADDsync.Physics.Arcade.Group#defaults
         * @type {PADDsync.Types.Physics.Arcade.PhysicsGroupDefaults}
         * @since 3.0.0
         */
        this.defaults = {
         ...
         *
         * @name PADDsync.Physics.Arcade.Group#type
         * @type {string}
     ...
     *
     * @method PADDsync.Physics.Arcade.Group#createCallbackHandler
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object being added.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Group#removeCallbackHandler
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object being removed.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Group#setVelocity
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Physics.Arcade.Group} This Physics Group object.
     */
     ...
     *
     * @method PADDsync.Physics.Arcade.Group#setVelocityX
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Arcade.Group#setVelocityY
     * @since 3.0.0
     *
     * @param {number} value - The velocity value.
