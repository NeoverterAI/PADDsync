 ...
 * this Game Object.
 *
 * @function PADDsync.Physics.Matter.MatterGameObject
 * @since 3.3.0
 *
 * @param {PADDsync.Physics.Matter.World} world - The Matter world to add the body to.
 * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object that will have the Matter body applied to it.
 ...
 *
 * @return {PADDsync.GameObjects.GameObject} The Game Object that was created with the Matter body.
 */
