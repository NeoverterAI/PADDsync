...
/**
 * @typedef {object} PADDsync.Physics.Matter.Events.CollisionActiveEvent
 *
 * @property {PADDsync.Types.Physics.Matter.MatterCollisionPair[]} pairs - A list of all affected pairs in the collision.
 ...
 *
 * @event PADDsync.Physics.Matter.Events#COLLISION_ACTIVE
 * @type {string}
 * @since 3.0.0
 *
 * @param {PADDsync.Physics.Matter.Events.CollisionActiveEvent} event - The Collision Event object.
