 ...
 *
 * @namespace PADDsync.Physics.Matter.Components.SetBody
 * @since 3.0.0
 */
var SetBody = {
     ...
     *
     * @method PADDsync.Physics.Matter.Components.SetBody#setRectangle
     * @since 3.0.0
     *
     ...
     * plugins, mass, friction, collision categories, etc. So be sure to re-apply these as needed.
     *
     * @method PADDsync.Physics.Matter.Components.SetBody#setCircle
     * @since 3.0.0
     *
     ...
     * plugins, mass, friction, collision categories, etc. So be sure to re-apply these as needed.
     *
     * @method PADDsync.Physics.Matter.Components.SetBody#setPolygon
     * @since 3.0.0
     *
     ...
     * plugins, mass, friction, collision categories, etc. So be sure to re-apply these as needed.
     *
     * @method PADDsync.Physics.Matter.Components.SetBody#setTrapezoid
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Components.SetBody#setExistingBody
     * @since 3.0.0
     *
     ...
     * plugins, mass, friction, collision categories, etc. So be sure to re-apply these as needed.
     *
     * @method PADDsync.Physics.Matter.Components.SetBody#setBody
     * @since 3.0.0
     *
     * @param {(string|PADDsync.Types.Physics.Matter.MatterSetBodyConfig)} config - Either a string, such as `circle`, or a Matter Set Body Configuration object.
     * @param {PADDsync.Types.Physics.Matter.MatterBodyConfig} [options] - An optional Body configuration object that is used to set initial Body properties on creation.
     *
     * @return {this} This Game Object instance.
     */
