 ...
 *
 * @namespace PADDsync.Physics.Matter.Components.Mass
 * @since 3.0.0
 */
var Mass = {
     ...
     *
     * @method PADDsync.Physics.Matter.Components.Mass#setMass
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Components.Mass#setDensity
     * @since 3.0.0
     *
     ...
     *
     * @name PADDsync.Physics.Matter.Components.Mass#centerOfMass
     * @type {PADDsync.Math.Vector2}
     * @readonly
     * @since 3.10.0
     *
     * @return {PADDsync.Math.Vector2} The center of mass.
     */
    centerOfMass: {
