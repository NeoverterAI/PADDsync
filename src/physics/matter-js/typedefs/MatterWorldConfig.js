/**
 * @typedef {object} PADDsync.Types.Physics.Matter.MatterWorldConfig
 * @since 3.0.0
 *
 * @property {PADDsync.Types.Math.Vector2Like} [gravity] - Sets {@link PADDsync.Physics.Matter.World#gravity}.
 ...
 * @property {(boolean|PADDsync.Types.Physics.Matter.MatterDebugConfig)} [debug=false] - Controls the Matter Debug Rendering options. If a boolean it will use the default values, otherwise, specify a Debug Config object.
 * @property {PADDsync.Types.Physics.Matter.MatterRunnerConfig} [runner] - Sets the Matter Runner options.
 */
