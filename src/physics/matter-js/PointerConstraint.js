 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - A reference to the Scene to which this Pointer Constraint belongs.
 * @param {PADDsync.Physics.Matter.World} world - A reference to the Matter World instance to which this Constraint belongs.
...
var PointerConstraint = new Class({
    ...
    function PointerConstraint (scene, world, options)
    {
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#world
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#camera
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#pointer
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#active
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#position
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#body
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#part
         * @type {?MatterJS.BodyType}
         * @since 3.16.2
         */
        this.part = null;
         ...
         *
         * @name PADDsync.Physics.Matter.PointerConstraint#constraint
     ...
     *
     * @method PADDsync.Physics.Matter.PointerConstraint#onDown
     * @since 3.0.0
     *
     * @param {PADDsync.Input.Pointer} pointer - A reference to the Pointer that was pressed.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.PointerConstraint#onUp
     * @since 3.22.0
     *
     * @param {PADDsync.Input.Pointer} pointer - A reference to the Pointer that was pressed.
     */
     ...
     * body.
     *
     * @method PADDsync.Physics.Matter.PointerConstraint#getBody
     * @fires PADDsync.Physics.Matter.Events#DRAG_START
     * @since 3.16.2
     *
     ...
     *
     * @method PADDsync.Physics.Matter.PointerConstraint#hitTestBody
     * @since 3.16.2
     *
     * @param {MatterJS.BodyType} body - The Matter Body to check.
     * @param {PADDsync.Math.Vector2} position - A translated hit test position.
     *
     ...
     *
     * @method PADDsync.Physics.Matter.PointerConstraint#update
     * @fires PADDsync.Physics.Matter.Events#DRAG
     * @since 3.0.0
     */
    update: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Matter.PointerConstraint#stopDrag
     * @fires PADDsync.Physics.Matter.Events#DRAG_END
     * @since 3.16.2
     */
    stopDrag: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Matter.PointerConstraint#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
