 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Phaser Scene that owns this Matter Physics instance.
 */
var MatterPhysics = new Class({
    ...
    function MatterPhysics (scene)
    {
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#systems
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#config
         * @type {PADDsync.Types.Physics.Matter.MatterWorldConfig}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#world
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#add
         * @type {PADDsync.Physics.Matter.Factory}
         * @since 3.0.0
         */
        this.add;
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#bodyBounds
         * @type {PADDsync.Physics.Matter.BodyBounds}
         * @since 3.22.0
         */
        this.bodyBounds;
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#body
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#composite
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#collision
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#detector
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#pair
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#pairs
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#query
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#resolver
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#constraint
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#bodies
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#composites
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#axes
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#bounds
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#svg
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#vector
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#vertices
         ...
         * A `Matter.Body` maintains a set of vertices to represent the shape of the object (its convex hull).
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#verts
         * @type {MatterJS.VerticesFactory}
         * @since 3.14.0
         */
        this.verts = Vertices;
         ...
         *
         * @name PADDsync.Physics.Matter.MatterPhysics#_tempVec2
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#boot
     * @private
     * @since 3.5.1
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#start
     * @private
     * @since 3.5.0
     */
    start: function ()
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#getConfig
     * @since 3.0.0
     *
     * @return {PADDsync.Types.Physics.Matter.MatterWorldConfig} The Matter World Config.
     */
    getConfig: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#pause
     * @fires PADDsync.Physics.Matter.Events#PAUSE
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Matter.World} The Matter World object.
     */
    pause: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#resume
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Matter.World} The Matter World object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#set60Hz
     * @since 3.4.0
     *
     ...
     * If you have set a custom `getDelta` function then this will override it.
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#set30Hz
     * @since 3.4.0
     *
     * @return {this} This Matter Physics instance.
     */
     ...
     * of your game.
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#step
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#containsPoint
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} body - The body, or an array of bodies, to check against the point.
     ...
     * transform them before passing them.
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#intersectPoint
     * @since 3.22.0
     *
     * @param {number} x - The horizontal coordinate of the point.
     * @param {number} y - The vertical coordinate of the point.
     * @param {PADDsync.Types.Physics.Matter.MatterBody[]} [bodies] - An array of bodies to check. If not provided it will search all bodies in the world.
     *
     * @return {PADDsync.Types.Physics.Matter.MatterBody[]} An array of bodies which contain the given point.
     */
     ...
     * If no bodies are provided it will search all bodies in the Matter World, including within Composites.
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#intersectRect
     * @since 3.22.0
     *
     ...
     * @param {PADDsync.Types.Physics.Matter.MatterBody[]} [bodies] - An array of bodies to check. If not provided it will search all bodies in the world.
     *
     * @return {PADDsync.Types.Physics.Matter.MatterBody[]} An array of bodies that intersect with the given area.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#intersectRay
     * @since 3.22.0
     *
     ...
     * @param {PADDsync.Types.Physics.Matter.MatterBody[]} [bodies] - An array of bodies to check. If not provided it will search all bodies in the world.
     *
     * @return {PADDsync.Types.Physics.Matter.MatterBody[]} An array of bodies whos vertices intersect with the ray segment.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#intersectBody
     * @since 3.22.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterBody} body - The target body.
     * @param {PADDsync.Types.Physics.Matter.MatterBody[]} [bodies] - An array of bodies to check the target body against. If not provided it will search all bodies in the world.
     *
     * @return {PADDsync.Types.Physics.Matter.MatterBody[]} An array of bodies whos vertices intersect with target body.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#overlap
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} target - The target body, or array of target bodies, to check.
     * @param {PADDsync.Types.Physics.Matter.MatterBody[]} [bodies] - The second body, or array of bodies, to check. If falsey it will check against all bodies in the world.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [overlapCallback] - An optional callback function that is called if the bodies overlap.
     * @param {PADDsync.Types.Physics.Arcade.ArcadePhysicsCallback} [processCallback] - An optional callback function that lets you perform additional checks against the two bodies if they overlap. If this is set then `overlapCallback` will only be invoked if this callback returns `true`.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#setCollisionCategory
     * @since 3.22.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterBody[]} bodies - An array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#setCollisionGroup
     * @since 3.22.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterBody[]} bodies - An array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#setCollidesWith
     * @since 3.22.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterBody[]} bodies - An array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#getMatterBodies
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#setVelocity
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#setVelocityX
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {number} x - The horizontal linear velocity value.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#setVelocityY
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {number} y - The vertical linear velocity value.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#setAngularVelocity
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#applyForce
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {PADDsync.Types.Math.Vector2Like} force - A Vector that specifies the force to apply.
     *
     * @return {this} This Matter Physics instance.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#applyForceFromPosition
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {PADDsync.Types.Math.Vector2Like} position - A Vector that specifies the world-space position to apply the force at.
     ...
     * Use very small speed values, such as 0.1, depending on the mass and required velocity.
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#applyForceFromAngle
     * @since 3.22.0
     *
     * @param {(PADDsync.Types.Physics.Matter.MatterBody|PADDsync.Types.Physics.Matter.MatterBody[])} bodies - Either a single Body, or an array of bodies to update. If falsey it will use all bodies in the world.
     * @param {number} speed - A speed value to be applied to a directional force.
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#getConstraintLength
     * @since 3.22.0
     *
     ...
     *
     * ```javascript
     * this.matter.alignBody(body, 400, 600, PADDsync.Display.Align.BOTTOM_CENTER);
     * ```
     *
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#alignBody
     * @since 3.22.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterBody} body - The Body to align.
     * @param {number} x - The horizontal position to align the body to.
     * @param {number} y - The vertical position to align the body to.
     * @param {number} align - One of the `PADDsync.Display.Align` constants, such as `PADDsync.Display.Align.TOP_LEFT`.
     *
     * @return {this} This Matter Physics instance.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.Physics.Matter.MatterPhysics#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function ()
