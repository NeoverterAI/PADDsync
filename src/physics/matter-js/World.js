...
/**
 * @classdesc
 * The Matter World class is responsible for managing one single instance of a Matter Physics World for PADDsync.
 *
 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene to which this Matter World instance belongs.
 * @param {PADDsync.Types.Physics.Matter.MatterWorldConfig} config - The Matter World configuration object.
 */
var World = new Class({
    ...
    function World (scene, config)
    {
         ...
         *
         * @name PADDsync.Physics.Matter.World#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Physics.Matter.World#engine
         ...
         *
         * @name PADDsync.Physics.Matter.World#localWorld
         * @type {MatterJS.World}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.World#walls
         * @type {PADDsync.Types.Physics.Matter.MatterWalls}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.World#enabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         * of your game.
         *
         * @name PADDsync.Physics.Matter.World#getDelta
         * @type {function}
         * @since 3.4.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.World#runner
         * @type {PADDsync.Types.Physics.Matter.MatterRunnerConfig}
         * @since 3.22.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.World#autoUpdate
         * @type {boolean}
         * @default true
         * @since 3.4.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.World#drawDebug
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.World#debugGraphic
         ...
         *
         * @name PADDsync.Physics.Matter.World#debugConfig
         * @type {PADDsync.Types.Physics.Matter.MatterDebugConfig}
         * @since 3.22.0
         */
        this.debugConfig = {
     ...
     *
     * @method PADDsync.Physics.Matter.World#setCompositeRenderStyle
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#setBodyRenderStyle
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#setConstraintRenderStyle
     * @since 3.22.0
     *
     ...
     * via this class.
     *
     * @method PADDsync.Physics.Matter.World#setEventsProxy
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#setBounds
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Physics.Matter.World} This Matter World object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#updateWall
     * @since 3.0.0
     *
    ...
    /**
     * Creates a PADDsync.GameObjects.Graphics object that is used to render all of the debug bodies and joints to.
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#createDebugGraphic
     * @since 3.0.0
     *
     * @return {PADDsync.GameObjects.Graphics} The newly created Graphics object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#disableGravity
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#setGravity
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#create
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#add
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#remove
     * @since 3.0.0
     *
     * @param {(object|object[])} object - Can be single object, or an array, and can be a body, composite or constraint.
     ...
     * Triggers `beforeRemove` and `afterRemove` events.
     *
     * @method PADDsync.Physics.Matter.World#removeConstraint
     * @since 3.0.0
     *
     ...
     * you should call the `PADDsync.Physics.Matter.World.convertTiles` function directly, passing
     * it an array of the tiles you've added to your map.
     *
     * @method PADDsync.Physics.Matter.World#convertTilemapLayer
     * @since 3.0.0
     *
     * @param {PADDsync.Tilemaps.TilemapLayer} tilemapLayer - An array of tiles.
     * @param {object} [options] - Options to be passed to the MatterTileBody constructor. {@see PADDsync.Physics.Matter.TileBody}
     *
     * @return {this} This Matter World object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#convertTiles
     * @since 3.0.0
     *
     * @param {PADDsync.Tilemaps.Tile[]} tiles - An array of tiles.
     * @param {object} [options] - Options to be passed to the MatterTileBody constructor. {@see PADDsync.Physics.Matter.TileBody}
     *
     * @return {this} This Matter World object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#nextGroup
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#nextCategory
     * @since 3.0.0
     *
     * @return {number} Unique category bitfield
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#pause
     ...
     *
     * @method PADDsync.Physics.Matter.World#resume
     * @fires PADDsync.Physics.Matter.Events#RESUME
     * @since 3.0.0
     *
     * @return {this} This Matter World object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#update
     * @since 3.0.0
     *
     ...
     * of your game.
     *
     * @method PADDsync.Physics.Matter.World#step
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#update60Hz
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#update30Hz
     * @since 3.4.0
     *
     * @return {number} The delta value to be passed to Engine.update.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#has
     * @since 3.22.0
     *
     * @param {(MatterJS.Body|PADDsync.GameObjects.GameObject)} body - The Matter Body, or Game Object, to search for within the world.
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#getAllBodies
     * @since 3.22.0
     *
     * @return {MatterJS.BodyType[]} An array of all the Matter JS Bodies in this World.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#getAllConstraints
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#getAllComposites
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#postUpdate
     * @private
     * @since 3.0.0
     */
    postUpdate: function ()
     ...
     *
     * @method PADDsync.Physics.Matter.World#renderGrid
     * @since 3.22.0
     *
     * @param {MatterJS.Grid} grid - The Matter Grid to be rendered.
     * @param {PADDsync.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     * you wish to render the Grid to your own Graphics instance.
     *
     * @method PADDsync.Physics.Matter.World#renderSeparations
     * @since 3.22.0
     *
     ...
     * you wish to render the Grid to your own Graphics instance.
     *
     * @method PADDsync.Physics.Matter.World#renderCollisions
     * @since 3.22.0
     *
     * @param {MatterJS.Pair[]} pairs - An array of Matter Pairs to be rendered.
     * @param {PADDsync.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     *
     * @method PADDsync.Physics.Matter.World#renderBodyBounds
     * @since 3.22.0
     *
     ...
     * you wish to render bounds to your own Graphics instance.
     *
     * @method PADDsync.Physics.Matter.World#renderBodyAxes
     * @since 3.22.0
     *
     * @param {array} bodies - An array of bodies from the localWorld.
     * @param {PADDsync.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     * you wish to render bounds to your own Graphics instance.
     *
     * @method PADDsync.Physics.Matter.World#renderBodyVelocity
     * @since 3.22.0
     *
     * @param {array} bodies - An array of bodies from the localWorld.
     * @param {PADDsync.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     *
     * @method PADDsync.Physics.Matter.World#renderBodies
     * @private
     * @since 3.14.0
     *
     * @param {array} bodies - An array of bodies from the localWorld.
     ...
     *
     * @method PADDsync.Physics.Matter.World#renderBody
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#renderConvexHull
     * @since 3.22.0
     *
     * @param {MatterJS.BodyType} body - The Matter Body to be rendered.
     * @param {PADDsync.GameObjects.Graphics} graphics - The Graphics object to render to.
     ...
     * Called automatically by the `postUpdate` method.
     *
     * @method PADDsync.Physics.Matter.World#renderJoints
     * @private
     * @since 3.14.0
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#renderConstraint
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.World#resetCollisionIDs
     * @since 3.17.0
     */
     ...
     *
     * @method PADDsync.Physics.Matter.World#shutdown
     * @since 3.0.0
     */
    shutdown: function ()
    {
     ...
     *
     * @method PADDsync.Physics.Matter.World#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
