 ...
 *
 * @param {PADDsync.Physics.Matter.World} world - The Matter world instance this body belongs to.
...
var MatterTileBody = new Class({
    ...
    function MatterTileBody (world, tile, options)
    {
         ...
         *
         * @name PADDsync.Physics.Matter.TileBody#tile
         ...
         *
         * @name PADDsync.Physics.Matter.TileBody#world
     ...
     *
     * @method PADDsync.Physics.Matter.TileBody#setFromTileRectangle
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterBodyTileOptions} [options] - Options to be used when creating the Matter body. See MatterJS.Body for a list of what Matter accepts.
     *
     * @return {PADDsync.Physics.Matter.TileBody} This TileBody object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.TileBody#setFromTileCollision
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterBodyTileOptions} [options] - Options to be used when creating the Matter body. See MatterJS.Body for a list of what Matter accepts.
     *
     ...
     * exists.
     *
     * @method PADDsync.Physics.Matter.TileBody#setBody
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.TileBody#removeBody
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Matter.TileBody} This TileBody object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.TileBody#destroy
     * @since 3.0.0
     *
     * @return {PADDsync.Physics.Matter.TileBody} This TileBody object.
     */
