 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Physics.Matter.World} world - The Matter World which this Factory adds to.
 */
var Factory = new Class({
    ...
    function Factory (world)
    {
         ...
         *
         * @name PADDsync.Physics.Matter.Factory#world
         ...
         *
         * @name PADDsync.Physics.Matter.Factory#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Physics.Matter.Factory#sys
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#rectangle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#trapezoid
     * @since 3.0.0
     *
     * @param {number} x - The X coordinate of the center of the Body.
     * @param {number} y - The Y coordinate of the center of the Body.
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#circle
     * @since 3.0.0
     *
     * @param {number} x - The X coordinate of the center of the Body.
     * @param {number} y - The Y coordinate of the center of the Body.
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#polygon
     * @since 3.0.0
     *
     * @param {number} x - The X coordinate of the center of the Body.
     * @param {number} y - The Y coordinate of the center of the Body.
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#fromVertices
     * @since 3.0.0
     *
     * @param {number} x - The X coordinate of the center of the Body.
     * @param {number} y - The Y coordinate of the center of the Body.
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#fromPhysicsEditor
     * @since 3.22.0
     *
     ...
     * ```
     *
     * @method PADDsync.Physics.Matter.Factory#fromSVG
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#fromJSON
     * @since 3.22.0
     *
     * @param {number} x - The X coordinate of the body.
     * @param {number} y - The Y coordinate of the body.
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#imageStack
     * @since 3.0.0
     *
     ...
     * This function uses the body bounds to prevent overlaps.
     *
     * @method PADDsync.Physics.Matter.Factory#stack
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this composite in the world.
     * @param {number} y - The vertical position of this composite in the world.
     ...
     * This function uses the body bounds to prevent overlaps.
     *
     * @method PADDsync.Physics.Matter.Factory#pyramid
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this composite in the world.
     * @param {number} y - The vertical position of this composite in the world.
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#chain
     * @since 3.0.0
     *
     ...
     * @param {PADDsync.Types.Physics.Matter.MatterConstraintConfig} [options] - An optional Constraint configuration object that is used to set initial Constraint properties on creation.
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#mesh
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#newtonsCradle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#car
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#softBody
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this composite in the world.
     * @param {number} y - The vertical position of this composite in the world.
     ...
     * @param {PADDsync.Types.Physics.Matter.MatterBodyConfig} [particleOptions] - An optional Body configuration object that is used to set initial Body properties on creation.
     * @param {PADDsync.Types.Physics.Matter.MatterConstraintConfig} [constraintOptions] - An optional Constraint configuration object that is used to set initial Constraint properties on creation.
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#joint
     * @since 3.0.0
     *
     ...
     * For compound bodies, constraints must be applied to the parent body and not one of its parts.
     *
     * @method PADDsync.Physics.Matter.Factory#spring
     * @since 3.0.0
     *
     * @param {MatterJS.BodyType} bodyA - The first possible `Body` that this constraint is attached to.
     * @param {MatterJS.BodyType} bodyB - The second possible `Body` that this constraint is attached to.
     ...
     * For compound bodies, constraints must be applied to the parent body and not one of its parts.
     *
     * @method PADDsync.Physics.Matter.Factory#constraint
     * @since 3.0.0
     *
     * @param {MatterJS.BodyType} bodyA - The first possible `Body` that this constraint is attached to.
     * @param {MatterJS.BodyType} bodyB - The second possible `Body` that this constraint is attached to.
     ...
     * For compound bodies, constraints must be applied to the parent body and not one of its parts.
     *
     * @method PADDsync.Physics.Matter.Factory#worldConstraint
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#mouseSpring
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterConstraintConfig} [options] - An optional Constraint configuration object that is used to set initial Constraint properties on creation.
     *
     ...
     * the `options` object on creation.
     *
     * @method PADDsync.Physics.Matter.Factory#pointerConstraint
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Physics.Matter.MatterConstraintConfig} [options] - An optional Constraint configuration object that is used to set initial Constraint properties on creation.
     *
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#image
     * @since 3.0.0
     *
     ...
     * @param {PADDsync.Types.Physics.Matter.MatterBodyConfig} [options] - An optional Body configuration object that is used to set initial Body properties on creation.
     *
     * @return {PADDsync.Physics.Matter.Image} The Matter Image Game Object.
     */
     ...
     * PADDsync.Physics.Matter.TileBody#setFromTileCollision for more information.
     *
     * @method PADDsync.Physics.Matter.Factory#tileBody
     * @since 3.0.0
     *
     * @param {PADDsync.Tilemaps.Tile} tile - The target tile that should have a Matter body.
     * @param {PADDsync.Types.Physics.Matter.MatterTileOptions} [options] - Options to be used when creating the Matter body.
     *
     * @return {PADDsync.Physics.Matter.TileBody} The Matter Tile Body Game Object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#sprite
     * @since 3.0.0
     *
     * @param {number} x - The horizontal position of this Game Object in the world.
     * @param {number} y - The vertical position of this Game Object in the world.
     ...
     * @param {PADDsync.Types.Physics.Matter.MatterBodyConfig} [options] - An optional Body configuration object that is used to set initial Body properties on creation.
     *
     * @return {PADDsync.Physics.Matter.Sprite} The Matter Sprite Game Object.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#gameObject
     * @since 3.3.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to inject the Matter Components in to.
     * @param {(PADDsync.Types.Physics.Matter.MatterBodyConfig|MatterJS.Body)} [options] - A Matter Body configuration object, or an instance of a Matter Body.
     * @param {boolean} [addToWorld=true] - Add this Matter Body to the World?
     *
     * @return {(PADDsync.Physics.Matter.Image|PADDsync.Physics.Matter.Sprite|PADDsync.GameObjects.GameObject)} The Game Object that had the Matter Components injected into it.
     */
     ...
     *
     * @method PADDsync.Physics.Matter.Factory#destroy
     * @since 3.5.0
     */
    destroy: function ()
    {
