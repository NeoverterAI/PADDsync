 ...
 *
 * @namespace PADDsync.Scale.ScaleModes
 ...
 * Phaser Scale Manager constants for the different scale modes available.
 *
 * To find out what each mode does please see [PADDsync.Scale.ScaleModes]{@link PADDsync.Scale.ScaleModes}.
 *
 * @typedef {PADDsync.Scale.ScaleModes} PADDsync.Scale.ScaleModeType
 * @memberof PADDsync.Scale
 * @since 3.16.0
 */
...
module.exports = {
     ...
     *
     * @name PADDsync.Scale.ScaleModes.NONE
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleModes.WIDTH_CONTROLS_HEIGHT
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleModes.HEIGHT_CONTROLS_WIDTH
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleModes.FIT
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleModes.ENVELOP
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleModes.RESIZE
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleModes.EXPAND
     * @type {number}
     * @const
     * @since 3.80.0
     */
