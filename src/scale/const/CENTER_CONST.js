 ...
 *
 * @namespace PADDsync.Scale.Center
 ...
 * Phaser Scale Manager constants for centering the game canvas.
 *
 * To find out what each mode does please see [PADDsync.Scale.Center]{@link PADDsync.Scale.Center}.
 *
 * @typedef {PADDsync.Scale.Center} PADDsync.Scale.CenterType
 * @memberof PADDsync.Scale
 * @since 3.16.0
 */
...
module.exports = {
    ...
    /**
     * The game canvas is not centered within the parent by PADDsync.
     * You can still center it yourself via CSS.
     *
     * @name PADDsync.Scale.Center.NO_CENTER
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.Center.CENTER_BOTH
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     * game canvas, and does not factor in any other CSS styles you may have applied.
     *
     * @name PADDsync.Scale.Center.CENTER_HORIZONTALLY
     * @type {number}
     * @const
     * @since 3.16.0
     */
     ...
     * game canvas, and does not factor in any other CSS styles you may have applied.
     *
     * @name PADDsync.Scale.Center.CENTER_VERTICALLY
     * @type {number}
     * @const
     * @since 3.16.0
     */
