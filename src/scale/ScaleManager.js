 ...
 * scale: {
 *     parent: 'yourgamediv',
 *     autoCenter: PADDsync.Scale.CENTER_BOTH,
 *     width: 800,
 *     height: 600
 * }
 * ```
...
var ScaleManager = new Class({
    ...
    function ScaleManager (game)
    {
         ...
         *
         * @name PADDsync.Scale.ScaleManager#game
         * @type {PADDsync.Game}
         * @readonly
         * @since 3.15.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#canvas
         ...
         *
         * @name PADDsync.Scale.ScaleManager#canvasBounds
         ...
         *
         * @name PADDsync.Scale.ScaleManager#parent
         * @type {?any}
         * @since 3.16.0
         */
        this.parent = null;
         ...
         *
         * @name PADDsync.Scale.ScaleManager#parentIsWindow
         * @type {boolean}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#parentSize
         * @type {PADDsync.Structs.Size}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#gameSize
         * @type {PADDsync.Structs.Size}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#baseSize
         * @type {PADDsync.Structs.Size}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#displaySize
         * @type {PADDsync.Structs.Size}
         * @since 3.16.0
         */
         ...
         * The game scale mode.
         *
         * @name PADDsync.Scale.ScaleManager#scaleMode
         * @type {PADDsync.Scale.ScaleModeType}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#zoom
         * @type {number}
         * @since 3.16.0
         */
        this.zoom = 1;
         ...
         *
         * @name PADDsync.Scale.ScaleManager#_resetZoom
         * @type {boolean}
         * @readonly
         * @since 3.19.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#displayScale
         ...
         *
         * @name PADDsync.Scale.ScaleManager#autoRound
         * @type {boolean}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#autoCenter
         * @type {PADDsync.Scale.CenterType}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#orientation
         * @type {PADDsync.Scale.OrientationType}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#fullscreen
         * @type {PADDsync.Device.Fullscreen}
         * @since 3.16.0
         */
        this.fullscreen;
         ...
         *
         * @name PADDsync.Scale.ScaleManager#fullscreenTarget
         * @type {?any}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#_createdFullscreenTarget
         * @type {boolean}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#dirty
         * @type {boolean}
         * @since 3.16.0
         */
        this.dirty = false;
         ...
         * checked here.
         *
         * @name PADDsync.Scale.ScaleManager#resizeInterval
         * @type {number}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#_lastCheck
         * @type {number}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#_checkOrientation
         * @type {boolean}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Scale.ScaleManager#domlisteners
         * @type {object}
         * @private
         * @since 3.16.0
         */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#preBoot
     * @protected
     * @listens PADDsync.Core.Events#BOOT
     * @since 3.16.0
     */
    preBoot: function ()
    {
    ...
    /**
     * The Boot handler is called by PADDsync.Game when it first starts up.
     * The renderer is available by now and the canvas has been added to the DOM.
     *
     * @method PADDsync.Scale.ScaleManager#boot
     * @protected
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.16.0
     */
    boot: function ()
    {
     ...
     *
     * @method PADDsync.Scale.ScaleManager#parseConfig
     * @protected
     * @since 3.16.0
     *
     * @param {PADDsync.Types.Core.GameConfig} config - The Game configuration object.
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#getParent
     * @since 3.16.0
     *
     * @param {PADDsync.Types.Core.GameConfig} config - The Game configuration object.
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#getParentBounds
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#lockOrientation
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#setParentSize
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#setGameSize
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#resize
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.16.0
     *
     * @param {number} width - The new width of the game.
     ...
     *
     * @method PADDsync.Scale.ScaleManager#setZoom
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#setMaxZoom
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.16.0
     *
     * @return {this} The Scale Manager instance.
     ...
     *
     * @method PADDsync.Scale.ScaleManager#setSnap
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.80.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#refresh
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#updateOrientation
     * @fires PADDsync.Scale.Events#ORIENTATION_CHANGE
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#updateScale
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#getMaxZoom
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#updateCenter
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#updateBounds
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#transformX
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#transformY
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#startFullscreen
     * @fires PADDsync.Scale.Events#ENTER_FULLSCREEN
     * @fires PADDsync.Scale.Events#FULLSCREEN_FAILED
     * @fires PADDsync.Scale.Events#FULLSCREEN_UNSUPPORTED
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#fullscreenSuccessHandler
     * @private
     * @fires PADDsync.Scale.Events#ENTER_FULLSCREEN
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.17.0
     ...
     *
     * @method PADDsync.Scale.ScaleManager#fullscreenErrorHandler
     * @private
     * @fires PADDsync.Scale.Events#FULLSCREEN_FAILED
     * @fires PADDsync.Scale.Events#RESIZE
     * @since 3.17.0
     ...
     *
     * @method PADDsync.Scale.ScaleManager#getFullscreenTarget
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#removeFullscreenTarget
     * @since 3.17.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#stopFullscreen
     * @fires PADDsync.Scale.Events#FULLSCREEN_UNSUPPORTED
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#leaveFullScreenSuccessHandler
     * @fires PADDsync.Scale.Events#LEAVE_FULLSCREEN
     * @since 3.85.0
     */
     ...
     * from fullscreen unless the iframe has the `allowfullscreen` attribute.
     *
     * @method PADDsync.Scale.ScaleManager#toggleFullscreen
     * @fires PADDsync.Scale.Events#ENTER_FULLSCREEN
     * @fires PADDsync.Scale.Events#LEAVE_FULLSCREEN
     * @fires PADDsync.Scale.Events#FULLSCREEN_UNSUPPORTED
     * @fires PADDsync.Scale.Events#RESIZE
     ...
     *
     * @method PADDsync.Scale.ScaleManager#startListeners
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#onFullScreenChange
     * @protected
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#onFullScreenError
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#getViewPort
     * @since 3.60.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The camera this viewport is respond upon.
     * @param {PADDsync.Geom.Rectangle} [out] - The Rectangle of visible area.
     *
     * @return {PADDsync.Geom.Rectangle} The Rectangle of visible area.
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#step
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Scale.ScaleManager#stopListeners
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Scale.ScaleManager#destroy
     * @since 3.16.0
     */
    destroy: function ()
    {
     ...
     *
     * @name PADDsync.Scale.ScaleManager#isFullscreen
     * @type {boolean}
     * @readonly
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleManager#width
     * @type {number}
     * @readonly
     * @since 3.16.0
     */
     ...
     * This is typically the size given in the game configuration.
     *
     * @name PADDsync.Scale.ScaleManager#height
     * @type {number}
     * @readonly
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleManager#isPortrait
     * @type {boolean}
     * @readonly
     * @since 3.16.0
     */
     ...
     * This value is usually only available on mobile devices.
     *
     * @name PADDsync.Scale.ScaleManager#isLandscape
     * @type {boolean}
     * @readonly
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleManager#isGamePortrait
     * @type {boolean}
     * @readonly
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Scale.ScaleManager#isGameLandscape
     * @type {boolean}
     * @readonly
     * @since 3.16.0
     */
