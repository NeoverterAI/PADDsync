 ...
 *
 * This is invoked automatically by the PADDsync.Game instance.
 *
 * @class RequestAnimationFrame
 * @memberof PADDsync.DOM
 * @constructor
 * @since 3.0.0
 */
var RequestAnimationFrame = new Class({
    ...
    function RequestAnimationFrame ()
    {
         ...
         *
         * @name PADDsync.DOM.RequestAnimationFrame#isRunning
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.DOM.RequestAnimationFrame#callback
         ...
         *
         * @name PADDsync.DOM.RequestAnimationFrame#isSetTimeOut
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.DOM.RequestAnimationFrame#timeOutID
         * @type {?number}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.DOM.RequestAnimationFrame#delay
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.DOM.RequestAnimationFrame#step
         * @type {FrameRequestCallback}
         * @since 3.0.0
         *
         ...
         *
         * @name PADDsync.DOM.RequestAnimationFrame#stepTimeout
         * @type {function}
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.DOM.RequestAnimationFrame#start
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.DOM.RequestAnimationFrame#stop
     * @since 3.0.0
     */
    stop: function ()
    {
     ...
     *
     * @method PADDsync.DOM.RequestAnimationFrame#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
