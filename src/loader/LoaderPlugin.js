 ...
 * @memberof PADDsync.Loader
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene which owns this Loader instance.
 */
var LoaderPlugin = new Class({
    ...
    function LoaderPlugin (scene)
    {
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#systems
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#cacheManager
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#textureManager
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#sceneManager
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#prefix
         * @type {string}
         * @default ''
         * @since 3.7.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#path
         * @type {string}
         * @default ''
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#baseURL
         * @type {string}
         * @default ''
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#maxParallelDownloads
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#xhr
         * @type {PADDsync.Types.Loader.XHRSettingsObject}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#crossOrigin
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#imageLoadType
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * This is populated by the `PADDsync.Core.Config#loaderLocalScheme` game configuration setting and defaults to
         * `[ 'file://', 'capacitor://' ]`. Additional local schemes can be added to this array as needed.
         *
         * @name PADDsync.Loader.LoaderPlugin#localSchemes
         * @type {string[]}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#totalToLoad
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#progress
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#list
         * @type {PADDsync.Structs.Set.<PADDsync.Loader.File>}
         * @since 3.0.0
         */
         ...
         * By the end of the load process this Set will be empty.
         *
         * @name PADDsync.Loader.LoaderPlugin#inflight
         * @type {PADDsync.Structs.Set.<PADDsync.Loader.File>}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#queue
         * @type {PADDsync.Structs.Set.<PADDsync.Loader.File>}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#_deleteQueue
         * @type {PADDsync.Structs.Set.<PADDsync.Loader.File>}
         * @private
         * @since 3.7.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#totalFailed
         * @type {number}
         * @default 0
         * @since 3.7.0
         */
         ...
         * This value is reset when you call `Loader.start`.
         *
         * @name PADDsync.Loader.LoaderPlugin#totalComplete
         * @type {number}
         * @default 0
         * @since 3.7.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#state
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Loader.LoaderPlugin#multiKeyIndex
         * @type {number}
         * @private
         * @since 3.20.0
         */
         ...
         * is changed.
         *
         * @name PADDsync.Loader.LoaderPlugin#maxRetries
         * @type {number}
         * @default 2
         * @since 3.85.0
         */
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#boot
     * @private
     * @since 3.5.1
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Loader.LoaderPlugin#pluginStart
     * @private
     * @since 3.5.1
     */
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#setBaseURL
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#setPath
     * @since 3.0.0
     *
     ...
     * file _already_ in the load queue. To reset it, call this method with no arguments.
     *
     * @method PADDsync.Loader.LoaderPlugin#setPrefix
     * @since 3.7.0
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#setCORS
     * @since 3.0.0
     *
     ...
     *
     * The file must be an instance of `PADDsync.Loader.File`, or a class that extends it. The Loader will check that the key
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#addFile
     * @fires PADDsync.Loader.Events#ADD
     * @since 3.0.0
     *
     * @param {(PADDsync.Loader.File|PADDsync.Loader.File[])} file - The file, or array of files, to be added to the load queue.
     */
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#keyExists
     * @since 3.7.0
     *
     * @param {PADDsync.Loader.File} file - The file to check the key of.
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#addPack
     * @since 3.7.0
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#removePack
     * @since 3.85.0
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#isLoading
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#isReady
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#start
     * @fires PADDsync.Loader.Events#START
     * @since 3.0.0
     */
    start: function ()
    {
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#updateProgress
     * @fires PADDsync.Loader.Events#PROGRESS
     * @since 3.0.0
     */
     ...
     * Called automatically during the load process.
     *
     * @method PADDsync.Loader.LoaderPlugin#update
     * @since 3.10.0
     */
    update: function ()
    {
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#checkLoadQueue
     * @private
     * @since 3.7.0
     */
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#nextFile
     * @fires PADDsync.Loader.Events#FILE_LOAD
     * @fires PADDsync.Loader.Events#FILE_LOAD_ERROR
     * @since 3.0.0
     *
     * @param {PADDsync.Loader.File} file - The File that just finished loading, or errored during load.
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#fileProcessComplete
     * @since 3.7.0
     *
     * @param {PADDsync.Loader.File} file - The file that has finished processing.
     */
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#loadComplete
     * @fires PADDsync.Loader.Events#COMPLETE
     * @fires PADDsync.Loader.Events#POST_PROCESS
     * @since 3.7.0
     */
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#flagForRemoval
     * @since 3.7.0
     *
     * @param {PADDsync.Loader.File} file - The File to be queued for deletion when the Loader completes.
     */
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#saveJSON
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#save
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#reset
     * @since 3.0.0
     */
    reset: function ()
    {
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.Loader.LoaderPlugin#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function ()
