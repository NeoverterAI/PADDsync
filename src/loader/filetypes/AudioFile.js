 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#audio method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#audio.
 *
 * @class AudioFile
 * @extends PADDsync.Loader.File
 ...
 * @param {(string|PADDsync.Types.Loader.FileTypes.AudioFileConfig)} key - The key to use for this file, or a file configuration object.
 * @param {PADDsync.Types.Loader.FileTypes.AudioFileURLConfig} [urlConfig] - The absolute or relative URL to load this file from in a config object.
...
var AudioFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.AudioFile#onProcess
     * @since 3.0.0
     */
    onProcess: function ()
    {
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.AudioFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Audio File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#audio
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.AudioFileConfig|PADDsync.Types.Loader.FileTypes.AudioFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {(string|string[]|PADDsync.Types.Loader.FileTypes.AudioFileURLConfig|PADDsync.Types.Loader.FileTypes.AudioFileURLConfig[])} [urls] - The absolute or relative URL to load the audio files from.
