 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#glsl method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#glsl.
 *
 * @class GLSLFile
 ...
 * @param {(string|PADDsync.Types.Loader.FileTypes.GLSLFileConfig)} key - The key to use for this file, or a file configuration object.
...
var GLSLFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.GLSLFile#onProcess
     * @since 3.7.0
     */
    onProcess: function ()
    {
     ...
     *
     * @method PADDsync.Loader.FileTypes.GLSLFile#addToCache
     * @since 3.17.0
     */
    addToCache: function ()
    {
     ...
     *
     * @method PADDsync.Loader.FileTypes.GLSLFile#getShaderName
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Loader.FileTypes.GLSLFile#getShaderType
     * @since 3.17.0
     *
     * @param {string[]} headerSource - The header data.
     *
     ...
     *
     * @method PADDsync.Loader.FileTypes.GLSLFile#getShaderUniforms
     * @since 3.17.0
     *
     * @param {string[]} headerSource - The header data.
     *
     ...
     *
     * @method PADDsync.Loader.FileTypes.GLSLFile#extractBlock
     * @private
     * @since 3.17.0
     *
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.GLSLFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the GLSL File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#glsl
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.GLSLFileConfig|PADDsync.Types.Loader.FileTypes.GLSLFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
