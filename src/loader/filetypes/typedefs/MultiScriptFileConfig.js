/**
 * @typedef {object} PADDsync.Types.Loader.FileTypes.MultiScriptFileConfig
 *
 ...
 * @property {PADDsync.Types.Loader.XHRSettingsObject} [xhrSettings] - Extra XHR Settings specifically for these files.
 */
