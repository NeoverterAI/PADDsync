/**
 * @typedef {object} PADDsync.Types.Loader.FileTypes.PackFileSection
 *
 * @property {PADDsync.Types.Loader.FileConfig[]} files - The files to load. See {@link PADDsync.Types.Loader.FileTypes}.
 * @property {string} [baseURL] - A URL used to resolve paths in `files`. Example: 'http://labs.phaser.io/assets/'.
 * @property {string} [defaultType] - The default {@link PADDsync.Types.Loader.FileConfig} `type`.
