 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#spritesheet method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#spritesheet.
 *
 ...
 * @param {(string|PADDsync.Types.Loader.FileTypes.SpriteSheetFileConfig)} key - The key to use for this file, or a file configuration object.
 * @param {string|string[]} [url] - The absolute or relative URL to load this file from. If undefined or `null` it will be set to `<key>.png`, i.e. if `key` was "alien" then the URL will be "alien.png".
 * @param {PADDsync.Types.Loader.FileTypes.ImageFrameConfig} [frameConfig] - The frame configuration object.
...
var SpriteSheetFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.SpriteSheetFile#addToCache
     * @since 3.7.0
     */
    addToCache: function ()
    {
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.SpriteSheetFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Sprite Sheet File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#spritesheet
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.SpriteSheetFileConfig|PADDsync.Types.Loader.FileTypes.SpriteSheetFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 ...
 * @param {PADDsync.Types.Loader.FileTypes.ImageFrameConfig} [frameConfig] - The frame configuration object. At a minimum it should have a `frameWidth` property.
