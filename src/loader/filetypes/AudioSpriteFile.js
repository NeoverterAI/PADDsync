 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#audioSprite method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#audioSprite.
 *
 * @class AudioSpriteFile
 * @extends PADDsync.Loader.MultiFile
 * @memberof PADDsync.Loader.FileTypes
 * @constructor
 * @since 3.7.0
 *
 * @param {PADDsync.Loader.LoaderPlugin} loader - A reference to the Loader that is responsible for this file.
 * @param {(string|PADDsync.Types.Loader.FileTypes.AudioSpriteFileConfig)} key - The key to use for this file, or a file configuration object.
 ...
 * @param {PADDsync.Types.Loader.XHRSettingsObject} [audioXhrSettings] - An XHR Settings configuration object for the audio file. Used in replacement of the Loaders default XHR Settings.
 * @param {PADDsync.Types.Loader.XHRSettingsObject} [jsonXhrSettings] - An XHR Settings configuration object for the json file. Used in replacement of the Loaders default XHR Settings.
 */
var AudioSpriteFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.AudioSpriteFile#onFileComplete
     * @since 3.7.0
     *
     * @param {PADDsync.Loader.File} file - The File that has completed processing.
     */
     ...
     *
     * @method PADDsync.Loader.FileTypes.AudioSpriteFile#addToCache
     * @since 3.7.0
     */
    addToCache: function ()
    {
 ...
 *
 * If the JSON file includes a 'resource' object then you can let PADDsync parse it and load the audio
 ...
 * its events to know when it's safe to use the asset. Please see the PADDsync.Loader.LoaderPlugin class for more details.
 *
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.AudioSpriteFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Audio Sprite File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#audioSprite
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.AudioSpriteFileConfig|PADDsync.Types.Loader.FileTypes.AudioSpriteFileConfig[])} key - The key to use for this file, or a file configuration object, or an array of objects.
 * @param {string} jsonURL - The absolute or relative URL to load the json file from. Or a well formed JSON object to use instead.
 * @param {(string|string[])} [audioURL] - The absolute or relative URL to load the audio file from. If empty it will be obtained by parsing the JSON file.
 * @param {any} [audioConfig] - The audio configuration options.
 * @param {PADDsync.Types.Loader.XHRSettingsObject} [audioXhrSettings] - An XHR Settings configuration object for the audio file. Used in replacement of the Loaders default XHR Settings.
