 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#animation method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#animation.
 *
 ...
 * @param {(string|PADDsync.Types.Loader.FileTypes.JSONFileConfig)} key - The key to use for this file, or a file configuration object.
...
var AnimationJSONFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.AnimationJSONFile#onProcess
     * @since 3.7.0
     */
    onProcess: function ()
    {
     ...
     *
     * @method PADDsync.Loader.FileTypes.AnimationJSONFile#onLoadComplete
     * @since 3.7.0
     */
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.JSONFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the JSON File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#animation
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.0.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.JSONFileConfig|PADDsync.Types.Loader.FileTypes.JSONFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {string} [url] - The absolute or relative URL to load this file from. If undefined or `null` it will be set to `<key>.json`, i.e. if `key` was "alien" then the URL will be "alien.json".
