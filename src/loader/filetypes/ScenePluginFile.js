 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#scenePlugin method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#scenePlugin.
 *
 ...
 * @param {(string|PADDsync.Types.Loader.FileTypes.ScenePluginFileConfig)} key - The key to use for this file, or a file configuration object.
...
var ScenePluginFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.ScenePluginFile#onProcess
     * @since 3.8.0
     */
    onProcess: function ()
    {
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.ScenePluginFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Script File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#scenePlugin
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.8.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.ScenePluginFileConfig|PADDsync.Types.Loader.FileTypes.ScenePluginFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
