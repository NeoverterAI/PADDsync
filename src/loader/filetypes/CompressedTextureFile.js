 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#texture method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#texture.
 *
 ...
 * @param {PADDsync.Types.Loader.FileTypes.CompressedTextureFileEntry} entry - The compressed texture file entry to load.
 * @param {PADDsync.Types.Loader.XHRSettingsObject} [xhrSettings] - Extra XHR Settings specifically for this file.
 */
var CompressedTextureFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.CompressedTextureFile#onFileComplete
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Loader.FileTypes.CompressedTextureFile#addToCache
     * @since 3.60.0
     */
    addToCache: function ()
    {
     ...
     *
     * @method PADDsync.Loader.FileTypes.CompressedTextureFile#addMultiToCache
     * @since 3.60.0
     */
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.CompressedTextureFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Compressed Texture File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#texture
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.60.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.CompressedTextureFileConfig|PADDsync.Types.Loader.FileTypes.CompressedTextureFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {PADDsync.Types.Loader.FileTypes.CompressedTextureFileConfig} [url] - The compressed texture configuration object. Not required if passing a config object as the `key` parameter.
 * @param {PADDsync.Types.Loader.XHRSettingsObject} [xhrSettings] - An XHR Settings configuration object. Used in replacement of the Loaders default XHR Settings.
 *
