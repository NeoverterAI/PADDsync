 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#font method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#font.
 *
 * @class FontFile
 ...
 * @param {(string|PADDsync.Types.Loader.FileTypes.FontFileConfig)} key - The key to use for this file, or a file configuration object.
...
var FontFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.FontFile#onProcess
     * @since 3.87.0
     */
    onProcess: function ()
    {
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.FontFileConfig` for more details.
 * 
 ...
 *
 * Note: The ability to load this type of file will only be available if the Font File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#font
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.87.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.FontFileConfig|PADDsync.Types.Loader.FileTypes.FontFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
 * @param {string} [url] - The absolute or relative URL to load this file from. If undefined or `null` it will be set to `<key>.ttf`, i.e. if `key` was "alien" then the URL will be "alien.ttf".
 * @param {string} [format='truetype'] - The font type. Should be a string, like 'truetype' or 'opentype'.
 * @param {object} [descriptors] - An optional object containing font descriptors for the Font Face. See https://developer.mozilla.org/en-US/docs/Web/API/FontFace/FontFace#descriptors for more details.
