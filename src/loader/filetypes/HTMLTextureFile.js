 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#htmlTexture method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#htmlTexture.
 *
 ...
 * @param {(string|PADDsync.Types.Loader.FileTypes.HTMLTextureFileConfig)} key - The key to use for this file, or a file configuration object.
...
var HTMLTextureFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.HTMLTextureFile#onProcess
     * @since 3.7.0
     */
    onProcess: function ()
    {
     ...
     *
     * @method PADDsync.Loader.FileTypes.HTMLTextureFile#addToCache
     * @since 3.7.0
     */
    addToCache: function ()
    {
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.HTMLTextureFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the HTMLTextureFile File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#htmlTexture
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.12.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.HTMLTextureFileConfig|PADDsync.Types.Loader.FileTypes.HTMLTextureFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
