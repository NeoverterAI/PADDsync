 ...
 *
 * These are created when you use the PADDsync.Loader.LoaderPlugin#pack method and are not typically created directly.
 *
 * For documentation about what all the arguments and configuration options mean please see PADDsync.Loader.LoaderPlugin#pack.
 *
 * @class PackFile
 ...
 * @param {(string|PADDsync.Types.Loader.FileTypes.PackFileConfig)} key - The key to use for this file, or a file configuration object.
...
var PackFile = new Class({
     ...
     *
     * @method PADDsync.Loader.FileTypes.PackFile#onProcess
     * @since 3.7.0
     */
    onProcess: function ()
    {
 ...
 * ```
 *
 * See the documentation for `PADDsync.Types.Loader.FileTypes.PackFileConfig` for more details.
 *
 ...
 *
 * Note: The ability to load this type of file will only be available if the Pack File type has been built into PADDsync.
 * It is available in the default build but can be excluded from custom builds.
 *
 * @method PADDsync.Loader.LoaderPlugin#pack
 * @fires PADDsync.Loader.Events#ADD
 * @since 3.7.0
 *
 * @param {(string|PADDsync.Types.Loader.FileTypes.PackFileConfig|PADDsync.Types.Loader.FileTypes.PackFileConfig[])} key - The key to use for this file, or a file configuration object, or array of them.
