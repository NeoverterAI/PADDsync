 ...
 *
 * @function PADDsync.Loader.XHRLoader
 * @since 3.0.0
 *
 * @param {PADDsync.Loader.File} file - The File to download.
 * @param {PADDsync.Types.Loader.XHRSettingsObject} globalXHRSettings - The global XHRSettings object.
 *
