...
/**
 * @namespace PADDsync.Plugins.PluginCache
 */
 ...
 *
 * @method PADDsync.Plugins.PluginCache.register
 * @since 3.8.0
 *
 ...
 *
 * @method PADDsync.Plugins.PluginCache.registerCustom
 * @since 3.8.0
 *
 * @param {string} key - A reference used to get this plugin from the plugin cache.
 * @param {function} plugin - The plugin to be stored. Should be the core object, not instantiated.
 ...
 *
 * @method PADDsync.Plugins.PluginCache.hasCore
 * @since 3.8.0
 *
 ...
 *
 * @method PADDsync.Plugins.PluginCache.hasCustom
 * @since 3.8.0
 *
 * @param {string} key - The key to check for.
 *
 ...
 *
 * @method PADDsync.Plugins.PluginCache.getCore
 * @since 3.8.0
 *
 * @param {string} key - The key of the core plugin to get.
 *
 * @return {PADDsync.Types.Plugins.CorePluginContainer} The core plugin object.
 */
 ...
 *
 * @method PADDsync.Plugins.PluginCache.getCustom
 * @since 3.8.0
 *
 * @param {string} key - The key of the custom plugin to get.
 *
 * @return {PADDsync.Types.Plugins.CustomPluginContainer} The custom plugin object.
 */
 ...
 *
 * @method PADDsync.Plugins.PluginCache.getCustomClass
 * @since 3.8.0
 *
 * @param {string} key - The key of the custom plugin to get.
 *
 ...
 *
 * @method PADDsync.Plugins.PluginCache.remove
 * @since 3.8.0
 *
 ...
 *
 * @method PADDsync.Plugins.PluginCache.removeCustom
 * @since 3.8.0
 *
 ...
 *
 * @method PADDsync.Plugins.PluginCache.destroyCorePlugins
 * @since 3.12.0
 */
 ...
 *
 * @method PADDsync.Plugins.PluginCache.destroyCustomPlugins
 * @since 3.12.0
 */
