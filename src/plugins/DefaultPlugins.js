 ...
 * The Default Plugins.
 *
 * @namespace PADDsync.Plugins.DefaultPlugins
...
var DefaultPlugins = {
    ...
    /**
     * These are the Global Managers that are created by the PADDsync.Game instance.
     * They are referenced from Scene.Systems so that plugins can use them.
     *
     * @name PADDsync.Plugins.DefaultPlugins.Global
     * @type {array}
     * @since 3.0.0
     */
    Global: [
     ...
     *
     * @name PADDsync.Plugins.DefaultPlugins.CoreScene
     * @type {array}
     * @since 3.0.0
     */
    CoreScene: [
     ...
     *
     * @name PADDsync.Plugins.DefaultPlugins.DefaultScene
     * @type {array}
     * @since 3.0.0
     */
    DefaultScene: [
