...
/**
 * @classdesc
 * The PluginManager is responsible for installing and adding plugins to PADDsync.
 *
 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - The game instance that owns this Plugin Manager.
 */
var PluginManager = new Class({
    ...
    function PluginManager (game)
    {
         ...
         *
         * @name PADDsync.Plugins.PluginManager#game
         * @type {PADDsync.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name PADDsync.Plugins.PluginManager#plugins
         * @type {PADDsync.Types.Plugins.GlobalPlugin[]}
         * @since 3.8.0
         */
        this.plugins = [];
         ...
         *
         * @name PADDsync.Plugins.PluginManager#scenePlugins
         * @type {string[]}
         * @since 3.8.0
         */
        this.scenePlugins = [];
         ...
         *
         * @name PADDsync.Plugins.PluginManager#_pendingGlobal
         * @private
         * @type {array}
         * @since 3.8.0
         */
         ...
         *
         * @name PADDsync.Plugins.PluginManager#_pendingScene
         * @private
         * @type {array}
         * @since 3.8.0
         */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#boot
     * @protected
     * @since 3.0.0
     */
    boot: function ()
     ...
     *
     * @method PADDsync.Plugins.PluginManager#addToScene
     * @protected
     * @since 3.8.0
     *
     * @param {PADDsync.Scenes.Systems} sys - The Scene Systems class to install all the plugins in to.
     ...
     *
     * @method PADDsync.Plugins.PluginManager#getDefaultScenePlugins
     * @protected
     * @since 3.8.0
     *
     ...
     *
     * @method PADDsync.Plugins.PluginManager#installScenePlugin
     * @since 3.8.0
     *
     ...
     * @param {string} [mapping] - If this plugin is injected into the PADDsync.Scene class, this is the property key to use.
     * @param {PADDsync.Scene} [addToScene] - Optionally automatically add this plugin to the given Scene.
     ...
     *
     * @method PADDsync.Plugins.PluginManager#install
     * @since 3.8.0
     *
     ...
     *
     * @return {?PADDsync.Plugins.BasePlugin} The plugin that was started, or `null` if `start` was false, or game isn't yet booted.
     */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#getIndex
     * @protected
     * @since 3.8.0
     *
     ...
     *
     * @method PADDsync.Plugins.PluginManager#getEntry
     * @protected
     * @since 3.8.0
     *
     * @param {string} key - The unique plugin key.
     *
     * @return {PADDsync.Types.Plugins.GlobalPlugin} The plugin entry.
     */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#isActive
     * @since 3.8.0
     *
     * @param {string} key - The unique plugin key.
     *
     ...
     *
     * @method PADDsync.Plugins.PluginManager#start
     * @since 3.8.0
     *
     ...
     *
     * @return {?PADDsync.Plugins.BasePlugin} The plugin that was started, or `null` if invalid key given or plugin is already stopped.
     */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#createEntry
     * @private
     * @since 3.9.0
     *
     ...
     * @param {string} [runAs] - Run the plugin under a new key. This allows you to run one plugin multiple times.
     *
     * @return {?PADDsync.Plugins.BasePlugin} The plugin that was started, or `null` if invalid key given.
     */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#stop
     * @since 3.8.0
     *
     ...
     *
     * @method PADDsync.Plugins.PluginManager#get
     * @since 3.8.0
     *
     ...
     *
     * @return {?(PADDsync.Plugins.BasePlugin|function)} The plugin, or `null` if no plugin was found matching the key.
     */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#getClass
     * @since 3.8.0
     *
     * @param {string} key - The key of the plugin to get.
     *
     * @return {PADDsync.Plugins.BasePlugin} A Plugin object
     */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#removeGlobalPlugin
     * @since 3.8.0
     *
     ...
     * It is up to you to remove all references to this plugin that you may hold within your game code.
     *
     * @method PADDsync.Plugins.PluginManager#removeScenePlugin
     * @since 3.8.0
     *
     * @param {string} key - The key of the plugin to remove.
     */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#registerGameObject
     * @since 3.8.0
     *
     ...
     *
     * @method PADDsync.Plugins.PluginManager#removeGameObject
     * @since 3.19.0
     *
     ...
     *
     * @method PADDsync.Plugins.PluginManager#registerFileType
     * @since 3.8.0
     *
     * @param {string} key - The key of the Game Object that the given callbacks will create, i.e. `image`, `sprite`.
     * @param {function} callback - The callback to invoke when the Game Object Factory is called.
     * @param {PADDsync.Scene} [addToScene] - Optionally add this file type into the Loader Plugin owned by the given Scene.
     */
     ...
     *
     * @method PADDsync.Plugins.PluginManager#destroy
     * @since 3.8.0
     */
    destroy: function ()
    {
