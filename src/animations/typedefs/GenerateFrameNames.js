/**
 * @typedef {object} PADDsync.Types.Animations.GenerateFrameNames
 * @since 3.0.0
 *
 ...
 * @property {PADDsync.Types.Animations.AnimationFrame[]} [outputArray=[]] - The array to append the created configuration objects to.
