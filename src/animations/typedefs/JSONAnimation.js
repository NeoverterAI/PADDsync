/**
 * @typedef {object} PADDsync.Types.Animations.JSONAnimation
 * @since 3.0.0
 *
 ...
 * @property {PADDsync.Types.Animations.JSONAnimationFrame[]} frames - An array of the AnimationFrame objects inside this Animation.
