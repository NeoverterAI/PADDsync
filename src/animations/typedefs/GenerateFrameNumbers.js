/**
 * @typedef {object} PADDsync.Types.Animations.GenerateFrameNumbers
 * @since 3.0.0
 *
 ...
 * @property {PADDsync.Types.Animations.AnimationFrame[]} [outputArray=[]] - An array to concatenate the output onto.
