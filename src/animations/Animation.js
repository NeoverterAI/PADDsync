...
var Animation = new Class({
    ...
    function Animation (manager, key, config)
    {
         ...
         *
         * @name PADDsync.Animations.Animation#showBeforeDelay
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Animations.Animation#randomFrame
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
     ...
     * @since 3.50.0
     *
     * @param {PADDsync.Animations.Animation} target - The target to set the values on.
     ...
     * @since 3.0.0
     *
     * @param {PADDsync.Animations.AnimationState} state - The Animation State belonging to the Game Object invoking this call.
     */
     ...
     * @since 3.0.0
     *
     * @param {PADDsync.Animations.AnimationState} state - The Animation State to advance.
     */
     ...
     * @since 3.12.0
     *
     * @return {PADDsync.Animations.AnimationFrame} The last Animation Frame.
     */
     ...
     * @since 3.12.0
     *
     * @param {PADDsync.Animations.AnimationState} state - The Animation State.
