 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - A reference to the PADDsync.Game instance.
 */
var AnimationManager = new Class({
    ...
    function AnimationManager (game)
    {
         ...
         *
         * @name PADDsync.Animations.AnimationManager#game
         * @type {PADDsync.Game}
         * @protected
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Animations.AnimationManager#textureManager
         ...
         *
         * @name PADDsync.Animations.AnimationManager#globalTimeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Animations.AnimationManager#anims
         ...
         *
         * @name PADDsync.Animations.AnimationManager#mixes
         * @type {PADDsync.Structs.Map.<string, PADDsync.Animations.Animation>}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Animations.AnimationManager#paused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Animations.AnimationManager#name
         * @type {string}
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Animations.AnimationManager#boot
     * @listens PADDsync.Core.Events#DESTROY
     * @since 3.0.0
     */
    boot: function ()
    {
     ...
     *
     * @method PADDsync.Animations.AnimationManager#addMix
     * @since 3.50.0
     *
     * @param {(string|PADDsync.Animations.Animation)} animA - The string-based key, or instance of, Animation A.
     * @param {(string|PADDsync.Animations.Animation)} animB - The string-based key, or instance of, Animation B.
     ...
     * new delay.
     *
     * @method PADDsync.Animations.AnimationManager#removeMix
     * @since 3.50.0
     *
     * @param {(string|PADDsync.Animations.Animation)} animA - The string-based key, or instance of, Animation A.
     * @param {(string|PADDsync.Animations.Animation)} [animB] - The string-based key, or instance of, Animation B. If not given, all mixes for Animation A will be removed.
     *
     * @return {this} This Animation Manager.
     */
     ...
     *
     * @method PADDsync.Animations.AnimationManager#getMix
     * @since 3.50.0
     *
     * @param {(string|PADDsync.Animations.Animation)} animA - The string-based key, or instance of, Animation A.
     * @param {(string|PADDsync.Animations.Animation)} animB - The string-based key, or instance of, Animation B.
     ...
     *
     * @method PADDsync.Animations.AnimationManager#add
     * @fires PADDsync.Animations.Events#ADD_ANIMATION
     * @since 3.0.0
     *
     * @param {string} key - The key under which the Animation should be added. The Animation will be updated with it. Must be unique.
     * @param {PADDsync.Animations.Animation} animation - The Animation which should be added to the Animation Manager.
     *
     * @return {this} This Animation Manager.
     */
     ...
     *
     * @method PADDsync.Animations.AnimationManager#exists
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Animations.AnimationManager#createFromAseprite
     * @since 3.50.0
     *
     ...
     * @param {(PADDsync.Animations.AnimationManager|PADDsync.GameObjects.GameObject)} [target] - Create the animations on this target Sprite. If not given, they will be created globally in this Animation Manager.
     *
     ...
     *
     * @method PADDsync.Animations.AnimationManager#create
     * @fires PADDsync.Animations.Events#ADD_ANIMATION
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Animations.AnimationManager#fromJSON
     * @since 3.0.0
     *
     * @param {(string|PADDsync.Types.Animations.JSONAnimations|PADDsync.Types.Animations.JSONAnimation)} data - The JSON object to parse.
     ...
     *
     * @return {PADDsync.Animations.Animation[]} An array containing all of the Animation objects that were created as a result of this call.
     */
     ...
     *
     * @method PADDsync.Animations.AnimationManager#generateFrameNames
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Animations.AnimationManager#generateFrameNumbers
     * @since 3.0.0
     *
     * @param {string} key - The key for the texture containing the animation frames.
     ...
     * Get an Animation.
     *
     * @method PADDsync.Animations.AnimationManager#get
     * @since 3.0.0
     *
     * @param {string} key - The key of the Animation to retrieve.
     *
     * @return {PADDsync.Animations.Animation} The Animation.
     */
    get: function (key)
    {
     ...
     *
     * @method PADDsync.Animations.AnimationManager#getAnimsFromTexture
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Animations.AnimationManager#pauseAll
     * @fires PADDsync.Animations.Events#PAUSE_ALL
     * @since 3.0.0
     *
     * @return {this} This Animation Manager.
     */
     ...
     *
     * @method PADDsync.Animations.AnimationManager#play
     * @since 3.0.0
     *
     ...
     * @param {PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[]} children - An array of Game Objects to play the animation on. They must have an Animation Component.
     *
     * @return {this} This Animation Manager.
     */
     ...
     * child 4: 0ms delay
     *
     * @method PADDsync.Animations.AnimationManager#staggerPlay
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Animations.AnimationManager#remove
     * @fires PADDsync.Animations.Events#REMOVE_ANIMATION
     * @since 3.0.0
     *
     * @param {string} key - The key of the animation to remove.
     *
     * @return {PADDsync.Animations.Animation} The Animation instance that was removed from the Animation Manager.
     */
    remove: function (key)
    {
     ...
     *
     * @method PADDsync.Animations.AnimationManager#resumeAll
     * @fires PADDsync.Animations.Events#RESUME_ALL
     * @since 3.0.0
     *
     * @return {this} This Animation Manager.
     */
     ...
     *
     * @method PADDsync.Animations.AnimationManager#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Types.Animations.JSONAnimations} The resulting JSONAnimations formatted object.
     */
    toJSON: function (key)
    {
        var output = {
     ...
     * This method should not be called directly. It will be called automatically as a response to a `destroy` event from the PADDsync.Game instance.
     *
     * @method PADDsync.Animations.AnimationManager#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
