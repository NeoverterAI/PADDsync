...
var AnimationState = new Class({
    ...
    function AnimationState (parent)
    {
         ...
         *
         * @name PADDsync.Animations.AnimationState#randomFrame
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Animations.AnimationState#showBeforeDelay
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Animations.AnimationState#createFromAseprite
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.Animations.Animation[]} An array of Animation instances that were successfully created.
     */
