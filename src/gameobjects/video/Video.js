...
var Video = new Class({
    ...
    function Video (scene, x, y, key)
    {
         ...
         *
         * @name PADDsync.GameObjects.Video#video
         ...
         * Will be `undefined` until a video is loaded for playback.
         *
         * @name PADDsync.GameObjects.Video#videoTexture
         ...
         * Will be `undefined` until a video is loaded for playback.
         *
         * @name PADDsync.GameObjects.Video#videoTextureSource
         * @type {?PADDsync.Textures.TextureSource}
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#snapshotTexture
         * @type {?PADDsync.Textures.CanvasTexture}
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#flipY
         * @type {boolean}
         * @since 3.20.0
         */
        this.flipY = false;
         ...
         *
         * @name PADDsync.GameObjects.Video#_key
         * @type {string}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#touchLocked
         * @type {boolean}
         * @readonly
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#playWhenUnlocked
         * @type {boolean}
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#frameReady
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#isStalled
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#failedPlayAttempts
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#metadata
         ...
         *
         * @name PADDsync.GameObjects.Video#retry
         * @type {number}
         * @since 3.20.0
         */
        this.retry = 0;
         ...
         *
         * @name PADDsync.GameObjects.Video#retryInterval
         * @type {number}
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_systemMuted
         * @type {boolean}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_codeMuted
         * @type {boolean}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_systemPaused
         * @type {boolean}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_codePaused
         * @type {boolean}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_callbacks
         * @type {any}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_loadCallbackHandler
         * @type {function}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_metadataCallbackHandler
         * @type {function}
         * @private
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_crop
         * @type {object}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#markers
         * @type {any}
         * @since 3.20.0
         */
        this.markers = {};
         ...
         * The in marker.
         *
         * @name PADDsync.GameObjects.Video#_markerIn
         * @type {number}
         * @private
         * @since 3.20.0
         */
         ...
         * The out marker.
         *
         * @name PADDsync.GameObjects.Video#_markerOut
         * @type {number}
         * @private
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_playingMarker
         * @type {boolean}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_lastUpdate
         * @type {number}
         * @private
         * @since 3.60.0
        */
         ...
         *
         * @name PADDsync.GameObjects.Video#cacheKey
         * @type {string}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#isSeeking
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_playCalled
         * @type {boolean}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_getFrame
         * @type {boolean}
         * @private
         * @since 3.85.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_rfvCallbackId
         * @type {number}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Video#_device
         * @type {string[]}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Video#load
     * @since 3.60.0
     *
     ...
     * go through the unlock process again.
     *
     * @method PADDsync.GameObjects.Video#changeSource
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#getVideoKey
     * @since 3.20.0
     *
     ...
     * go through the unlock process again.
     *
     * @method PADDsync.GameObjects.Video#loadURL
     * @since 3.60.0
     *
     * @param {(string|string[]|PADDsync.Types.Loader.FileTypes.VideoFileURLConfig|PADDsync.Types.Loader.FileTypes.VideoFileURLConfig[])} [urls] - The absolute or relative URL to load the video files from.
     ...
     *
     * @method PADDsync.GameObjects.Video#loadMediaStream
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#loadHandler
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#requestVideoFrame
     * @fires PADDsync.GameObjects.Events#VIDEO_CREATED
     * @fires PADDsync.GameObjects.Events#VIDEO_LOOP
     * @fires PADDsync.GameObjects.Events#VIDEO_COMPLETE
     * @fires PADDsync.GameObjects.Events#VIDEO_PLAY
     * @fires PADDsync.GameObjects.Events#VIDEO_TEXTURE
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#play
     * @since 3.20.0
     *
     * @param {boolean} [loop=false] - Should the video loop automatically when it reaches the end? Please note that not all browsers support _seamless_ video looping for all encoding formats.
     * @param {number} [markerIn] - Optional in marker time, in seconds, for playback of a sequence of the video.
     ...
     * If the video is already playing, or has been queued to play with `changeSource` then this method just returns.
     *
     * @method PADDsync.GameObjects.Video#getFirstFrame
     * @since 3.85.0
     *
     * @return {this} This Video Game Object for method chaining.
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#addLoadEventHandlers
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#removeLoadEventHandlers
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#addEventHandlers
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#removeEventHandlers
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#createPlayPromise
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#addMarker
     * @since 3.20.0
     *
     ...
     * See https://github.com/w3c/media-and-entertainment/issues/4 for more details about this issue.
     *
     * @method PADDsync.GameObjects.Video#playMarker
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#removeMarker
     * @since 3.20.0
     *
     ...
     * multiple times will overwrite the previous snapshot with the most recent one.
     *
     * @method PADDsync.GameObjects.Video#snapshotArea
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#saveSnapshotTexture
     * @since 3.20.0
     *
     * @param {string} key - The unique key to store the texture as within the global Texture Manager.
     *
     * @return {PADDsync.Textures.CanvasTexture} The Texture that was saved.
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#playSuccess
     * @fires PADDsync.GameObjects.Events#VIDEO_UNLOCKED
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#playError
     * @fires PADDsync.GameObjects.Events#VIDEO_ERROR
     * @fires PADDsync.GameObjects.Events#VIDEO_UNSUPPORTED
     * @fires PADDsync.GameObjects.Events#VIDEO_LOCKED
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#legacyPlayHandler
     * @since 3.60.0
     */
     ...
     * Called when the video emits a `playing` event.
     *
     * @method PADDsync.GameObjects.Video#playingHandler
     * @fires PADDsync.GameObjects.Events#VIDEO_PLAYING
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#loadErrorHandler
     * @fires PADDsync.GameObjects.Events#VIDEO_ERROR
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#metadataHandler
     * @fires PADDsync.GameObjects.Events#VIDEO_METADATA
     * @since 3.80.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#setSizeToFrame
     * @since 3.0.0
     *
     * @param {PADDsync.Textures.Frame|boolean} [frame] - The frame to base the size of this Game Object on.
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#stalledHandler
     * @fires PADDsync.GameObjects.Events#VIDEO_STALLED
     * @since 3.60.0
     *
     * @param {Event} event - The error Event.
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#completeHandler
     * @fires PADDsync.GameObjects.Events#VIDEO_COMPLETE
     * @since 3.20.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#preUpdate
     * @private
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#seekTo
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#getCurrentTime
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#setCurrentTime
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#seekingHandler
     * @fires PADDsync.GameObjects.Events#VIDEO_SEEKING
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#seekedHandler
     * @fires PADDsync.GameObjects.Events#VIDEO_SEEKED
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#getProgress
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#getDuration
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#setMute
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#isMuted
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#globalMute
     * @private
     * @since 3.20.0
     *
     * @param {(PADDsync.Sound.WebAudioSoundManager|PADDsync.Sound.HTML5AudioSoundManager)} soundManager - A reference to the Sound Manager that emitted the event.
     ...
     *
     * @method PADDsync.GameObjects.Video#globalPause
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#globalResume
     * @private
     * @since 3.20.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#setPaused
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#pause
     * @since 3.60.0
     *
     * @return {this} This Video Game Object for method chaining.
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#resume
     * @since 3.60.0
     *
     * @return {this} This Video Game Object for method chaining.
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#getVolume
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#setVolume
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#getPlaybackRate
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#setPlaybackRate
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#getLoop
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#setLoop
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#isPlaying
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#isPaused
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#saveTexture
     * @since 3.20.0
     *
     * @param {string} key - The unique key to store the texture as within the global Texture Manager.
     ...
     *
     * @method PADDsync.GameObjects.Video#stop
     * @fires PADDsync.GameObjects.Events#VIDEO_STOP
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Video#removeVideoElement
     * @since 3.20.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Video#preDestroy
     * @private
     * @since 3.21.0
     */
    preDestroy: function ()
