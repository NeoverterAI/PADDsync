 ...
 * @private
 *
 * @param {PADDsync.Renderer.WebGL.WebGLPipeline} pipeline - The WebGLPipeline. Must have a `batchQuad` method.
 * @param {PADDsync.GameObjects.BitmapText} src - The BitmapText Game Object.
 * @param {PADDsync.Types.GameObjects.BitmapText.BitmapTextCharacter} char - The character to render.
 * @param {PADDsync.Types.GameObjects.BitmapText.BitmapFontCharacterData} glyph - The character glyph.
 * @param {number} offsetX - The x offset.
 * @param {number} offsetY - The y offset.
 * @param {PADDsync.GameObjects.Components.TransformMatrix} calcMatrix - The transform matrix.
 ...
 * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture.
