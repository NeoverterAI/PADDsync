 ...
 * @private
 *
 * @param {(PADDsync.GameObjects.DynamicBitmapText|PADDsync.GameObjects.BitmapText)} src - The BitmapText to calculate the bounds values for.
 ...
 *
 * @return {PADDsync.Types.GameObjects.BitmapText.BitmapTextSize} The calculated bounds values of the BitmapText.
 */
