 ...
 *
 * @param {PADDsync.Scene} scene - The Scene to which this Game Object belongs. It can only belong to one Scene at any given time.
...
var BitmapText = new Class({
    ...
    function BitmapText (scene, x, y, font, text, size, align)
    {
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#font
         * @type {string}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#fontData
         * @type {PADDsync.Types.GameObjects.BitmapText.BitmapFontData}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#_text
         * @type {string}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#_fontSize
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#_letterSpacing
         * @type {number}
         * @private
         * @since 3.4.0
         */
         ...
         * Can be a negative or positive number.
         *
         * @name PADDsync.GameObjects.BitmapText#_lineSpacing
         * @type {number}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#_align
         * @type {number}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#_bounds
         * @type {PADDsync.Types.GameObjects.BitmapText.BitmapTextSize}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#_dirty
         * @type {boolean}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#_maxWidth
         * @type {number}
         * @private
         * @since 3.21.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#wordWrapCharCode
         * @type {number}
         * @since 3.21.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#charColors
         * @type {array}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * You can set this directly, or use `PADDsync.GameObjects.BitmapText#setDropShadow`.
         *
         * @name PADDsync.GameObjects.BitmapText#dropShadowX
         * @type {number}
         * @since 3.50.0
         */
        this.dropShadowX = 0;
         ...
         * You can set this directly, or use `PADDsync.GameObjects.BitmapText#setDropShadow`.
         *
         * @name PADDsync.GameObjects.BitmapText#dropShadowY
         * @type {number}
         * @since 3.50.0
         */
        this.dropShadowY = 0;
         ...
         * You can set this directly, or use `PADDsync.GameObjects.BitmapText#setDropShadow`.
         *
         * @name PADDsync.GameObjects.BitmapText#dropShadowColor
         * @type {number}
         * @since 3.50.0
         */
         ...
         * You can set this directly, or use `PADDsync.GameObjects.BitmapText#setDropShadow`.
         *
         * @name PADDsync.GameObjects.BitmapText#dropShadowAlpha
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.BitmapText#fromAtlas
         * @type {boolean}
         * @since 3.54.0
         * @readonly
         */
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setLeftAlign
     * @since 3.11.0
     *
     ...
     * This only has any effect if this BitmapText contains more than one line of text.
     *
     * @method PADDsync.GameObjects.BitmapText#setCenterAlign
     * @since 3.11.0
     *
     * @return {this} This BitmapText Object.
     */
     ...
     * This only has any effect if this BitmapText contains more than one line of text.
     *
     * @method PADDsync.GameObjects.BitmapText#setRightAlign
     * @since 3.11.0
     *
     * @return {this} This BitmapText Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setFontSize
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setLetterSpacing
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setLineSpacing
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setText
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setDropShadow
     * @webglOnly
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setCharacterTint
     * @webglOnly
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setWordTint
     * @webglOnly
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#getTextBounds
     * @since 3.0.0
     *
     * @param {boolean} [round=false] - Whether to round the results up to the nearest integer.
     *
     * @return {PADDsync.Types.GameObjects.BitmapText.BitmapTextSize} An object that describes the size of this Bitmap Text.
     */
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#getCharacterAt
     * @since 3.50.0
     *
     ...
     *
     * @return {PADDsync.Types.GameObjects.BitmapText.BitmapTextCharacter} The character object at the given position, or `null`.
     */
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#updateDisplayOrigin
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setFont
     * @since 3.11.0
     *
     * @param {string} font - The key of the font to use from the Bitmap Font cache.
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setMaxWidth
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#setDisplaySize
     * @since 3.61.0
     *
     ...
     * The alignment position is based on the longest line of text.
     *
     * @name PADDsync.GameObjects.BitmapText#align
     * @type {number}
     * @since 3.11.0
     */
    align: {
     ...
     *
     * @name PADDsync.GameObjects.BitmapText#text
     * @type {string}
     * @since 3.0.0
     */
    text: {
     ...
     *
     * @name PADDsync.GameObjects.BitmapText#fontSize
     * @type {number}
     * @since 3.0.0
     */
    fontSize: {
     ...
     *
     * @name PADDsync.GameObjects.BitmapText#letterSpacing
     * @type {number}
     * @since 3.0.0
     */
    letterSpacing: {
     ...
     *
     * @name PADDsync.GameObjects.BitmapText#lineSpacing
     * @type {number}
     * @since 3.60.0
     */
    lineSpacing: {
     ...
     * Disable maxWidth by setting the value to 0.
     *
     * @name PADDsync.GameObjects.BitmapText#maxWidth
     * @type {number}
     * @since 3.21.0
     */
    maxWidth: {
     ...
     *
     * @name PADDsync.GameObjects.BitmapText#width
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     * This property is read-only.
     *
     * @name PADDsync.GameObjects.BitmapText#height
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     * This property is read-only.
     *
     * @name PADDsync.GameObjects.BitmapText#displayWidth
     * @type {number}
     * @readonly
     * @since 3.60.0
     */
     ...
     * This property is read-only.
     *
     * @name PADDsync.GameObjects.BitmapText#displayHeight
     * @type {number}
     * @readonly
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#toJSON
     * @since 3.0.0
     *
     * @return {PADDsync.Types.GameObjects.BitmapText.JSONBitmapText} A JSON representation of this Bitmap Text.
     */
    toJSON: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.BitmapText#preDestroy
     * @protected
     * @since 3.50.0
     */
    preDestroy: function ()
 ...
 *
 * @name PADDsync.GameObjects.BitmapText.ALIGN_LEFT
 * @type {number}
 * @since 3.11.0
 */
 ...
 *
 * @name PADDsync.GameObjects.BitmapText.ALIGN_CENTER
 * @type {number}
 * @since 3.11.0
 */
 ...
 *
 * @name PADDsync.GameObjects.BitmapText.ALIGN_RIGHT
 * @type {number}
 * @since 3.11.0
 */
 ...
 *
 * @method PADDsync.GameObjects.BitmapText.ParseFromAtlas
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene to parse the Bitmap Font for.
 ...
 *
 * @method PADDsync.GameObjects.BitmapText.ParseXMLBitmapFont
 * @since 3.17.0
 *
 * @param {XMLDocument} xml - The XML Document to parse the font from.
 * @param {PADDsync.Textures.Frame} frame - The texture frame to take into account when creating the uv data.
 ...
 *
 * @return {PADDsync.Types.GameObjects.BitmapText.BitmapFontData} The parsed Bitmap Font data.
 */
