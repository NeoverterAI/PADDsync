 ...
 *
 * @function PADDsync.GameObjects.RetroFont.Parse
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - A reference to the Phaser Scene.
 * @param {PADDsync.Types.GameObjects.BitmapText.RetroFontConfig} config - The font configuration object.
 *
 * @return {PADDsync.Types.GameObjects.BitmapText.BitmapFontData} A parsed Bitmap Font data entry for the Bitmap Font cache.
 */
