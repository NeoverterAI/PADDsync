 ...
 * @extends PADDsync.GameObjects.BitmapText
...
var DynamicBitmapText = new Class({
    ...
    function DynamicBitmapText (scene, x, y, font, text, size, align)
    {
         ...
         *
         * @name PADDsync.GameObjects.DynamicBitmapText#scrollX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DynamicBitmapText#scrollY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DynamicBitmapText#cropWidth
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DynamicBitmapText#cropHeight
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DynamicBitmapText#displayCallback
         * @type {PADDsync.Types.GameObjects.BitmapText.DisplayCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DynamicBitmapText#callbackData
         * @type {PADDsync.Types.GameObjects.BitmapText.DisplayCallbackConfig}
         * @since 3.11.0
         */
        this.callbackData = {
            parent: this,
     ...
     *
     * @method PADDsync.GameObjects.DynamicBitmapText#setSize
     * @since 3.0.0
     *
     ...
     *
     * The callback receives a {@link PADDsync.Types.GameObjects.BitmapText.DisplayCallbackConfig} object that contains information about the character that's
     ...
     *
     * @method PADDsync.GameObjects.DynamicBitmapText#setDisplayCallback
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.BitmapText.DisplayCallback} callback - The display callback to set.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.DynamicBitmapText#setScrollX
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DynamicBitmapText#setScrollY
     * @since 3.0.0
     *
