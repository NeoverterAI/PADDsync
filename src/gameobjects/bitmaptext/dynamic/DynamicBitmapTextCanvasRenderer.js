 ...
 *
 * @method PADDsync.GameObjects.DynamicBitmapText#renderCanvas
 * @since 3.0.0
 * @private
 *
 * @param {PADDsync.Renderer.Canvas.CanvasRenderer} renderer - A reference to the current active Canvas renderer.
 * @param {PADDsync.GameObjects.DynamicBitmapText} src - The Game Object being rendered in this call.
