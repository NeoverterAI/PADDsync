 ...
 *
 * @method PADDsync.GameObjects.DOMElement#renderWebGL
 * @since 3.17.0
 * @private
 *
 * @param {PADDsync.Renderer.WebGL.WebGLRenderer} renderer - A reference to the current active renderer.
 * @param {PADDsync.GameObjects.DOMElement} src - The Game Object being rendered in this call.
