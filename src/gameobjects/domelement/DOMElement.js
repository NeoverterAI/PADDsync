 ...
 * ```
 *
 * You must also have a parent container for PADDsync. This is specified by the `parent` property in the
 * game config.
 *
 ...
 * Element that you wish to be placed under the control of PADDsync. For example:
 *
 * ```javascript
 * this.add.dom(x, y, 'div', 'background-color: lime; width: 220px; height: 100px; font: 48px Arial', 'PADDsync');
 * ```
 *
...
var DOMElement = new Class({
    ...
    function DOMElement (scene, x, y, element, style, innerText)
    {
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#parent
         * @type {Element}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#cache
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#node
         * @type {Element}
         * @since 3.17.0
         */
        this.node;
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#transformOnly
         * @type {boolean}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#skewX
         * @type {number}
         * @since 3.17.0
         */
        this.skewX = 0;
         ...
         * https://developer.mozilla.org/en-US/docs/Web/CSS/transform
         *
         * @name PADDsync.GameObjects.DOMElement#skewY
         * @type {number}
         * @since 3.17.0
         */
        this.skewY = 0;
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#rotate3d
         ...
         * https://developer.mozilla.org/en-US/docs/Web/CSS/transform-function/rotate3d
         *
         * @name PADDsync.GameObjects.DOMElement#rotate3dAngle
         * @type {string}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#pointerEvents
         * @type {string}
         * @since 3.55.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#width
         * @type {number}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#height
         * @type {number}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#displayWidth
         * @type {number}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#displayHeight
         * @type {number}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.DOMElement#handler
         * @type {number}
         * @private
         * @since 3.17.0
         */
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#handleSceneEvent
     * @private
     * @since 3.22.0
     *
     * @param {PADDsync.Scenes.Systems} sys - The Scene Systems.
     */
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#setSkew
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#setPerspective
     * @since 3.17.0
     *
     ...
     * **Changing this value changes it globally for all DOM Elements, as they all share the same parent container.**
     *
     * @name PADDsync.GameObjects.DOMElement#perspective
     * @type {number}
     * @since 3.17.0
     */
    perspective: {
     ...
     * ```
     *
     * @method PADDsync.GameObjects.DOMElement#addListener
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#removeListener
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#dispatchNativeEvent
     * @private
     * @since 3.17.0
     *
     ...
     *
     * ```javascript
     * this.add.dom().createElement('div', 'background-color: lime; width: 220px; height: 100px; font: 48px Arial', 'PADDsync');
     * ```
     *
     ...
     * };
     *
     * this.add.dom().createElement('div', style, 'PADDsync');
     * ```
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#createElement
     * @since 3.17.0
     *
     ...
     *
     * ```javascript
     * this.add.dom().setElement(h1, 'background-color: lime; width: 220px; height: 100px; font: 48px Arial', 'PADDsync');
     * ```
     *
     * And using a style object:
     *
     ...
     * };
     *
     * this.add.dom().setElement(h1, style, 'PADDsync');
     * ```
     *
     * @method PADDsync.GameObjects.DOMElement#setElement
     * @since 3.17.0
     *
     ...
     * Any event listeners you may have previously created will need to be re-created after this call.
     *
     * @method PADDsync.GameObjects.DOMElement#createFromCache
     * @since 3.17.0
     *
     ...
     * Any event listeners you may have previously created will need to be re-created after this call.
     *
     * @method PADDsync.GameObjects.DOMElement#createFromHTML
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#removeElement
     * @since 3.17.0
     *
     * @return {this} This DOM Element instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#updateSize
     * @since 3.17.0
     *
     * @return {this} This DOM Element instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#getChildByProperty
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#getChildByID
     * @since 3.17.0
     *
     ...
     * Be aware that class and id names are case-sensitive.
     *
     * @method PADDsync.GameObjects.DOMElement#getChildByName
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#setClassName
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#setText
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#setHTML
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#preRender
     * @private
     * @since 3.60.0
     */
    preRender: function ()
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#willRender
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.DOMElement#preDestroy
     * @private
     * @since 3.17.0
     */
    preDestroy: function ()
