 ...
 * performance by calling {@link PADDsync.GameObjects.Graphics#generateTexture}. This will 'bake' the Graphics object into
 ...
 *
 * @param {PADDsync.Scene} scene - The Scene to which this Graphics object belongs.
 * @param {PADDsync.Types.GameObjects.Graphics.Options} [options] - Options that set the position and default style of this Graphics object.
 */
var Graphics = new Class({
    ...
    function Graphics (scene, options)
    {
         ...
         *
         * @name PADDsync.GameObjects.Graphics#displayOriginX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Graphics#displayOriginY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Graphics#commandBuffer
         * @type {array}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Graphics#defaultFillColor
         * @type {number}
         * @readonly
         * @default -1
         * @since 3.0.0
         ...
         * Set this value with `setDefaultStyles()`.
         *
         * @name PADDsync.GameObjects.Graphics#defaultFillAlpha
         * @type {number}
         * @readonly
         * @default 1
         * @since 3.0.0
         ...
         * Set this value with `setDefaultStyles()`.
         *
         * @name PADDsync.GameObjects.Graphics#defaultStrokeWidth
         * @type {number}
         * @readonly
         * @default 1
         * @since 3.0.0
         ...
         * Set this value with `setDefaultStyles()`.
         *
         * @name PADDsync.GameObjects.Graphics#defaultStrokeColor
         * @type {number}
         * @readonly
         * @default -1
         * @since 3.0.0
         ...
         * Set this value with `setDefaultStyles()`.
         *
         * @name PADDsync.GameObjects.Graphics#defaultStrokeAlpha
         * @type {number}
         * @readonly
         * @default 1
         * @since 3.0.0
         ...
         *
         * @name PADDsync.GameObjects.Graphics#_lineWidth
         * @type {number}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#setDefaultStyles
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Graphics.Styles} options - The styles to set as defaults.
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#lineStyle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillStyle
     * @since 3.0.0
     *
     ...
     * entity at this time.
     *
     * @method PADDsync.GameObjects.Graphics#fillGradientStyle
     * @webglOnly
     * @since 3.12.0
     *
     ...
     * entity at this time.
     *
     * @method PADDsync.GameObjects.Graphics#lineGradientStyle
     * @webglOnly
     * @since 3.12.0
     *
     * @param {number} lineWidth - The stroke width.
     ...
     *
     * @method PADDsync.GameObjects.Graphics#beginPath
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#closePath
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillPath
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fill
     * @since 3.16.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokePath
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     * It was added to match the CanvasRenderingContext 2D API.
     *
     * @method PADDsync.GameObjects.Graphics#stroke
     * @since 3.16.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillCircleShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Circle} circle - The circle to fill.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeCircleShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Circle} circle - The circle to stroke.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillCircle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeCircle
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of the center of the circle.
     * @param {number} y - The y coordinate of the center of the circle.
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillRectShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Rectangle} rect - The rectangle to fill.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeRectShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Rectangle} rect - The rectangle to stroke.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillRect
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeRect
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of the top-left of the rectangle.
     * @param {number} y - The y coordinate of the top-left of the rectangle.
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillRoundedRect
     * @since 3.11.0
     *
     * @param {number} x - The x coordinate of the top-left of the rectangle.
     * @param {number} y - The y coordinate of the top-left of the rectangle.
     * @param {number} width - The width of the rectangle.
     * @param {number} height - The height of the rectangle.
     * @param {(PADDsync.Types.GameObjects.Graphics.RoundedRectRadius|number)} [radius=20] - The corner radius; It can also be an object to specify different radius for corners.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeRoundedRect
     * @since 3.11.0
     *
     * @param {number} x - The x coordinate of the top-left of the rectangle.
     * @param {number} y - The y coordinate of the top-left of the rectangle.
     * @param {number} width - The width of the rectangle.
     * @param {number} height - The height of the rectangle.
     * @param {(PADDsync.Types.GameObjects.Graphics.RoundedRectRadius|number)} [radius=20] - The corner radius; It can also be an object to specify different radii for corners.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillPointShape
     * @since 3.0.0
     *
     * @param {(PADDsync.Geom.Point|PADDsync.Math.Vector2|object)} point - The point to fill.
     ...
     * Draws a square at the given position, 1 pixel in size by default.
     *
     * @method PADDsync.GameObjects.Graphics#fillPoint
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillTriangleShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Triangle} triangle - The triangle to fill.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeTriangleShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Triangle} triangle - The triangle to stroke.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillTriangle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeTriangle
     * @since 3.0.0
     *
     * @param {number} x0 - The x coordinate of the first point.
     * @param {number} y0 - The y coordinate of the first point.
     ...
     * Draw the given line.
     *
     * @method PADDsync.GameObjects.Graphics#strokeLineShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Line} line - The line to stroke.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#lineBetween
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#lineTo
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#moveTo
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokePoints
     * @since 3.0.0
     *
     * @param {(array|PADDsync.Geom.Point[])} points - The points to stroke.
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillPoints
     * @since 3.0.0
     *
     * @param {(array|PADDsync.Geom.Point[])} points - The points to fill.
     * @param {boolean} [closeShape=false] - When `true`, the shape is closed by joining the last point to the first point.
     * @param {boolean} [closePath=false] - When `true`, the path is closed before being stroked.
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeEllipseShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Ellipse} ellipse - The ellipse to stroke.
     ...
     *
     * @method PADDsync.GameObjects.Graphics#strokeEllipse
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillEllipseShape
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Ellipse} ellipse - The ellipse to fill.
     * @param {number} [smoothness=32] - The number of points to draw the ellipse with.
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#fillEllipse
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of the center of the ellipse.
     * @param {number} y - The y coordinate of the center of the ellipse.
     ...
     *
     * Call {@link PADDsync.GameObjects.Graphics#fillPath} or {@link PADDsync.GameObjects.Graphics#strokePath} after calling
     * this method to draw the arc.
     *
     * @method PADDsync.GameObjects.Graphics#arc
     * @since 3.0.0
     *
     * @param {number} x - The x coordinate of the center of the circle.
     * @param {number} y - The y coordinate of the center of the circle.
     ...
     *
     * @method PADDsync.GameObjects.Graphics#slice
     * @since 3.4.0
     *
     ...
     *
     * The most recently saved state can then be restored with {@link PADDsync.GameObjects.Graphics#restore}.
     *
     * @method PADDsync.GameObjects.Graphics#save
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * Use {@link PADDsync.GameObjects.Graphics#save} to save the current state, and call this afterwards to restore that state.
     *
     * If there is no saved state, this command does nothing.
     *
     * @method PADDsync.GameObjects.Graphics#restore
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#translateCanvas
     * @since 3.0.0
     *
     ...
     * only of the objects drawn by it after calling this method.
     *
     * @method PADDsync.GameObjects.Graphics#scaleCanvas
     * @since 3.0.0
     *
     ...
     * only of the objects drawn by it after calling this method.
     *
     * @method PADDsync.GameObjects.Graphics#rotateCanvas
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#clear
     * @since 3.0.0
     *
     * @return {this} This Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Graphics#generateTexture
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Graphics#preDestroy
     * @protected
     * @since 3.9.0
     */
    preDestroy: function ()
 ...
 *
 * @name PADDsync.GameObjects.Graphics.TargetCamera
 * @type {PADDsync.Cameras.Scene2D.Camera}
 * @since 3.1.0
 */
