 ...
 * @since 3.0.0
 *
 * @param {PADDsync.GameObjects.Text} text - The Text object that this TextStyle is styling.
 * @param {PADDsync.Types.GameObjects.Text.TextStyle} style - The style settings to set.
 */
var TextStyle = new Class({
    ...
    function TextStyle (text, style)
    {
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#parent
         * @type {PADDsync.GameObjects.Text}
         * @since 3.0.0
         */
        this.parent = text;
         ...
         * The font family.
         *
         * @name PADDsync.GameObjects.TextStyle#fontFamily
         * @type {string}
         * @default 'Courier'
         * @since 3.0.0
         */
         ...
         * The font size.
         *
         * @name PADDsync.GameObjects.TextStyle#fontSize
         * @type {(string|number)}
         * @default '16px'
         * @since 3.0.0
         */
         ...
         * The font style.
         *
         * @name PADDsync.GameObjects.TextStyle#fontStyle
         * @type {string}
         * @since 3.0.0
         */
        this.fontStyle;
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#backgroundColor
         * @type {string}
         * @since 3.0.0
         */
         ...
         * The text fill color.
         *
         * @name PADDsync.GameObjects.TextStyle#color
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#stroke
         * @type {(string|CanvasGradient|CanvasPattern)}
         * @default '#fff'
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#strokeThickness
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#shadowOffsetX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#shadowOffsetY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * The shadow color.
         *
         * @name PADDsync.GameObjects.TextStyle#shadowColor
         * @type {string}
         * @default '#000'
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#shadowBlur
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#shadowStroke
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#shadowFill
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         * The text alignment.
         *
         * @name PADDsync.GameObjects.TextStyle#align
         * @type {string}
         * @default 'left'
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#maxLines
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#fixedWidth
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#fixedHeight
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#resolution
         * @type {number}
         * @default 0
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#rtl
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#testString
         * @type {string}
         * @default '|MÉqgy'
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#baselineX
         * @type {number}
         * @default 1.2
         * @since 3.3.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#baselineY
         * @type {number}
         * @default 1.4
         * @since 3.3.0
         */
         ...
         * re-wrap, use {@link PADDsync.GameObjects.TextStyle#setWordWrapWidth}.
         *
         * @name PADDsync.GameObjects.TextStyle#wordWrapWidth
         * @type {number | null}
         * @default null
         * @since 3.24.0
         */
         ...
         * {@link PADDsync.GameObjects.TextStyle#setWordWrapCallback}.
         *
         * @name PADDsync.GameObjects.TextStyle#wordWrapCallback
         ...
         * {@link PADDsync.GameObjects.TextStyle#setWordWrapCallback}.
         *
         * @name PADDsync.GameObjects.TextStyle#wordWrapCallbackScope
         * @type {object | null}
         * @default null
         * @since 3.24.0
         */
         ...
         * advanced setting and re-wrap, use {@link PADDsync.GameObjects.TextStyle#setWordWrapWidth}.
         *
         * @name PADDsync.GameObjects.TextStyle#wordWrapUseAdvanced
         * @type {boolean}
         * @default false
         * @since 3.24.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TextStyle#_font
         * @type {string}
         * @private
         * @since 3.0.0
         */
     ...
     * });
     *
     * @method PADDsync.GameObjects.TextStyle#setStyle
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Text.TextStyle} style - The style settings to set.
     ...
     *
     * @return {PADDsync.GameObjects.Text} The parent Text object.
     */
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#syncFont
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#syncStyle
     * @since 3.0.0
     *
     * @param {HTMLCanvasElement} canvas - The Canvas Element.
     * @param {CanvasRenderingContext2D} context - The Canvas Rendering Context.
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#syncShadow
     * @since 3.0.0
     *
     * @param {CanvasRenderingContext2D} context - The Canvas Rendering Context.
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#update
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setFont
     * @since 3.0.0
     *
     ...
     * Set the font family.
     *
     * @method PADDsync.GameObjects.TextStyle#setFontFamily
     * @since 3.0.0
     *
     ...
     * Set the font style.
     *
     * @method PADDsync.GameObjects.TextStyle#setFontStyle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setFontSize
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setTestString
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setFixedSize
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setBackgroundColor
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setFill
     * @since 3.0.0
     *
     ...
     * Set the text fill color.
     *
     * @method PADDsync.GameObjects.TextStyle#setColor
     * @since 3.0.0
     *
     * @param {(string|CanvasGradient|CanvasPattern)} color - The text fill color.
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setResolution
     * @since 3.12.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setStroke
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setShadow
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setShadowOffset
     * @since 3.0.0
     *
     * @param {number} [x=0] - The horizontal shadow offset.
     * @param {number} [y=0] - The vertical shadow offset.
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setShadowColor
     * @since 3.0.0
     *
     * @param {string} [color='#000'] - The shadow color.
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setShadowBlur
     * @since 3.0.0
     *
     * @param {number} [blur=0] - The shadow blur radius.
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setShadowStroke
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setShadowFill
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setWordWrapWidth
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setWordWrapCallback
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setAlign
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#setMaxLines
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#getTextMetrics
     * @since 3.0.0
     *
     * @return {PADDsync.Types.GameObjects.Text.TextMetrics} The text metrics.
     */
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TextStyle#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
