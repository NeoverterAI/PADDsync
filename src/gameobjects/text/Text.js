 ...
 * @extends PADDsync.GameObjects.Components.Crop
 ...
 * @param {PADDsync.Types.GameObjects.Text.TextStyle} style - The text style configuration object.
 *
...
var Text = new Class({
    ...
    function Text (scene, x, y, text, style)
    {
         ...
         *
         * @name PADDsync.GameObjects.Text#renderer
         ...
         *
         * @name PADDsync.GameObjects.Text#canvas
         ...
         *
         * @name PADDsync.GameObjects.Text#context
         ...
         *
         * @name PADDsync.GameObjects.Text#style
         * @type {PADDsync.GameObjects.TextStyle}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Text#autoRound
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Text#splitRegExp
         * @type {object}
         * @since 3.0.0
         */
        this.splitRegExp = /(?:\r\n|\r|\n)/;
         ...
         * The text to display.
         *
         * @name PADDsync.GameObjects.Text#_text
         * @type {string}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Text#padding
         * @type {PADDsync.Types.GameObjects.Text.TextPadding}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Text#width
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Text#height
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Text#lineSpacing
         * @type {number}
         * @since 3.13.0
         */
        this.lineSpacing = 0;
         ...
         * be sure to call `updateText` after, or you won't see the change reflected in the Text object.
         *
         * @name PADDsync.GameObjects.Text#letterSpacing
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Text#_crop
         * @type {object}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Text#_textureKey
         * @type {string}
         * @private
         * @since 3.80.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Text#initRTL
     * @since 3.0.0
     */
    initRTL: function ()
    {
     ...
     * bounds.
     *
     * @method PADDsync.GameObjects.Text#runWordWrap
     * @since 3.0.0
     *
     ...
     * single character.
     *
     * @method PADDsync.GameObjects.Text#advancedWordWrap
     * @since 3.0.0
     *
     * @param {string} text - The text to perform word wrap detection against.
     ...
     *
     * @method PADDsync.GameObjects.Text#basicWordWrap
     * @since 3.0.0
     *
     * @param {string} text - The text to perform word wrap detection against.
     * @param {CanvasRenderingContext2D} context - The Canvas Rendering Context.
     ...
     *
     * @method PADDsync.GameObjects.Text#getWrappedText
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setText
     * @since 3.0.0
     *
     ...
     * An array of strings will be joined with `\n` line breaks.
     *
     * @method PADDsync.GameObjects.Text#appendText
     * @since 3.60.0
     *
     ...
     * });
     *
     * @method PADDsync.GameObjects.Text#setStyle
     * @since 3.0.0
     *
     ...
     * ```
     *
     * @method PADDsync.GameObjects.Text#setFont
     * @since 3.0.0
     *
     ...
     * ```
     *
     * @method PADDsync.GameObjects.Text#setFontFamily
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setFontSize
     * @since 3.0.0
     *
     ...
     * Set the font style.
     *
     * @method PADDsync.GameObjects.Text#setFontStyle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setFixedSize
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setBackgroundColor
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setFill
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setColor
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setStroke
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setShadow
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setShadowOffset
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setShadowColor
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setShadowBlur
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setShadowStroke
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setShadowFill
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setWordWrapWidth
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setWordWrapCallback
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setAlign
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setResolution
     * @since 3.12.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setLineSpacing
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setLetterSpacing
     * @since 3.70.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setPadding
     * @since 3.0.0
     *
     * @param {(number|PADDsync.Types.GameObjects.Text.TextPadding)} left - The left padding value, or a padding config object.
     ...
     *
     * @method PADDsync.GameObjects.Text#setMaxLines
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#setRTL
     * @since 3.70.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Text#updateText
     * @since 3.0.0
     *
     * @return {this} This Text object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Text#getTextMetrics
     * @since 3.0.0
     *
     ...
     *
     * @name PADDsync.GameObjects.Text#text
     * @type {string}
     * @since 3.0.0
     */
    text: {
     ...
     *
     * @method PADDsync.GameObjects.Text#toJSON
     * @since 3.0.0
     *
     * @return {PADDsync.Types.GameObjects.JSONGameObject} A JSON representation of the Text object.
     */
    toJSON: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.Text#preDestroy
     * @protected
     * @since 3.0.0
     */
    preDestroy: function ()
     ...
     *
     * @name PADDsync.GameObjects.Text#originX
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Text#originY
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
