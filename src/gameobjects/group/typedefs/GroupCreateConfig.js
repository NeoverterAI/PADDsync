 ...
 *
 * `key` is required. {@link PADDsync.GameObjects.Group#defaultKey} is not used.
 *
 * @typedef {object} PADDsync.Types.GameObjects.Group.GroupCreateConfig
 * @since 3.0.0
 *
 ...
 * @property {?PADDsync.Types.Input.HitAreaCallback} [hitAreaCallback] - A callback to be invoked when the Game Object is interacted with.
 * @property {?(false|PADDsync.Types.Actions.GridAlignConfig)} [gridAlign=false] - Align the new Game Objects in a grid using these settings.
 *
 * @see PADDsync.Actions.GridAlign
 * @see PADDsync.Actions.SetAlpha
 * @see PADDsync.Actions.SetHitArea
 * @see PADDsync.Actions.SetRotation
 * @see PADDsync.Actions.SetScale
 * @see PADDsync.Actions.SetXY
 * @see PADDsync.Actions.SetDepth
 * @see PADDsync.Actions.SetScrollFactor
 * @see PADDsync.GameObjects.Group#createFromConfig
 * @see PADDsync.Utils.Array.Range
 */
