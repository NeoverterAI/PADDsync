 ...
 * @param {PADDsync.Types.GameObjects.Group.GroupConfig|PADDsync.Types.GameObjects.Group.GroupCreateConfig} [config] - Settings for this group. If `key` is set, PADDsync.GameObjects.Group#createMultiple is also called with these settings.
 *
 * @see PADDsync.Physics.Arcade.Group
 * @see PADDsync.Physics.Arcade.StaticGroup
 */
var Group = new Class({
    ...
    function Group (scene, children, config)
    {
         ...
         *
         * @name PADDsync.GameObjects.Group#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.GameObjects.Group#children
         ...
         *
         * @name PADDsync.GameObjects.Group#isParent
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#type
         * @type {string}
         * @default 'Group'
         * @since 3.21.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#classType
         * @type {function}
         * @since 3.0.0
         * @default PADDsync.GameObjects.Sprite
         * @see PADDsync.Types.GameObjects.Group.GroupClassTypeConstructor
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#name
         * @type {string}
         * @default ''
         * @since 3.18.0
         */
        ...
        /**
         * Whether this group runs its {@link PADDsync.GameObjects.Group#preUpdate} method (which may update any members).
         *
         * @name PADDsync.GameObjects.Group#active
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#maxSize
         * @type {number}
         * @since 3.0.0
         * @default -1
         */
         ...
         *
         * This is used in {@link PADDsync.GameObjects.Group#create}
         * but not in {@link PADDsync.GameObjects.Group#createMultiple}.
         *
         * @name PADDsync.GameObjects.Group#defaultKey
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#defaultFrame
         * @type {(string|number)}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#runChildUpdate
         * @type {boolean}
         * @default false
         * @since 3.0.0
         * @see PADDsync.GameObjects.Group#preUpdate
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#createCallback
         * @type {?PADDsync.Types.GameObjects.Group.GroupCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#removeCallback
         * @type {?PADDsync.Types.GameObjects.Group.GroupCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#createMultipleCallback
         * @type {?PADDsync.Types.GameObjects.Group.GroupMultipleCreateCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Group#internalCreateCallback
         * @type {?PADDsync.Types.GameObjects.Group.GroupCallback}
         * @private
         * @since 3.22.0
         */
         ...
         * For internal use only by a Group, or any class that extends it.
         *
         * @name PADDsync.GameObjects.Group#internalRemoveCallback
         * @type {?PADDsync.Types.GameObjects.Group.GroupCallback}
         * @private
         * @since 3.22.0
         */
    ...
    /**
     * Creates a new Game Object and adds it to this group, unless the group {@link PADDsync.GameObjects.Group#isFull is full}.
     *
     * Calls {@link PADDsync.GameObjects.Group#createCallback}.
     *
     * @method PADDsync.GameObjects.Group#create
     * @since 3.0.0
     *
     ...
     * @param {boolean} [visible=true] - The {@link PADDsync.GameObjects.Components.Visible#visible} state of the new Game Object.
     * @param {boolean} [active=true] - The {@link PADDsync.GameObjects.GameObject#active} state of the new Game Object.
     *
     ...
     *
     * If the group becomes {@link PADDsync.GameObjects.Group#isFull}, no further Game Objects are created.
     *
     * Calls {@link PADDsync.GameObjects.Group#createMultipleCallback} and {@link PADDsync.GameObjects.Group#createCallback}.
     *
     * @method PADDsync.GameObjects.Group#createMultiple
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Group.GroupCreateConfig|PADDsync.Types.GameObjects.Group.GroupCreateConfig[]} config - Creation settings. This can be a single configuration object or an array of such objects, which will be applied in turn.
     *
    ...
    /**
     * A helper for {@link PADDsync.GameObjects.Group#createMultiple}.
     *
     * @method PADDsync.GameObjects.Group#createFromConfig
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Group.GroupCreateConfig} options - Creation settings.
     *
     * @return {any[]} The newly created Game Objects.
     */
    ...
    /**
     * Updates any group members, if {@link PADDsync.GameObjects.Group#runChildUpdate} is enabled.
     *
     * @method PADDsync.GameObjects.Group#preUpdate
     * @since 3.0.0
     *
     ...
     * Calls {@link PADDsync.GameObjects.Group#createCallback}.
     *
     * @method PADDsync.GameObjects.Group#add
     * @since 3.0.0
     *
     ...
     * Calls {@link PADDsync.GameObjects.Group#createCallback}.
     *
     * @method PADDsync.GameObjects.Group#addMultiple
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject[]} children - The Game Objects to add.
     ...
     *
     * Calls {@link PADDsync.GameObjects.Group#removeCallback}.
     *
     * @method PADDsync.GameObjects.Group#remove
     * @since 3.0.0
     *
     ...
     *
     * Does not call {@link PADDsync.GameObjects.Group#removeCallback}.
     *
     * @method PADDsync.GameObjects.Group#clear
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#contains
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} child - A Game Object.
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#getChildren
     * @since 3.0.0
     *
     * @return {PADDsync.GameObjects.GameObject[]} The group members.
     */
     ...
     *
     * @method PADDsync.GameObjects.Group#getLength
     * @since 3.0.0
     *
     * @return {number}
     */
     ...
     * the first 50.
     *
     * @method PADDsync.GameObjects.Group#getMatching
     * @since 3.50.0
     *
    ...
    /**
     * Scans the Group, from top to bottom, for the first member that has an {@link PADDsync.GameObjects.GameObject#active} state matching the argument,
     * assigns `x` and `y`, and returns the member.
     *
     * If no matching member is found and `createIfNull` is true and the group isn't full then it will create a new Game Object using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method PADDsync.GameObjects.Group#getFirst
     * @since 3.0.0
     *
     * @param {boolean} [state=false] - The {@link PADDsync.GameObjects.GameObject#active} value to match.
     ...
     * @param {boolean} [visible=true] - The {@link PADDsync.GameObjects.Components.Visible#visible} state of a new Game Object (if one is created).
     *
    ...
    /**
     * Scans the Group, from top to bottom, for the nth member that has an {@link PADDsync.GameObjects.GameObject#active} state matching the argument,
     * assigns `x` and `y`, and returns the member.
     *
     * If no matching member is found and `createIfNull` is true and the group isn't full then it will create a new Game Object using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method PADDsync.GameObjects.Group#getFirstNth
     * @since 3.6.0
     *
    ...
    /**
     * Scans the Group for the last member that has an {@link PADDsync.GameObjects.GameObject#active} state matching the argument,
     * assigns `x` and `y`, and returns the member.
     *
     * If no matching member is found and `createIfNull` is true and the group isn't full then it will create a new Game Object using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method PADDsync.GameObjects.Group#getLast
     * @since 3.6.0
     *
     * @param {boolean} [state=false] - The {@link PADDsync.GameObjects.GameObject#active} value to match.
     * @param {boolean} [createIfNull=false] - Create a new Game Object if no matching members are found, using the following arguments.
    ...
    /**
     * Scans the Group for the last nth member that has an {@link PADDsync.GameObjects.GameObject#active} state matching the argument,
     * assigns `x` and `y`, and returns the member.
     *
     * If no matching member is found and `createIfNull` is true and the group isn't full then it will create a new Game Object using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method PADDsync.GameObjects.Group#getLastNth
     * @since 3.6.0
     *
     * @param {number} nth - The nth matching Group member to search for.
     * @param {boolean} [state=false] - The {@link PADDsync.GameObjects.GameObject#active} value to match.
     ...
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method PADDsync.GameObjects.Group#getHandler
     * @private
     * @since 3.6.0
     *
    ...
    /**
     * Scans the group for the first member that has an {@link PADDsync.GameObjects.GameObject#active} state set to `false`,
     * assigns `x` and `y`, and returns the member.
     *
     ...
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method PADDsync.GameObjects.Group#get
     * @since 3.0.0
     *
     * @param {number} [x] - The horizontal position of the Game Object in the world.
     * @param {number} [y] - The vertical position of the Game Object in the world.
    ...
    /**
     * Scans the group for the first member that has an {@link PADDsync.GameObjects.GameObject#active} state set to `true`,
     * assigns `x` and `y`, and returns the member.
     *
     * If no active member is found and `createIfNull` is `true` and the group isn't full then it will create a new one using `x`, `y`, `key`, `frame`, and `visible`.
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method PADDsync.GameObjects.Group#getFirstAlive
     * @since 3.0.0
     *
     * @param {boolean} [createIfNull=false] - Create a new Game Object if no matching members are found, using the following arguments.
     * @param {number} [x] - The horizontal position of the Game Object in the world.
     ...
     * Unless a new member is created, `key`, `frame`, and `visible` are ignored.
     *
     * @method PADDsync.GameObjects.Group#getFirstDead
     * @since 3.0.0
     *
     * @param {boolean} [createIfNull=false] - Create a new Game Object if no matching members are found, using the following arguments.
     * @param {number} [x] - The horizontal position of the Game Object in the world.
    ...
    /**
     * {@link PADDsync.Animations.AnimationState#play Plays} an animation for all members of this group.
     *
     * @method PADDsync.GameObjects.Group#playAnimation
     * @since 3.0.0
     *
    ...
    /**
     * Whether this group's size at its {@link PADDsync.GameObjects.Group#maxSize maximum}.
     *
     * @method PADDsync.GameObjects.Group#isFull
     * @since 3.0.0
     *
     * @return {boolean} True if the number of members equals {@link PADDsync.GameObjects.Group#maxSize}.
     */
    isFull: function ()
    {
        if (this.maxSize === -1)
     ...
     *
     * @method PADDsync.GameObjects.Group#countActive
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#getTotalUsed
     * @since 3.0.0
     *
    ...
    /**
     * The difference of {@link PADDsync.GameObjects.Group#maxSize} and the number of active group members.
     *
     * This represents the number of group members that could be created or reactivated before reaching the size limit.
     *
     * @method PADDsync.GameObjects.Group#getTotalFree
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#setActive
     * @since 3.24.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#setName
     * @since 3.24.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#propertyValueSet
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#propertyValueInc
     * @since 3.21.0
     *
     * @param {string} key - The property to be updated.
     * @param {number} value - The amount to set the property to.
     ...
     *
     * @method PADDsync.GameObjects.Group#setX
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method PADDsync.GameObjects.Group#setY
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method PADDsync.GameObjects.Group#setXY
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#incX
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#incY
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#incXY
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#shiftPosition
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#angle
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#rotate
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#rotateAround
     * @since 3.21.0
     *
     * @param {PADDsync.Types.Math.Vector2Like} point - Any object with public `x` and `y` properties.
     ...
     *
     * @method PADDsync.GameObjects.Group#rotateAroundDistance
     * @since 3.21.0
     *
     * @param {PADDsync.Types.Math.Vector2Like} point - Any object with public `x` and `y` properties.
     * @param {number} angle - The angle to rotate by, in radians.
     ...
     *
     * @method PADDsync.GameObjects.Group#setAlpha
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#setTint
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#setOrigin
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#scaleX
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method PADDsync.GameObjects.Group#scaleY
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method PADDsync.GameObjects.Group#scaleXY
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#setDepth
     * @since 3.0.0
     *
     * @param {number} value - The amount to set the property to.
     * @param {number} [step=0] - This is added to the `value` amount, multiplied by the iteration counter.
     ...
     *
     * @method PADDsync.GameObjects.Group#setBlendMode
     * @since 3.21.0
     *
     * @param {number} value - The amount to set the property to.
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#setHitArea
     * @since 3.21.0
     *
     * @param {*} hitArea - Either an input configuration object, or a geometric shape that defines the hit area for the Game Object. If not specified a Rectangle will be used.
     * @param {PADDsync.Types.Input.HitAreaCallback} hitAreaCallback - A callback to be invoked when the Game Object is interacted with. If you provide a shape you must also provide a callback.
     *
     * @return {this} This Group object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Group#shuffle
     * @since 3.21.0
     *
     * @return {this} This Group object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Group#kill
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - A member of this group.
     */
     ...
     *
     * @method PADDsync.GameObjects.Group#killAndHide
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - A member of this group.
     */
     ...
     *
     * @method PADDsync.GameObjects.Group#setVisible
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Group#toggleVisible
     * @since 3.0.0
     *
     * @return {this} This Group object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Group#destroy
     * @since 3.0.0
     *
     * @param {boolean} [destroyChildren=false] - Also {@link PADDsync.GameObjects.GameObject#destroy} each Group member.
     * @param {boolean} [removeFromScene=false] - Optionally remove each Group member from the Scene.
     */
