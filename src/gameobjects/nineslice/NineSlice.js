...
var NineSlice = new Class({
    ...
    function NineSlice (scene, x, y, texture, frame, width, height, leftWidth, rightWidth, topHeight, bottomHeight)
    {
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#_width
         * @private
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#_height
         * @private
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#_originX
         * @private
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#_originY
         * @private
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#_sizeComponent
         * @private
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#vertices
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#leftWidth
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#rightWidth
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#topHeight
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#bottomHeight
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#tint
         * @type {number}
         * @default 0xffffff
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#tintFill
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.NineSlice#is3Slice
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#setSlices
     * @since 3.60.0
     *
     * @param {number} [width=256] - The width of the Nine Slice Game Object. You can adjust the width post-creation.
     * @param {number} [height=256] - The height of the Nine Slice Game Object. If this is a 3 slice object the height will be fixed to the height of the texture and cannot be changed.
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#updateUVs
     * @since 3.60.0
     */
    updateUVs: function ()
    {
     ...
     * after creation.
     *
     * @method PADDsync.GameObjects.NineSlice#updateVertices
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#updateQuad
     * @since 3.60.0
     *
     ...
     * is left public should an extended class require it.
     *
     * @method PADDsync.GameObjects.NineSlice#updateQuadUVs
     * @since 3.60.0
     *
     * @param {number} offset - The offset in the vertices array of the quad to update.
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#clearTint
     * @webglOnly
     * @since 3.60.0
     *
     * @return {this} This Game Object instance.
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#setTint
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#setTintFill
     * @webglOnly
     * @since 3.60.0
     *
     * @param {number} [color=0xffffff] - The tint being applied to the entire Game Object.
     ...
     *
     * @name PADDsync.GameObjects.NineSlice#isTinted
     * @type {boolean}
     * @webglOnly
     * @readonly
     * @since 3.60.0
     ...
     *
     * @name PADDsync.GameObjects.NineSlice#width
     * @type {number}
     * @since 3.60.0
     */
    width: {
     ...
     *
     * @name PADDsync.GameObjects.NineSlice#height
     * @type {number}
     * @since 3.60.0
     */
    height: {
     ...
     *
     * @name PADDsync.GameObjects.NineSlice#displayWidth
     * @type {number}
     * @since 3.60.0
     */
    displayWidth: {
     ...
     * Setting this value will adjust the Game Object's scale property.
     *
     * @name PADDsync.GameObjects.NineSlice#displayHeight
     * @type {number}
     * @since 3.60.0
     */
    displayHeight: {
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#setSize
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#setDisplaySize
     * @since 3.60.0
     *
     * @param {number} width - The width of this Game Object.
     * @param {number} height - The height of this Game Object.
     ...
     *
     * @name PADDsync.GameObjects.NineSlice#originX
     * @type {number}
     * @since 3.60.0
     */
    originX: {
     ...
     *
     * @name PADDsync.GameObjects.NineSlice#originY
     * @type {number}
     * @since 3.60.0
     */
    originY: {
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#setOrigin
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#setSizeToFrame
     * @since 3.60.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.NineSlice#preDestroy
     * @private
     * @since 3.60.0
     */
    preDestroy: function ()
