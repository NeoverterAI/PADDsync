/**
 * @typedef {object} PADDsync.Types.GameObjects.TileSprite.TileSpriteConfig
 ...
 * @property {(number|string|PADDsync.Textures.Frame)} [frame=''] - An optional frame from the Texture this Tile Sprite is rendering with.
 */
