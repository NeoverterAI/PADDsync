...
var TileSprite = new Class({
    ...
    function TileSprite (scene, x, y, width, height, textureKey, frameKey)
    {
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#_tilePosition
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#_tileScale
         * @type {PADDsync.Math.Vector2}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#dirty
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#renderer
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#canvas
         ...
         * Only used in Canvas mode.
         *
         * @name PADDsync.GameObjects.TileSprite#context
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#displayTexture
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#displayFrame
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#_crop
         * @type {object}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#_textureKey
         * @type {string}
         * @private
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#texture
         * @type {PADDsync.Textures.Texture|PADDsync.Textures.CanvasTexture}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#frame
         * @type {PADDsync.Textures.Frame}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#potWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#potHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#fillCanvas
         * @type {HTMLCanvasElement}
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#fillContext
         * @type {CanvasRenderingContext2D}
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.GameObjects.TileSprite#fillPattern
         * @type {?(PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper|CanvasPattern)}
         * @since 3.12.0
         */
     ...
     *
     * @method PADDsync.GameObjects.TileSprite#setTexture
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TileSprite#setFrame
     * @since 3.0.0
     *
     * @param {(string|number)} frame - The name or index of the frame within the Texture.
     *
    ...
    /**
     * Sets {@link PADDsync.GameObjects.TileSprite#tilePositionX} and {@link PADDsync.GameObjects.TileSprite#tilePositionY}.
     *
     * @method PADDsync.GameObjects.TileSprite#setTilePosition
     * @since 3.3.0
     *
    ...
    /**
     * Sets {@link PADDsync.GameObjects.TileSprite#tileScaleX} and {@link PADDsync.GameObjects.TileSprite#tileScaleY}.
     *
     * @method PADDsync.GameObjects.TileSprite#setTileScale
     * @since 3.12.0
     *
     ...
     *
     * @method PADDsync.GameObjects.TileSprite#updateTileTexture
     * @private
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.GameObjects.TileSprite#updateCanvas
     * @private
     * @since 3.12.0
     */
     ...
     *
     * @method PADDsync.GameObjects.TileSprite#preDestroy
     * @protected
     * @since 3.9.0
     */
    preDestroy: function ()
     ...
     *
     * @name PADDsync.GameObjects.TileSprite#tilePositionX
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.GameObjects.TileSprite#tilePositionY
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.GameObjects.TileSprite#tileScaleX
     * @type {number}
     * @default 1
     * @since 3.11.0
     */
     ...
     *
     * @name PADDsync.GameObjects.TileSprite#tileScaleY
     * @type {number}
     * @default 1
     * @since 3.11.0
     */
