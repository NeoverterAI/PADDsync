...
/**
 * @classdesc
 * A Scene plugin that provides a {@link PADDsync.GameObjects.LightsManager} for the Light2D pipeline.
 *
 * Available from within a Scene via `this.lights`.
 *
 * Add Lights using the {@link PADDsync.GameObjects.LightsManager#addLight} method:
 *
 * ```javascript
 ...
 *
 * @class LightsPlugin
 * @extends PADDsync.GameObjects.LightsManager
 * @memberof PADDsync.GameObjects
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene that this Lights Plugin belongs to.
 */
var LightsPlugin = new Class({
    ...
    function LightsPlugin (scene)
    {
         ...
         *
         * @name PADDsync.GameObjects.LightsPlugin#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.GameObjects.LightsPlugin#systems
     ...
     *
     * @method PADDsync.GameObjects.LightsPlugin#boot
     * @since 3.0.0
     */
    boot: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.LightsPlugin#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
