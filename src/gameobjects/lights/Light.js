 ...
 * A 2D Light.
 *
 * These are created by the {@link PADDsync.GameObjects.LightsManager}, available from within a scene via `this.lights`.
 *
...
var Light = new Class({
    ...
    function Light (x, y, radius, r, g, b, intensity)
    {
         ...
         *
         * @name PADDsync.GameObjects.Light#color
         ...
         *
         * @name PADDsync.GameObjects.Light#intensity
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Light#renderFlags
         * @type {number}
         * @default 15
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Light#cameraFilter
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
     ...
     *
     * @name PADDsync.GameObjects.Light#displayWidth
     * @type {number}
     * @since 3.60.0
     */
    displayWidth: {
     ...
     *
     * @name PADDsync.GameObjects.Light#displayHeight
     * @type {number}
     * @since 3.60.0
     */
    displayHeight: {
     ...
     * The width of this Light Game Object. This is the same as `Light.diameter`.
     *
     * @name PADDsync.GameObjects.Light#width
     * @type {number}
     * @since 3.60.0
     */
    width: {
     ...
     * The height of this Light Game Object. This is the same as `Light.diameter`.
     *
     * @name PADDsync.GameObjects.Light#height
     * @type {number}
     * @since 3.60.0
     */
    height: {
     ...
     *
     * @method PADDsync.GameObjects.Light#willRender
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Light#setColor
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Light#setIntensity
     * @since 3.0.0
     *
     * @param {number} intensity - The intensity of the light.
     *
     ...
     *
     * @method PADDsync.GameObjects.Light#setRadius
     * @since 3.0.0
     *
     * @param {number} radius - The radius of the light.
     *
 ...
 * @memberof PADDsync.GameObjects.Light
 * @default
 */
