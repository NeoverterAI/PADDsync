 ...
 *
 * @param {PADDsync.GameObjects.Light} light - The Light.
 */
...
var LightsManager = new Class({
    ...
    function LightsManager ()
    {
         ...
         *
         * @name PADDsync.GameObjects.LightsManager#lights
         * @type {PADDsync.GameObjects.Light[]}
         * @default []
         * @since 3.0.0
         */
        this.lights = [];
         ...
         * The ambient color.
         *
         * @name PADDsync.GameObjects.LightsManager#ambientColor
         ...
         *
         * @name PADDsync.GameObjects.LightsManager#active
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.LightsManager#maxLights
         * @type {number}
         * @readonly
         * @since 3.15.0
         */
         ...
         *
         * @name PADDsync.GameObjects.LightsManager#visibleLights
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
     ...
     *
     * Note: This method will only be available if the Point Light Game Object has been built into PADDsync.
     *
     ...
     *
     * @method PADDsync.GameObjects.LightsManager#addPointLight
     * @since 3.50.0
     *
     ...
     *
     * @return {PADDsync.GameObjects.PointLight} The Game Object that was created.
     */
     ...
     *
     * @method PADDsync.GameObjects.LightsManager#enable
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.LightsManager#disable
     * @since 3.0.0
     *
     * @return {this} This Lights Manager instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.LightsManager#getLights
     * @since 3.50.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera to cull Lights for.
     *
     * @return {PADDsync.GameObjects.Light[]} The culled Lights.
     */
     ...
     *
     * @method PADDsync.GameObjects.LightsManager#setAmbientColor
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.LightsManager#getMaxVisibleLights
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.LightsManager#getLightCount
     * @since 3.0.0
     *
     ...
     * Add a Light.
     *
     * @method PADDsync.GameObjects.LightsManager#addLight
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.GameObjects.Light} The Light that was added.
     */
     ...
     * Remove a Light.
     *
     * @method PADDsync.GameObjects.LightsManager#removeLight
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Light} light - The Light to remove.
     *
     * @return {this} This Lights Manager instance.
     */
     ...
     * culled Lights.
     *
     * @method PADDsync.GameObjects.LightsManager#shutdown
     * @since 3.0.0
     */
    shutdown: function ()
    {
     ...
     *
     * Cleans up all references by calling {@link PADDsync.GameObjects.LightsManager#shutdown}.
     *
     * @method PADDsync.GameObjects.LightsManager#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
