...
var Mesh = new Class({
    ...
    function Mesh (scene, x, y, texture, frame, vertices, uvs, indicies, containsZ, normals, colors, alphas)
    {
         ...
         *
         * @name PADDsync.GameObjects.Mesh#faces
         * @type {PADDsync.Geom.Mesh.Face[]}
         * @since 3.50.0
         */
        this.faces = [];
         ...
         *
         * @name PADDsync.GameObjects.Mesh#vertices
         * @type {PADDsync.Geom.Mesh.Vertex[]}
         * @since 3.50.0
         */
        this.vertices = [];
         ...
         *
         * @name PADDsync.GameObjects.Mesh#tintFill
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Mesh#debugCallback
         * @type {function}
         * @since 3.50.0
         */
         ...
         * been called.
         *
         * @name PADDsync.GameObjects.Mesh#debugGraphic
         ...
         *
         * @name PADDsync.GameObjects.Mesh#hideCCW
         * @type {boolean}
         * @since 3.50.0
         */
        this.hideCCW = true;
         ...
         *
         * @name PADDsync.GameObjects.Mesh#modelPosition
         ...
         * Changing this property will impact all vertices being rendered by this Mesh.
         *
         * @name PADDsync.GameObjects.Mesh#modelScale
         * @type {PADDsync.Math.Vector3}
         * @since 3.50.0
         */
         ...
         * degrees you can use `modelRotation.x = PADDsync.Math.DegToRad(90)`.
         *
         ...
         * Changing this property will impact all vertices being rendered by this Mesh.
         *
         * @name PADDsync.GameObjects.Mesh#modelRotation
         * @type {PADDsync.Math.Vector3}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Mesh#dirtyCache
         * @type {number[]}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Mesh#transformMatrix
         ...
         *
         * @name PADDsync.GameObjects.Mesh#viewPosition
         * @type {PADDsync.Math.Vector3}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Mesh#viewMatrix
         * @type {PADDsync.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Mesh#projectionMatrix
         * @type {PADDsync.Math.Matrix4}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Mesh#totalRendered
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Mesh#totalFrame
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * need it.
         *
         * @name PADDsync.GameObjects.Mesh#ignoreDirtyCache
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Mesh#fov
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Mesh#panX
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#panY
     * @since 3.50.0
     *
     * @param {number} v - The amount to pan by.
     */
     ...
     *
     * @method PADDsync.GameObjects.Mesh#panZ
     * @since 3.50.0
     *
     * @param {number} v - The amount to pan by.
     */
     ...
     * See also `setOrtho`.
     *
     * @method PADDsync.GameObjects.Mesh#setPerspective
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#setOrtho
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#clear
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#addVerticesFromObj
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#sortByDepth
     * @since 3.50.0
     *
     * @param {PADDsync.Geom.Mesh.Face} faceA - The first Face.
     * @param {PADDsync.Geom.Mesh.Face} faceB - The second Face.
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#depthSort
     * @since 3.50.0
     *
     * @return {this} This Mesh Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Mesh#addVertex
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#addFace
     * @since 3.50.0
     *
     * @param {PADDsync.Geom.Mesh.Vertex} vertex1 - The first vertex of the Face.
     * @param {PADDsync.Geom.Mesh.Vertex} vertex2 - The second vertex of the Face.
     * @param {PADDsync.Geom.Mesh.Vertex} vertex3 - The third vertex of the Face.
     *
     * @return {this} This Mesh Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Mesh#addVertices
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#getFaceCount
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#getVertexCount
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#getFace
     * @since 3.50.0
     *
     * @param {number} index - The index of the Face to get.
     *
     * @return {PADDsync.Geom.Mesh.Face} The Face at the given index, or `undefined` if index out of range.
     */
     ...
     *
     * @method PADDsync.GameObjects.Mesh#hasFaceAt
     * @since 3.60.0
     *
     * @param {number} x - The x position to check against.
     * @param {number} y - The y position to check against.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The camera to pass the coordinates through. If not give, the default Scene Camera is used.
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#getFaceAt
     * @since 3.50.0
     *
     * @param {number} x - The x position to check against.
     * @param {number} y - The y position to check against.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The camera to pass the coordinates through. If not give, the default Scene Camera is used.
     *
     * @return {PADDsync.Geom.Mesh.Face[]} An array of Face objects that intersect with the given point, ordered by depth.
     */
     ...
     * with no arguments.
     *
     * @method PADDsync.GameObjects.Mesh#setDebug
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.Graphics} [graphic] - The Graphic instance to render to if using the built-in callback.
     ...
     *
     * @method PADDsync.GameObjects.Mesh#isDirty
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#preUpdate
     * @protected
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#renderDebug
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.Mesh} src - The Mesh object being rendered.
     * @param {PADDsync.Geom.Mesh.Face[]} faces - An array of Faces.
     */
     ...
     *
     * @method PADDsync.GameObjects.Mesh#preDestroy
     * @private
     * @since 3.50.0
     */
    preDestroy: function ()
     ...
     *
     * @method PADDsync.GameObjects.Mesh#clearTint
     * @webglOnly
     * @since 3.60.0
     *
     * @return {this} This Game Object instance.
     ...
     *
     * @method PADDsync.GameObjects.Mesh#setInteractive
     * @since 3.60.0
     * 
     * @param {(PADDsync.Types.Input.InputConfiguration)} [config] - An input configuration object but it will ignore hitArea, hitAreaCallback and pixelPerfect with associated alphaTolerance properties.
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#setTint
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#uvScroll
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#uvScale
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Mesh#tint
     * @type {number}
     * @webglOnly
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Mesh#rotateX
     * @type {number}
     * @since 3.60.0
     */
    rotateX: {
     ...
     *
     * @method PADDsync.GameObjects.Mesh#rotateY
     * @type {number}
     * @since 3.60.0
     */
    rotateY: {
     ...
     *
     * @method PADDsync.GameObjects.Mesh#rotateZ
     * @type {number}
     * @since 3.60.0
     */
    rotateZ: {
