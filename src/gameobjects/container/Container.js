 ...
 * @param {PADDsync.GameObjects.GameObject[]} [children] - An optional array of Game Objects to add to this Container.
 */
var Container = new Class({
    ...
    function Container (scene, x, y, children)
    {
         ...
         *
         * @name PADDsync.GameObjects.Container#list
         ...
         *
         * @name PADDsync.GameObjects.Container#exclusive
         * @type {boolean}
         * @default true
         * @since 3.4.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Container#maxSize
         * @type {number}
         * @default -1
         * @since 3.4.0
         */
         ...
         * The cursor position.
         *
         * @name PADDsync.GameObjects.Container#position
         * @type {number}
         * @since 3.4.0
         */
        this.position = 0;
         ...
         *
         * @name PADDsync.GameObjects.Container#localTransform
         ...
         *
         * @name PADDsync.GameObjects.Container#_sortKey
         * @type {string}
         * @private
         * @since 3.4.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Container#_sysEvents
         ...
         *
         * @name PADDsync.GameObjects.Container#scrollFactorX
         * @type {number}
         * @default 1
         * @since 3.4.0
         */
         ...
         * them from physics bodies if not accounted for in your code.
         *
         * @name PADDsync.GameObjects.Container#scrollFactorY
         * @type {number}
         * @default 1
         * @since 3.4.0
         */
     ...
     *
     * @name PADDsync.GameObjects.Container#originX
     * @type {number}
     * @readonly
     * @override
     * @since 3.4.0
     ...
     * Do not change this value. It has no effect other than to break things.
     *
     * @name PADDsync.GameObjects.Container#originY
     * @type {number}
     * @readonly
     * @override
     * @since 3.4.0
     ...
     * Do not change this value. It has no effect other than to break things.
     *
     * @name PADDsync.GameObjects.Container#displayOriginX
     * @type {number}
     * @readonly
     * @override
     * @since 3.4.0
     ...
     * Do not change this value. It has no effect other than to break things.
     *
     * @name PADDsync.GameObjects.Container#displayOriginY
     * @type {number}
     * @readonly
     * @override
     * @since 3.4.0
     ...
     * display list, but are being replicated where-ever this Container is.
     *
     * @method PADDsync.GameObjects.Container#setExclusive
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Container#getBounds
     * @since 3.4.0
     *
     * @param {PADDsync.Geom.Rectangle} [output] - A Geom.Rectangle object to store the values in. If not provided a new Rectangle will be created.
     *
     * @return {PADDsync.Geom.Rectangle} The values stored in the output object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#addHandler
     * @private
     * @since 3.4.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object that was just added to this Container.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#removeHandler
     * @private
     * @since 3.4.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object that was just removed from this Container.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#pointToContainer
     * @since 3.4.0
     *
     * @param {PADDsync.Types.Math.Vector2Like} source - The Source Point to be transformed.
     * @param {PADDsync.Types.Math.Vector2Like} [output] - A destination object to store the transformed point in. If none given a Vector2 will be created and returned.
     *
     * @return {PADDsync.Types.Math.Vector2Like} The transformed point.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#getBoundsTransformMatrix
     * @since 3.4.0
     *
     * @return {PADDsync.GameObjects.Components.TransformMatrix} The world transform matrix.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#add
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {(T|T[])} - [child]
     *
     * @param {PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[]} child - The Game Object, or array of Game Objects, to add to the Container.
     *
     ...
     * Each Game Object must be unique within the Container.
     *
     * @method PADDsync.GameObjects.Container#addAt
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {(T|T[])} - [child]
     ...
     *
     * @method PADDsync.GameObjects.Container#getAt
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [$return]
     ...
     *
     * @return {?PADDsync.GameObjects.GameObject} The Game Object at the specified index, or `null` if none found.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#getIndex
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child]
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to search for in this Container.
     *
     ...
     *
     * @method PADDsync.GameObjects.Container#sort
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Container#getByName
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [$return]
     ...
     *
     * @return {?PADDsync.GameObjects.GameObject} The first child with a matching name, or `null` if none were found.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#getRandom
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [$return]
     ...
     *
     * @return {?PADDsync.GameObjects.GameObject} A random child from the Container, or `null` if the Container is empty.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#getFirst
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [$return]
     ...
     *
     * @return {?PADDsync.GameObjects.GameObject} The first matching Game Object, or `null` if none was found.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#getAll
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T[]} - [$return]
     ...
     * @param {number} [endIndex=Container.length] - An optional end index to search up to (but not included)
     *
     * @return {PADDsync.GameObjects.GameObject[]} An array of matching Game Objects from this Container.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#count
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Container#swap
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child1,child2]
     *
     * @param {PADDsync.GameObjects.GameObject} child1 - The first Game Object to swap.
     * @param {PADDsync.GameObjects.GameObject} child2 - The second Game Object to swap.
     *
     * @return {this} This Container instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#moveTo
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child]
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to move.
     ...
     *
     * @method PADDsync.GameObjects.Container#moveAbove
     * @since 3.55.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child1,child2]
     *
     * @param {PADDsync.GameObjects.GameObject} child1 - The Game Object to move above base Game Object.
     * @param {PADDsync.GameObjects.GameObject} child2 - The base Game Object.
     *
     * @return {this} This Container instance.
     */
     ...
     * These 2 Game Objects must already be children of this Container.
     *
     * @method PADDsync.GameObjects.Container#moveBelow
     * @since 3.55.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child1,child2]
     *
     * @param {PADDsync.GameObjects.GameObject} child1 - The Game Object to move below base Game Object.
     * @param {PADDsync.GameObjects.GameObject} child2 - The base Game Object.
     *
     * @return {this} This Container instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#remove
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {(T|T[])} - [child]
     *
     * @param {PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[]} child - The Game Object, or array of Game Objects, to be removed from the Container.
     ...
     *
     * @method PADDsync.GameObjects.Container#removeAt
     * @since 3.4.0
     *
     ...
     * You can also optionally call `destroy` on each Game Object that is removed from the Container.
     *
     * @method PADDsync.GameObjects.Container#removeBetween
     * @since 3.4.0
     *
     * @param {number} [startIndex=0] - An optional start index to search from.
     * @param {number} [endIndex=Container.length] - An optional end index to search up to (but not included)
     ...
     * You can also optionally call `destroy` on each Game Object that is removed from the Container.
     *
     * @method PADDsync.GameObjects.Container#removeAll
     * @since 3.4.0
     *
     * @param {boolean} [destroyChild=false] - Optionally call `destroy` on each Game Object successfully removed from this Container.
     *
     ...
     *
     * @method PADDsync.GameObjects.Container#bringToTop
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child]
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to bring to the top of the Container.
     *
     * @return {this} This Container instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#sendToBack
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child]
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to send to the bottom of the Container.
     *
     * @return {this} This Container instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#moveUp
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child]
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to be moved in the Container.
     *
     * @return {this} This Container instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#moveDown
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child]
     ...
     *
     * @method PADDsync.GameObjects.Container#reverse
     * @since 3.4.0
     *
     * @return {this} This Container instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#shuffle
     * @since 3.4.0
     *
     * @return {this} This Container instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#replace
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [oldChild,newChild]
     *
     * @param {PADDsync.GameObjects.GameObject} oldChild - The Game Object in this Container that will be replaced.
     * @param {PADDsync.GameObjects.GameObject} newChild - The Game Object to be added to this Container.
     * @param {boolean} [destroyChild=false] - Optionally call `destroy` on the Game Object if successfully removed from this Container.
     *
     * @return {this} This Container instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#exists
     * @since 3.4.0
     *
     * @generic {PADDsync.GameObjects.GameObject} T
     * @genericUse {T} - [child]
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to check for within this Container.
     *
     ...
     * the first 50 Game Objects.
     *
     * @method PADDsync.GameObjects.Container#setAll
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Container#each
     * @since 3.4.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Container#iterate
     * @since 3.4.0
     *
     * @param {function} callback - The function to call.
     * @param {object} [context] - Value to use as `this` when executing callback.
     ...
     * them from physics bodies if not accounted for in your code.
     *
     * @method PADDsync.GameObjects.Container#setScrollFactor
     * @since 3.4.0
     *
     ...
     *
     * @name PADDsync.GameObjects.Container#length
     * @type {number}
     * @readonly
     * @since 3.4.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Container#first
     * @type {?PADDsync.GameObjects.GameObject}
     * @readonly
     * @since 3.4.0
     */
     ...
     * You can move the cursor by calling `Container.next` and `Container.previous`.
     *
     * @name PADDsync.GameObjects.Container#last
     * @type {?PADDsync.GameObjects.GameObject}
     * @readonly
     * @since 3.4.0
     */
     ...
     * You can move the cursor by calling `Container.next` and `Container.previous`.
     *
     * @name PADDsync.GameObjects.Container#next
     * @type {?PADDsync.GameObjects.GameObject}
     * @readonly
     * @since 3.4.0
     */
     ...
     * You can move the cursor by calling `Container.next` and `Container.previous`.
     *
     * @name PADDsync.GameObjects.Container#previous
     * @type {?PADDsync.GameObjects.GameObject}
     * @readonly
     * @since 3.4.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Container#preDestroy
     * @protected
     * @since 3.9.0
     */
    preDestroy: function ()
     ...
     *
     * @method PADDsync.GameObjects.Container#onChildDestroyed
     * @protected
     * @since 3.80.0
     */
