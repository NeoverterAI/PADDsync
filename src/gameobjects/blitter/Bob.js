 ...
 * @since 3.0.0
 *
 * @param {PADDsync.GameObjects.Blitter} blitter - The parent Blitter object is responsible for updating this Bob.
...
var Bob = new Class({
    ...
    function Bob (blitter, x, y, frame, visible)
    {
         ...
         *
         * @name PADDsync.GameObjects.Bob#parent
         * @type {PADDsync.GameObjects.Blitter}
         * @since 3.0.0
         */
        this.parent = blitter;
         ...
         *
         * @name PADDsync.GameObjects.Bob#x
         * @type {number}
         * @since 3.0.0
         */
        this.x = x;
         ...
         *
         * @name PADDsync.GameObjects.Bob#y
         * @type {number}
         * @since 3.0.0
         */
        this.y = y;
         ...
         *
         * @name PADDsync.GameObjects.Bob#frame
         ...
         *
         * @name PADDsync.GameObjects.Bob#data
         * @type {object}
         * @default {}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Bob#tint
         * @type {number}
         * @default 0xffffff
         * @since 3.20.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Bob#_visible
         * @type {boolean}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Bob#_alpha
         * @type {number}
         * @private
         * @default 1
         * @since 3.0.0
         ...
         *
         * @name PADDsync.GameObjects.Bob#flipX
         * @type {boolean}
         * @since 3.0.0
         */
        this.flipX = false;
         ...
         * Flipping always takes place from the middle of the texture.
         *
         * @name PADDsync.GameObjects.Bob#flipY
         * @type {boolean}
         * @since 3.0.0
         */
        this.flipY = false;
         ...
         *
         * @name PADDsync.GameObjects.Bob#hasTransformComponent
         * @type {boolean}
         * @private
         * @readonly
         * @since 3.60.0
     ...
     *
     * @method PADDsync.GameObjects.Bob#setFrame
     * @since 3.0.0
     *
     * @param {(string|number|PADDsync.Textures.Frame)} [frame] - The frame to be used during rendering.
     *
     ...
     *
     * @method PADDsync.GameObjects.Bob#resetFlip
     * @since 3.0.0
     *
     * @return {this} This Bob Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Bob#reset
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Bob#setPosition
     * @since 3.20.0
     *
     * @param {number} x - The x position of the Bob. Bob coordinate are relative to the position of the Blitter object.
     * @param {number} y - The y position of the Bob. Bob coordinate are relative to the position of the Blitter object.
     ...
     *
     * @method PADDsync.GameObjects.Bob#setFlipX
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Bob#setFlipY
     * @since 3.0.0
     *
     * @param {boolean} value - The flipped state. `false` for no flip, or `true` to be flipped.
     *
     ...
     *
     * @method PADDsync.GameObjects.Bob#setFlip
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Bob#setVisible
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Bob#setAlpha
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Bob#setTint
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Bob#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     * An invisible Bob will skip rendering.
     *
     * @name PADDsync.GameObjects.Bob#visible
     * @type {boolean}
     * @since 3.0.0
     */
    visible: {
     ...
     * A Bob with alpha 0 will skip rendering.
     *
     * @name PADDsync.GameObjects.Bob#alpha
     * @type {number}
     * @since 3.0.0
     */
    alpha: {
