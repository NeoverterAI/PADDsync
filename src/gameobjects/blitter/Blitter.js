 ...
 *
 * @param {PADDsync.GameObjects.Bob} bob - The Bob that was created by the Blitter.
...
var Blitter = new Class({
    ...
    function Blitter (scene, x, y, texture, frame)
    {
         ...
         *
         * @name PADDsync.GameObjects.Blitter#children
         * @type {PADDsync.Structs.List.<PADDsync.GameObjects.Bob>}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Blitter#renderList
         * @type {PADDsync.GameObjects.Bob[]}
         * @default []
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Blitter#dirty
         * @type {boolean}
         * @since 3.0.0
         */
        this.dirty = false;
     ...
     *
     * @method PADDsync.GameObjects.Blitter#create
     * @since 3.0.0
     *
     * @param {number} x - The x position of the Bob. Bob coordinate are relative to the position of the Blitter object.
     * @param {number} y - The y position of the Bob. Bob coordinate are relative to the position of the Blitter object.
     * @param {(string|number|PADDsync.Textures.Frame)} [frame] - The Frame the Bob will use. It _must_ be part of the Texture the parent Blitter object is using.
     ...
     *
     * @return {PADDsync.GameObjects.Bob} The newly created Bob object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Blitter#createFromCallback
     * @since 3.0.0
     *
     ...
     * @param {(string|number|PADDsync.Textures.Frame|string[]|number[]|PADDsync.Textures.Frame[])} [frame] - The Frame the Bobs will use. It must be part of the Blitter Texture.
     * @param {boolean} [visible=true] - Should the created Bob render or not?
     *
     * @return {PADDsync.GameObjects.Bob[]} An array of Bob objects that were created.
     */
     ...
     *
     * @method PADDsync.GameObjects.Blitter#createMultiple
     * @since 3.0.0
     *
     * @param {number} quantity - The quantity of Bob objects to create.
     * @param {(string|number|PADDsync.Textures.Frame|string[]|number[]|PADDsync.Textures.Frame[])} [frame] - The Frame the Bobs will use. It must be part of the Blitter Texture.
     ...
     *
     * @method PADDsync.GameObjects.Blitter#childCanRender
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Bob} child - The Bob to check for rendering.
     *
     ...
     *
     * @method PADDsync.GameObjects.Blitter#getRenderList
     * @since 3.0.0
     *
     * @return {PADDsync.GameObjects.Bob[]} An array of Bob objects that will be rendered this frame.
     */
     ...
     *
     * @method PADDsync.GameObjects.Blitter#clear
     * @since 3.0.0
     */
    clear: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.Blitter#preDestroy
     * @protected
     * @since 3.9.0
     */
    preDestroy: function ()
