 ...
 *
 * @class Layer
 * @extends PADDsync.Structs.List.<PADDsync.GameObjects.GameObject>
 ...
 * @param {PADDsync.GameObjects.GameObject[]} [children] - An optional array of Game Objects to add to this Layer.
 */
var Layer = new Class({
    ...
    function Layer (scene, children)
    {
         ...
         *
         * @name PADDsync.GameObjects.Layer#scene
         * @type {PADDsync.Scene}
         * @since 3.50.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.GameObjects.Layer#displayList
         * @type {(PADDsync.GameObjects.DisplayList|PADDsync.GameObjects.Layer)}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer#type
         * @type {string}
         * @since 3.50.0
         */
        this.type = 'Layer';
         ...
         *
         * @name PADDsync.GameObjects.Layer#state
         * @type {(number|string)}
         * @since 3.50.0
         */
        this.state = 0;
         ...
         *
         * @name PADDsync.GameObjects.Layer#parentContainer
         ...
         *
         * @name PADDsync.GameObjects.Layer#name
         * @type {string}
         * @default ''
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer#active
         * @type {boolean}
         * @default true
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer#tabIndex
         * @type {number}
         * @default -1
         * @since 3.51.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer#data
         ...
         *
         * @name PADDsync.GameObjects.Layer#renderFlags
         * @type {number}
         * @default 15
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer#cameraFilter
         * @type {number}
         * @default 0
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer#input
         ...
         *
         * @name PADDsync.GameObjects.Layer#body
         ...
         *
         * @name PADDsync.GameObjects.Layer#ignoreDestroy
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Layer#systems
         ...
         *
         * @name PADDsync.GameObjects.Layer#events
         ...
         *
         * @name PADDsync.GameObjects.Layer#sortChildrenFlag
         * @type {boolean}
         * @default false
         * @since 3.50.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Layer#setActive
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#setName
     * @since 3.50.0
     *
     ...
     * If you need to store complex data about your Game Object, look at using the Data Component instead.
     *
     * @method PADDsync.GameObjects.Layer#setState
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#setDataEnabled
     * @since 3.50.0
     ...
     *
     * @method PADDsync.GameObjects.Layer#setData
     * @since 3.50.0
     *
     ...
     * When the value is first set, a `setdata` event is emitted from this Game Object.
     *
     * @method PADDsync.GameObjects.Layer#incData
     * @since 3.50.0
     *
     ...
     * When the value is first set, a `setdata` event is emitted from this Game Object.
     *
     * @method PADDsync.GameObjects.Layer#toggleData
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#getData
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#setInteractive
     * @since 3.51.0
     *
     * @return {this} This GameObject.
     */
     ...
     * the Layer has the same shape as a Game Object.
     *
     * @method PADDsync.GameObjects.Layer#disableInteractive
     * @since 3.51.0
     *
     * @return {this} This GameObject.
     */
     ...
     * the Layer has the same shape as a Game Object.
     *
     * @method PADDsync.GameObjects.Layer#removeInteractive
     * @since 3.51.0
     *
     * @return {this} This GameObject.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer#addedToScene
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer#removedFromScene
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer#update
     * @since 3.50.0
     *
     * @param {...*} [args] - args
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer#toJSON
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#willRender
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#getIndexList
     * @since 3.51.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#addChildCallback
     * @private
     * @fires PADDsync.Scenes.Events#ADDED_TO_SCENE
     * @fires PADDsync.GameObjects.Events#ADDED_TO_SCENE
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object that was added to the list.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer#removeChildCallback
     * @private
     * @fires PADDsync.Scenes.Events#REMOVED_FROM_SCENE
     * @fires PADDsync.GameObjects.Events#REMOVED_FROM_SCENE
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object that was removed from the list.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer#queueDepthSort
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer#depthSort
     * @since 3.50.0
     */
    depthSort: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.Layer#sortByDepth
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} childA - The first Game Object.
     * @param {PADDsync.GameObjects.GameObject} childB - The second Game Object.
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#getChildren
     * @since 3.50.0
     *
     * @return {PADDsync.GameObjects.GameObject[]} An array of Game Objects within this Layer.
     */
     ...
     *
     * You can query which list it is on by looking at the `PADDsync.GameObjects.Layer#displayList` property.
     *
     * If a Layer isn't on any display list, it will not be rendered. If you just wish to temporarily
     * disable it from rendering, consider using the `setVisible` method, instead.
     *
     * @method PADDsync.GameObjects.Layer#addToDisplayList
     * @fires PADDsync.Scenes.Events#ADDED_TO_SCENE
     * @fires PADDsync.GameObjects.Events#ADDED_TO_SCENE
     * @since 3.60.0
     *
     * @param {(PADDsync.GameObjects.DisplayList|PADDsync.GameObjects.Layer)} [displayList] - The Display List to add to. Defaults to the Scene Display List.
     *
     ...
     *
     * You can query which list it is on by looking at the `PADDsync.GameObjects.GameObject#displayList` property.
     *
     * If a Layer isn't on any Display List, it will not be rendered. If you just wish to temporarily
     * disable it from rendering, consider using the `setVisible` method, instead.
     *
     * @method PADDsync.GameObjects.Layer#removeFromDisplayList
     * @fires PADDsync.Scenes.Events#REMOVED_FROM_SCENE
     * @fires PADDsync.GameObjects.Events#REMOVED_FROM_SCENE
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#getDisplayList
     * @since 3.88.0
     *
     * @return {?PADDsync.GameObjects.GameObject[]} The internal Display List array of Game Objects, or `null`.
     */
     ...
     *
     * @method PADDsync.GameObjects.Layer#destroy
     ...
     *
     * @method PADDsync.GameObjects.Layer#eventNames
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#listeners
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#listenerCount
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     *
     ...
     *
     * @method PADDsync.GameObjects.Layer#emit
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     ...
     *
     * @method PADDsync.GameObjects.Layer#on
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     ...
     * Add a listener for a given event.
     *
     * @method PADDsync.GameObjects.Layer#addListener
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     * @param {function} fn - The listener function.
     ...
     *
     * @method PADDsync.GameObjects.Layer#once
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     * @param {function} fn - The listener function.
     ...
     *
     * @method PADDsync.GameObjects.Layer#removeListener
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     ...
     * Remove the listeners of a given event.
     *
     * @method PADDsync.GameObjects.Layer#off
     * @since 3.50.0
     *
     * @param {(string|symbol)} event - The event name.
     * @param {function} [fn] - Only remove the listeners that match this function.
     ...
     *
     * @method PADDsync.GameObjects.Layer#removeAllListeners
     * @since 3.50.0
     *
     * @param {(string|symbol)} [event] - The event name.
     *
