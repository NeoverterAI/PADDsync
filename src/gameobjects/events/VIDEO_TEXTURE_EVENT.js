 ...
 *
 * @event PADDsync.GameObjects.Events#VIDEO_TEXTURE
 * @type {string}
 * @since 3.60.0
 *
 * @param {PADDsync.GameObjects.Video} video - The Video Game Object that emitted the event.
 * @param {PADDsync.Textures.Texture} texture - The Texture that was created.
 */
