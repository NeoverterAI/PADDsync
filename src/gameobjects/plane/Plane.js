 ...
 *
 * @class Plane
 * @extends PADDsync.GameObjects.Mesh
 * @memberof PADDsync.GameObjects
 * @constructor
 * @since 3.60.0
 *
 * @param {PADDsync.Scene} scene - The Scene to which this Plane belongs. A Plane can only belong to one Scene at a time.
 ...
 * @param {string|PADDsync.Textures.Texture} [texture] - The key, or instance of the Texture this Plane will use to render with, as stored in the Texture Manager.
...
var Plane = new Class({
    ...
    function Plane (scene, x, y, texture, frame, width, height, tile)
    {
         ...
         *
         * @name PADDsync.GameObjects.Plane#anims
         ...
         *
         * @name PADDsync.GameObjects.Plane#gridWidth
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         * This value is read-only. To adjust it, see the `setGridSize` method.
         *
         * @name PADDsync.GameObjects.Plane#gridHeight
         * @type {number}
         * @readonly
         * @since 3.60.0
         */
         ...
         * This value is read-only. To adjust it, see the `setGridSize` method.
         *
         * @name PADDsync.GameObjects.Plane#isTiled
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Plane#_checkerboard
         * @type {?WebGLTexture}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @name PADDsync.GameObjects.Plane#originX
     * @type {number}
     * @readonly
     * @override
     * @since 3.70.0
     ...
     * Do not change this value. It has no effect other than to break things.
     *
     * @name PADDsync.GameObjects.Plane#originY
     * @type {number}
     * @readonly
     * @override
     * @since 3.70.0
     ...
     *
     * @method PADDsync.GameObjects.Plane#preDestroy
     * @since 3.60.0
     *
     * @param {number} [width=8] - The width of this Plane, in cells, not pixels.
     * @param {number} [height=8] - The height of this Plane, in cells, not pixels.
     ...
     * if required.
     *
     * @method PADDsync.GameObjects.Plane#setSizeToFrame
     * @since 3.60.0
     * @override
     *
     ...
     *
     * @method PADDsync.GameObjects.Plane#setViewHeight
     * @since 3.60.0
     *
     ...
     * your game.
     *
     * @method PADDsync.GameObjects.Plane#createCheckerboard
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Plane#removeCheckerboard
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Plane#play
     ...
     * Also, see the documentation in the Animation Manager for further details on creating animations.
     *
     * @method PADDsync.GameObjects.Plane#playReverse
     * @fires PADDsync.Animations.Events#ANIMATION_START
     * @since 3.60.0
     *
     * @param {(string|PADDsync.Animations.Animation|PADDsync.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     * search the global Animation Manager and look for it there.
     *
     * @method PADDsync.GameObjects.Plane#playAfterDelay
     * @fires PADDsync.Animations.Events#ANIMATION_START
     * @since 3.60.0
     *
     * @param {(string|PADDsync.Animations.Animation|PADDsync.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     * search the global Animation Manager and look for it there.
     *
     * @method PADDsync.GameObjects.Plane#playAfterRepeat
     * @fires PADDsync.Animations.Events#ANIMATION_START
     * @since 3.60.0
     *
     * @param {(string|PADDsync.Animations.Animation|PADDsync.Types.Animations.PlayAnimationConfig)} key - The string-based key of the animation to play, or an Animation instance, or a `PlayAnimationConfig` object.
     ...
     *
     * @method PADDsync.GameObjects.Plane#stop
     ...
     *
     * @method PADDsync.GameObjects.Plane#stopAfterDelay
     * @fires PADDsync.Animations.Events#ANIMATION_STOP
     * @since 3.60.0
     *
     ...
     * when the current one stops.
     *
     * @method PADDsync.GameObjects.Plane#stopAfterRepeat
     * @fires PADDsync.Animations.Events#ANIMATION_STOP
     * @since 3.60.0
     *
     ...
     * when the current one stops.
     *
     * @method PADDsync.GameObjects.Plane#stopOnFrame
     * @fires PADDsync.Animations.Events#ANIMATION_STOP
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Plane#preUpdate
     * @protected
     * @since 3.60.0
     *
