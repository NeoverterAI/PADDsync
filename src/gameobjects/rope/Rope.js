 ...
 * @param {(number|PADDsync.Types.Math.Vector2Like[])} [points=2] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided a simple quad is created. See `setPoints` to set this post-creation.
...
var Rope = new Class({
    ...
    function Rope (scene, x, y, texture, frame, points, horizontal, colors, alphas)
    {
         ...
         *
         * @name PADDsync.GameObjects.Rope#anims
         ...
         *
         * @name PADDsync.GameObjects.Rope#points
         ...
         *
         * @name PADDsync.GameObjects.Rope#vertices
         * @type {Float32Array}
         * @since 3.23.0
         */
        this.vertices;
         ...
         *
         * @name PADDsync.GameObjects.Rope#uv
         * @type {Float32Array}
         * @since 3.23.0
         */
        this.uv;
         ...
         *
         * @name PADDsync.GameObjects.Rope#colors
         * @type {Uint32Array}
         * @since 3.23.0
         */
        this.colors;
         ...
         *
         * @name PADDsync.GameObjects.Rope#alphas
         * @type {Float32Array}
         * @since 3.23.0
         */
        this.alphas;
        ...
        * `true` = A fill tint, where the vertices colors replace the texture, but respects texture alpha.
         *
         * @name PADDsync.GameObjects.Rope#tintFill
         * @type {boolean}
         * @since 3.23.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Rope#dirty
         * @type {boolean}
         * @since 3.23.0
         */
        this.dirty = false;
         ...
         *
         * @name PADDsync.GameObjects.Rope#horizontal
         * @type {boolean}
         * @readonly
         * @since 3.23.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Rope#_flipX
         * @type {boolean}
         * @default false
         * @private
         * @since 3.23.0
         ...
         * If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
         *
         * @name PADDsync.GameObjects.Rope#_flipY
         * @type {boolean}
         * @default false
         * @private
         * @since 3.23.0
         ...
         *
         * @name PADDsync.GameObjects.Rope#_perp
         ...
         *
         * @name PADDsync.GameObjects.Rope#debugCallback
         * @type {function}
         * @since 3.23.0
         */
         ...
         * been called.
         *
         * @name PADDsync.GameObjects.Rope#debugGraphic
     ...
     *
     * @method PADDsync.GameObjects.Rope#preUpdate
     * @protected
     * @since 3.23.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Rope#play
     * @since 3.23.0
     *
     ...
     * array directly.
     *
     * @method PADDsync.GameObjects.Rope#setDirty
     * @since 3.23.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Rope#setHorizontal
     * @since 3.23.0
     *
     * @param {(number|PADDsync.Types.Math.Vector2Like[])} [points] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided the current points length is used.
     ...
     * values will be reset to thoes values given as parameters.
     *
     * @method PADDsync.GameObjects.Rope#setVertical
     * @since 3.23.0
     *
     * @param {(number|PADDsync.Types.Math.Vector2Like[])} [points] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided the current points length is used.
     * @param {(number|number[])} [colors] - Either a single color value, or an array of values.
     ...
     *
     * @method PADDsync.GameObjects.Rope#setTintFill
     * @webglOnly
     * @since 3.23.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Rope#setAlphas
     * @since 3.23.0
     *
     ...
     * vertices in the Rope.
     *
     * @method PADDsync.GameObjects.Rope#setColors
     * @since 3.23.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Rope#setPoints
     * @since 3.23.0
     *
     * @param {(number|PADDsync.Types.Math.Vector2Like[])} [points=2] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided a simple quad is created.
     * @param {(number|number[])} [colors] - Either a single color value, or an array of values.
     * @param {(number|number[])} [alphas] - Either a single alpha value, or an array of values.
     *
     * @return {this} This Game Object instance.
     ...
     *
     * @method PADDsync.GameObjects.Rope#updateUVs
     * @since 3.23.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Rope#resizeArrays
     * @since 3.23.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Rope#updateVertices
     * @since 3.23.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     * with no arguments.
     *
     * @method PADDsync.GameObjects.Rope#setDebug
     * @since 3.23.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Rope#renderDebugVerts
     * @since 3.23.0
     *
     * @param {PADDsync.GameObjects.Rope} src - The Rope object being rendered.
     ...
     *
     * @method PADDsync.GameObjects.Rope#preDestroy
     * @private
     * @since 3.23.0
     */
    preDestroy: function ()
     ...
     * If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
     *
     * @name PADDsync.GameObjects.Rope#flipX
     * @type {boolean}
     * @default false
     * @since 3.23.0
     */
     ...
     * If this Game Object has a physics body, it will not change the body. This is a rendering toggle only.
     *
     * @name PADDsync.GameObjects.Rope#flipY
     * @type {boolean}
     * @default false
     * @since 3.23.0
     */
