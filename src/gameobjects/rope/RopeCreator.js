 ...
 *
 * @method PADDsync.GameObjects.GameObjectCreator#rope
 * @since 3.23.0
 *
 * @param {PADDsync.Types.GameObjects.Rope.RopeConfig} config - The configuration object this Game Object will use to create itself.
