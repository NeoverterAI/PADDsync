/**
 * @typedef {object} PADDsync.Types.GameObjects.Rope.RopeConfig
 ...
 * @property {(integer|PADDsync.Types.Math.Vector2Like[])} [points=2] - An array containing the vertices data for this Rope, or a number that indicates how many segments to split the texture frame into. If none is provided a simple quad is created. See `setPoints` to set this post-creation.
