...
var IsoTriangle = new Class({
    ...
    function IsoTriangle (scene, x, y, size, height, reversed, fillTop, fillLeft, fillRight)
    {
         ...
         *
         * @name PADDsync.GameObjects.IsoTriangle#projection
         * @type {number}
         * @default 4
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoTriangle#fillTop
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoTriangle#fillLeft
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoTriangle#fillRight
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoTriangle#showTop
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoTriangle#showLeft
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoTriangle#showRight
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoTriangle#isReversed
         * @type {boolean}
         * @default false
         * @since 3.13.0
         */
     ...
     *
     * @method PADDsync.GameObjects.IsoTriangle#setProjection
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.IsoTriangle#setReversed
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.IsoTriangle#setFaces
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.IsoTriangle#setFillStyle
     * @since 3.13.0
     *
