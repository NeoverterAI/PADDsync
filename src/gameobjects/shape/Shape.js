...
var Shape = new Class({
    ...
    function Shape (scene, type, data)
    {
         ...
         *
         * @name PADDsync.GameObjects.Shape#geom
         * @type {any}
         * @readonly
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shape#pathData
         * @type {number[]}
         * @readonly
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shape#pathIndexes
         * @type {number[]}
         * @readonly
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shape#fillColor
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shape#fillAlpha
         * @type {number}
         * @since 3.13.0
         */
        this.fillAlpha = 1;
         ...
         *
         * @name PADDsync.GameObjects.Shape#strokeColor
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shape#strokeAlpha
         * @type {number}
         * @since 3.13.0
         */
        this.strokeAlpha = 1;
         ...
         *
         * @name PADDsync.GameObjects.Shape#lineWidth
         * @type {number}
         * @since 3.13.0
         */
        this.lineWidth = 1;
         ...
         *
         * @name PADDsync.GameObjects.Shape#isFilled
         * @type {boolean}
         * @since 3.13.0
         */
        this.isFilled = false;
         ...
         *
         * @name PADDsync.GameObjects.Shape#isStroked
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shape#closePath
         * @type {boolean}
         * @since 3.13.0
         */
        this.closePath = true;
         ...
         *
         * @name PADDsync.GameObjects.Shape#_tempLine
         * @type {PADDsync.Geom.Line}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shape#width
         * @type {number}
         * @since 3.13.0
         */
        this.width = 0;
         ...
         *
         * @name PADDsync.GameObjects.Shape#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = 0;
     ...
     *
     * @method PADDsync.GameObjects.Shape#setFillStyle
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Shape#setStrokeStyle
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Shape#setClosePath
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Shape#setSize
     * @private
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Shape#setDisplaySize
     * @since 3.53.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Shape#preDestroy
     * @protected
     * @since 3.13.0
     */
    preDestroy: function ()
     ...
     *
     * @name PADDsync.GameObjects.Shape#displayWidth
     * @type {number}
     * @since 3.13.0
     */
    displayWidth: {
     ...
     * Setting this value will adjust the Game Object's scale property.
     *
     * @name PADDsync.GameObjects.Shape#displayHeight
     * @type {number}
     * @since 3.13.0
     */
    displayHeight: {
