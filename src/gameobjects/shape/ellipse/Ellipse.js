...
var Ellipse = new Class({
    ...
    function Ellipse (scene, x, y, width, height, fillColor, fillAlpha)
    {
         ...
         *
         * @name PADDsync.GameObjects.Ellipse#_smoothness
         * @type {number}
         * @private
         * @since 3.13.0
         */
     ...
     *
     * @name PADDsync.GameObjects.Ellipse#smoothness
     * @type {number}
     * @default 64
     * @since 3.13.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Ellipse#setSize
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Ellipse#setSmoothness
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Ellipse#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
