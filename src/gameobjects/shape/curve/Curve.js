 ...
 *
 * To render a Curve Shape you must first create a `PADDsync.Curves.Curve` object, then pass it to
 ...
 * @param {PADDsync.Curves.Curve} [curve] - The Curve object to use to create the Shape.
...
var Curve = new Class({
    ...
    function Curve (scene, x, y, curve, fillColor, fillAlpha)
    {
         ...
         *
         * @name PADDsync.GameObjects.Curve#_smoothness
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Curve#_curveBounds
     ...
     *
     * @name PADDsync.GameObjects.Curve#smoothness
     * @type {number}
     * @default 32
     * @since 3.13.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Curve#setSmoothness
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Curve#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
