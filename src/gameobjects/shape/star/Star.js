...
var Star = new Class({
    ...
    function Star (scene, x, y, points, innerRadius, outerRadius, fillColor, fillAlpha)
    {
         ...
         *
         * @name PADDsync.GameObjects.Star#_points
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Star#_innerRadius
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Star#_outerRadius
         * @type {number}
         * @private
         * @since 3.13.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Star#setPoints
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Star#setInnerRadius
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Star#setOuterRadius
     * @since 3.13.0
     *
     ...
     *
     * @name PADDsync.GameObjects.Star#points
     * @type {number}
     * @default 5
     * @since 3.13.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Star#innerRadius
     * @type {number}
     * @default 32
     * @since 3.13.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Star#outerRadius
     * @type {number}
     * @default 64
     * @since 3.13.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Star#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
