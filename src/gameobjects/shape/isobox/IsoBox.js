...
var IsoBox = new Class({
    ...
    function IsoBox (scene, x, y, size, height, fillTop, fillLeft, fillRight)
    {
         ...
         *
         * @name PADDsync.GameObjects.IsoBox#projection
         * @type {number}
         * @default 4
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoBox#fillTop
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoBox#fillLeft
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoBox#fillRight
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoBox#showTop
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoBox#showLeft
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.IsoBox#showRight
         * @type {boolean}
         * @default true
         * @since 3.13.0
         */
     ...
     *
     * @method PADDsync.GameObjects.IsoBox#setProjection
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.IsoBox#setFaces
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.IsoBox#setFillStyle
     * @since 3.13.0
     *
