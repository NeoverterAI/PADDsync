 ...
 *
 * @class Arc
 * @extends PADDsync.GameObjects.Shape
...
var Arc = new Class({
    ...
    function Arc (scene, x, y, radius, startAngle, endAngle, anticlockwise, fillColor, fillAlpha)
    {
         ...
         *
         * @name PADDsync.GameObjects.Arc#_startAngle
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Arc#_endAngle
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Arc#_anticlockwise
         * @type {boolean}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Arc#_iterations
         * @type {number}
         * @default 0.01
         * @private
         * @since 3.13.0
     ...
     *
     * @name PADDsync.GameObjects.Arc#iterations
     * @type {number}
     * @default 0.01
     * @since 3.13.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Arc#radius
     * @type {number}
     * @since 3.13.0
     */
    radius: {
     ...
     *
     * @name PADDsync.GameObjects.Arc#startAngle
     * @type {number}
     * @since 3.13.0
     */
    startAngle: {
     ...
     *
     * @name PADDsync.GameObjects.Arc#endAngle
     * @type {number}
     * @since 3.13.0
     */
    endAngle: {
     ...
     *
     * @name PADDsync.GameObjects.Arc#anticlockwise
     * @type {boolean}
     * @since 3.13.0
     */
    anticlockwise: {
     ...
     *
     * @method PADDsync.GameObjects.Arc#setRadius
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Arc#setIterations
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Arc#setStartAngle
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Arc#setEndAngle
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Arc#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
