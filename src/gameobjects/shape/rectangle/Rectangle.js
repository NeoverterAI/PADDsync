...
var Rectangle = new Class({
    ...
    function Rectangle (scene, x, y, width, height, fillColor, fillAlpha)
    {
         ...
         *
         * @name PADDsync.GameObjects.Shape#radius
         * @type {number}
         * @readonly
         * @since 3.90.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shape#isRounded
         * @type {boolean}
         * @readonly
         * @since 3.90.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Rectangle#setRounded
     * @since 3.90.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Rectangle#setSize
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Rectangle#updateData
     * @private
     * @since 3.13.0
     *
     * @return {this} This Game Object instance.
     ...
     *
     * @method PADDsync.GameObjects.Rectangle#updateRoundedData
     * @private
     * @since 3.90.0
     *
     * @return {this} This Game Object instance.
     ...
     *
     * @method PADDsync.GameObjects.Rectangle#arcTo
     * @private
     * @since 3.90.0
     *
