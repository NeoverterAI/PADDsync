...
var Line = new Class({
    ...
    function Line (scene, x, y, x1, y1, x2, y2, strokeColor, strokeAlpha)
    {
         ...
         *
         * @name PADDsync.GameObjects.Line#lineWidth
         * @type {number}
         * @since 3.13.0
         */
        this.lineWidth = 1;
         ...
         *
         * @name PADDsync.GameObjects.Line#_startWidth
         * @type {number}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Line#_endWidth
         * @type {number}
         * @private
         * @since 3.13.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Line#setLineWidth
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Line#setTo
     * @since 3.13.0
     *
     * @param {number} [x1=0] - The horizontal position of the start of the line.
     * @param {number} [y1=0] - The vertical position of the start of the line.
