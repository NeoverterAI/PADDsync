...
var Grid = new Class({
    ...
    function Grid (scene, x, y, width, height, cellWidth, cellHeight, fillColor, fillAlpha, outlineFillColor, outlineFillAlpha)
    {
         ...
         *
         * @name PADDsync.GameObjects.Grid#cellWidth
         * @type {number}
         * @since 3.13.0
         */
         ...
         * Must be a positive value.
         *
         * @name PADDsync.GameObjects.Grid#cellHeight
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Grid#showCells
         * @type {boolean}
         * @since 3.13.0
         */
        this.showCells = true;
         ...
         *
         * @name PADDsync.GameObjects.Grid#outlineFillColor
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Grid#outlineFillAlpha
         * @type {number}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Grid#showOutline
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Grid#showAltCells
         * @type {boolean}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Grid#altFillColor
         * @type {number}
         * @since 3.13.0
         */
        this.altFillColor;
         ...
         *
         * @name PADDsync.GameObjects.Grid#altFillAlpha
         * @type {number}
         * @since 3.13.0
         */
        this.altFillAlpha;
     ...
     *
     * @method PADDsync.GameObjects.Grid#setFillStyle
     * @since 3.13.0
     *
     * @param {number} [fillColor] - The color the grid cells will be filled with, i.e. 0xff0000 for red.
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Grid#setAltFillStyle
     * @since 3.13.0
     *
     ...
     * This call can be chained.
     *
     * @method PADDsync.GameObjects.Grid#setOutlineStyle
     * @since 3.13.0
     *
