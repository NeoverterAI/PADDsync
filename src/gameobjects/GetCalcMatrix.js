 ...
 * Object is rendered.
 *
 * @function PADDsync.GameObjects.GetCalcMatrix
 * @memberof PADDsync.GameObjects
 * @since 3.50.0
 *
 * @param {PADDsync.GameObjects.GameObject} src - The Game Object to calculate the transform matrix for.
 * @param {PADDsync.Cameras.Scene2D.Camera} camera - The camera being used to render the Game Object.
 * @param {PADDsync.GameObjects.Components.TransformMatrix} [parentMatrix] - The transform matrix of the parent container, if any.
 *
 * @return {PADDsync.Types.GameObjects.GetCalcMatrixResults} The results object containing the updated transform matrices.
 */
