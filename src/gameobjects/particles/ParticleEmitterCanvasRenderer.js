 ...
 *
 * @method PADDsync.GameObjects.Particles.Emitter#renderCanvas
 * @since 3.60.0
 * @private
 *
 * @param {PADDsync.Renderer.Canvas.CanvasRenderer} renderer - A reference to the current active Canvas renderer.
 * @param {PADDsync.GameObjects.Particles.ParticleEmitter} emitter - The Game Object being rendered in this call.
