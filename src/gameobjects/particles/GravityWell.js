 ...
 * @since 3.0.0
 *
 * @param {(number|PADDsync.Types.GameObjects.Particles.GravityWellConfig)} [x=0] - The x coordinate of the Gravity Well, in world space.
...
var GravityWell = new Class({
    ...
    function GravityWell (x, y, power, epsilon, gravity)
    {
         ...
         *
         * @name PADDsync.GameObjects.Particles.GravityWell#_gravity
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.GravityWell#_power
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.GameObjects.Particles.GravityWell#_epsilon
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
     ...
     *
     * @method PADDsync.GameObjects.Particles.GravityWell#update
     * @since 3.0.0
     *
     ...
     * Defaults to 100.
     *
     * @name PADDsync.GameObjects.Particles.GravityWell#epsilon
     * @type {number}
     * @since 3.0.0
     */
    epsilon: {
     ...
     * Defaults to 0.
     *
     * @name PADDsync.GameObjects.Particles.GravityWell#power
     * @type {number}
     * @since 3.0.0
     */
    power: {
     ...
     * Defaults to 50.
     *
     * @name PADDsync.GameObjects.Particles.GravityWell#gravity
     * @type {number}
     * @since 3.0.0
     */
    gravity: {
