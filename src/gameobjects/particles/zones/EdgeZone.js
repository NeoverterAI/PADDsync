 ...
 *
 * @class EdgeZone
 * @memberof PADDsync.GameObjects.Particles.Zones
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Types.GameObjects.Particles.EdgeZoneSource} source - An object instance with a `getPoints(quantity, stepRate)` method returning an array of points.
...
var EdgeZone = new Class({
    ...
    function EdgeZone (source, quantity, stepRate, yoyo, seamless, total)
    {
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#source
         * @type {PADDsync.Types.GameObjects.Particles.EdgeZoneSource|PADDsync.Types.GameObjects.Particles.RandomZoneSource}
         * @since 3.0.0
         */
        this.source = source;
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#points
         * @type {PADDsync.Geom.Point[]}
         * @default []
         * @since 3.0.0
         */
        this.points = [];
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#quantity
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#stepRate
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#yoyo
         * @type {boolean}
         * @since 3.0.0
         */
        this.yoyo = yoyo;
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#counter
         * @type {number}
         * @default -1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#seamless
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#_length
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#_direction
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.EdgeZone#total
         * @type {number}
         * @since 3.60.0
         */
        this.total = total;
    ...
    /**
     * Update the {@link PADDsync.GameObjects.Particles.Zones.EdgeZone#points} from the EdgeZone's
     * {@link PADDsync.GameObjects.Particles.Zones.EdgeZone#source}.
     *
     * Also updates internal properties.
     *
     * @method PADDsync.GameObjects.Particles.Zones.EdgeZone#updateSource
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.Zones.EdgeZone#changeSource
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.EdgeZoneSource} source - An object instance with a `getPoints(quantity, stepRate)` method returning an array of points.
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.Zones.EdgeZone#getPoint
     * @since 3.0.0
     *
