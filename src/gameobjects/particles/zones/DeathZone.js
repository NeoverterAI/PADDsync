 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Types.GameObjects.Particles.DeathZoneSource} source - An object instance that has a `contains` method that returns a boolean when given `x` and `y` arguments.
...
var DeathZone = new Class({
    ...
    function DeathZone (source, killOnEnter)
    {
         ...
         * This could be a Geometry shape, such as `PADDsync.Geom.Circle`, or your own custom object.
         *
         * @name PADDsync.GameObjects.Particles.Zones.DeathZone#source
         * @type {PADDsync.Types.GameObjects.Particles.DeathZoneSource}
         * @since 3.0.0
         */
        this.source = source;
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.DeathZone#killOnEnter
         * @type {boolean}
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Particles.Zones.DeathZone#willKill
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle to test against this Death Zones.
     *
