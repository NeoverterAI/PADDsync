 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Types.GameObjects.Particles.RandomZoneSource} source - An object instance with a `getRandomPoint(point)` method.
 */
var RandomZone = new Class({
    ...
    function RandomZone (source)
    {
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.RandomZone#source
         * @type {PADDsync.Types.GameObjects.Particles.RandomZoneSource}
         * @since 3.0.0
         */
        this.source = source;
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.RandomZone#_tempVec
         ...
         *
         * @name PADDsync.GameObjects.Particles.Zones.RandomZone#total
         * @type {number}
         * @since 3.60.0
         */
        this.total = -1;
     ...
     *
     * @method PADDsync.GameObjects.Particles.Zones.RandomZone#getPoint
     * @since 3.0.0
     *
