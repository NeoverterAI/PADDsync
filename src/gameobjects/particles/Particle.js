 ...
 * @since 3.0.0
 *
 * @param {PADDsync.GameObjects.Particles.ParticleEmitter} emitter - The Emitter to which this Particle belongs.
 */
var Particle = new Class({
    ...
    function Particle (emitter)
    {
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#emitter
         * @type {PADDsync.GameObjects.Particles.ParticleEmitter}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#texture
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#frame
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#x
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#y
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#worldPosition
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#velocityX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#velocityY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#accelerationX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#accelerationY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#maxVelocityX
         * @type {number}
         * @default 10000
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#maxVelocityY
         * @type {number}
         * @default 10000
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#bounce
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#scaleX
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#scaleY
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#alpha
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#angle
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#rotation
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#tint
         * @type {number}
         * @webglOnly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#life
         * @type {number}
         * @default 1000
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#lifeCurrent
         * @type {number}
         * @default 1000
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#delayCurrent
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#holdCurrent
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#lifeT
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#data
         * @type {PADDsync.Types.GameObjects.Particles.ParticleData}
         * @since 3.0.0
         */
        this.data = {
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#isCropped
         * @type {boolean}
         * @private
         * @readonly
         * @since 3.60.0
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#scene
         * @type {PADDsync.Scene}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#anims
         ...
         *
         * @name PADDsync.GameObjects.Particles.Particle#bounds
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#emit
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#isAlive
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#kill
     * @since 3.60.0
     */
    kill: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#setPosition
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#fire
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#update
     * @since 3.0.0
     *
     * @param {number} delta - The delta time in ms.
     * @param {number} step - The delta value divided by 1000.
     * @param {PADDsync.GameObjects.Particles.ParticleProcessor[]} processors - An array of all active Particle Processors.
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#computeVelocity
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Particles.ParticleEmitter} emitter - The Emitter that is updating this Particle.
     * @param {number} delta - The delta time in ms.
     * @param {number} step - The delta value divided by 1000.
     * @param {PADDsync.GameObjects.Particles.ParticleProcessor[]} processors - An array of all active Particle Processors.
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#setSizeToFrame
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#getBounds
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Components.TransformMatrix} [matrix] - Optional transform matrix to apply to this particle.
     *
     * @return {PADDsync.Geom.Rectangle} A Rectangle containing the transformed bounds of this particle.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.Particle#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
