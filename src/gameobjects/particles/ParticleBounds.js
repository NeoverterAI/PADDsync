 ...
 * @extends PADDsync.GameObjects.Particles.ParticleProcessor
...
var ParticleBounds = new Class({
    ...
    function ParticleBounds (x, y, width, height, collideLeft, collideRight, collideTop, collideBottom)
    {
         ...
         * the boundary.
         *
         * @name PADDsync.GameObjects.Particles.ParticleBounds#bounds
        ...
        /**
         * Whether particles interact with the left edge of the emitter {@link PADDsync.GameObjects.Particles.ParticleEmitter#bounds}.
         *
         * @name PADDsync.GameObjects.Particles.ParticleBounds#collideLeft
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
        ...
        /**
         * Whether particles interact with the right edge of the emitter {@link PADDsync.GameObjects.Particles.ParticleBounds#bounds}.
         *
         * @name PADDsync.GameObjects.Particles.ParticleBounds#collideRight
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
        ...
        /**
         * Whether particles interact with the top edge of the emitter {@link PADDsync.GameObjects.Particles.ParticleBounds#bounds}.
         *
         * @name PADDsync.GameObjects.Particles.ParticleBounds#collideTop
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
        ...
        /**
         * Whether particles interact with the bottom edge of the emitter {@link PADDsync.GameObjects.Particles.ParticleBounds#bounds}.
         *
         * @name PADDsync.GameObjects.Particles.ParticleBounds#collideBottom
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleBounds#update
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The Particle to update.
     */
