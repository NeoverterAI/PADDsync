 ...
 * @extends PADDsync.GameObjects.Particles.EmitterOp
...
var EmitterColorOp = new Class({
    ...
    function EmitterColorOp (key)
    {
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterColorOp#r
         * @type {number[]}
         * @since 3.60.0
         */
        this.r = [];
         ...
         * Populated during the `setMethods` method.
         *
         * @name PADDsync.GameObjects.Particles.EmitterColorOp#g
         * @type {number[]}
         * @since 3.60.0
         */
        this.g = [];
         ...
         * Populated during the `setMethods` method.
         *
         * @name PADDsync.GameObjects.Particles.EmitterColorOp#b
         * @type {number[]}
         * @since 3.60.0
         */
        this.b = [];
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterColorOp#getMethod
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterColorOp#setMethods
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterColorOp#setEase
     * @since 3.60.0
     *
     ...
     *
     * It prepares the particle for easing by {@link PADDsync.GameObjects.Particles.EmitterColorOp#easeValueUpdate}.
     *
     * @method PADDsync.GameObjects.Particles.EmitterColorOp#easedValueEmit
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     *
     * @return {number} {@link PADDsync.GameObjects.Particles.EmitterColorOp#start}, as the new value of the property.
     */
     ...
     * {@link PADDsync.GameObjects.Particles.EmitterColorOp#start} and {@link PADDsync.GameObjects.Particles.EmitterColorOp#end}
     * range.
     *
     * @method PADDsync.GameObjects.Particles.EmitterColorOp#easeValueUpdate
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
