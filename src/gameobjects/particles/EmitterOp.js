 ...
 * @param {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType|PADDsync.Types.GameObjects.Particles.EmitterOpOnUpdateType} defaultValue - The default value of the property.
...
var EmitterOp = new Class({
    ...
    function EmitterOp (key, defaultValue, emitOnly)
    {
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#propertyKey
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#propertyValue
         ...
         * configuration object.
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#defaultValue
         * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType|PADDsync.Types.GameObjects.Particles.EmitterOpOnUpdateType}
         * @since 3.0.0
         */
        ...
        /**
         * The number of steps for stepped easing between {@link PADDsync.GameObjects.Particles.EmitterOp#start} and
         * {@link PADDsync.GameObjects.Particles.EmitterOp#end} values, per emit.
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#steps
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#counter
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#yoyo
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#direction
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#start
         * @type {number|number[]}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#current
         * @type {number}
         * @since 3.60.0
         */
        this.current = 0;
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#end
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#ease
         * @type {?function}
         * @since 3.0.0
         */
        this.ease = null;
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#interpolation
         * @type {?function}
         * @since 3.60.0
         */
         ...
         *
         * Set to `true` to allow only {@link PADDsync.GameObjects.Particles.EmitterOp#onEmit} callbacks to be set and
         * affect this property.
         *
         * Set to `false` to allow both {@link PADDsync.GameObjects.Particles.EmitterOp#onEmit} and
         * {@link PADDsync.GameObjects.Particles.EmitterOp#onUpdate} callbacks to be set and affect this property.
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#emitOnly
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#onEmit
         * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#onUpdate
         * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnUpdateCallback}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#active
         * @type {boolean}
         * @since 3.60.0
         */
        this.active = true;
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#method
         * @type {number}
         * @since 3.60.0
         */
        this.method = 0;
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#_onEmit
         * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitCallback}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.EmitterOp#_onUpdate
         * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnUpdateCallback}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#loadConfig
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterConfig} [config] - Settings for the Particle Emitter that owns this property.
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#onChange
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#getMethod
     * @since 3.60.0
     *
    ...
    /**
     * Update the {@link PADDsync.GameObjects.Particles.EmitterOp#onEmit} and
     * {@link PADDsync.GameObjects.Particles.EmitterOp#onUpdate} callbacks based on the method returned
     * from `getMethod`. The method is stored in the `EmitterOp.method` property
     * and is a number between 0 and 9 inclusively.
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#setMethods
     * @since 3.0.0
     *
     * @return {this} This Emitter Op object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#has
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#hasBoth
     * @since 3.0.0
     *
     * @param {object} object - The object to check.
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#hasEither
     * @since 3.0.0
     *
     * @param {object} object - The object to check.
     * @param {string} key1 - The key of the first property to check the object for.
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#defaultEmit
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#defaultUpdate
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#proxyEmit
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#proxyUpdate
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#staticValueEmit
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#staticValueUpdate
     * @since 3.0.0
     *
     * @return {number} The current value of the property.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#randomStaticValueEmit
     * @since 3.0.0
     *
     * @return {number} The new value of the property.
     */
    ...
    /**
     * An `onEmit` callback that returns a value between the {@link PADDsync.GameObjects.Particles.EmitterOp#start} and
     * {@link PADDsync.GameObjects.Particles.EmitterOp#end} range.
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#randomRangedValueEmit
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     ...
     * {@link PADDsync.GameObjects.Particles.EmitterOp#end} range.
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#randomRangedIntEmit
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The key of the property.
     ...
     * {@link PADDsync.GameObjects.Particles.EmitterOp#start} and {@link PADDsync.GameObjects.Particles.EmitterOp#end}
     * range.
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#steppedEmit
     * @since 3.0.0
     *
     * @return {number} The new value of the property.
     */
     ...
     *
     * It prepares the particle for easing by {@link PADDsync.GameObjects.Particles.EmitterOp#easeValueUpdate}.
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#easedValueEmit
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     *
     * @return {number} {@link PADDsync.GameObjects.Particles.EmitterOp#start}, as the new value of the property.
     */
     ...
     * range.
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#easeValueUpdate
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle.
     * @param {string} key - The name of the property.
     ...
     *
     * @method PADDsync.GameObjects.Particles.EmitterOp#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
