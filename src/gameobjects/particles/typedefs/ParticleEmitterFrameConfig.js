/**
 * @typedef {object} PADDsync.Types.GameObjects.Particles.ParticleEmitterFrameConfig
 * @since 3.0.0
 *
 * @property {number[]|string[]|PADDsync.Textures.Frame[]} [frames] - Array of texture frames.
