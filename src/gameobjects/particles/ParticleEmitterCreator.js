 ...
 *
 * Note: This method will only be available if the Particles Game Object has been built into PADDsync.
 *
 * @method PADDsync.GameObjects.GameObjectCreator#particles
 * @since 3.0.0
 *
 * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterCreatorConfig} config - The configuration object this Game Object will use to create itself.
 * @param {boolean} [addToScene] - Add this Game Object to the Scene after creating it? If set this argument overrides the `add` property in the config object.
 *
 * @return {PADDsync.GameObjects.Particles.ParticleEmitter} The Game Object that was created.
 */
