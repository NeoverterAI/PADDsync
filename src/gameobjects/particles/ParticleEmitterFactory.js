 ...
 *
 * @method PADDsync.GameObjects.GameObjectFactory#particles
 * @since 3.60.0
 *
 ...
 * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterConfig} [config] - Configuration settings for the Particle Emitter.
 *
