...
/**
 * @classdesc
 * A Particle Emitter is a special kind of Game Object that controls a pool of {@link PADDsync.GameObjects.Particles.Particle Particles}.
 *
 ...
 * @memberof PADDsync.GameObjects.Particles
 * @constructor
 * @since 3.60.0
 *
 * @extends PADDsync.GameObjects.Components.AlphaSingle
 ...
 * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterConfig} [config] - Settings for this emitter.
 */
var ParticleEmitter = new Class({
    ...
    function ParticleEmitter (scene, x, y, texture, config)
    {
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleClass
         * @type {function}
         * @default PADDsync.GameObjects.Particles.Particle
         * @since 3.0.0
         * @see PADDsync.Types.GameObjects.Particles.ParticleClassConstructor
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#config
         * @type {PADDsync.Types.GameObjects.Particles.ParticleEmitterConfig}
         * @since 3.85.0
         */
        this.config = null;
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#ops
         * @type {PADDsync.Types.GameObjects.Particles.ParticleEmitterOps}
         * @since 3.60.0
         */
        this.ops = {
         ...
         * using {@link PADDsync.GameObjects.Particles.ParticleEmitter#speed} as the value. If set to false then this acts as a point Emitter.
         * A point emitter will emit particles only in the direction derived from the speedX and speedY values.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#radial
         * @type {boolean}
         * @default true
         * @since 3.0.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setRadial
         */
        this.radial = true;
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#gravityX
         * @type {number}
         * @default 0
         * @since 3.0.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setGravity
         */
        this.gravityX = 0;
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#gravityY
         * @type {number}
         * @default 0
         * @since 3.0.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setGravity
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#acceleration
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#moveTo
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#emitCallback
         * @type {?PADDsync.Types.GameObjects.Particles.ParticleEmitterCallback}
         * @default null
         * @since 3.0.0
         */
        ...
        /**
         * The calling context for {@link PADDsync.GameObjects.Particles.ParticleEmitter#emitCallback}.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#emitCallbackScope
         * @type {?*}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#deathCallback
         * @type {?PADDsync.Types.GameObjects.Particles.ParticleDeathCallback}
         * @default null
         * @since 3.0.0
         */
        ...
        /**
         * The calling context for {@link PADDsync.GameObjects.Particles.ParticleEmitter#deathCallback}.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#deathCallbackScope
         * @type {?*}
         * @default null
         * @since 3.0.0
         */
         ...
         * 0 means unlimited.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#maxParticles
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * 0 means no limits.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#maxAliveParticles
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#stopAfter
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#duration
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         * Calling {@link PADDsync.GameObjects.Particles.ParticleEmitter#flow} also puts the emitter in flow mode (frequency >= 0).
         * Calling {@link PADDsync.GameObjects.Particles.ParticleEmitter#explode} also puts the emitter in explode mode (frequency = -1).
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#frequency
         * @type {number}
         * @default 0
         * @since 3.0.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setFrequency
         */
        this.frequency = 0;
         ...
         *
         * Controlled by {@link PADDsync.GameObjects.Particles.ParticleEmitter#start} and {@link PADDsync.GameObjects.Particles.ParticleEmitter#stop}.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#emitting
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleBringToTop
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#emitZones
         * @type {PADDsync.Types.GameObjects.Particles.EmitZoneObject[]}
         * @since 3.60.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setEmitZone
         */
        this.emitZones = [];
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#deathZones
         * @type {PADDsync.GameObjects.Particles.Zones.DeathZone[]}
         * @since 3.60.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setDeathZone
         */
        this.deathZones = [];
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#viewBounds
         * @type {?PADDsync.Geom.Rectangle}
         * @default null
         * @since 3.60.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setViewBounds
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#follow
         * @type {?PADDsync.Types.Math.Vector2Like}
         * @default null
         * @since 3.0.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#startFollow
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#stopFollow
         */
        this.follow = null;

        /**
         * The offset of the particle origin from the {@link PADDsync.GameObjects.Particles.ParticleEmitter#follow} target.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#followOffset
        ...
        /**
         * Whether the emitter's {@link PADDsync.GameObjects.Particles.ParticleEmitter#visible} state will track
         * the {@link PADDsync.GameObjects.Particles.ParticleEmitter#follow} target's visibility state.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#trackVisible
         * @type {boolean}
         * @default false
         * @since 3.0.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#startFollow
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#frames
        ...
        /**
         * Whether texture {@link PADDsync.GameObjects.Particles.ParticleEmitter#frames} are selected at random.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#randomFrame
         * @type {boolean}
         * @default true
         * @since 3.0.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setEmitterFrame
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#frameQuantity
         * @type {number}
         * @default 1
         * @since 3.0.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setEmitterFrame
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#anims
         * @type {string[]}
         * @since 3.60.0
         */
        this.anims = [];
        ...
        /**
         * Whether animations {@link PADDsync.GameObjects.Particles.ParticleEmitter#anims} are selected at random.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#randomAnim
         * @type {boolean}
         * @default true
         * @since 3.60.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setAnim
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#animQuantity
         * @type {number}
         * @default 1
         * @since 3.60.0
         * @see PADDsync.GameObjects.Particles.ParticleEmitter#setAnim
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#dead
         * @type {PADDsync.GameObjects.Particles.Particle[]}
         * @private
         * @since 3.0.0
         */
        this.dead = [];
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#alive
         * @type {PADDsync.GameObjects.Particles.Particle[]}
         * @private
         * @since 3.0.0
         */
         ...
         * 1 - frameCounter - Counts up to {@link PADDsync.GameObjects.Particles.ParticleEmitter#frameQuantity}.
         ...
         * 8 - currentFrame - The current texture frame, as an index of {@link PADDsync.GameObjects.Particles.ParticleEmitter#frames}.
         * 9 - currentAnim - The current animation, as an index of {@link PADDsync.GameObjects.Particles.ParticleEmitter#anims}.
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#counters
         * @type {Float32Array}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#skipping
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#worldMatrix
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#sortProperty
         * @type {string}
         * @since 3.60.0
         */
        this.sortProperty = '';
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#sortOrderAsc
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#sortCallback
         * @type {?PADDsync.Types.GameObjects.Particles.ParticleSortCallback}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#processors
         * @type {PADDsync.Structs.List.<PADDsync.GameObjects.Particles.ParticleProcessor>}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleEmitter#tintFill
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setConfig
     * @since 3.60.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterConfig} config - Settings for this emitter.
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#updateConfig
     * @since 3.85.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterConfig} config - Settings for this emitter.
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#toJSON
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#resetCounters
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#startFollow
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Math.Vector2Like} target - The Object to follow.
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#stopFollow
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * Chooses a texture frame from {@link PADDsync.GameObjects.Particles.ParticleEmitter#frames}.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getFrame
     * @since 3.0.0
     *
     * @return {PADDsync.Textures.Frame} The texture frame.
     */
    getFrame: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setEmitterFrame
     * @since 3.0.0
     *
     * @param {(array|string|number|PADDsync.Types.GameObjects.Particles.ParticleEmitterFrameConfig)} frames - One or more texture frames, or a configuration object.
    ...
    /**
     * Chooses an animation from {@link PADDsync.GameObjects.Particles.ParticleEmitter#anims}, if populated.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getAnim
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setAnim
     * @since 3.60.0
     *
     * @param {(string|string[]|PADDsync.Types.GameObjects.Particles.ParticleEmitterAnimConfig)} anims - One or more animations, or a configuration object.
    ...
    /**
     * Turns {@link PADDsync.GameObjects.Particles.ParticleEmitter#radial} particle movement on or off.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setRadial
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#addParticleBounds
     * @since 3.60.0
     *
     * @param {(number|PADDsync.Types.GameObjects.Particles.ParticleEmitterBounds|PADDsync.Types.GameObjects.Particles.ParticleEmitterBoundsAlt)} x - The x-coordinate of the left edge of the boundary, or an object representing a rectangle.
     ...
     *
     * @return {PADDsync.GameObjects.Particles.ParticleBounds} The Particle Bounds processor.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setParticleSpeed
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setParticleScale
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setParticleGravity
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setParticleAlpha
     * @since 3.60.0
     *
     * @param {(PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType|PADDsync.Types.GameObjects.Particles.EmitterOpOnUpdateType)} value - A value between 0 (transparent) and 1 (opaque).
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setParticleTint
     * @since 3.60.0
     * @webglOnly
     *
     * @param {(PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType|PADDsync.Types.GameObjects.Particles.EmitterOpOnUpdateType)} value - A value between 0 and 0xffffff.
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * Sets the angle of a {@link PADDsync.GameObjects.Particles.ParticleEmitter#radial} particle stream.
     *
     * The value is given in degrees using Phaser's right-handed coordinate system.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setEmitterAngle
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType} value - The angle of the initial velocity of emitted particles, in degrees.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setParticleLifespan
     * @since 3.60.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType} value - The lifespan of a particle, in ms.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setQuantity
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType} quantity - The number of particles to release at each flow cycle or explosion.
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * Sets the emitter's {@link PADDsync.GameObjects.Particles.ParticleEmitter#frequency}
     * and {@link PADDsync.GameObjects.Particles.ParticleEmitter#quantity}.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setFrequency
     * @since 3.0.0
     *
     ...
     * Any valid object from the `PADDsync.Geometry` namespace is allowed, as long as
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#addDeathZone
     * @since 3.60.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.DeathZoneObject|PADDsync.Types.GameObjects.Particles.DeathZoneObject[]} config - A Death Zone configuration object, a Death Zone instance, a valid Geometry object or an array of them.
     *
     * @return {PADDsync.GameObjects.Particles.Zones.DeathZone[]} An array of the Death Zones that were added to this Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#removeDeathZone
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Zones.DeathZone} zone - The Death Zone that should be removed from this Emitter.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#clearDeathZones
     * @since 3.70.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * An {@link PADDsync.Types.GameObjects.Particles.ParticleEmitterEdgeZoneConfig EdgeZone} places particles on its edges.
     * Its {@link PADDsync.Types.GameObjects.Particles.EdgeZoneSource source} can be a Curve, Path, Circle, Ellipse, Line, Polygon, Rectangle, or Triangle;
     * or any object with a suitable {@link PADDsync.Types.GameObjects.Particles.EdgeZoneSourceCallback getPoints} method.
     *
     * A {@link PADDsync.Types.GameObjects.Particles.ParticleEmitterRandomZoneConfig RandomZone} places the particles randomly within its interior.
     * Its {@link PADDsync.GameObjects.Particles.Zones.RandomZone#source source} can be a Circle, Ellipse, Line, Polygon, Rectangle, or Triangle; or any object with a suitable {@link PADDsync.Types.GameObjects.Particles.RandomZoneSourceCallback getRandomPoint} method.
     *
     * An Emission Zone can only exist once within this Emitter.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#addEmitZone
     * @since 3.60.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.EmitZoneData|PADDsync.Types.GameObjects.Particles.EmitZoneData[]} zone - An Emission Zone configuration object, a RandomZone or EdgeZone instance, or an array of them.
     *
     * @return {PADDsync.Types.GameObjects.Particles.EmitZoneObject[]} An array of the Emission Zones that were added to this Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#removeEmitZone
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Zones.EdgeZone|PADDsync.GameObjects.Particles.Zones.RandomZone} zone - The Emission Zone that should be removed from this Emitter.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#clearEmitZones
     * @since 3.70.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getEmitZone
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle to set the emission zone for.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getDeathZone
     * @fires PADDsync.GameObjects.Particles.Events#DEATH_ZONE
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Particles.Particle} particle - The particle to test against the Death Zones.
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setEmitZone
     * @since 3.0.0
     *
     * @param {number|PADDsync.GameObjects.Particles.Zones.EdgeZone|PADDsync.GameObjects.Particles.Zones.RandomZone} zone - The Emit Zone to set as the active zone.
     *
     * @return {this} This Particle Emitter.
     */
     ...
     * property is set.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#addParticleProcessor
     * @since 3.60.0
     *
     * @generic {PADDsync.GameObjects.Particles.ParticleProcessor} T
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#removeParticleProcessor
     * @since 3.60.0
     *
     * @generic {PADDsync.GameObjects.Particles.ParticleProcessor} T
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getProcessors
     * @since 3.60.0
     *
     * @return {PADDsync.GameObjects.Particles.ParticleProcessor[]} - An array of active Particle Processors.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#createGravityWell
     * @since 3.60.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.GravityWellConfig} config - Configuration settings for the Gravity Well to create.
     *
     * @return {PADDsync.GameObjects.Particles.GravityWell} The Gravity Well that was created.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#reserve
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getAliveParticleCount
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getDeadParticleCount
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getParticleCount
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#atLimit
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#onParticleEmit
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterCallback} callback - The function.
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#onParticleDeath
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.ParticleDeathCallback} callback - The function.
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#killAll
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#forEachAlive
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterCallback} callback - The function.
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#forEachDead
     * @since 3.0.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.ParticleEmitterCallback} callback - The function.
     * @param {*} context - The functions calling context.
    ...
    /**
     * Turns {@link PADDsync.GameObjects.Particles.ParticleEmitter#on} the emitter and resets the flow counter.
     *
     * If this emitter is in flow mode (frequency >= 0; the default), the particle flow will start (or restart).
     *
     * If this emitter is in explode mode (frequency = -1), nothing will happen.
     * Use {@link PADDsync.GameObjects.Particles.ParticleEmitter#explode} or {@link PADDsync.GameObjects.Particles.ParticleEmitter#flow} instead.
     *
     * Calling this method will emit the `START` event.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#start
     * @fires PADDsync.GameObjects.Particles.Events#START
     * @since 3.0.0
     *
    ...
    /**
     * Turns {@link PADDsync.GameObjects.Particles.ParticleEmitter#emitting off} the emitter and
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#stop
     * @fires PADDsync.GameObjects.Particles.Events#STOP
     * @since 3.11.0
     *
    ...
    /**
     * {@link PADDsync.GameObjects.Particles.ParticleEmitter#active Deactivates} the emitter.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#pause
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * {@link PADDsync.GameObjects.Particles.ParticleEmitter#active Activates} the emitter.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#resume
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setSortProperty
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#setSortCallback
     * @since 3.60.0
     *
     * @param {PADDsync.Types.GameObjects.Particles.ParticleSortCallback} [callback] - The callback to invoke when the particles are sorted. Leave undefined to reset to the default.
     *
     * @return {this} This Particle Emitter.
     */
    ...
    /**
     * Sorts active particles with {@link PADDsync.GameObjects.Particles.ParticleEmitter#depthSortCallback}.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#depthSort
     * @since 3.0.0
     *
     * @return {this} This Particle Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#depthSortCallback
     * @since 3.0.0
     *
     ...
     *
     * To resume a flow at the current frequency and quantity, use {@link PADDsync.GameObjects.Particles.ParticleEmitter#start} instead.
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#flow
     * @fires PADDsync.GameObjects.Particles.Events#START
     * @since 3.0.0
     *
     * @param {number} frequency - The time interval (>= 0) of each flow cycle, in ms.
     * @param {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType} [count=1] - The number of particles to emit at each flow cycle.
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#explode
     * @fires PADDsync.GameObjects.Particles.Events#EXPLODE
     * @since 3.0.0
     *
     ...
     *
     * @return {(PADDsync.GameObjects.Particles.Particle|undefined)} The most recently emitted Particle, or `undefined` if the emitter is at its limit.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#emitParticleAt
     * @since 3.0.0
     *
     * @param {number} [x=this.x] - The x coordinate to emit the Particles from.
     * @param {number} [y=this.x] - The y coordinate to emit the Particles from.
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#emitParticle
     * @since 3.0.0
     *
     * @param {number} [count=this.quantity] - The number of Particles to emit.
     * @param {number} [x=this.x] - The x coordinate to emit the Particles from.
     ...
     * @return {(PADDsync.GameObjects.Particles.Particle|undefined)} The most recently emitted Particle, or `undefined` if the emitter is at its limit.
     *
     * @see PADDsync.GameObjects.Particles.Particle#fire
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#fastForward
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#preUpdate
     * @fires PADDsync.GameObjects.Particles.Events#COMPLETE
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#overlap
     * @since 3.60.0
     *
     * @param {(PADDsync.Geom.Rectangle|PADDsync.Physics.Arcade.Body)} target - A Rectangle or Arcade Physics Body to check for intersection against all alive particles.
     *
     * @return {PADDsync.GameObjects.Particles.Particle[]} An array of Particles that overlap with the given target.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#getBounds
     * @since 3.60.0
     *
     ...
     * @param {number} [delta] - The amount of delta to use for each step. Defaults to 1000 / 60.
     * @param {PADDsync.Geom.Rectangle} [output] - The Rectangle to store the results in. If not given a new one will be created.
     *
     * @return {PADDsync.Geom.Rectangle} A Rectangle containing the calculated bounds of this Emitter.
     */
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#createEmitter
     * @since 3.60.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleX
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType|PADDsync.Types.GameObjects.Particles.EmitterOpOnUpdateType}
     * @since 3.60.0
     */
    particleX: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleY
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType|PADDsync.Types.GameObjects.Particles.EmitterOpOnUpdateType}
     * @since 3.60.0
     */
    particleY: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#accelerationX
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    accelerationX: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#accelerationY
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    accelerationY: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#maxVelocityX
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     * @default 10000
     */
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#maxVelocityY
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     * @default 10000
     */
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#speed
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    speed: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#speedX
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    speedX: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#speedY
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    speedY: {
    ...
    /**
     * The x coordinate emitted particles move toward, when {@link PADDsync.GameObjects.Particles.ParticleEmitter#moveTo} is true.
     *
     * Accessing this property should typically return a number.
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#moveToX
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    moveToX: {
    ...
    /**
     * The y coordinate emitted particles move toward, when {@link PADDsync.GameObjects.Particles.ParticleEmitter#moveTo} is true.
     *
     * Accessing this property should typically return a number.
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#moveToY
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    moveToY: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#bounce
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    bounce: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleScaleX
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleScaleX: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleScaleY
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleScaleY: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleColor
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleColor: {
     ...
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#colorEase
     * @type {string}
     * @since 3.60.0
     */
    colorEase: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleTint
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleTint: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleAlpha
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleAlpha: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#lifespan
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    lifespan: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleAngle
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleAngle: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#particleRotate
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    particleRotate: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#quantity
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @see PADDsync.GameObjects.Particles.ParticleEmitter#setFrequency
     * @see PADDsync.GameObjects.Particles.ParticleEmitter#setQuantity
     * @since 3.60.0
     */
    quantity: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#delay
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    delay: {
     ...
     * However, it can be set to any valid EmitterOp onEmit type.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#hold
     * @type {PADDsync.Types.GameObjects.Particles.EmitterOpOnEmitType}
     * @since 3.60.0
     */
    hold: {
     ...
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#flowCounter
     * @type {number}
     * @since 3.60.0
     */
    flowCounter: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#frameCounter
     * @type {number}
     * @since 3.60.0
     */
    frameCounter: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#animCounter
     * @type {number}
     * @since 3.60.0
     */
    animCounter: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#elapsed
     * @type {number}
     * @since 3.60.0
     */
    elapsed: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#stopCounter
     * @type {number}
     * @since 3.60.0
     */
    stopCounter: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#completeFlag
     * @type {boolean}
     * @since 3.60.0
     */
    completeFlag: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#zoneIndex
     * @type {number}
     * @since 3.60.0
     */
    zoneIndex: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#zoneTotal
     * @type {number}
     * @since 3.60.0
     */
    zoneTotal: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#currentFrame
     * @type {number}
     * @since 3.60.0
     */
    currentFrame: {
     ...
     * Treat this property as read-only.
     *
     * @name PADDsync.GameObjects.Particles.ParticleEmitter#currentAnim
     * @type {number}
     * @since 3.60.0
     */
    currentAnim: {
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleEmitter#preDestroy
     * @since 3.60.0
     */
    preDestroy: function ()
    {
