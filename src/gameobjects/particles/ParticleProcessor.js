...
var ParticleProcessor = new Class({
    ...
    function ParticleProcessor (x, y, active)
    {
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleProcessor#manager
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleProcessor#x
         * @type {number}
         * @since 3.60.0
         */
        this.x = x;
         ...
         *
         * @name PADDsync.GameObjects.Particles.ParticleProcessor#y
         * @type {number}
         * @since 3.60.0
         */
        this.y = y;
         ...
         * its parent Emitter.
         *
         * @name PADDsync.GameObjects.Particles.ParticleProcessor#active
         * @type {boolean}
         * @since 3.60.0
         */
        this.active = active;
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleProcessor#update
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Particles.ParticleProcessor#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
