...
var GameObjectCreator = new Class({
    ...
    function GameObjectCreator (scene)
    {
         ...
         *
         * @name PADDsync.GameObjects.GameObjectCreator#scene
         * @type {PADDsync.Scene}
         * @protected
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.GameObjects.GameObjectCreator#systems
         ...
         *
         * @name PADDsync.GameObjects.GameObjectCreator#events
         ...
         *
         * @name PADDsync.GameObjects.GameObjectCreator#displayList
         ...
         *
         * @name PADDsync.GameObjects.GameObjectCreator#updateList
     ...
     *
     * @method PADDsync.GameObjects.GameObjectCreator#boot
     * @private
     * @since 3.5.1
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.GameObjects.GameObjectCreator#start
     * @private
     * @since 3.5.0
     */
    start: function ()
     ...
     *
     * @method PADDsync.GameObjects.GameObjectCreator#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.GameObjects.GameObjectCreator#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function ()
 ...
 * to be called when you invoke PADDsync.Scene.make[ factoryType ] method.
 *
 * @method PADDsync.GameObjects.GameObjectCreator.register
 * @static
 * @since 3.0.0
 *
 * @param {string} factoryType - The key of the factory that you will use to call to PADDsync.Scene.make[ factoryType ] method.
 * @param {function} factoryFunction - The constructor function to be called when you invoke to the PADDsync.Scene.make method.
 */
 ...
 *
 * @method PADDsync.GameObjects.GameObjectCreator.remove
 * @static
 * @since 3.0.0
 *
