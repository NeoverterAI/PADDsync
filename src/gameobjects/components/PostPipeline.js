 ...
 *
 * @namespace PADDsync.GameObjects.Components.PostPipeline
 * @webglOnly
 * @since 3.60.0
 */
...
var PostPipeline = {
     ...
     *
     * @name PADDsync.GameObjects.Components.PostPipeline#hasPostPipeline
     * @type {boolean}
     * @webglOnly
     * @since 3.60.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Components.PostPipeline#postPipelines
     ...
     *
     * @name PADDsync.GameObjects.Components.PostPipeline#postPipelineData
     * @type {object}
     * @webglOnly
     * @since 3.60.0
     */
     ...
     *
     * @name PADDsync.GameObjects.Components.PostPipeline#preFX
     * @type {?PADDsync.GameObjects.Components.FX}
     * @webglOnly
     * @since 3.60.0
     */
    preFX: null,
     ...
     *
     * @name PADDsync.GameObjects.Components.PostPipeline#postFX
     * @type {PADDsync.GameObjects.Components.FX}
     * @webglOnly
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.PostPipeline#initPostPipeline
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Components.PostPipeline#setPostPipeline
     * @webglOnly
     * @since 3.60.0
     *
     * @param {(string|string[]|function|function[]|PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline|PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline[])} pipelines - Either the string-based name of the pipeline, or a pipeline instance, or class, or an array of them.
     ...
     *
     * @method PADDsync.GameObjects.Components.PostPipeline#setPostPipelineData
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Components.PostPipeline#getPostPipeline
     * @webglOnly
     * @since 3.60.0
     *
     * @param {(string|function|PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline)} pipeline - The string-based name of the pipeline, or a pipeline class.
     *
     * @return {(PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline|PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline[])} An array of all the Post Pipelines matching the name. This array will be empty if there was no match. If there was only one single match, that pipeline is returned directly, not in an array.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.PostPipeline#resetPostPipeline
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Components.PostPipeline#removePostPipeline
     * @webglOnly
     * @since 3.60.0
     *
     * @param {string|PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline} pipeline - The string-based name of the pipeline, or a pipeline class.
     *
     ...
     *
     * @method PADDsync.GameObjects.Components.PostPipeline#clearFX
     * @webglOnly
     * @since 3.60.0
     *
     * @return {this} This Game Object.
