...
var TextureCrop = {
     ...
     * @since 3.11.0
     *
     * @param {(number|PADDsync.Geom.Rectangle)} [x] - The x coordinate to start the crop from. Cannot be negative or exceed the Frame width. Or a PADDsync.Geom.Rectangle object, in which case the rest of the arguments are ignored.
     ...
     * @since 3.0.0
     *
     * @param {(string|number|PADDsync.Textures.Frame)} frame - The name or index of the frame within the Texture, or a Frame instance.
