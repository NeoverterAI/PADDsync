 ...
 * @webglOnly
 *
 * @param {PADDsync.GameObjects.GameObject} gameObject - A reference to the Game Object that owns this FX Component.
...
var FX = new Class({
    ...
    function FX (gameObject, isPost)
    {
         ...
         *
         * @name PADDsync.GameObjects.Components.FX#gameObject
         ...
         *
         * @name PADDsync.GameObjects.Components.FX#isPost
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Components.FX#enabled
         * @type {boolean}
         * @since 3.60.0
         */
        this.enabled = false;
         ...
         *
         * @name PADDsync.GameObjects.Components.FX#list
         * @type {PADDsync.FX.Controller[]}
         * @since 3.60.0
         */
        this.list = [];
         ...
         *
         * @name PADDsync.GameObjects.Components.FX#padding
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
     ...
     * You do not need to set this if you're only using Post FX.
     *
     * @method PADDsync.GameObjects.Components.FX#setPadding
     * @webglOnly
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#onFXCopy
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline} pipeline - The PreFX Pipeline that invoked this callback.
     */
    onFXCopy: function ()
    {
    },
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#onFX
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline} pipeline - The PreFX Pipeline that invoked this callback.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#enable
     * @since 3.60.0
     *
     * @param {number} [padding=0] - The amount of padding to add to this Game Object.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#clear
     * @since 3.60.0
     *
     * @return {this} This Game Object instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#remove
     * @since 3.60.0
     *
     * @generic {PADDsync.FX.Controller} T
     * @genericUse {T} - [fx]
     *
     * @param {PADDsync.FX.Controller|PADDsync.Display.ColorMatrix} fx - The FX Controller to remove from this FX Component.
     *
     * @return {this} This Game Object instance.
     */
    remove: function (fx)
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#disable
     * @since 3.60.0
     *
     ...
     * `clear` first.
     *
     * @method PADDsync.GameObjects.Components.FX#add
     * @since 3.60.0
     *
     * @generic {PADDsync.FX.Controller} T
     * @genericUse {T} - [fx]
     *
     * @param {PADDsync.FX.Controller} fx - The FX Controller to add to this FX Component.
     * @param {object} [config] - Optional configuration object that is passed to the pipeline during instantiation.
     *
     * @return {PADDsync.FX.Controller} The FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addGlow
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Glow} The Glow FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addShadow
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Shadow} The Shadow FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addPixelate
     * @since 3.60.0
     *
     * @param {number} [amount=1] - The amount of pixelation to apply.
     *
     * @return {PADDsync.FX.Pixelate} The Pixelate FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addVignette
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Vignette} The Vignette FX Controller.
     */
     ...
     * material properties.
     *
     * @method PADDsync.GameObjects.Components.FX#addShine
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Shine} The Shine FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addBlur
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Blur} The Blur FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addGradient
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Gradient} The Gradient FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addBloom
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Bloom} The Bloom FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addColorMatrix
     * @since 3.60.0
     *
     * @return {PADDsync.FX.ColorMatrix} The ColorMatrix FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addCircle
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Circle} The Circle FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addBarrel
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Barrel} The Barrel FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addDisplacement
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Displacement} The Displacement FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#addWipe
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Wipe} The Wipe FX Controller.
     */
     ...
     * It is up to you to set the `progress` value yourself, i.e. via a Tween, in order to transition the effect.
     *
     * @method PADDsync.GameObjects.Components.FX#addReveal
     * @since 3.60.0
     *
     * @param {number} [wipeWidth=0.1] - The width of the wipe effect. This value is normalized in the range 0 to 1.
     * @param {number} [direction=0] - The direction of the wipe effect. Either 0 or 1. Set in conjunction with the axis property.
     ...
     * See also Tilt Shift.
     *
     * @method PADDsync.GameObjects.Components.FX#addBokeh
     * @since 3.60.0
     *
     ...
     *
     * @return {PADDsync.FX.Bokeh} The Bokeh FX Controller.
     */
     ...
     * See also Bokeh.
     *
     * @method PADDsync.GameObjects.Components.FX#addTiltShift
     * @since 3.60.0
     *
     * @param {number} [radius=0.5] - The radius of the bokeh effect.
     * @param {number} [amount=1] - The amount of the bokeh effect.
     ...
     *
     * @return {PADDsync.FX.Bokeh} The Bokeh TiltShift FX Controller.
     */
     ...
     *
     * @method PADDsync.GameObjects.Components.FX#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
