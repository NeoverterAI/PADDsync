...
var Pipeline = {
     ...
     *
     * @name PADDsync.GameObjects.Components.Pipeline#pipelineData
     * @type {object}
     * @webglOnly
     * @since 3.50.0
     */
     ...
     * @since 3.0.0
     *
     * @param {(string|PADDsync.Renderer.WebGL.WebGLPipeline)} [pipeline] - Either the string-based name of the pipeline, or a pipeline instance to set.
     *
     ...
     *
     * @method PADDsync.GameObjects.Components.Pipeline#setPipelineData
     * @webglOnly
     * @since 3.50.0
     *
