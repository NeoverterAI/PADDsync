 ...
 * @since 3.0.0
 *
 * @extends PADDsync.GameObjects.Components.PathFollower
 *
 * @param {PADDsync.Scene} scene - The Scene to which this PathFollower belongs.
...
var PathFollower = new Class({
     ...
     *
     * @method PADDsync.GameObjects.PathFollower#preUpdate
     * @protected
     * @since 3.0.0
     *
