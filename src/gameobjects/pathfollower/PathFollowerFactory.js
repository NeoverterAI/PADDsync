 ...
 *
 * Note: This method will only be available if the PathFollower Game Object has been built into PADDsync.
 *
 * @method PADDsync.GameObjects.GameObjectFactory#follower
 * @since 3.0.0
 *
 * @param {PADDsync.Curves.Path} path - The Path this PathFollower is connected to.
 ...
 *
 * @return {PADDsync.GameObjects.PathFollower} The Game Object that was created.
 */
