 ...
 *
 * It works by taking a reference to a `PADDsync.Display.BaseShader` instance, as found in the Shader Cache. These can
 ...
 * @param {(string|PADDsync.Display.BaseShader)} key - The key of the shader to use from the shader cache, or a BaseShader instance.
...
var Shader = new Class({
    ...
    function Shader (scene, key, x, y, width, height, textures, textureData)
    {
         ...
         *
         * @name PADDsync.GameObjects.Shader#blendMode
         * @type {number}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#shader
         * @type {PADDsync.Display.BaseShader}
         * @since 3.17.0
         */
        this.shader;
         ...
         *
         * @name PADDsync.GameObjects.Shader#renderer
         ...
         *
         * @name PADDsync.GameObjects.Shader#gl
         ...
         *
         * @name PADDsync.GameObjects.Shader#vertexData
         * @type {ArrayBuffer}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#vertexBuffer
         ...
         *
         * @name PADDsync.GameObjects.Shader#_deferSetShader
         ...
         *
         * @name PADDsync.GameObjects.Shader#_deferProjOrtho
         ...
         *
         * @name PADDsync.GameObjects.Shader#program
         ...
         *
         * @name PADDsync.GameObjects.Shader#bytes
         * @type {Uint8Array}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#vertexViewF32
         * @type {Float32Array}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#_tempMatrix1
         * @private
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name PADDsync.GameObjects.Shader#_tempMatrix2
         * @private
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @since 3.17.0
         */
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name PADDsync.GameObjects.Shader#_tempMatrix3
         * @private
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#viewMatrix
         * @type {Float32Array}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#projectionMatrix
         * @type {Float32Array}
         * @readonly
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#uniforms
         * @type {any}
         * @since 3.17.0
         */
        this.uniforms = {};
         ...
         *
         * @name PADDsync.GameObjects.Shader#pointer
         ...
         *
         * @name PADDsync.GameObjects.Shader#_rendererWidth
         * @type {number}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#_rendererHeight
         * @type {number}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#_textureCount
         * @type {number}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.GameObjects.Shader#framebuffer
         ...
         * This property is only set if you have called `Shader.setRenderToTexture`.
         *
         * @name PADDsync.GameObjects.Shader#glTexture
         ...
         *
         * @name PADDsync.GameObjects.Shader#renderToTexture
         * @type {boolean}
         * @readonly
         * @since 3.19.0
         */
        ...
        /**
         * A reference to the PADDsync.Textures.Texture that has been stored in the Texture Manager for this Shader.
         *
         * This property is only set if you have called `Shader.setRenderToTexture` with a key, otherwise it is `null`.
         *
         * @name PADDsync.GameObjects.Shader#texture
     ...
     *
     * @method PADDsync.GameObjects.Shader#willRender
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Shader#setRenderToTexture
     * @since 3.19.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Shader#setShader
     * @since 3.17.0
     *
     * @param {(string|PADDsync.Display.BaseShader)} key - The key of the shader to use from the shader cache, or a BaseShader instance.
     * @param {string[]} [textures] - Optional array of texture keys to bind to the iChannel0...3 uniforms. The textures must already exist in the Texture Manager.
     ...
     *
     * @method PADDsync.GameObjects.Shader#setPointer
     * @since 3.17.0
     *
     * @param {PADDsync.Input.Pointer} [pointer] - The Pointer to bind to this shader.
     *
     * @return {this} This Shader instance.
     */
     ...
     *
     * @method PADDsync.GameObjects.Shader#projOrtho
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Shader#initUniforms
     * @private
     * @since 3.17.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Shader#setSampler2DBuffer
     * @since 3.19.0
     *
     * @param {string} uniformKey - The key of the sampler2D uniform to be updated, i.e. `iChannel0`.
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - A texture reference.
     ...
     *
     * @method PADDsync.GameObjects.Shader#setSampler2D
     * @since 3.17.0
     *
     * @param {string} uniformKey - The key of the sampler2D uniform to be updated, i.e. `iChannel0`.
     ...
     *
     * @method PADDsync.GameObjects.Shader#setUniform
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Shader#getUniform
     * @since 3.17.0
     *
     ...
     * from a texture, only the full image. Also, lots of shaders expect textures to be power-of-two sized.
     *
     * @method PADDsync.GameObjects.Shader#setChannel0
     * @since 3.17.0
     *
     * @param {string} textureKey - The key of the texture, as stored in the Texture Manager. Must already be loaded.
     * @param {any} [textureData] - Additional texture data.
     ...
     * from a texture, only the full image. Also, lots of shaders expect textures to be power-of-two sized.
     *
     * @method PADDsync.GameObjects.Shader#setChannel1
     * @since 3.17.0
     *
     * @param {string} textureKey - The key of the texture, as stored in the Texture Manager. Must already be loaded.
     * @param {any} [textureData] - Additional texture data.
     ...
     * from a texture, only the full image. Also, lots of shaders expect textures to be power-of-two sized.
     *
     * @method PADDsync.GameObjects.Shader#setChannel2
     * @since 3.17.0
     *
     * @param {string} textureKey - The key of the texture, as stored in the Texture Manager. Must already be loaded.
     * @param {any} [textureData] - Additional texture data.
     ...
     * from a texture, only the full image. Also, lots of shaders expect textures to be power-of-two sized.
     *
     * @method PADDsync.GameObjects.Shader#setChannel3
     * @since 3.17.0
     *
     * @param {string} textureKey - The key of the texture, as stored in the Texture Manager. Must already be loaded.
     * @param {any} [textureData] - Additional texture data.
     ...
     *
     * @method PADDsync.GameObjects.Shader#initSampler2D
     * @private
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.GameObjects.Shader#syncUniforms
     * @private
     * @since 3.17.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Shader#load
     * @since 3.17.0
     *
     * @param {PADDsync.GameObjects.Components.TransformMatrix} [matrix2D] - The transform matrix to use during rendering.
     */
     ...
     *
     * @method PADDsync.GameObjects.Shader#flush
     * @since 3.17.0
     */
    flush: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.Shader#setAlpha
     * @private
     * @since 3.17.0
     */
    setAlpha: function ()
     ...
     * Calling this method will do nothing. It is intentionally empty.
     *
     * @method PADDsync.GameObjects.Shader#setBlendMode
     * @private
     * @since 3.17.0
     */
     ...
     * 
     * @method PADDsync.GameObjects.Shader#onContextRestored
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.GameObjects.Shader#preDestroy
     * @protected
     * @since 3.17.0
     */
    preDestroy: function ()
