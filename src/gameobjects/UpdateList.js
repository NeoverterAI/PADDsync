 ...
 *
 * Some or all of these Game Objects may also be part of the Scene's [Display List]{@link PADDsync.GameObjects.DisplayList}, for Rendering.
 *
 * @class UpdateList
 * @extends PADDsync.Structs.ProcessQueue.<PADDsync.GameObjects.GameObject>
 * @memberof PADDsync.GameObjects
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene that the Update List belongs to.
 */
var UpdateList = new Class({
    ...
    function UpdateList (scene)
    {
         ...
         *
         * @name PADDsync.GameObjects.UpdateList#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         * The Scene's Systems.
         *
         * @name PADDsync.GameObjects.UpdateList#systems
         ...
         *
         * @name PADDsync.GameObjects.UpdateList#_pending
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.20.0
         ...
         *
         * @name PADDsync.GameObjects.UpdateList#_active
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.20.0
         ...
         *
         * @name PADDsync.GameObjects.UpdateList#_destroy
         * @type {Array.<*>}
         * @private
         * @default []
         * @since 3.20.0
         ...
         *
         * @name PADDsync.GameObjects.UpdateList#_toProcess
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#boot
     * @private
     * @since 3.5.1
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.GameObjects.UpdateList#start
     * @private
     * @since 3.5.0
     */
    start: function ()
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#sceneUpdate
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#shutdown
     * @since 3.0.0
     */
    shutdown: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#add
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#remove
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#removeAll
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#update
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.GameObjects.UpdateList#getActive
     * @since 3.0.0
     *
     * @return {Array.<*>} A list of active items.
     */
     ...
     *
     * @name PADDsync.GameObjects.UpdateList#length
     * @type {number}
     * @readonly
     * @since 3.20.0
     */
