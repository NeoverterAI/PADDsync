 ...
 *
 * @param {PADDsync.Scene} scene - The Scene to which this Point Light belongs. A Point Light can only belong to one Scene at a time.
...
var PointLight = new Class({
    ...
    function PointLight (scene, x, y, color, radius, intensity, attenuation)
    {
         ...
         *
         * @name PADDsync.GameObjects.PointLight#color
         ...
         *
         * @name PADDsync.GameObjects.PointLight#intensity
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.GameObjects.PointLight#attenuation
         * @type {number}
         * @since 3.50.0
         */
     ...
     *
     * @name PADDsync.GameObjects.PointLight#radius
     * @type {number}
     * @since 3.50.0
     */
    radius: {
