 ...
 *
 * @function PADDsync.Actions.ShiftPosition
 * @since 3.0.0
 *
 * @generic {PADDsync.GameObjects.GameObject[]} G - [items]
 * @generic {PADDsync.Math.Vector2} O - [output,$return]
 *
 * @param {(PADDsync.Types.Math.Vector2Like[]|PADDsync.GameObjects.GameObject[])} items - An array of Game Objects, or objects with public x and y positions. The contents of this array are updated by this Action.
 ...
 * @param {PADDsync.Types.Math.Vector2Like} [output] - An optional Vec2Like object to store the final position in.
 *
 * @return {PADDsync.Types.Math.Vector2Like} The output vector.
 */
