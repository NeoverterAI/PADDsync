 ...
 * 
 * If you wish to pass a `PADDsync.GameObjects.Line` Shape to this function, you should pass its `geom` property.
 *
 * @function PADDsync.Actions.RandomLine
 * @since 3.0.0
 *
 ...
 * @param {PADDsync.Geom.Line} line - The Line to position the Game Objects randomly on.
 *
