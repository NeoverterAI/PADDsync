 ...
 *
 * @function PADDsync.Actions.GetFirst
 * @since 3.0.0
 *
 * @generic {PADDsync.GameObjects.GameObject[]} G - [items]
 *
 * @param {(array|PADDsync.GameObjects.GameObject[])} items - The array of items to be searched by this action.
 ...
 *
 * @return {?(object|PADDsync.GameObjects.GameObject)} The first object in the array that matches the comparison object, or `null` if no match was found.
 */
