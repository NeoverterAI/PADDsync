 ...
 *
 * @function PADDsync.Actions.GetLast
 * @since 3.3.0
 *
 ...
 *
 * @return {?(object|PADDsync.GameObjects.GameObject)} The last object in the array that matches the comparison object, or `null` if no match was found.
 */
