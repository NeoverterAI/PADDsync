 ...
 * 
 * ```javascript
 * PADDsync.Actions.Spread(itemsArray, 'alpha', 0, 1);
 * ```
 *
 * @function PADDsync.Actions.Spread
 * @since 3.0.0
 *
 ...
 *
 * @return {(array|PADDsync.GameObjects.GameObject[])} The array of Game Objects that were passed to this Action.
 */
