 ...
 * of the PADDsync.Display.Align constants, such as `PADDsync.Display.Align.TOP_LEFT`,
 * `PADDsync.Display.Align.TOP_CENTER`, etc.
 *
 * The first item isn't moved. The second item is aligned next to the first,
 * then the third next to the second, and so on.
 *
 * @function PADDsync.Actions.AlignTo
 * @since 3.22.0
 *
 * @generic {PADDsync.GameObjects.GameObject[]} G - [items,$return]
 *
 * @param {(array|PADDsync.GameObjects.GameObject[])} items - The array of items to be updated by this action.
 * @param {number} position - The position to align the items with. This is an align constant, such as `PADDsync.Display.Align.LEFT_CENTER`.
 * @param {number} [offsetX=0] - Optional horizontal offset from the position.
 * @param {number} [offsetY=0] - Optional vertical offset from the position.
 *
 * @return {(array|PADDsync.GameObjects.GameObject[])} The array of objects that were passed to this Action.
 */
