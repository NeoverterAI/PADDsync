 ...
 *
 * @function PADDsync.Tweens.Builders.NumberTweenBuilder
 * @since 3.0.0
 *
 * @param {PADDsync.Tweens.TweenManager} parent - The owner of the new Tween.
 * @param {PADDsync.Types.Tweens.NumberTweenBuilderConfig} config - Configuration for the new Tween.
 * @param {PADDsync.Types.Tweens.TweenConfigDefaults} defaults - Tween configuration defaults.
 *
 * @return {PADDsync.Tweens.Tween} The new tween.
 */
