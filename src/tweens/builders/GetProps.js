 ...
 *
 * @function PADDsync.Tweens.Builders.GetProps
 * @since 3.0.0
 *
 * @param {PADDsync.Types.Tweens.TweenBuilderConfig} config - The configuration object of the Tween to get the properties from.
 *
