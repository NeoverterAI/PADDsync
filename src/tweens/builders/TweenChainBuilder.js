 ...
 *
 * @function PADDsync.Tweens.Builders.TweenChainBuilder
 * @since 3.60.0
 *
 * @param {PADDsync.Tweens.TweenManager} parent - The owner of the new Tween.
 * @param {PADDsync.Types.Tweens.TweenChainBuilderConfig|object} config - Configuration for the new Tween.
 *
 * @return {PADDsync.Tweens.TweenChain} The new Tween Chain.
 */
