 ...
 * @since 3.60.0
 *
 * @param {(PADDsync.Tweens.TweenManager|PADDsync.Tweens.TweenChain)} parent - A reference to the Tween Manager, or Tween Chain, that owns this Tween.
 */
var BaseTween = new Class({
    ...
    function BaseTween (parent)
    {
         ...
         *
         * @name PADDsync.Tweens.BaseTween#parent
         * @type {(PADDsync.Tweens.TweenManager|PADDsync.Tweens.TweenChain)}
         * @since 3.60.0
         */
        this.parent = parent;
         ...
         * through in sequence.
         *
         * @name PADDsync.Tweens.BaseTween#data
         * @type {(PADDsync.Tweens.TweenData[]|PADDsync.Tweens.Tween[])}
         * @since 3.60.0
         */
        this.data = [];
         ...
         *
         * @name PADDsync.Tweens.BaseTween#totalData
         * @type {number}
         * @since 3.60.0
         */
        this.totalData = 0;
         ...
         *
         * @name PADDsync.Tweens.BaseTween#startDelay
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#hasStarted
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#timeScale
         * @type {number}
         * @default 1
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#loop
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#loopDelay
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#loopCounter
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         * set to loop forever.
         *
         * @name PADDsync.Tweens.BaseTween#completeDelay
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#countdown
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#state
         * @type {PADDsync.Tweens.StateType}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#paused
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTween#callbacks
         * @type {PADDsync.Types.Tweens.TweenCallbacks}
         * @since 3.60.0
         */
        this.callbacks = {
            onActive: null,
         ...
         *
         * @name PADDsync.Tweens.BaseTween#callbackScope
         * @type {any}
         * @since 3.60.0
         */
        this.callbackScope;
         ...
         * the Tween Manager.
         *
         * @name PADDsync.Tweens.BaseTween#persist
         * @type {boolean}
         * @since 3.60.0
         */
        this.persist = false;
     ...
     * This value is multiplied by the `TweenManager.timeScale`.
     *
     * @method PADDsync.Tweens.BaseTween#setTimeScale
     * @since 3.60.0
     *
     ...
     * A value of 0.5 runs 50% slower, and so on.
     *
     * @method PADDsync.Tweens.BaseTween#getTimeScale
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isPlaying
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isPaused
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#pause
     * @fires PADDsync.Tweens.Events#TWEEN_PAUSE
     * @since 3.60.0
     *
     * @return {this} This Tween instance.
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#resume
     * @fires PADDsync.Tweens.Events#TWEEN_RESUME
     * @since 3.60.0
     *
     * @return {this} This Tween instance.
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#makeActive
     * @fires PADDsync.Tweens.Events#TWEEN_ACTIVE
     * @since 3.60.0
     */
    makeActive: function ()
    {
     ...
     * and callback.
     *
     * @method PADDsync.Tweens.BaseTween#onCompleteHandler
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#complete
     * @fires PADDsync.Tweens.Events#TWEEN_COMPLETE
     * @since 3.2.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#completeAfterLoop
     * @fires PADDsync.Tweens.Events#TWEEN_COMPLETE
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#remove
     * @since 3.60.0
     *
     * @return {this} This Tween instance.
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#stop
     * @fires PADDsync.Tweens.Events#TWEEN_STOP
     * @since 3.60.0
     *
     * @return {this} This Tween instance.
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#updateLoopCountdown
     * @since 3.60.0
     *
     ...
     * the dispatch of related events. Called automatically by `Tween.update`.
     *
     * @method PADDsync.Tweens.BaseTween#updateStartCountdown
     * @since 3.60.0
     *
     * @param {number} delta - The delta time in ms since the last frame. This is a smoothed and capped value based on the FPS rate.
     */
     ...
     * the dispatch of related events. Called automatically by `Tween.update`.
     *
     * @method PADDsync.Tweens.BaseTween#updateCompleteDelay
     * @since 3.60.0
     *
     * @param {number} delta - The delta time in ms since the last frame. This is a smoothed and capped value based on the FPS rate.
     */
     ...
     * `onUpdate` - When a TweenData updates a property on a source target during playback.
     *
     * @method PADDsync.Tweens.BaseTween#setCallback
     * @since 3.60.0
     *
     * @param {PADDsync.Types.Tweens.TweenCallbackTypes} type - The type of callback to set. One of: `onActive`, `onComplete`, `onLoop`, `onPause`, `onRepeat`, `onResume`, `onStart`, `onStop`, `onUpdate` or `onYoyo`.
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setPendingState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setActiveState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setLoopDelayState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setCompleteDelayState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setStartDelayState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setPendingRemoveState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setRemovedState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setFinishedState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#setDestroyedState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isPending
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isActive
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isLoopDelayed
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isCompleteDelayed
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isStartDelayed
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isPendingRemove
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isRemoved
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isFinished
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#isDestroyed
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTween#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
