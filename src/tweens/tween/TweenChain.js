 ...
 * @since 3.60.0
 *
 * @param {(PADDsync.Tweens.TweenManager|PADDsync.Tweens.TweenChain)} parent - A reference to the Tween Manager, or TweenChain, that owns this TweenChain.
 */
var TweenChain = new Class({
    ...
    function TweenChain (parent)
    {
         ...
         *
         * @name PADDsync.Tweens.TweenChain#currentTween
         ...
         *
         * @name PADDsync.Tweens.TweenChain#currentIndex
         * @type {number}
         * @since 3.60.0
         */
        this.currentIndex = 0;
     ...
     *
     * @method PADDsync.Tweens.TweenChain#init
     ...
     * Please note that Tweens will not manipulate any target property that begins with an underscore.
     *
     * @method PADDsync.Tweens.TweenChain#add
     * @since 3.60.0
     *
     * @param {PADDsync.Types.Tweens.TweenBuilderConfig[]|object[]} tweens - An array of Tween configuration objects for the Tweens in this chain.
     *
     * @return {this} This TweenChain instance.
     */
    add: function (tweens)
     ...
     *
     * @method PADDsync.Tweens.TweenChain#remove
     * @since 3.60.0
     * @override
     *
     ...
     *
     * @method PADDsync.Tweens.TweenChain#hasTarget
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenChain#restart
     * @since 3.60.0
     *
     * @return {this} This TweenChain instance.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenChain#reset
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenChain#makeActive
     * @since 3.60.0
     * @override
     *
     ...
     *
     * @method PADDsync.Tweens.TweenChain#nextState
     ...
     *
     * @method PADDsync.Tweens.TweenChain#play
     * @since 3.60.0
     *
     * @return {this} This TweenChain instance.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenChain#resetTweens
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.TweenChain#update
     * @fires PADDsync.Tweens.Events#TWEEN_COMPLETE
     * @fires PADDsync.Tweens.Events#TWEEN_LOOP
     ...
     *
     * @method PADDsync.Tweens.TweenChain#nextTween
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenChain#setCurrentTween
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenChain#dispatchEvent
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenChain#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
 ...
 *
 * @method PADDsync.GameObjects.GameObjectFactory#tweenchain
 * @since 3.60.0
 *
 * @param {PADDsync.Types.Tweens.TweenBuilderConfig|object} config - The TweenChain configuration.
 *
 * @return {PADDsync.Tweens.TweenChain} The TweenChain that was created.
 */
 ...
 * Note: This method will only be available if Tweens have been built into PADDsync.
 *
 * @method PADDsync.GameObjects.GameObjectCreator#tweenchain
 * @since 3.60.0
 *
 * @param {PADDsync.Types.Tweens.TweenBuilderConfig|object} config - The TweenChain configuration.
 *
