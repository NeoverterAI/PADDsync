...
var BaseTweenData = new Class({
    ...
    function BaseTweenData (tween, targetIndex, delay, duration, yoyo, hold, repeat, repeatDelay, flipX, flipY)
    {
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#tween
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#targetIndex
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#duration
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#totalDuration
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#delay
         * @type {number}
         * @since 3.60.0
         */
        this.delay = 0;
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#getDelay
         * @type {function}
         * @since 3.60.0
         */
        this.getDelay = delay;
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#yoyo
         * @type {boolean}
         * @since 3.60.0
         */
        this.yoyo = yoyo;
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#hold
         * @type {number}
         * @since 3.60.0
         */
        this.hold = hold;
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#repeat
         * @type {number}
         * @since 3.60.0
         */
        this.repeat = repeat;
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#repeatDelay
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#repeatCounter
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#flipX
         * @type {boolean}
         * @since 3.60.0
         */
        this.flipX = flipX;
         ...
         * has a function matching this name, like most Phaser GameObjects do.
         *
         * @name PADDsync.Tweens.BaseTweenData#flipY
         * @type {boolean}
         * @since 3.60.0
         */
        this.flipY = flipY;
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#progress
         * @type {number}
         * @since 3.60.0
         */
        this.progress = 0;
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#elapsed
         * @type {number}
         * @since 3.60.0
         */
        this.elapsed = 0;
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#state
         ...
         *
         * @name PADDsync.Tweens.BaseTweenData#isCountdown
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#getTarget
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setTargetValue
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setCreatedState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setDelayState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setPendingRenderState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setPlayingForwardState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setPlayingBackwardState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setHoldState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setRepeatState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setCompleteState
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#isCreated
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#isDelayed
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#isPendingRender
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#isPlayingForward
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#isPlayingBackward
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#isHolding
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#isRepeating
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#isComplete
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setStateFromEnd
     * @fires PADDsync.Tweens.Events#TWEEN_REPEAT
     * @fires PADDsync.Tweens.Events#TWEEN_YOYO
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#setStateFromStart
     * @fires PADDsync.Tweens.Events#TWEEN_REPEAT
     * @since 3.60.0
     *
     * @param {number} diff - Any extra time that needs to be accounted for in the elapsed and progress values.
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#reset
     * @since 3.60.0
     */
    reset: function ()
    {
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#onRepeat
     * @fires PADDsync.Tweens.Events#TWEEN_REPEAT
     * @fires PADDsync.Tweens.Events#TWEEN_YOYO
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.BaseTweenData#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
