 ...
 * @extends PADDsync.Tweens.BaseTween
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Tweens.TweenManager} parent - A reference to the Tween Manager that owns this Tween.
...
var Tween = new Class({
    ...
    function Tween (parent, targets)
    {
         ...
         *
         * @name PADDsync.Tweens.Tween#targets
         * @type {object[]}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#totalTargets
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#isSeeking
         * @type {boolean}
         * @readonly
         * @since 3.19.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#isInfinite
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#elapsed
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#totalElapsed
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#duration
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#progress
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#totalDuration
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#totalProgress
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.Tween#isNumberTween
         * @type {boolean}
         * @default false
         * @since 3.88.0
         */
     ...
     * yourself.
     *
     * @method PADDsync.Tweens.Tween#add
     * @since 3.60.0
     *
     ...
     * @param {PADDsync.Types.Tweens.GetEndCallback} getEnd - What the property will be at the END of the Tween.
     * @param {PADDsync.Types.Tweens.GetStartCallback} getStart - What the property will be at the START of the Tween.
     * @param {?PADDsync.Types.Tweens.GetActiveCallback} getActive - If not null, is invoked _immediately_ as soon as the TweenData is running, and is set on the target property.
     ...
     *
     * @return {PADDsync.Tweens.TweenData} The TweenData instance that was added.
     */
     ...
     * yourself.
     *
     * @method PADDsync.Tweens.Tween#addFrame
     * @since 3.60.0
     *
     * @param {number} targetIndex - The target index within the Tween targets array.
     ...
     * @param {boolean} flipY - Should toggleFlipY be called when yoyo or repeat happens?
     *
     * @return {PADDsync.Tweens.TweenFrameData} The TweenFrameData instance that was added.
     */
     ...
     *
     * @method PADDsync.Tweens.Tween#getValue
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.Tween#hasTarget
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.Tween#updateTo
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.Tween#restart
     * @since 3.0.0
     *
     * @return {this} This Tween instance.
     */
     ...
     *
     * @method PADDsync.Tweens.Tween#nextState
     * @fires PADDsync.Tweens.Events#TWEEN_COMPLETE
     * @fires PADDsync.Tweens.Events#TWEEN_LOOP
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.Tween#onCompleteHandler
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Tweens.Tween#play
     * @since 3.0.0
     *
     * @return {this} This Tween instance.
     */
     ...
     *
     * @method PADDsync.Tweens.Tween#seek
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.Tween#initTweenData
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.Tween#reset
     ...
     *
     * @method PADDsync.Tweens.Tween#update
     * @fires PADDsync.Tweens.Events#TWEEN_COMPLETE
     * @fires PADDsync.Tweens.Events#TWEEN_LOOP
     * @fires PADDsync.Tweens.Events#TWEEN_START
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.Tween#forward
     * @since 3.60.0
     *
     ...
     * If the Tween is paused or has already finished, calling this will have no effect.
     *
     * @method PADDsync.Tweens.Tween#rewind
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.Tween#dispatchEvent
     * @since 3.60.0
     *
     * @param {PADDsync.Types.Tweens.Event} event - The Event to be dispatched.
     * @param {PADDsync.Types.Tweens.TweenCallbackTypes} [callback] - The name of the callback to be invoked. Can be `null` or `undefined` to skip invocation.
     */
     ...
     *
     * @method PADDsync.Tweens.Tween#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
 ...
 *
 * Note: This method will only be available if Tweens have been built into PADDsync.
 *
 * @method PADDsync.GameObjects.GameObjectFactory#tween
 * @since 3.0.0
 *
 ...
 *
 * @return {PADDsync.Tweens.Tween} The Tween that was created.
 */
 ...
 * Note: This method will only be available if Tweens have been built into PADDsync.
 *
 * @method PADDsync.GameObjects.GameObjectCreator#tween
 * @since 3.0.0
 *
 * @param {PADDsync.Types.Tweens.TweenBuilderConfig|PADDsync.Types.Tweens.TweenChainBuilderConfig|PADDsync.Tweens.Tween|PADDsync.Tweens.TweenChain} config - A Tween Configuration object, or a Tween or TweenChain instance.
 *
