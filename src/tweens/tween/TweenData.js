 ...
 * @extends PADDsync.Tweens.BaseTweenData
 * @constructor
 * @since 3.60.0
 *
 * @param {PADDsync.Tweens.Tween} tween - The tween this TweenData instance belongs to.
...
var TweenData = new Class({
    ...
    function TweenData (tween, targetIndex, key, getEnd, getStart, getActive, ease, delay, duration, yoyo, hold, repeat, repeatDelay, flipX, flipY, interpolation, interpolationData)
    {
         ...
         *
         * @name PADDsync.Tweens.TweenData#key
         * @type {string}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenData#getActiveValue
         * @type {?PADDsync.Types.Tweens.GetActiveCallback}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenData#getEndValue
         * @type {PADDsync.Types.Tweens.GetEndCallback}
         * @since 3.60.0
         */
         ...
         * start delay, or if the tween is reset, or is set to repeat.
         *
         * @name PADDsync.Tweens.TweenData#getStartValue
         * @type {PADDsync.Types.Tweens.GetStartCallback}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenData#ease
         * @type {function}
         * @since 3.60.0
         */
        this.ease = ease;
         ...
         *
         * @name PADDsync.Tweens.TweenData#start
         * @type {number}
         * @since 3.60.0
         */
        this.start = 0;
         ...
         *
         * @name PADDsync.Tweens.TweenData#previous
         * @type {number}
         * @since 3.60.0
         */
        this.previous = 0;
         ...
         *
         * @name PADDsync.Tweens.TweenData#current
         * @type {number}
         * @since 3.60.0
         */
        this.current = 0;
         ...
         *
         * @name PADDsync.Tweens.TweenData#end
         * @type {number}
         * @since 3.60.0
         */
        this.end = 0;
         ...
         *
         * @name PADDsync.Tweens.TweenData#interpolation
         * @type {?function}
         * @default null
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenData#interpolationData
         * @type {?number[]}
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Tweens.TweenData#reset
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenData#update
     * @fires PADDsync.Tweens.Events#TWEEN_UPDATE
     * @fires PADDsync.Tweens.Events#TWEEN_REPEAT
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenData#dispatchEvent
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenData#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
