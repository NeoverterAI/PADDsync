...
var TweenFrameData = new Class({
    ...
    function TweenFrameData (tween, targetIndex, texture, frame, delay, duration, hold, repeat, repeatDelay, flipX, flipY)
    {
         ...
         *
         * @name PADDsync.Tweens.TweenFrameData#key
         * @type {string}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenFrameData#startTexture
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenFrameData#endTexture
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenFrameData#startFrame
         * @type {(string|number)}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenFrameData#endFrame
         * @type {(string|number)}
         * @since 3.60.0
         */
        this.endFrame = frame;
         ...
         *
         * @name PADDsync.Tweens.TweenFrameData#yoyo
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Tweens.TweenFrameData#reset
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenFrameData#update
     ...
     *
     * @method PADDsync.Tweens.TweenFrameData#dispatchEvent
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenFrameData#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
