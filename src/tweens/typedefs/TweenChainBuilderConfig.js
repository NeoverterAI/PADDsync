/**
 * @typedef {object} PADDsync.Types.Tweens.TweenChainBuilderConfig
 * @extends object
 * @since 3.60.0
 *
 ...
 * @property {PADDsync.Types.Tweens.TweenBuilderConfig[]} [tweens] - The tweens to chain together.
 * @property {any} [callbackScope] - The scope (or context) for all of the callbacks. The default scope is the chain.
 * @property {PADDsync.Types.Tweens.TweenOnCompleteCallback} [onComplete] - A function to call when the chain completes.
 * @property {array} [onCompleteParams] - Additional parameters to pass to `onComplete`.
 * @property {PADDsync.Types.Tweens.TweenOnLoopCallback} [onLoop] - A function to call each time the chain loops.
 * @property {array} [onLoopParams] - Additional parameters to pass to `onLoop`.
 * @property {PADDsync.Types.Tweens.TweenOnStartCallback} [onStart] - A function to call when the chain starts playback, after any delays have expired.
 * @property {array} [onStartParams] - Additional parameters to pass to `onStart`.
 * @property {PADDsync.Types.Tweens.TweenOnStopCallback} [onStop] - A function to call when the chain is stopped.
 * @property {array} [onStopParams] - Additional parameters to pass to `onStop`.
 * @property {PADDsync.Types.Tweens.TweenOnActiveCallback} [onActive] - A function to call when the chain becomes active within the Tween Manager.
 * @property {array} [onActiveParams] - Additional parameters to pass to `onActive`.
 * @property {PADDsync.Types.Tweens.TweenOnPauseCallback} [onPause] - A function to call when the chain is paused.
 * @property {array} [onPauseParams] - Additional parameters to pass to `onPause`.
 * @property {PADDsync.Types.Tweens.TweenOnResumeCallback} [onResume] - A function to call when the chain is resumed after being paused.
