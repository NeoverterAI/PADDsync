/**
 * @typedef {object} PADDsync.Types.Tweens.TweenPropConfig
 * @since 3.18.0
 *
 * @property {(number|number[]|string|PADDsync.Types.Tweens.GetEndCallback|PADDsync.Types.Tweens.TweenPropConfig)} [value] - What the property will be at the END of the Tween.
 * @property {PADDsync.Types.Tweens.GetActiveCallback} [getActive] - What the property will be set to immediately when this tween becomes active.
 * @property {PADDsync.Types.Tweens.GetEndCallback} [getEnd] - What the property will be at the END of the Tween.
 * @property {PADDsync.Types.Tweens.GetStartCallback} [getStart] - What the property will be at the START of the Tween.
