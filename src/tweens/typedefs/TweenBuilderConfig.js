/**
 * @typedef {object} PADDsync.Types.Tweens.TweenBuilderConfig
 * @extends object
 * @since 3.18.0
 *
 ...
 * @property {Object.<string,(number|string|PADDsync.Types.Tweens.GetEndCallback|PADDsync.Types.Tweens.TweenPropConfig)>} [props] - The properties to tween.
 ...
 * @property {PADDsync.Types.Tweens.TweenOnRepeatCallback} [onRepeat] - A function to call each time a property tween repeats. Called once per property per target.
 ...
 * @property {PADDsync.Types.Tweens.TweenOnYoyoCallback} [onYoyo] - A function to call each time a property tween yoyos. Called once per property per target.
 ...
 * @property {PADDsync.Types.Tweens.TweenOnPauseCallback} [onPause] - A function to call when the tween is paused.
 * @property {array} [onPauseParams] - Additional parameters to pass to `onPause`.
 * @property {PADDsync.Types.Tweens.TweenOnResumeCallback} [onResume] - A function to call when the tween is resumed after being paused.
