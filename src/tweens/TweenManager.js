 ...
 *
 * @class TweenManager
 * @memberof PADDsync.Tweens
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene which owns this Tween Manager.
 */
var TweenManager = new Class({
    ...
    function TweenManager (scene)
    {
         ...
         *
         * @name PADDsync.Tweens.TweenManager#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Tweens.TweenManager#events
         ...
         *
         * @name PADDsync.Tweens.TweenManager#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenManager#paused
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenManager#processing
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenManager#tweens
         ...
         *
         * @name PADDsync.Tweens.TweenManager#time
         * @type {number}
         * @since 3.60.0
         */
        this.time = 0;
         ...
         *
         * @name PADDsync.Tweens.TweenManager#startTime
         * @type {number}
         * @since 3.60.0
         */
        this.startTime = 0;
         ...
         *
         * @name PADDsync.Tweens.TweenManager#nextTime
         * @type {number}
         * @since 3.60.0
         */
        this.nextTime = 0;
         ...
         *
         * @name PADDsync.Tweens.TweenManager#prevTime
         * @type {number}
         * @since 3.60.0
         */
        this.prevTime = 0;
         ...
         *
         * @name PADDsync.Tweens.TweenManager#maxLag
         * @type {number}
         * @default 500
         * @since 3.60.0
         */
         ...
         * See the `TweenManager.setLagSmooth` method for further details.
         *
         * @name PADDsync.Tweens.TweenManager#lagSkip
         * @type {number}
         * @default 33
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Tweens.TweenManager#gap
         * @type {number}
         * @since 3.60.0
         */
        this.gap = 1000 / 240;
     ...
     *
     * @method PADDsync.Tweens.TweenManager#boot
     * @private
     * @since 3.5.1
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Tweens.TweenManager#start
     * @private
     * @since 3.5.0
     */
    start: function ()
     ...
     *
     * @method PADDsync.Tweens.TweenManager#create
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Tweens.TweenBuilderConfig|PADDsync.Types.Tweens.TweenBuilderConfig[]|object|object[]} config - A Tween Configuration object. Or an array of Tween Configuration objects.
     *
     * @return {PADDsync.Tweens.Tween|PADDsync.Tweens.Tween[]} The created Tween, or an array of Tweens if an array of tween configs was provided.
     */
     ...
     * If you wish to chain Tweens together for sequential playback, see the `TweenManager.chain` method.
     *
     * @method PADDsync.Tweens.TweenManager#add
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Tweens.TweenBuilderConfig|PADDsync.Types.Tweens.TweenChainBuilderConfig|PADDsync.Tweens.Tween|PADDsync.Tweens.TweenChain} config - A Tween Configuration object, or a Tween or TweenChain instance.
     *
     * @return {PADDsync.Tweens.Tween} The created Tween.
     */
    add: function (config)
    {
        var tween = config;
     ...
     * If you wish to chain Tweens together for sequential playback, see the `TweenManager.chain` method.
     *
     * @method PADDsync.Tweens.TweenManager#addMultiple
     * @since 3.60.0
     *
     * @param {PADDsync.Types.Tweens.TweenBuilderConfig[]|object[]} configs - An array of Tween Configuration objects.
     *
     * @return {PADDsync.Tweens.Tween[]} An array of created Tweens.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#chain
     * @since 3.60.0
     *
     * @param {PADDsync.Types.Tweens.TweenChainBuilderConfig|object} tweens - A Tween Chain configuration object.
     *
     * @return {PADDsync.Tweens.TweenChain} The Tween Chain instance.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#getChainedTweens
     * @since 3.60.0
     *
     * @param {PADDsync.Tweens.Tween} tween - The Tween to return the chain from.
     *
     * @return {PADDsync.Tweens.Tween[]} An array of the chained tweens, or an empty array if there aren't any.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#has
     * @since 3.60.0
     *
     * @param {PADDsync.Tweens.Tween} tween - The Tween instance to check.
     *
     ...
     * Playback will start immediately unless the tween has been configured to be paused.
     *
     * @method PADDsync.Tweens.TweenManager#existing
     * @since 3.0.0
     *
     * @param {PADDsync.Tweens.Tween} tween - The Tween to add.
     *
     ...
     * Please note that a Tween will not manipulate any target property that begins with an underscore.
     *
     * @method PADDsync.Tweens.TweenManager#addCounter
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Tweens.NumberTweenBuilderConfig} config - The configuration object for the Number Tween.
     *
     * @return {PADDsync.Tweens.Tween} The created Number Tween.
     */
     ...
     * ```
     *
     * @method PADDsync.Tweens.TweenManager#stagger
     * @since 3.19.0
     *
     ...
     * @param {PADDsync.Types.Tweens.StaggerConfig} config - The configuration object for the Stagger function.
     *
     ...
     *
     * @method PADDsync.Tweens.TweenManager#setLagSmooth
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenManager#setFps
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenManager#getDelta
     * @since 3.60.0
     *
     ...
     * paused.
     *
     * @method PADDsync.Tweens.TweenManager#tick
     * @since 3.60.0
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     * been paused.
     *
     * @method PADDsync.Tweens.TweenManager#update
     * @since 3.0.0
     */
    update: function ()
    {
     ...
     *
     * @method PADDsync.Tweens.TweenManager#step
     * @since 3.60.0
     *
     * @param {boolean} [tick=false] - Is this a manual tick, or an automated tick?
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#remove
     * @since 3.17.0
     *
     * @param {PADDsync.Tweens.Tween} tween - The Tween to be removed.
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#reset
     * @since 3.60.0
     *
     * @param {PADDsync.Tweens.Tween} tween - The Tween to be reset.
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#makeActive
     * @since 3.0.0
     *
     * @param {PADDsync.Tweens.Tween} tween - The Tween to check.
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#each
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenManager#getTweens
     * @since 3.0.0
     *
     * @return {PADDsync.Tweens.Tween[]} A new array containing references to all Tweens.
     */
    getTweens: function ()
    {
     ...
     * upon it.
     *
     * @method PADDsync.Tweens.TweenManager#getTweensOf
     * @since 3.0.0
     *
     * @param {(object|object[])} target - The target to look for. Provide an array to look for multiple targets.
     *
     * @return {PADDsync.Tweens.Tween[]} A new array containing all Tweens which affect the given target(s).
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#getGlobalTimeScale
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenManager#setGlobalTimeScale
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenManager#isTweening
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenManager#killAll
     * @since 3.0.0
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#killTweensOf
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tweens.TweenManager#pauseAll
     * @since 3.0.0
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     * As of Phaser 3.60 you can also toggle the boolean property `TweenManager.paused`.
     *
     * @method PADDsync.Tweens.TweenManager#resumeAll
     * @since 3.0.0
     *
     * @return {this} This Tween Manager instance.
     */
     ...
     *
     * @method PADDsync.Tweens.TweenManager#shutdown
     * @since 3.0.0
     */
    shutdown: function ()
    {
     ...
     *
     * @method PADDsync.Tweens.TweenManager#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
