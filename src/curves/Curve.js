...
var Curve = new Class({
    ...
    function Curve (type)
    {
         ...
         *
         * @name PADDsync.Curves.Curve#type
         * @type {string}
         * @since 3.0.0
         */
        this.type = type;
         ...
         *
         * @name PADDsync.Curves.Curve#defaultDivisions
         * @type {number}
         * @default 5
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Curve#arcLengthDivisions
         * @type {number}
         * @default 100
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Curve#cacheArcLengths
         * @type {number[]}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Curve#needsUpdate
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Curve#active
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Curve#_tmpVec2A
         ...
         * A temporary calculation Vector.
         *
         * @name PADDsync.Curves.Curve#_tmpVec2B
         * @type {PADDsync.Math.Vector2}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Curves.Curve#draw
     * @since 3.0.0
     *
     * @generic {PADDsync.GameObjects.Graphics} G - [graphics,$return]
     *
     * @param {PADDsync.GameObjects.Graphics} graphics - The Graphics instance onto which this curve will be drawn.
     ...
     *
     * @return {PADDsync.GameObjects.Graphics} The Graphics object to which the curve was drawn.
     */
     ...
     *
     * @method PADDsync.Curves.Curve#getBounds
     * @since 3.0.0
     *
     * @param {PADDsync.Geom.Rectangle} [out] - The Rectangle to store the bounds in. If falsey a new object will be created.
     * @param {number} [accuracy=16] - The accuracy of the bounds calculations.
     *
     * @return {PADDsync.Geom.Rectangle} A Rectangle object holding the bounds of this curve. If `out` was given it will be this object.
     */
     ...
     *
     * @method PADDsync.Curves.Curve#getDistancePoints
     * @since 3.0.0
     *
     * @param {number} distance - The distance, in pixels, between each point along the curve.
     *
     * @return {PADDsync.Geom.Point[]} An Array of Point objects.
     */
     ...
     *
     * @method PADDsync.Curves.Curve#getEndPoint
     * @since 3.0.0
     *
     * @param {PADDsync.Math.Vector2} [out] - Optional Vector object to store the result in.
     *
     * @return {PADDsync.Math.Vector2} Vector2 containing the coordinates of the curves end point.
     */
     ...
     *
     * @method PADDsync.Curves.Curve#getLength
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Curve#getLengths
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Curve#getPointAt
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {number} u - The relative position, [0..1].
     * @param {PADDsync.Math.Vector2} [out] - A point to store the result in.
     *
     * @return {PADDsync.Math.Vector2} The point.
     */
     ...
     *
     * @method PADDsync.Curves.Curve#getPoints
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2[]} O - [out,$return]
     *
     ...
     * @param {(array|PADDsync.Math.Vector2[])} [out] - An optional array to store the points in.
     *
     * @return {(array|PADDsync.Math.Vector2[])} An array of Points from the curve.
     */
     ...
     *
     * @method PADDsync.Curves.Curve#getRandomPoint
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {PADDsync.Math.Vector2} [out] - A point object to store the result in.
     *
     * @return {PADDsync.Math.Vector2} The point.
     */
     ...
     * `1 + divisions` points will be returned.
     *
     * @method PADDsync.Curves.Curve#getSpacedPoints
     * @since 3.0.0
     *
     ...
     * @param {(array|PADDsync.Math.Vector2[])} [out] - An optional array to store the points in.
     *
     * @return {PADDsync.Math.Vector2[]} An array of points.
     */
     ...
     *
     * @method PADDsync.Curves.Curve#getStartPoint
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method PADDsync.Curves.Curve#getTangent
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method PADDsync.Curves.Curve#getTangentAt
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     ...
     * @param {PADDsync.Math.Vector2} [out] - A vector to store the result in.
     *
     * @return {PADDsync.Math.Vector2} The tangent vector.
     */
     ...
     *
     * @method PADDsync.Curves.Curve#getTFromDistance
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Curve#getUtoTmapping
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Curve#updateArcLengths
     * @since 3.0.0
     *
     * @see PADDsync.Curves.Curve#getLengths()
     */
