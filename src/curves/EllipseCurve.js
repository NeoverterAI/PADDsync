 ...
 *
 * @class Ellipse
 * @extends PADDsync.Curves.Curve
 * @memberof PADDsync.Curves
 * @constructor
 * @since 3.0.0
 *
 * @param {(number|PADDsync.Types.Curves.EllipseCurveConfig)} [x=0] - The x coordinate of the ellipse, or an Ellipse Curve configuration object.
...
var EllipseCurve = new Class({
    ...
    function EllipseCurve (x, y, xRadius, yRadius, startAngle, endAngle, clockwise, rotation)
    {
         ...
         *
         * @name PADDsync.Curves.Ellipse#p0
         ...
         *
         * @name PADDsync.Curves.Ellipse#_xRadius
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Ellipse#_yRadius
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Ellipse#_startAngle
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Ellipse#_endAngle
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Ellipse#_clockwise
         * @type {boolean}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Ellipse#_rotation
         * @type {number}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Curves.Ellipse#getStartPoint
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {PADDsync.Math.Vector2} [out] - A Vector2 object to store the result in. If not given will be created.
     *
     * @return {PADDsync.Math.Vector2} The coordinates of the point on the curve. If an `out` object was given this will be returned.
     */
     ...
     *
     * @method PADDsync.Curves.Ellipse#getResolution
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#getPoint
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#setXRadius
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#setYRadius
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#setWidth
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#setHeight
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#setStartAngle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#setEndAngle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#setClockwise
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Ellipse#setRotation
     * @since 3.0.0
     *
     ...
     *
     * @name PADDsync.Curves.Ellipse#x
     * @type {number}
     * @since 3.0.0
     */
    x: {
     ...
     *
     * @name PADDsync.Curves.Ellipse#y
     * @type {number}
     * @since 3.0.0
     */
    y: {
     ...
     * The horizontal radius of the ellipse.
     *
     * @name PADDsync.Curves.Ellipse#xRadius
     * @type {number}
     * @since 3.0.0
     */
    xRadius: {
     ...
     * The vertical radius of the ellipse.
     *
     * @name PADDsync.Curves.Ellipse#yRadius
     * @type {number}
     * @since 3.0.0
     */
    yRadius: {
     ...
     *
     * @name PADDsync.Curves.Ellipse#startAngle
     * @type {number}
     * @since 3.0.0
     */
    startAngle: {
     ...
     *
     * @name PADDsync.Curves.Ellipse#endAngle
     * @type {number}
     * @since 3.0.0
     */
    endAngle: {
     ...
     *
     * @name PADDsync.Curves.Ellipse#clockwise
     * @type {boolean}
     * @since 3.0.0
     */
    clockwise: {
     ...
     *
     * @name PADDsync.Curves.Ellipse#angle
     * @type {number}
     * @since 3.14.0
     */
    angle: {
     ...
     *
     * @name PADDsync.Curves.Ellipse#rotation
     * @type {number}
     * @since 3.0.0
     */
    rotation: {
     ...
     *
     * @method PADDsync.Curves.Ellipse#toJSON
     * @since 3.0.0
     *
     * @return {PADDsync.Types.Curves.JSONEllipseCurve} The JSON object containing this curve data.
     */
    toJSON: function ()
    {
        return {
 ...
 *
 * @function PADDsync.Curves.Ellipse.fromJSON
 * @since 3.0.0
 *
 * @param {PADDsync.Types.Curves.JSONEllipseCurve} data - The JSON object containing this curve data.
 *
 * @return {PADDsync.Curves.Ellipse} The ellipse curve constructed from the configuration object.
 */
