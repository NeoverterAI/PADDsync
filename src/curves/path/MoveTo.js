...
var MoveTo = new Class({
    ...
    function MoveTo (x, y)
    {
         ...
         *
         * @name PADDsync.Curves.MoveTo#active
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.MoveTo#p0
     ...
     *
     * @method PADDsync.Curves.MoveTo#getPoint
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.MoveTo#getPointAt
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {number} u - The position in the path to retrieve, between 0 and 1. Not used.
     * @param {PADDsync.Math.Vector2} [out] - An optional vector in which to store the point.
     *
     * @return {PADDsync.Math.Vector2} The modified `out` vector, or a new `Vector2` if none was provided.
     */
     ...
     *
     * @method PADDsync.Curves.MoveTo#getResolution
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.MoveTo#getLength
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.MoveTo#toJSON
     * @since 3.0.0
     *
     * @return {PADDsync.Types.Curves.JSONCurve} A primitive object with the curve's type and only point.
     */
    toJSON: function ()
    {
        return {
