 ...
 *
 * @class Path
 * @memberof PADDsync.Curves
 * @constructor
 * @since 3.0.0
 *
 * @param {number} [x=0] - The X coordinate of the Path's starting point or a {@link PADDsync.Types.Curves.JSONPath}.
...
var Path = new Class({
    ...
    function Path (x, y)
    {
         ...
         *
         * @name PADDsync.Curves.Path#name
         * @type {string}
         * @default ''
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Path#defaultDivisions
         * @type {number}
         * @default 12
         * @since 3.70.0
         */
         ...
         *
         * @name PADDsync.Curves.Path#curves
         * @type {PADDsync.Curves.Curve[]}
         * @default []
         * @since 3.0.0
         */
        this.curves = [];
         ...
         *
         * @name PADDsync.Curves.Path#cacheLengths
         * @type {number[]}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Path#autoClose
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Curves.Path#startPoint
         ...
         *
         * @name PADDsync.Curves.Path#_tmpVec2A
         * @type {PADDsync.Math.Vector2}
         * @private
         * @since 3.0.0
         */
         ...
         * A temporary vector used to avoid object creation when adding a Curve to the Path.
         *
         * @name PADDsync.Curves.Path#_tmpVec2B
         * @type {PADDsync.Math.Vector2}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Curves.Path#add
     * @since 3.0.0
     *
     * @param {PADDsync.Curves.Curve} curve - The Curve to append.
     *
     ...
     *
     * @method PADDsync.Curves.Path#circleTo
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Path#closePath
     * @since 3.0.0
     *
     * @return {this} This Path object.
     */
     ...
     *
     * @method PADDsync.Curves.Path#cubicBezierTo
     * @since 3.0.0
     *
     * @param {(number|PADDsync.Math.Vector2)} x - The x coordinate of the end point. Or, if a Vector2, the p1 value.
     * @param {(number|PADDsync.Math.Vector2)} y - The y coordinate of the end point. Or, if a Vector2, the p2 value.
     * @param {(number|PADDsync.Math.Vector2)} control1X - The x coordinate of the first control point. Or, if a Vector2, the p3 value.
     ...
     *
     * @method PADDsync.Curves.Path#quadraticBezierTo
     * @since 3.2.0
     *
     * @param {(number|PADDsync.Math.Vector2[])} x - The X coordinate of the second control point or, if it's a `Vector2`, the first control point.
     ...
     *
     * @method PADDsync.Curves.Path#draw
     * @since 3.0.0
     *
     * @generic {PADDsync.GameObjects.Graphics} G - [out,$return]
     *
     * @param {PADDsync.GameObjects.Graphics} graphics - The Graphics Game Object to draw to.
     ...
     *
     * @return {PADDsync.GameObjects.Graphics} The Graphics object which was drawn to.
     */
     ...
     *
     * @method PADDsync.Curves.Path#ellipseTo
     * @since 3.0.0
     *
     ...
     *
     * The provided object should be a {@link PADDsync.Types.Curves.JSONPath}, as returned by {@link #toJSON}. Providing a malformed object may cause errors.
     *
     * @method PADDsync.Curves.Path#fromJSON
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Curves.JSONPath} data - The JSON object containing the Path data.
     *
     * @return {this} This Path object.
     */
     ...
     *
     * @method PADDsync.Curves.Path#getBounds
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {PADDsync.Geom.Rectangle} [out] - The Rectangle to store the bounds in.
     ...
     *
     * @return {PADDsync.Geom.Rectangle} The modified `out` Rectangle, or a new Rectangle if none was provided.
     */
     ...
     *
     * @method PADDsync.Curves.Path#getCurveLengths
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Path#getCurveAt
     * @since 3.60.0
     *
     * @param {number} t - The normalized location on the Path, between 0 and 1.
     *
     * @return {?PADDsync.Curves.Curve} The Curve that is part of this Path at a given location, or `null` if no curve was found.
     */
     ...
     *
     * @method PADDsync.Curves.Path#getEndPoint
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {PADDsync.Math.Vector2} [out] - The object to store the point in.
     *
     * @return {PADDsync.Math.Vector2} The modified `out` object, or a new Vector2 if none was provided.
     */
     ...
     *
     * @method PADDsync.Curves.Path#getLength
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Curves.Path#getPoint
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {number} t - The location of the point to return, between 0 and 1.
     * @param {PADDsync.Math.Vector2} [out] - The object in which to store the calculated point.
     *
     * @return {?PADDsync.Math.Vector2} The modified `out` object, or a new `Vector2` if none was provided.
     */
     ...
     *
     * @method PADDsync.Curves.Path#getPoints
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Math.Vector2[]} An array of Vector2 objects that containing the points along the Path.
     */
     ...
     *
     * @method PADDsync.Curves.Path#getRandomPoint
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {PADDsync.Math.Vector2} [out] - `Vector2` instance that should be used for storing the result. If `undefined` a new `Vector2` will be created.
     *
     * @return {PADDsync.Math.Vector2} The modified `out` object, or a new `Vector2` if none was provided.
     */
     ...
     *
     * @method PADDsync.Curves.Path#getSpacedPoints
     * @since 3.0.0
     *
     * @param {number} [divisions=40] - The amount of points to divide this Path into.
     *
     * @return {PADDsync.Math.Vector2[]} A list of the points this path was subdivided into.
     */
     ...
     *
     * @method PADDsync.Curves.Path#getStartPoint
     * @since 3.0.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     ...
     *
     * @method PADDsync.Curves.Path#getTangent
     * @since 3.23.0
     *
     * @generic {PADDsync.Math.Vector2} O - [out,$return]
     *
     * @param {number} t - The relative position on the path, [0..1].
     * @param {PADDsync.Math.Vector2} [out] - A vector to store the result in.
     *
     * @return {PADDsync.Math.Vector2} Vector approximating the tangent line at the point t (delta +/- 0.0001)
     */
     ...
     *
     * @method PADDsync.Curves.Path#lineTo
     * @since 3.0.0
     *
     * @param {(number|PADDsync.Math.Vector2|PADDsync.Types.Math.Vector2Like)} x - The X coordinate of the line's end point, or a `Vector2` / `Vector2Like` containing the entire end point.
     ...
     *
     * @method PADDsync.Curves.Path#splineTo
     * @since 3.0.0
     *
     * @param {PADDsync.Math.Vector2[]} points - The points the newly created spline curve should consist of.
     *
     * @return {this} This Path object.
     */
     ...
     *
     * @method PADDsync.Curves.Path#moveTo
     * @since 3.0.0
     *
     * @param {(number|PADDsync.Math.Vector2|PADDsync.Types.Math.Vector2Like)} x - The X coordinate of the position to move the path's end point to, or a `Vector2` / `Vector2Like` containing the entire new end point.
     ...
     *
     * @method PADDsync.Curves.Path#toJSON
     * @since 3.0.0
     *
     * @return {PADDsync.Types.Curves.JSONPath} The JSON object containing this path's data.
     */
    toJSON: function ()
    {
        var out = [];
     ...
     *
     * @method PADDsync.Curves.Path#updateArcLengths
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Curves.Path#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
 ...
 *
 * @method PADDsync.GameObjects.GameObjectFactory#path
 * @since 3.0.0
 *
 * @param {number} x - The horizontal position of this Path.
 * @param {number} y - The vertical position of this Path.
 *
 * @return {PADDsync.Curves.Path} The Path Object that was created.
 */
