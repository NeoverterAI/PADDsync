 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - The Game instance that owns the Input Manager.
...
var InputManager = new Class({
    ...
    function InputManager (game, config)
    {
         ...
         *
         * @name PADDsync.Input.InputManager#game
         * @type {PADDsync.Game}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#scaleManager
         ...
         *
         * @name PADDsync.Input.InputManager#canvas
         ...
         *
         * @name PADDsync.Input.InputManager#config
         * @type {PADDsync.Core.Config}
         * @since 3.0.0
         */
        this.config = config;
         ...
         *
         * @name PADDsync.Input.InputManager#enabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#events
         ...
         *
         * @name PADDsync.Input.InputManager#isOver
         * @type {boolean}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#defaultCursor
         * @type {string}
         * @since 3.10.0
         */
        this.defaultCursor = '';
         ...
         *
         * @name PADDsync.Input.InputManager#keyboard
         * @type {?PADDsync.Input.Keyboard.KeyboardManager}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#mouse
         ...
         *
         * @name PADDsync.Input.InputManager#touch
         * @type {PADDsync.Input.Touch.TouchManager}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#pointers
         ...
         *
         * @name PADDsync.Input.InputManager#pointersTotal
         * @type {number}
         * @readonly
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#mousePointer
         * @type {?PADDsync.Input.Pointer}
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#activePointer
         * @type {PADDsync.Input.Pointer}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#globalTopOnly
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#time
         * @type {number}
         * @readonly
         * @since 3.16.2
         */
         ...
         *
         * @name PADDsync.Input.InputManager#_tempPoint
         ...
         *
         * @name PADDsync.Input.InputManager#_tempHitTest
         * @type {array}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Input.InputManager#_tempMatrix
         ...
         * A re-cycled matrix used in hit test calculations.
         *
         * @name PADDsync.Input.InputManager#_tempMatrix2
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @private
         * @since 3.12.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#_tempSkip
         * @type {boolean}
         * @private
         * @since 3.18.0
         */
         ...
         *
         * @name PADDsync.Input.InputManager#mousePointerContainer
         * @type {PADDsync.Input.Pointer[]}
         * @private
         * @since 3.18.0
         */
     ...
     *
     * @method PADDsync.Input.InputManager#boot
     * @protected
     * @fires PADDsync.Input.Events#MANAGER_BOOT
     * @since 3.0.0
     */
    boot: function ()
    {
     ...
     *
     * @method PADDsync.Input.InputManager#setCanvasOver
     ...
     * Internal canvas state change, called automatically by the Mouse Manager.
     *
     * @method PADDsync.Input.InputManager#setCanvasOut
     ...
     *
     * @method PADDsync.Input.InputManager#preRender
     * @private
     * @since 3.18.0
     */
    preRender: function ()
     ...
     *
     * @method PADDsync.Input.InputManager#setDefaultCursor
     * @since 3.10.0
     *
     ...
     * https://developer.mozilla.org/en-US/docs/Web/CSS/cursor
     *
     * @method PADDsync.Input.InputManager#setCursor
     * @private
     * @since 3.10.0
     *
     * @param {PADDsync.Types.Input.InteractiveObject} interactiveObject - The Interactive Object that called this method.
     */
     ...
     *
     * @method PADDsync.Input.InputManager#resetCursor
     * @private
     * @since 3.10.0
     *
     * @param {PADDsync.Types.Input.InteractiveObject} interactiveObject - The Interactive Object that called this method. Pass `null` if you just want to set the force value.
     ...
     * via this method.
     *
     * @method PADDsync.Input.InputManager#addPointer
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.InputManager#updateInputPlugins
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.InputManager#onTouchStart
     * @private
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.InputManager#onTouchMove
     * @private
     * @since 3.18.0
     *
     * @param {TouchEvent} event - The native DOM Touch event.
     ...
     *
     * @method PADDsync.Input.InputManager#onTouchEnd
     * @private
     * @since 3.18.0
     *
     * @param {TouchEvent} event - The native DOM Touch event.
     ...
     *
     * @method PADDsync.Input.InputManager#onTouchCancel
     * @private
     * @since 3.18.0
     *
     * @param {TouchEvent} event - The native DOM Touch event.
     ...
     *
     * @method PADDsync.Input.InputManager#onMouseDown
     * @private
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.InputManager#onMouseMove
     * @private
     * @since 3.18.0
     *
     * @param {MouseEvent} event - The native DOM Mouse event.
     ...
     *
     * @method PADDsync.Input.InputManager#onMouseUp
     * @private
     * @since 3.18.0
     *
     * @param {MouseEvent} event - The native DOM Mouse event.
     ...
     *
     * @method PADDsync.Input.InputManager#onMouseWheel
     * @private
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.InputManager#onPointerLockChange
     * @fires PADDsync.Input.Events#POINTERLOCK_CHANGE
     * @private
     * @since 3.19.0
     *
     * @param {MouseEvent} event - The native DOM Mouse event.
     ...
     *
     * @method PADDsync.Input.InputManager#inputCandidate
     * @private
     * @since 3.10.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to test.
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera which is being tested against.
     *
     ...
     *
     * @method PADDsync.Input.InputManager#hitTest
     * @since 3.0.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to test against.
     ...
     *
     * @method PADDsync.Input.InputManager#pointWithinHitArea
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The interactive Game Object to check against.
     ...
     *
     * @method PADDsync.Input.InputManager#pointWithinInteractiveObject
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Input.InteractiveObject} object - The Interactive Object to check against.
     * @param {number} x - The translated x coordinate for the hit test.
     * @param {number} y - The translated y coordinate for the hit test.
     *
     * @return {boolean} `true` if the coordinates were inside the Game Objects hit area, otherwise `false`.
     ...
     *
     * @method PADDsync.Input.InputManager#transformPointer
     * @since 3.10.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to transform the values for.
     ...
     *
     * @method PADDsync.Input.InputManager#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
