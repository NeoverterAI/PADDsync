 ...
 * @memberof PADDsync.Input.Gamepad
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Input.Gamepad.GamepadPlugin} manager - A reference to the Gamepad Plugin.
 * @param {PADDsync.Types.Input.Gamepad.Pad} pad - The Gamepad object, as extracted from GamepadEvent.
 */
var Gamepad = new Class({
    ...
    function Gamepad (manager, pad)
    {
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#manager
         * @type {PADDsync.Input.Gamepad.GamepadPlugin}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#pad
         * @type {any}
         * @since 3.10.0
         */
        this.pad = pad;
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#id
         * @type {string}
         * @since 3.0.0
         */
        this.id = pad.id;
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#index
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#buttons
         * @type {PADDsync.Input.Gamepad.Button[]}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#axes
         * @type {PADDsync.Input.Gamepad.Axis[]}
         * @since 3.0.0
         */
        this.axes = axes;
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#vibration
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_LCLeft
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_LCRight
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_LCTop
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_LCBottom
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_RCLeft
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_RCRight
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_RCTop
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_RCBottom
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_FBLeftTop
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_FBLeftBottom
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_FBRightTop
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_FBRightBottom
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_HAxisLeft
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_VAxisLeft
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_HAxisRight
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_VAxisRight
         * @type {PADDsync.Input.Gamepad.Button}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#leftStick
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#rightStick
         * @type {PADDsync.Math.Vector2}
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Gamepad#_created
         * @type {number}
         * @private
         * @since 3.50.0
         */
     ...
     *
     * @method PADDsync.Input.Gamepad.Gamepad#getAxisTotal
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.Gamepad.Gamepad#getAxisValue
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.Gamepad.Gamepad#setAxisThreshold
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.Gamepad.Gamepad#getButtonTotal
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.Gamepad.Gamepad#getButtonValue
     * @since 3.10.0
     *
     ...
     * The index must be valid within the range of buttons supported by this Gamepad.
     *
     * @method PADDsync.Input.Gamepad.Gamepad#isButtonDown
     * @since 3.10.0
     *
     * @param {number} index - The index of the button to get the value for.
     *
     ...
     *
     * @method PADDsync.Input.Gamepad.Gamepad#update
     * @private
     * @since 3.0.0
     */
    update: function (pad)
     ...
     *
     * @method PADDsync.Input.Gamepad.Gamepad#destroy
     * @since 3.10.0
     */
    destroy: function ()
    {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#connected
     * @type {boolean}
     * @default true
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#timestamp
     * @type {number}
     * @since 3.0.0
     */
    timestamp: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#left
     * @type {boolean}
     * @since 3.10.0
     */
    left: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#right
     * @type {boolean}
     * @since 3.10.0
     */
    right: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#up
     * @type {boolean}
     * @since 3.10.0
     */
    up: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#down
     * @type {boolean}
     * @since 3.10.0
     */
    down: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#A
     * @type {boolean}
     * @since 3.10.0
     */
    A: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#Y
     * @type {boolean}
     * @since 3.10.0
     */
    Y: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#X
     * @type {boolean}
     * @since 3.10.0
     */
    X: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#B
     * @type {boolean}
     * @since 3.10.0
     */
    B: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#L1
     * @type {number}
     * @since 3.10.0
     */
    L1: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#L2
     * @type {number}
     * @since 3.10.0
     */
    L2: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#R1
     * @type {number}
     * @since 3.10.0
     */
    R1: {
     ...
     *
     * @name PADDsync.Input.Gamepad.Gamepad#R2
     * @type {number}
     * @since 3.10.0
     */
    R2: {
