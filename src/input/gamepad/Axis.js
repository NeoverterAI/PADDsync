 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Input.Gamepad.Gamepad} pad - A reference to the Gamepad that this Axis belongs to.
...
var Axis = new Class({
    ...
    function Axis (pad, index)
    {
         ...
         *
         * @name PADDsync.Input.Gamepad.Axis#pad
         ...
         *
         * @name PADDsync.Input.Gamepad.Axis#events
         ...
         *
         * @name PADDsync.Input.Gamepad.Axis#index
         * @type {number}
         * @since 3.0.0
         */
        this.index = index;
         ...
         *
         * @name PADDsync.Input.Gamepad.Axis#value
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.Axis#threshold
         * @type {number}
         * @default 0.1
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Input.Gamepad.Axis#update
     * @private
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Gamepad.Axis#getValue
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Gamepad.Axis#destroy
     * @since 3.10.0
     */
    destroy: function ()
    {
