...
var GamepadPlugin = new Class({
    ...
    function GamepadPlugin (sceneInputPlugin)
    {
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#scene
         * @type {PADDsync.Scene}
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#settings
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#sceneInputPlugin
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#enabled
         * @type {boolean}
         * @default true
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#target
         * @type {any}
         * @since 3.10.0
         */
        this.target;
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#gamepads
         * @type {PADDsync.Input.Gamepad.Gamepad[]}
         * @default []
         * @since 3.10.0
         */
        this.gamepads = [];
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#queue
         * @type {GamepadEvent[]}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#onGamepadHandler
         * @type {function}
         * @private
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#_pad1
         * @type {PADDsync.Input.Gamepad.Gamepad}
         * @private
         * @since 3.10.0
         */
         ...
         * Internal Gamepad reference.
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#_pad2
         * @type {PADDsync.Input.Gamepad.Gamepad}
         * @private
         * @since 3.10.0
         */
         ...
         * Internal Gamepad reference.
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#_pad3
         * @type {PADDsync.Input.Gamepad.Gamepad}
         * @private
         * @since 3.10.0
         */
         ...
         * Internal Gamepad reference.
         *
         * @name PADDsync.Input.Gamepad.GamepadPlugin#_pad4
         * @type {PADDsync.Input.Gamepad.Gamepad}
         * @private
         * @since 3.10.0
         */
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#boot
     * @private
     * @since 3.10.0
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#start
     * @private
     * @since 3.10.0
     */
    start: function ()
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#isActive
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#startListeners
     * @private
     * @since 3.10.0
     */
     ...
     * This is called automatically and does not need to be manually invoked.
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#stopListeners
     * @private
     * @since 3.10.0
     */
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#disconnectAll
     * @since 3.10.0
     */
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#refreshPads
     * @private
     * @since 3.10.0
     */
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#getAll
     * @since 3.10.0
     *
     * @return {PADDsync.Input.Gamepad.Gamepad[]} An array of all currently connected Gamepads.
     */
    getAll: function ()
    {
        var out = [];
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#getPad
     * @since 3.10.0
     *
     * @param {number} index - The index of the Gamepad to get.
     *
     * @return {PADDsync.Input.Gamepad.Gamepad} The Gamepad matching the given index, or undefined if none were found.
     */
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#update
     * @private
     * @fires PADDsync.Input.Gamepad.Events#CONNECTED
     * @fires PADDsync.Input.Gamepad.Events#DISCONNECTED
     * @since 3.10.0
     */
    update: function ()
    {
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#shutdown
     * @private
     * @since 3.10.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.Input.Gamepad.GamepadPlugin#destroy
     * @private
     * @since 3.10.0
     */
    destroy: function ()
     ...
     *
     * @name PADDsync.Input.Gamepad.GamepadPlugin#total
     * @type {number}
     * @since 3.10.0
     */
    total: {
     ...
     *
     * @name PADDsync.Input.Gamepad.GamepadPlugin#pad1
     * @type {PADDsync.Input.Gamepad.Gamepad}
     * @since 3.10.0
     */
    pad1: {
     ...
     * is plugged in, but hasn't yet had any buttons pressed on it.
     *
     * @name PADDsync.Input.Gamepad.GamepadPlugin#pad2
     * @type {PADDsync.Input.Gamepad.Gamepad}
     * @since 3.10.0
     */
    pad2: {
     ...
     * is plugged in, but hasn't yet had any buttons pressed on it.
     *
     * @name PADDsync.Input.Gamepad.GamepadPlugin#pad3
     * @type {PADDsync.Input.Gamepad.Gamepad}
     * @since 3.10.0
     */
    pad3: {
     ...
     * is plugged in, but hasn't yet had any buttons pressed on it.
     *
     * @name PADDsync.Input.Gamepad.GamepadPlugin#pad4
     * @type {PADDsync.Input.Gamepad.Gamepad}
     * @since 3.10.0
     */
    pad4: {
 ...
 *
 * @name PADDsync.Input.InputPlugin#gamepad
