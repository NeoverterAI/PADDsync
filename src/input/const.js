...
var INPUT_CONST = {
     ...
     *
     * @name PADDsync.Input.MOUSE_DOWN
     * @type {number}
     * @since 3.10.0
     */
    MOUSE_DOWN: 0,
     ...
     *
     * @name PADDsync.Input.MOUSE_MOVE
     * @type {number}
     * @since 3.10.0
     */
    MOUSE_MOVE: 1,
     ...
     *
     * @name PADDsync.Input.TOUCH_START
     * @type {number}
     * @since 3.10.0
     */
    TOUCH_START: 3,
     ...
     * A touch pointer has been started.
     *
     * @name PADDsync.Input.TOUCH_MOVE
     * @type {number}
     * @since 3.10.0
     */
    TOUCH_MOVE: 4,
     ...
     *
     * @name PADDsync.Input.POINTER_LOCK_CHANGE
     * @type {number}
     * @since 3.10.0
     */
     ...
     *
     * @name PADDsync.Input.TOUCH_CANCEL
     * @type {number}
     * @since 3.15.0
     */
    TOUCH_CANCEL: 7,
     ...
     *
     * @name PADDsync.Input.MOUSE_WHEEL
     * @type {number}
     * @since 3.18.0
     */
    MOUSE_WHEEL: 8
