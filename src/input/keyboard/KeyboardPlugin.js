 ...
 * @memberof PADDsync.Input.Keyboard
 * @constructor
 * @since 3.10.0
 *
 * @param {PADDsync.Input.InputPlugin} sceneInputPlugin - A reference to the Scene Input Plugin that the KeyboardPlugin belongs to.
 */
var KeyboardPlugin = new Class({
    ...
    function KeyboardPlugin (sceneInputPlugin)
    {
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#game
         * @type {PADDsync.Game}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#scene
         * @type {PADDsync.Scene}
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#settings
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#sceneInputPlugin
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#manager
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#enabled
         * @type {boolean}
         * @default true
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#keys
         * @type {PADDsync.Input.Keyboard.Key[]}
         * @since 3.10.0
         */
        this.keys = [];
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#combos
         * @type {PADDsync.Input.Keyboard.KeyCombo[]}
         * @since 3.10.0
         */
        this.combos = [];
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#prevCode
         * @type {string}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal repeat key flag.
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#prevTime
         * @type {number}
         * @private
         * @since 3.50.0
         */
         ...
         * Internal repeat key flag.
         *
         * @name PADDsync.Input.Keyboard.KeyboardPlugin#prevType
         * @type {string}
         * @private
         * @since 3.50.1
         */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#boot
     * @private
     * @since 3.10.0
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#start
     * @private
     * @since 3.10.0
     */
    start: function ()
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#isActive
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#addCapture
     * @since 3.16.0
     *
     ...
     * You can also provide an array mixing both strings and key code integers.
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#removeCapture
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#getCaptures
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#enableGlobalCapture
     * @since 3.16.0
     *
     * @return {this} This KeyboardPlugin object.
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#disableGlobalCapture
     * @since 3.16.0
     *
     * @return {this} This KeyboardPlugin object.
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#clearCaptures
     * @since 3.16.0
     *
     * @return {this} This KeyboardPlugin object.
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#createCursorKeys
     * @since 3.10.0
     *
     * @return {PADDsync.Types.Input.Keyboard.CursorKeys} An object containing the properties: `up`, `down`, `left`, `right`, `space` and `shift`.
     */
     ...
     *
     * ```javascript
     * this.input.keyboard.addKeys({ 'up': PADDsync.Input.Keyboard.KeyCodes.W, 'down': PADDsync.Input.Keyboard.KeyCodes.S });
     * ```
     *
     * would return an object containing the properties (`up` and `down`) mapped to W and S {@link PADDsync.Input.Keyboard.Key} objects.
     *
     ...
     * To use non-alpha numeric keys, use a string, such as 'UP', 'SPACE' or 'LEFT'.
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#addKeys
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#addKey
     * @since 3.10.0
     *
     * @param {(PADDsync.Input.Keyboard.Key|string|number)} key - Either a Key object, a string, such as `A` or `SPACE`, or a key code value.
     * @param {boolean} [enableCapture=true] - Automatically call `preventDefault` on the native DOM browser event for the key codes being added.
     * @param {boolean} [emitOnRepeat=false] - Controls if the Key will continuously emit a 'down' event while being held down (true), or emit the event just once (false, the default).
     *
     * @return {PADDsync.Input.Keyboard.Key} The newly created Key object, or a reference to it if it already existed in the keys array.
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#removeKey
     * @since 3.10.0
     *
     * @param {(PADDsync.Input.Keyboard.Key|string|number)} key - Either a Key object, a string, such as `A` or `SPACE`, or a key code value.
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#removeAllKeys
     * @since 3.24.0
     *
     ...
     * ```
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#createCombo
     * @since 3.10.0
     *
     * @param {(string|number[]|object[])} keys - The keys that comprise this combo.
     * @param {PADDsync.Types.Input.Keyboard.KeyComboConfig} [config] - A Key Combo configuration object.
     *
     * @return {PADDsync.Input.Keyboard.KeyCombo} The new KeyCombo object.
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#checkDown
     * @since 3.11.0
     *
     * @param {PADDsync.Input.Keyboard.Key} key - A Key object.
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#update
     * @private
     * @since 3.10.0
     */
    update: function ()
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#resetKeys
     * @since 3.15.0
     *
     * @return {this} This KeyboardPlugin object.
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#shutdown
     * @private
     * @since 3.10.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardPlugin#destroy
     * @private
     * @since 3.10.0
     */
    destroy: function ()
     ...
     * Internal time value.
     *
     * @name PADDsync.Input.Keyboard.KeyboardPlugin#time
     * @type {number}
     * @private
     * @since 3.11.0
     */
 ...
 *
 * @name PADDsync.Input.InputPlugin#keyboard
 * @type {?PADDsync.Input.Keyboard.KeyboardPlugin}
 * @since 3.10.0
 */
