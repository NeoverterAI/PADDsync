 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Input.Keyboard.KeyboardPlugin} plugin - The Keyboard Plugin instance that owns this Key object.
...
var Key = new Class({
    ...
    function Key (plugin, keyCode)
    {
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#plugin
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#keyCode
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#originalEvent
         * @type {KeyboardEvent}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#enabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#isDown
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#isUp
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#altKey
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#ctrlKey
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#shiftKey
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#metaKey
         * @type {boolean}
         * @default false
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#location
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#timeDown
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#duration
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#timeUp
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#emitOnRepeat
         * @type {boolean}
         * @default false
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#repeats
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#_justDown
         * @type {boolean}
         * @private
         * @default false
         * @since 3.0.0
         ...
         * True if the key has just been pressed (NOTE: requires to be reset, see justDown getter)
         *
         * @name PADDsync.Input.Keyboard.Key#_justUp
         * @type {boolean}
         * @private
         * @default false
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Input.Keyboard.Key#_tick
         * @type {number}
         * @private
         * @since 3.11.0
         */
     ...
     *
     * @method PADDsync.Input.Keyboard.Key#setEmitOnRepeat
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.Keyboard.Key#onDown
     * @fires PADDsync.Input.Keyboard.Events#DOWN
     * @since 3.16.0
     *
     ...
     * Called automatically by the Keyboard Plugin.
     *
     * @method PADDsync.Input.Keyboard.Key#onUp
     * @fires PADDsync.Input.Keyboard.Events#UP
     * @since 3.16.0
     *
     * @param {KeyboardEvent} event - The native DOM Keyboard event.
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.Key#reset
     * @since 3.6.0
     *
     * @return {this} This Key instance.
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.Key#getDuration
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Input.Keyboard.Key#destroy
     * @since 3.16.0
     */
    destroy: function ()
    {
