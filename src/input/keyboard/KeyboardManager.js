...
var KeyboardManager = new Class({
    ...
    function KeyboardManager (inputManager)
    {
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardManager#manager
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardManager#queue
         * @type {KeyboardEvent[]}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardManager#preventDefault
         * @type {boolean}
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardManager#captures
         * @type {number[]}
         * @since 3.16.0
         */
        this.captures = [];
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardManager#enabled
         * @type {boolean}
         * @default false
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardManager#target
         * @type {any}
         * @since 3.16.0
         */
        this.target;
         ...
         *
         * @name PADDsync.Input.Keyboard.KeyboardManager#onKeyDown
         * @type {function}
         * @since 3.16.00
         */
        this.onKeyDown = NOOP;
         ...
         * Initially empty and bound in the `startListeners` method.
         *
         * @name PADDsync.Input.Keyboard.KeyboardManager#onKeyUp
         * @type {function}
         * @since 3.16.00
         */
        this.onKeyUp = NOOP;
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardManager#boot
     * @private
     * @since 3.16.0
     */
    boot: function ()
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardManager#startListeners
     * @since 3.16.0
     */
     ...
     * This is called automatically and does not need to be manually invoked.
     *
     * @method PADDsync.Input.Keyboard.KeyboardManager#stopListeners
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardManager#postUpdate
     * @private
     * @since 3.16.0
     */
    postUpdate: function ()
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardManager#addCapture
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardManager#removeCapture
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardManager#clearCaptures
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Input.Keyboard.KeyboardManager#destroy
     * @since 3.16.0
     */
    destroy: function ()
    {
