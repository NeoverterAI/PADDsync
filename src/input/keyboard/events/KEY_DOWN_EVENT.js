 ...
 * name with any valid [Key Code string]{@link PADDsync.Input.Keyboard.KeyCodes}. For example, this will listen for the space bar:
 * `this.input.keyboard.on('keydown-SPACE', listener)`.
 *
 * You can also create a generic 'global' listener. See [Keyboard.Events.ANY_KEY_DOWN]{@linkcode PADDsync.Input.Keyboard.Events#event:ANY_KEY_DOWN} for details.
 *
 * Finally, you can create Key objects, which you can also listen for events from. See [Keyboard.Events.DOWN]{@linkcode PADDsync.Input.Keyboard.Events#event:DOWN} for details.
 *
 ...
 *
 * @event PADDsync.Input.Keyboard.Events#KEY_DOWN
 * @type {string}
 * @since 3.0.0
 *
