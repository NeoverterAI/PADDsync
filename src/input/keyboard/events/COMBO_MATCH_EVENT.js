 ...
 *
 * This event is dispatched by the Keyboard Plugin when a [Key Combo]{@link PADDsync.Input.Keyboard.KeyCombo} is matched.
 *
 ...
 * ```
 *
 * @event PADDsync.Input.Keyboard.Events#COMBO_MATCH
 * @type {string}
 * @since 3.0.0
 *
 * @param {PADDsync.Input.Keyboard.KeyCombo} keycombo - The Key Combo object that was matched.
