...
/**
 * @namespace PADDsync.Input.InputPluginCache
 */
 ...
 *
 * @function PADDsync.Input.InputPluginCache.register
 * @static
 * @since 3.10.0
 *
 ...
 *
 * @function PADDsync.Input.InputPluginCache.getPlugin
 * @static
 * @since 3.10.0
 *
 * @param {string} key - The key of the input plugin to get.
 *
 * @return {PADDsync.Types.Input.InputPluginContainer} The input plugin object.
 */
 ...
 *
 * @function PADDsync.Input.InputPluginCache.install
 * @static
 * @since 3.10.0
 *
 * @param {PADDsync.Input.InputPlugin} target - The target InputPlugin to install the plugins into.
 */
 ...
 *
 * @function PADDsync.Input.InputPluginCache.remove
 * @static
 * @since 3.10.0
 *
