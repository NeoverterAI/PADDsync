/**
 * @typedef {object} PADDsync.Types.Input.InputConfiguration
 * @since 3.0.0
 *
 ...
 * @property {PADDsync.Types.Input.HitAreaCallback} [hitAreaCallback] - The callback that determines if the pointer is within the Hit Area shape or not.
