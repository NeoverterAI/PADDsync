 ...
 * See the [Input Config object]{@linkcode PADDsync.Types.Core.InputConfig} for more details, including how to deal with Phaser
 ...
 * @memberof PADDsync.Input
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - A reference to the Scene that this Input Plugin is responsible for.
 */
var InputPlugin = new Class({
    ...
    function InputPlugin (scene)
    {
         ...
         *
         * @name PADDsync.Input.InputPlugin#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Input.InputPlugin#systems
         ...
         *
         * @name PADDsync.Input.InputPlugin#settings
         * @type {PADDsync.Types.Scenes.SettingsObject}
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#manager
         * @type {PADDsync.Input.InputManager}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#pluginEvents
         ...
         *
         * @name PADDsync.Input.InputPlugin#enabled
         * @type {boolean}
         * @default true
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#displayList
         ...
         *
         * @name PADDsync.Input.InputPlugin#cameras
         ...
         *
         * @name PADDsync.Input.InputPlugin#mouse
         * @type {?PADDsync.Input.Mouse.MouseManager}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#topOnly
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#pollRate
         * @type {number}
         * @default -1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#_pollTimer
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Input.InputPlugin#_eventContainer
         * @type {PADDsync.Types.Input.EventData}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#_eventData
         * @type {object}
         * @private
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#dragDistanceThreshold
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * [setPollAlways]{@linkcode PADDsync.Input.InputPlugin#setPollAlways} or
         * [setPollRate]{@linkcode PADDsync.Input.InputPlugin#setPollRate}.
         *
         * @name PADDsync.Input.InputPlugin#dragTimeThreshold
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#_temp
         * @type {array}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Input.InputPlugin#_tempZones
         * @type {array}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Input.InputPlugin#_list
         ...
         *
         * @name PADDsync.Input.InputPlugin#_pendingInsertion
         * @type {PADDsync.GameObjects.GameObject[]}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Input.InputPlugin#_pendingRemoval
         * @type {PADDsync.GameObjects.GameObject[]}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Input.InputPlugin#_draggable
         * @type {PADDsync.GameObjects.GameObject[]}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Input.InputPlugin#_drag
         ...
         *
         * @name PADDsync.Input.InputPlugin#_dragState
         * @type {number[]}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#_over
         * @type {{0:Array,1:Array,2:Array,3:Array,4:Array,5:Array,6:Array,7:Array,8:Array,9:Array,10:Array}}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#_validTypes
         * @type {string[]}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.InputPlugin#_updatedThisFrame
         * @type {boolean}
         * @private
         * @since 3.18.0
         */
     ...
     *
     * @method PADDsync.Input.InputPlugin#boot
     * @fires PADDsync.Input.Events#BOOT
     * @private
     * @since 3.5.1
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Input.InputPlugin#start
     * @fires PADDsync.Input.Events#START
     * @private
     * @since 3.5.0
     */
    start: function ()
     ...
     * Game Over handler.
     *
     * @method PADDsync.Input.InputPlugin#onGameOver
     * @fires PADDsync.Input.Events#GAME_OVER
     * @private
     * @since 3.16.2
     */
     ...
     * Game Out handler.
     *
     * @method PADDsync.Input.InputPlugin#onGameOut
     * @fires PADDsync.Input.Events#GAME_OUT
     * @private
     * @since 3.16.2
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#preUpdate
     * @private
     * @fires PADDsync.Input.Events#PRE_UPDATE
     * @since 3.0.0
     */
    preUpdate: function ()
    {
     ...
     *
     * @method PADDsync.Input.InputPlugin#isActive
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#setCursor
     * @since 3.85.0
     *
     * @param {PADDsync.Types.Input.InteractiveObject} interactiveObject - The Interactive Object that will set the cursor on the canvas.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#resetCursor
     * @since 3.85.0
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#updatePoll
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#update
     * @private
     * @fires PADDsync.Input.Events#UPDATE
     * @since 3.0.0
     *
     * @param {number} type - The type of event to process.
     * @param {PADDsync.Input.Pointer[]} pointers - An array of Pointers on which the event occurred.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#clear
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object that will have its Interactive Object removed.
     * @param {boolean} [skipQueue=false] - Skip adding this Game Object into the removal queue?
     *
     * @return {PADDsync.GameObjects.GameObject} The Game Object that had its Interactive Object removed.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#disable
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to have its input system disabled.
     ...
     *
     * @method PADDsync.Input.InputPlugin#enable
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to be enabled for input.
     * @param {(PADDsync.Types.Input.InputConfiguration|any)} [hitArea] - Either an input configuration object, or a geometric shape that defines the hit area for the Game Object. If not specified a Rectangle will be used.
     * @param {PADDsync.Types.Input.HitAreaCallback} [hitAreaCallback] - The 'contains' function to invoke to check if the pointer is within the hit area.
     ...
     *
     * @method PADDsync.Input.InputPlugin#hitTestPointer
     * @since 3.0.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to check against the Game Objects.
     *
     * @return {PADDsync.GameObjects.GameObject[]} An array of all the interactive Game Objects the Pointer was above.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#processDownEvents
     * @private
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_DOWN
     * @fires PADDsync.Input.Events#GAMEOBJECT_DOWN
     * @fires PADDsync.Input.Events#POINTER_DOWN
     * @fires PADDsync.Input.Events#POINTER_DOWN_OUTSIDE
     * @since 3.0.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer being tested.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#getDragState
     * @since 3.16.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to get the drag state for.
     *
     ...
     * 5 = Pointer actively dragging but has been released, notify draglist
     *
     * @method PADDsync.Input.InputPlugin#setDragState
     * @since 3.16.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to set the drag state for.
     ...
     * or time threshold.
     *
     * @method PADDsync.Input.InputPlugin#processDragThresholdEvent
     * @private
     * @since 3.18.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to check the drag thresholds on.
     ...
     *
     * @method PADDsync.Input.InputPlugin#processDragStartList
     * @private
     * @fires PADDsync.Input.Events#DRAG_START
     * @fires PADDsync.Input.Events#GAMEOBJECT_DRAG_START
     * @since 3.18.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to process the drag event on.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#processDragDownEvent
     * @private
     * @since 3.18.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to process the drag event on.
     ...
     *
     * @method PADDsync.Input.InputPlugin#processDragMoveEvent
     * @private
     * @fires PADDsync.Input.Events#DRAG_ENTER
     * @fires PADDsync.Input.Events#DRAG
     * @fires PADDsync.Input.Events#DRAG_LEAVE
     * @fires PADDsync.Input.Events#DRAG_OVER
     * @fires PADDsync.Input.Events#GAMEOBJECT_DRAG_ENTER
     * @fires PADDsync.Input.Events#GAMEOBJECT_DRAG
     * @fires PADDsync.Input.Events#GAMEOBJECT_DRAG_LEAVE
     * @fires PADDsync.Input.Events#GAMEOBJECT_DRAG_OVER
     * @since 3.18.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to process the drag event on.
     *
     ...
     * and prepares them all for interaction.
     *
     * @method PADDsync.Input.InputPlugin#processDragUpEvent
     * @fires PADDsync.Input.Events#DRAG_END
     * @fires PADDsync.Input.Events#DROP
     * @fires PADDsync.Input.Events#GAMEOBJECT_DRAG_END
     * @fires PADDsync.Input.Events#GAMEOBJECT_DROP
     * @private
     * @since 3.18.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to process the drag event on.
     ...
     *
     * @method PADDsync.Input.InputPlugin#processMoveEvents
     * @private
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_MOVE
     * @fires PADDsync.Input.Events#GAMEOBJECT_MOVE
     * @fires PADDsync.Input.Events#POINTER_MOVE
     * @since 3.0.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The pointer to check for events against.
     *
     * @return {number} The total number of objects interacted with.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#processWheelEvent
     * @private
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_WHEEL
     * @fires PADDsync.Input.Events#GAMEOBJECT_WHEEL
     * @fires PADDsync.Input.Events#POINTER_WHEEL
     * @since 3.18.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The pointer to check for events against.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#processOverEvents
     * @private
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_OVER
     * @fires PADDsync.Input.Events#GAMEOBJECT_OVER
     * @fires PADDsync.Input.Events#POINTER_OVER
     * @since 3.18.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The pointer to check for events against.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#processOutEvents
     * @private
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_OUT
     * @fires PADDsync.Input.Events#GAMEOBJECT_OUT
     * @fires PADDsync.Input.Events#POINTER_OUT
     * @since 3.18.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The pointer to check for events against.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#processOverOutEvents
     * @private
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_OVER
     * @fires PADDsync.Input.Events#GAMEOBJECT_OVER
     * @fires PADDsync.Input.Events#POINTER_OVER
     ...
     *
     * @method PADDsync.Input.InputPlugin#processUpEvents
     * @private
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_UP
     * @fires PADDsync.Input.Events#GAMEOBJECT_UP
     * @fires PADDsync.Input.Events#POINTER_UP
     * @fires PADDsync.Input.Events#POINTER_UP_OUTSIDE
     * @since 3.0.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The pointer to check for events against.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#forceDownState
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_DOWN
     * @fires PADDsync.Input.Events#GAMEOBJECT_DOWN
     * @since 3.85.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The pointer to use when setting the state.
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to have its state set.
     */
     ...
     * that is up to you to do before calling this method.
     *
     * @method PADDsync.Input.InputPlugin#forceUpState
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_UP
     * @fires PADDsync.Input.Events#GAMEOBJECT_UP
     * @since 3.85.0
     *
     ...
     * that is up to you to do before calling this method.
     *
     * @method PADDsync.Input.InputPlugin#forceOverState
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_OVER
     * @fires PADDsync.Input.Events#GAMEOBJECT_OVER
     * @since 3.85.0
     *
     ...
     * that is up to you to do before calling this method.
     *
     * @method PADDsync.Input.InputPlugin#forceOutState
     * @fires PADDsync.Input.Events#GAMEOBJECT_POINTER_OUT
     * @fires PADDsync.Input.Events#GAMEOBJECT_OUT
     * @since 3.85.0
     *
     ...
     * 
     * @method PADDsync.Input.InputPlugin#forceState
     * @since 3.85.0
     * 
     * @param {PADDsync.Input.Pointer} pointer - The pointer to use when setting the state.
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to have its state set.
     ...
     *
     * @method PADDsync.Input.InputPlugin#queueForInsertion
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to add.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#queueForRemoval
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to remove.
     *
     * @return {this} This InputPlugin object.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#setDraggable
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[])} gameObjects - An array of Game Objects to change the draggable state on.
     ...
     *
     * @method PADDsync.Input.InputPlugin#makePixelPerfect
     * @since 3.10.0
     *
     ...
     *
     * A hit area is typically one of the geometric shapes Phaser provides, such as a `PADDsync.Geom.Rectangle`
     * or `PADDsync.Geom.Circle`. However, it can be any object as long as it works with the provided callback.
     *
     ...
     * such as `PADDsync.Geom.Rectangle.Contains`.
     * 
     * A hit area callback can be supplied to the `hitArea` parameter without using the `hitAreaCallback` parameter.
     *
     * @method PADDsync.Input.InputPlugin#setHitArea
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set the hit area on.
     * @param {(PADDsync.Types.Input.InputConfiguration|PADDsync.Types.Input.HitAreaCallback|any)} [hitArea] - Either an input configuration object, a geometric shape that defines the hit area or a hit area callback. If not specified a Rectangle hit area will be used.
     * @param {PADDsync.Types.Input.HitAreaCallback} [hitAreaCallback] - The 'contains' function to invoke to check if the pointer is within the hit area.
     *
     * @return {this} This InputPlugin object.
     */
    ...
    /**
     * Sets the hit area for an array of Game Objects to be a `PADDsync.Geom.Circle` shape, using
     * the given coordinates and radius to control its position and size.
     *
     * @method PADDsync.Input.InputPlugin#setHitAreaCircle
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having a circle hit area.
     * @param {number} x - The center of the circle.
     * @param {number} y - The center of the circle.
     * @param {number} radius - The radius of the circle.
     * @param {PADDsync.Types.Input.HitAreaCallback} [callback] - The hit area callback. If undefined it uses Circle.Contains.
     *
     * @return {this} This InputPlugin object.
     */
    ...
    /**
     * Sets the hit area for an array of Game Objects to be a `PADDsync.Geom.Ellipse` shape, using
     * the given coordinates and dimensions to control its position and size.
     *
     * @method PADDsync.Input.InputPlugin#setHitAreaEllipse
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having an ellipse hit area.
     * @param {number} x - The center of the ellipse.
     * @param {number} y - The center of the ellipse.
     * @param {number} width - The width of the ellipse.
     * @param {number} height - The height of the ellipse.
     * @param {PADDsync.Types.Input.HitAreaCallback} [callback] - The hit area callback. If undefined it uses Ellipse.Contains.
     *
     * @return {this} This InputPlugin object.
     */
    ...
    /**
     * Sets the hit area for an array of Game Objects to be a `PADDsync.Geom.Rectangle` shape, using
     * the Game Objects texture frame to define the position and size of the hit area.
     *
     * @method PADDsync.Input.InputPlugin#setHitAreaFromTexture
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having an ellipse hit area.
     * @param {PADDsync.Types.Input.HitAreaCallback} [callback] - The hit area callback. If undefined it uses Rectangle.Contains.
     *
     * @return {this} This InputPlugin object.
     */
     ...
     * the given coordinates and dimensions to control its position and size.
     *
     * @method PADDsync.Input.InputPlugin#setHitAreaRectangle
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having a rectangular hit area.
    ...
    /**
     * Sets the hit area for an array of Game Objects to be a `PADDsync.Geom.Triangle` shape, using
     * the given coordinates to control the position of its points.
     *
     * @method PADDsync.Input.InputPlugin#setHitAreaTriangle
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[])} gameObjects - An array of Game Objects to set as having a  triangular hit area.
     ...
     * @param {PADDsync.Types.Input.HitAreaCallback} [callback] - The hit area callback. If undefined it uses Triangle.Contains.
     *
     * @return {this} This InputPlugin object.
     */
     ...
     * work.
     *
     * @method PADDsync.Input.InputPlugin#enableDebug
     * @since 3.19.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to create the input debug shape for.
     ...
     *
     * @method PADDsync.Input.InputPlugin#removeDebug
     * @since 3.19.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to remove the input debug shape from.
     *
     * @return {this} This Input Plugin.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#setPollAlways
     * @since 3.0.0
     *
     * @return {this} This InputPlugin object.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#setPollOnMove
     * @since 3.0.0
     *
     * @return {this} This InputPlugin object.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#setPollRate
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#setGlobalTopOnly
     * @since 3.0.0
     *
     ...
     * If set to `false` it will emit events from all Game Objects below a Pointer, not just the top one.
     *
     * @method PADDsync.Input.InputPlugin#setTopOnly
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#sortGameObjects
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject[]} gameObjects - An array of Game Objects to be sorted.
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to check against the Game Objects.
     *
     * @return {PADDsync.GameObjects.GameObject[]} The sorted array of Game Objects.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#sortDropZones
     * @since 3.52.0
     *
     * @param {PADDsync.GameObjects.GameObject[]} gameObjects - An array of Game Objects to be sorted.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#sortDropZoneHandler
     * @private
     * @since 3.52.0
     *
     * @param {PADDsync.GameObjects.GameObject} childA - The first Game Object to compare.
     * @param {PADDsync.GameObjects.GameObject} childB - The second Game Object to compare.
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#stopPropagation
     * @since 3.0.0
     *
     * @return {this} This InputPlugin object.
     */
     ...
     * via this method.
     *
     * @method PADDsync.Input.InputPlugin#addPointer
     * @since 3.10.0
     *
     * @param {number} [quantity=1] The number of new Pointers to create. A maximum of 10 is allowed in total.
     *
     * @return {PADDsync.Input.Pointer[]} An array containing all of the new Pointer objects that were created.
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#setDefaultCursor
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Input.InputPlugin#transitionIn
     * @private
     * @since 3.5.0
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#transitionComplete
     * @private
     * @since 3.5.0
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#transitionOut
     * @private
     * @since 3.5.0
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#shutdown
     * @fires PADDsync.Input.Events#SHUTDOWN
     * @private
     * @since 3.0.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.Input.InputPlugin#resetPointers
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Input.InputPlugin#destroy
     * @fires PADDsync.Input.Events#DESTROY
     * @private
     * @since 3.0.0
     */
    destroy: function ()
     ...
     *
     * @name PADDsync.Input.InputPlugin#x
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     * This is only safe to use if your game has just 1 non-transformed camera and doesn't use multi-touch.
     *
     * @name PADDsync.Input.InputPlugin#y
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Input.InputPlugin#isOver
     * @type {boolean}
     * @readonly
     * @since 3.16.0
     */
     ...
     *
     * @name PADDsync.Input.InputPlugin#mousePointer
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
    mousePointer: {
     ...
     *
     * @name PADDsync.Input.InputPlugin#activePointer
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Input.InputPlugin#pointer1
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer2
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer3
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer4
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer5
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer6
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer7
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer8
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer9
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
     ...
     * This will be `undefined` by default unless you add a new Pointer using `addPointer`.
     *
     * @name PADDsync.Input.InputPlugin#pointer10
     * @type {PADDsync.Input.Pointer}
     * @readonly
     * @since 3.10.0
     */
