...
/**
 * @classdesc
 * A Pointer object encapsulates both mouse and touch input within PADDsync.
 *
 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Input.InputManager} manager - A reference to the Input Manager.
...
var Pointer = new Class({
    ...
    function Pointer (manager, id)
    {
         ...
         *
         * @name PADDsync.Input.Pointer#manager
         ...
         *
         * @name PADDsync.Input.Pointer#id
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#event
         ...
         *
         * @name PADDsync.Input.Pointer#downElement
         * @type {any}
         * @readonly
         * @since 3.16.0
         */
         ...
         * In a default set-up this will be the Canvas that Phaser is rendering to, or the Window element.
         *
         * @name PADDsync.Input.Pointer#upElement
         * @type {any}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#camera
         ...
         *
         * @name PADDsync.Input.Pointer#button
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.18.0
         ...
         *
         * @name PADDsync.Input.Pointer#buttons
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#position
         ...
         *
         * @name PADDsync.Input.Pointer#prevPosition
         * @type {PADDsync.Math.Vector2}
         * @readonly
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#midPoint
         * @type {PADDsync.Math.Vector2}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#velocity
         * @type {PADDsync.Math.Vector2}
         * @readonly
         * @since 3.16.0
         */
         ...
         * it changes based on movement alone - a button doesn't have to be pressed first.
         *
         * @name PADDsync.Input.Pointer#angle
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#distance
         * @type {number}
         * @readonly
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#smoothFactor
         * @type {number}
         * @default 0
         * @since 3.16.0
         */
         ...
         * zero.
         *
         * @name PADDsync.Input.Pointer#motionFactor
         * @type {number}
         * @default 0.2
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#worldX
         * @type {number}
         * @default 0
         * @since 3.10.0
         */
         ...
         * the `Pointer.updateWorldPoint` method.
         *
         * @name PADDsync.Input.Pointer#worldY
         * @type {number}
         * @default 0
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#moveTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#downX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#downY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#downTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#upX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#upY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#upTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#primaryDown
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#isDown
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#wasTouch
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#wasCanceled
         * @type {boolean}
         * @default false
         * @since 3.15.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#movementX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#movementY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#identifier
         * @type {number}
         * @since 3.10.0
         */
        this.identifier = 0;
         ...
         *
         * @name PADDsync.Input.Pointer#pointerId
         * @type {number}
         * @since 3.10.0
         */
        this.pointerId = null;
         ...
         *
         * @name PADDsync.Input.Pointer#active
         * @type {boolean}
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#locked
         * @readonly
         * @type {boolean}
         * @since 3.19.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#deltaX
         * @type {number}
         * @default 0
         * @since 3.18.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#deltaY
         * @type {number}
         * @default 0
         * @since 3.18.0
         */
         ...
         *
         * @name PADDsync.Input.Pointer#deltaZ
         * @type {number}
         * @default 0
         * @since 3.18.0
         */
     ...
     *
     * @method PADDsync.Input.Pointer#updateWorldPoint
     * @since 3.19.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#positionToCamera
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera to use for the translation.
     * @param {(PADDsync.Math.Vector2|object)} [output] - A Vector2-like object in which to store the translated position.
     *
     * @return {(PADDsync.Math.Vector2|object)} A Vector2 containing the translated coordinates of this Pointer, based on the given camera.
     */
     ...
     *
     * @method PADDsync.Input.Pointer#updateMotion
     * @private
     * @since 3.16.0
     */
     ...
     *
     * @method PADDsync.Input.Pointer#up
     * @private
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#down
     * @private
     * @since 3.0.0
     *
     * @param {MouseEvent} event - The Mouse Event to process.
     ...
     *
     * @method PADDsync.Input.Pointer#move
     * @private
     * @since 3.0.0
     *
     * @param {MouseEvent} event - The Mouse Event to process.
     ...
     *
     * @method PADDsync.Input.Pointer#wheel
     * @private
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#touchstart
     * @private
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#touchmove
     * @private
     * @since 3.0.0
     *
     * @param {Touch} touch - The Changed Touch from the Touch Event.
     ...
     *
     * @method PADDsync.Input.Pointer#touchend
     * @private
     * @since 3.0.0
     *
     * @param {Touch} touch - The Changed Touch from the Touch Event.
     ...
     *
     * @method PADDsync.Input.Pointer#touchcancel
     * @private
     * @since 3.15.0
     *
     * @param {Touch} touch - The Changed Touch from the Touch Event.
     ...
     *
     * @method PADDsync.Input.Pointer#noButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#leftButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#rightButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#middleButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#backButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#forwardButtonDown
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#leftButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#rightButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#middleButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#backButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#forwardButtonReleased
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#getDistance
     * @since 3.13.0
     *
     ...
     * the Pointer was when the button was released.
     *
     * @method PADDsync.Input.Pointer#getDistanceX
     * @since 3.16.0
     *
     ...
     * the Pointer was when the button was released.
     *
     * @method PADDsync.Input.Pointer#getDistanceY
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#getDuration
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#getAngle
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#getInterpolatedPosition
     * @since 3.11.0
     *
     ...
     *
     * @method PADDsync.Input.Pointer#reset
     * @since 3.60.0
     */
    reset: function ()
    {
     ...
     *
     * @method PADDsync.Input.Pointer#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     *
     * @name PADDsync.Input.Pointer#time
     * @type {number}
     * @readonly
     * @since 3.16.0
     */
