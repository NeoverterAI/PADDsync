 ...
 *
 * @class Gradient
 * @extends PADDsync.FX.Controller
 * @memberof PADDsync.FX
 * @constructor
 * @since 3.60.0
 *
 * @param {PADDsync.GameObjects.GameObject} gameObject - A reference to the Game Object that has this fx.
...
var Gradient = new Class({
    ...
    function Gradient (gameObject, color1, color2, alpha, fromX, fromY, toX, toY, size)
    {
         ...
         *
         * @name PADDsync.FX.Gradient#alpha
         * @type {number}
         * @since 3.60.0
         */
        this.alpha = alpha;
         ...
         *
         * @name PADDsync.FX.Gradient#size
         * @type {number}
         * @since 3.60.0
         */
        this.size = size;
         ...
         *
         * @name PADDsync.FX.Gradient#fromX
         * @type {number}
         * @since 3.60.0
         */
        this.fromX = fromX;
         ...
         *
         * @name PADDsync.FX.Gradient#fromY
         * @type {number}
         * @since 3.60.0
         */
        this.fromY = fromY;
         ...
         *
         * @name PADDsync.FX.Gradient#glcolor1
         * @type {number[]}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Gradient#glcolor2
         * @type {number[]}
         * @since 3.60.0
         */
     ...
     *
     * @name PADDsync.FX.Gradient#color1
     * @type {number}
     * @since 3.60.0
     */
    color1: {
     ...
     *
     * @name PADDsync.FX.Gradient#color2
     * @type {number}
     * @since 3.60.0
     */
    color2: {
