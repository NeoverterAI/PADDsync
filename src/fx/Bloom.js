...
var Bloom = new Class({
    ...
    function Bloom (gameObject, color, offsetX, offsetY, blurStrength, strength, steps)
    {
         ...
         *
         * @name PADDsync.FX.Bloom#offsetX
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Bloom#offsetY
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Bloom#blurStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Bloom#strength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Bloom#glcolor
         * @type {number[]}
         * @since 3.60.0
         */
        this.glcolor = [ 1, 1, 1 ];
