...
var Blur = new Class({
    ...
    function Blur (gameObject, quality, x, y, strength, color, steps)
    {
         ...
         *
         * @name PADDsync.FX.Blur#strength
         * @type {number}
         * @since 3.60.0
         */
