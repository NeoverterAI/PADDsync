...
var Glow = new Class({
    ...
    function Glow (gameObject, color, outerStrength, innerStrength, knockout)
    {
         ...
         *
         * @name PADDsync.FX.Glow#outerStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Glow#innerStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Glow#knockout
         * @type {number}
         * @since 3.60.0
         */
