...
var Controller = new Class({
    ...
    function Controller (type, gameObject)
    {
         ...
         *
         * @name PADDsync.FX.Controller#type
         * @type {number}
         * @since 3.60.0
         */
        this.type = type;
         ...
         *
         * @name PADDsync.FX.Controller#gameObject
         ...
         *
         * @name PADDsync.FX.Controller#active
         * @type {boolean}
         * @since 3.60.0
         */
        this.active = true;
     ...
     *
     * @method PADDsync.FX.Controller#setActive
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.FX.Controller#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
