...
var Shadow = new Class({
    ...
    function Shadow (gameObject, x, y, decay, power, color, samples, intensity)
    {
         ...
         *
         * @name PADDsync.FX.Shadow#glcolor
         * @type {number[]}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Shadow#samples
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Shadow#intensity
         * @type {number}
         * @since 3.60.0
         */
