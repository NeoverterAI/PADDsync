...
var Circle = new Class({
    ...
    function Circle (gameObject, thickness, color, backgroundColor, scale, feather)
    {
         ...
         *
         * @name PADDsync.FX.Circle#feather
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Circle#thickness
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Circle#glcolor
         * @type {number[]}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Circle#glcolor2
         * @type {number[]}
         * @since 3.60.0
         */
     ...
     *
     * @name PADDsync.FX.Circle#backgroundColor
     * @type {number}
     * @since 3.60.0
     */
    backgroundColor: {
     ...
     *
     * @name PADDsync.FX.Circle#backgroundAlpha
     * @type {number}
     * @since 3.70.0
     */
    backgroundAlpha: {
