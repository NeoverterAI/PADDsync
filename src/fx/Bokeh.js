...
var Bokeh = new Class({
    ...
    function Bokeh (gameObject, radius, amount, contrast, isTiltShift, blurX, blurY, strength)
    {
         ...
         *
         * @name PADDsync.FX.Bokeh#contrast
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Bokeh#isTiltShift
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.FX.Bokeh#strength
         * @type {number}
         * @since 3.60.0
         */
