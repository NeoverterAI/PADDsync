 ...
 *
 * @function PADDsync.Renderer.Canvas.SetTransform
 * @since 3.12.0
 *
 ...
 * @param {PADDsync.GameObjects.GameObject} src - The Game Object being rendered. Can be any type that extends the base class.
 * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera that is rendering the Game Object.
 * @param {PADDsync.GameObjects.Components.TransformMatrix} [parentMatrix] - A parent transform matrix to apply to the Game Object before rendering.
 *
