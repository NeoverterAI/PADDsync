 ...
 * @memberof PADDsync.Renderer.Canvas
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - The Phaser Game instance that owns this renderer.
 */
var CanvasRenderer = new Class({
    ...
    function CanvasRenderer (game)
    {
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#config
         * @type {object}
         * @since 3.0.0
         */
        this.config = {
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#game
         * @type {PADDsync.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#type
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#drawCount
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = 0;
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = 0;
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#gameCanvas
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#gameContext
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#currentContext
         * @type {CanvasRenderingContext2D}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#antialias
         * @type {boolean}
         * @since 3.20.0
         */
         ...
         *
         * This object maps the {@link PADDsync.BlendModes} to canvas compositing operations.
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#blendModes
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#snapshotState
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#_tempMatrix1
         * @private
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#_tempMatrix2
         * @private
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @since 3.11.0
         */
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#_tempMatrix3
         * @private
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Renderer.Canvas.CanvasRenderer#isBooted
         * @type {boolean}
         * @since 3.50.0
         */
        this.isBooted = false;
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#init
     * @since 3.0.0
     */
    init: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#boot
     * @private
     * @since 3.50.0
     */
    boot: function ()
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#onResize
     * @since 3.16.0
     *
     * @param {PADDsync.Structs.Size} gameSize - The default Game Size object. This is the un-modified game dimensions.
     * @param {PADDsync.Structs.Size} baseSize - The base Size object. The game dimensions multiplied by the resolution. The canvas width / height values match this.
     */
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#resize
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#resetTransform
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#setBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#setContext
     * @since 3.12.0
     *
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#setAlpha
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#preRender
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#render
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#postRender
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#snapshotCanvas
     * @since 3.19.0
     *
     ...
     * more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#snapshot
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot image is created.
     * @param {string} [type='image/png'] - The format of the image to create, usually `image/png` or `image/jpeg`.
     ...
     * more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#snapshotArea
     * @since 3.16.0
     *
     ...
     * using less memory.
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#snapshotPixel
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#batchSprite
     * @since 3.12.0
     *
     * @param {PADDsync.GameObjects.GameObject} sprite - The texture based Game Object to draw.
     * @param {PADDsync.Textures.Frame} frame - The frame to draw, doesn't have to be that owned by the Game Object.
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera to use for the rendering transform.
     * @param {PADDsync.GameObjects.Components.TransformMatrix} [parentTransformMatrix] - The transform matrix of the parent container, if set.
     */
     ...
     *
     * @method PADDsync.Renderer.Canvas.CanvasRenderer#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
