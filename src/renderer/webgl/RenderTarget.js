 ...
 * @since 3.50.0
 *
 * @param {PADDsync.Renderer.WebGL.WebGLRenderer} renderer - A reference to the WebGLRenderer.
...
var RenderTarget = new Class({
    ...
    function RenderTarget (renderer, width, height, scale, minFilter, autoClear, autoResize, addDepthBuffer, forceClamp)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#renderer
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#framebuffer
         ...
         * This is created in the `RenderTarget.resize` method.
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#texture
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#width
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#height
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#scale
         * @type {number}
         * @since 3.50.0
         */
        this.scale = scale;
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#minFilter
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#autoClear
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#autoResize
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#hasDepthBuffer
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.RenderTarget#forceClamp
         * @type {boolean}
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.RenderTarget#init
     * @since 3.86.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.RenderTarget#setAutoResize
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.RenderTarget#resize
     * @since 3.50.0
     *
     * @param {number} width - The new width of this Render Target.
     * @param {number} height - The new height of this Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.RenderTarget#willResize
     * @since 3.70.0
     *
     * @param {number} width - The new width of this Render Target.
     * @param {number} height - The new height of this Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.RenderTarget#bind
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.RenderTarget#adjustViewport
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.RenderTarget#clear
     * @since 3.50.0
     */
     ...
     *
     * @name PADDsync.Renderer.WebGL.RenderTarget#unbind
     * @since 3.50.0
     *
     ...
     *
     * @name PADDsync.Renderer.WebGL.RenderTarget#destroy
     * @since 3.50.0
     */
    destroy: function ()
    {
