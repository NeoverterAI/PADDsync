 ...
 * @since 3.50.0
 *
 * @param {PADDsync.Renderer.WebGL.WebGLPipeline} pipeline - The WebGLPipeline to which this Shader belongs.
 ...
 * @param {PADDsync.Types.Renderer.WebGL.WebGLPipelineAttributeConfig[]} attributes - An array of attributes.
 */
var WebGLShader = new Class({
    ...
    function WebGLShader (pipeline, name, vertexShader, fragmentShader, attributes)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#pipeline
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#name
         * @type {string}
         * @since 3.50.0
         */
        this.name = name;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#renderer
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#gl
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#fragSrc
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#vertSrc
         * @type {string}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#program
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#attributes
         * @type {PADDsync.Types.Renderer.WebGL.WebGLPipelineAttribute[]}
         * @since 3.50.0
         */
        this.attributes;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#vertexComponentCount
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#vertexSize
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLShader#uniforms
         * @type {PADDsync.Types.Renderer.WebGL.WebGLPipelineUniformsConfig}
         * @since 3.50.0
         */
        this.uniforms = {};
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#createAttributes
     * @since 3.50.0
     *
     * @param {PADDsync.Types.Renderer.WebGL.WebGLPipelineAttributeConfig[]} attributes - An array of attributes configs.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#bind
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#rebind
     * @since 3.50.0
     *
     * @return {this} This WebGLShader instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setAttribPointers
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#createUniforms
     * @since 3.50.0
     *
     * @return {this} This WebGLShader instance.
     */
     ...
     * re-populate them.
     * 
     * @method PADDsync.Renderer.WebGL.WebGLShader#syncUniforms
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#hasUniform
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#resetUniform
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setUniform1
     * @since 3.50.0
     *
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setUniform2
     * @since 3.50.0
     *
     * @param {function} setter - The GL function to call.
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setUniform3
     * @since 3.50.0
     *
     * @param {function} setter - The GL function to call.
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setUniform4
     * @since 3.50.0
     *
     * @param {function} setter - The GL function to call.
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setBoolean
     * @since 3.60.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set1f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set2f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set3f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set4f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set1fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set2fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set3fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set4fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set1iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set2iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set3iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set4iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set1i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set2i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set3i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#set4i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number} x - X component of the uniform
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setMatrix2fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setMatrix3fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {boolean} transpose - Whether to transpose the matrix. Should be `false`.
     ...
     * one within the pipeline it belongs to.
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#setMatrix4fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#createProgram
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLShader#destroy
     * @since 3.50.0
     */
    destroy: function ()
    {
