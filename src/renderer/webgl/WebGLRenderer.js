 ...
 *
 * @param {PADDsync.Renderer.WebGL.WebGLRenderer} renderer - The WebGL Renderer which owns the context.
 */
 ...
 * any context change that happens for WebGL rendering inside of PADDsync. This means
 ...
 * @memberof PADDsync.Renderer.WebGL
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - The Game instance which owns this WebGL Renderer.
 */
var WebGLRenderer = new Class({
    ...
    function WebGLRenderer (game)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#config
         * @type {object}
         * @since 3.0.0
         */
        this.config = {
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#game
         * @type {PADDsync.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#type
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#pipelines
         * @type {PADDsync.Renderer.WebGL.PipelineManager}
         * @since 3.50.0
         */
        this.pipelines = null;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = 0;
         ...
         * This is populated in the onResize event handler.
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#canvas
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#blendModes
         * @type {array}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#contextLost
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#snapshotState
         * @type {PADDsync.Types.Renderer.Snapshot.SnapshotState}
         * @since 3.0.0
         */
        this.snapshotState = {
            x: 0,
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#maxTextures
         * @type {number}
         * @since 3.50.0
         */
        this.maxTextures = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#textureIndexes
         * @type {array}
         * @since 3.50.0
         */
        this.textureIndexes;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#glBufferWrappers
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#glProgramWrappers
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#glTextureWrappers
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#glFramebufferWrappers
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#glAttribLocationWrappers
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#glUniformLocationWrappers
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper[]}
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#currentFramebuffer
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#fboStack
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper[]}
         * @since 3.50.0
         */
        this.fboStack = [];
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#currentProgram
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#currentBlendMode
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#currentScissorEnabled
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#currentScissor
         * @type {Uint32Array}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#scissorStack
         * @type {Uint32Array}
         * @since 3.0.0
         */
        this.scissorStack = [];
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#contextLostHandler
         * @type {function}
         * @since 3.19.0
         */
         ...
         * This should not be changed and is set in the init method.
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#contextRestoredHandler
         * @type {function}
         * @since 3.19.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#previousContextLostHandler
         * @type {function}
         * @since 3.19.0
         */
         ...
         * This is set when `setContextHandlers` is called.
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#previousContextRestoredHandler
         * @type {function}
         * @since 3.19.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#gl
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#supportedExtensions
         * @type {string[]}
         * @default null
         * @since 3.0.0
         */
         ...
         * This is populated in the `setExtensions` method.
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#instancedArraysExtension
         ...
         * This is populated in the `setExtensions` method.
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#vaoExtension
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#extensions
         * @type {object}
         * @default {}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#glFormats
         * @type {array}
         * @since 3.2.0
         */
        this.glFormats;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#compression
         * @type {PADDsync.Types.Renderer.WebGL.WebGLTextureCompression}
         * @since 3.8.0
         */
        this.compression;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#drawingBufferHeight
         * @type {number}
         * @readonly
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#blankTexture
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper}
         * @readonly
         * @since 3.12.0
         */
         ...
         * This is set in the `boot` method.
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#normalTexture
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper}
         * @readonly
         * @since 3.80.0
         */
         ...
         * This is set in the `boot` method.
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#whiteTexture
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#maskCount
         * @type {number}
         * @since 3.17.0
         */
        this.maskCount = 0;
         ...
         * The mask stack.
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#maskStack
         * @type {PADDsync.Display.Masks.GeometryMask[]}
         * @since 3.17.0
         */
        this.maskStack = [];
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#currentMask
         * @type {any}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#currentCameraMask
         * @type {any}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#glFuncMap
         * @type {any}
         * @since 3.17.0
         */
        this.glFuncMap = null;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#currentType
         * @type {string}
         * @since 3.19.0
         */
        this.currentType = '';
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#newType
         * @type {boolean}
         * @since 3.19.0
         */
        this.newType = false;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#nextTypeMatch
         * @type {boolean}
         * @since 3.19.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#finalType
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#mipmapFilter
         * @type {GLenum}
         * @since 3.21.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#defaultScissor
         * @type {number[]}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#isBooted
         * @type {boolean}
         * @since 3.50.0
         */
        this.isBooted = false;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#renderTarget
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#projectionMatrix
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#projectionWidth
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#projectionHeight
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#maskSource
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#maskTarget
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#spector
         * @type {function}
         * @since 3.60.0
         */
        this.spector = null;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLRenderer#_debugCapture
         * @type {boolean}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#init
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#boot
     * @private
     * @since 3.11.0
     */
    boot: function ()
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#setExtensions
     * @since 3.85.2
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#setContextHandlers
     * @since 3.85.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#dispatchContextLost
     * @since 3.85.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#dispatchContextRestored
     * @since 3.85.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createTemporaryTextures
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#captureFrame
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#captureNextFrame
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#getFps
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#log
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#startCapture
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#stopCapture
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#onCapture
     * @private
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#onResize
     * @since 3.16.0
     *
     * @param {PADDsync.Structs.Size} gameSize - The default Game Size object. This is the un-modified game dimensions.
     * @param {PADDsync.Structs.Size} baseSize - The base Size object. The game dimensions. The canvas width / height values match this.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#beginCapture
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#endCapture
     * @since 3.50.0
     *
     * @return {PADDsync.Renderer.WebGL.RenderTarget} A reference to the WebGL Renderer Render Target.
     */
    endCapture: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#resize
     * @fires PADDsync.Renderer.Events#RESIZE
     * @since 3.0.0
     *
     ...
     * which formats it supports, see the `PADDsync.Renderer.WebGL.WebGLRenderer#compression` property instead.
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#getCompressedTextures
     * @since 3.60.0
     *
     * @return {PADDsync.Types.Renderer.WebGL.WebGLTextureCompression} The compression object.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#getCompressedTextureName
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#supportsCompressedTexture
     * @since 3.60.0
     *
     * @param {string} baseFormat - The Base Format to check.
     * @param {GLenum} [format] - An optional GLenum format to check within the base format.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#getAspectRatio
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#setProjectionMatrix
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#resetProjectionMatrix
     * @since 3.50.0
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#hasExtension
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#getExtension
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#flush
     * @since 3.0.0
     */
    flush: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#pushScissor
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#setScissor
     * @since 3.0.0
     *
     * @param {number} x - The x position of the scissor.
     * @param {number} y - The y position of the scissor.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#resetScissor
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#popScissor
     * @since 3.0.0
     */
    popScissor: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#hasActiveStencilMask
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#resetViewport
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#setBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#addBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#updateBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#removeBlendMode
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#pushFramebuffer
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper} framebuffer - The framebuffer that needs to be bound.
     ...
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [texture=null] - Bind the given frame buffer texture?
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#setFramebuffer
     * @since 3.0.0
     *
     * @param {(PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper|null)} framebuffer - The framebuffer that needs to be bound, or `null` to bind back to the default framebuffer.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#popFramebuffer
     * @since 3.50.0
     *
     * @param {boolean} [updateScissor=false] - If a framebuffer is given, set the gl scissor to match the frame buffer size? Or, if `null` given, pop the scissor from the stack.
     * @param {boolean} [setViewport=true] - Should the WebGL viewport be set?
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper} The Framebuffer that was set, or `null` if there aren't any more in the stack.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#restoreFramebuffer
     * @since 3.60.0
     *
     * @param {boolean} [updateScissor=false] - If a framebuffer is given, set the gl scissor to match the frame buffer size? Or, if `null` given, pop the scissor from the stack.
     * @param {boolean} [setViewport=true] - Should the WebGL viewport be set?
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#setProgram
     * @since 3.0.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The program that needs to be bound.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#resetProgram
     * @since 3.50.0
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createTextureFromSource
     * @since 3.0.0
     *
     ...
     *
     * @return {?PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The WebGLTextureWrapper that was created, or `null` if it couldn't be created.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createTexture2D
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The WebGLTextureWrapper that was created.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createFramebuffer
     * @since 3.0.0
     *
     ...
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} renderTexture - The color texture where the color pixels are written.
     * @param {boolean} [addDepthStencilBuffer=false] - Create a Renderbuffer for the depth stencil?
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper} Wrapped framebuffer which is safe to use with the renderer.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#beginBitmapMask
     * @since 3.60.0
     *
     * @param {PADDsync.Display.Masks.BitmapMask} mask - The BitmapMask instance that called beginMask.
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The camera rendering the current mask.
     */
     ...
     * The framebuffer for the masked object is also bound for further use.
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#drawBitmapMask
     * @since 3.60.0
     *
     * @param {PADDsync.Display.Masks.BitmapMask} mask - The BitmapMask instance that called beginMask.
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The camera rendering the current mask.
     * @param {PADDsync.Renderer.WebGL.Pipelines.BitmapMaskPipeline} bitmapMaskPipeline - The BitmapMask Pipeline instance that is requesting the draw.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createProgram
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper} The wrapped, linked WebGLProgram created from the given shader source.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createVertexBuffer
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper} Wrapped vertex buffer
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createAttribLocation
     * @since 3.80.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The WebGLProgramWrapper instance.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createUniformLocation
     * @since 3.80.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The WebGLProgramWrapper instance.
     ...
     * Wrapper for creating a vertex buffer.
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createIndexBuffer
     * @since 3.0.0
     *
     * @param {ArrayBuffer} initialDataOrSize - Either ArrayBuffer or an integer indicating the size of the vbo.
     * @param {number} bufferUsage - How the buffer is used. gl.DYNAMIC_DRAW, gl.STATIC_DRAW or gl.STREAM_DRAW.
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper} Wrapped index buffer
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#deleteTexture
     * @since 3.0.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The WebGL Texture to be deleted.
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#deleteFramebuffer
     * @since 3.0.0
     *
     * @param {(PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper|null)} framebuffer - The Framebuffer to be deleted.
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#deleteProgram
     * @since 3.0.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The shader program to be deleted.
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#deleteAttribLocation
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper} attrib - The attrib location to be deleted.
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#deleteUniformLocation
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper} uniform - The uniform location to be deleted.
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#deleteBuffer
     * @since 3.0.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper} vertexBuffer - The WebGLBuffer to be deleted.
     *
     * @return {this} This WebGLRenderer instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#preRenderCamera
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera to pre-render.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#getCurrentStencilMask
     * @private
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#postRenderCamera
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera to post-render.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#preRender
     * @fires PADDsync.Renderer.Events#PRE_RENDER_CLEAR
     * @fires PADDsync.Renderer.Events#PRE_RENDER
     * @since 3.0.0
     */
    preRender: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#render
     * @fires PADDsync.Renderer.Events#RENDER
     * @since 3.0.0
     *
     * @param {PADDsync.Scene} scene - The Scene to render.
     * @param {PADDsync.GameObjects.GameObject[]} children - An array of filtered Game Objects that can be rendered by the given Camera.
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Scene Camera to render with.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#postRender
     * @fires PADDsync.Renderer.Events#POST_RENDER
     * @since 3.0.0
     */
    postRender: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#clearStencilMask
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#restoreStencilMask
     * @since 3.60.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#snapshot
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot image is created.
     ...
     * which gets more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#snapshotArea
     * @since 3.16.0
     *
     ...
     * using less memory.
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#snapshotPixel
     * @since 3.16.0
     *
     ...
     * @param {PADDsync.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot pixel data is extracted.
     *
     * @return {this} This WebGL Renderer.
     */
     ...
     * which gets more expensive the larger the canvas size gets, so please be careful how you employ this in your game.
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#snapshotFramebuffer
     * @since 3.19.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper} framebuffer - The framebuffer to grab from.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#canvasToTexture
     * @since 3.0.0
     *
     * @param {HTMLCanvasElement} srcCanvas - The Canvas to create the WebGL Texture from
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [dstTexture] - The destination WebGLTextureWrapper to set.
     ...
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The newly created, or updated, WebGLTextureWrapper.
     */
     ...
     * Creates a new WebGL Texture based on the given Canvas Element.
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createCanvasTexture
     * @since 3.20.0
     *
     * @param {HTMLCanvasElement} srcCanvas - The Canvas to create the WebGL Texture from.
     * @param {boolean} [noRepeat=false] - Should this canvas be allowed to set `REPEAT` (such as for Text objects?)
     * @param {boolean} [flipY=false] - Should the WebGL Texture set `UNPACK_MULTIPLY_FLIP_Y`?
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The newly created WebGLTextureWrapper.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#updateCanvasTexture
     * @since 3.20.0
     *
     * @param {HTMLCanvasElement} srcCanvas - The Canvas to update the WebGL Texture from.
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} dstTexture - The destination WebGLTextureWrapper to update.
     * @param {boolean} [flipY=false] - Should the WebGL Texture set `UNPACK_MULTIPLY_FLIP_Y`?
     * @param {boolean} [noRepeat=false] - Should this canvas be allowed to set `REPEAT` (such as for Text objects?)
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The updated WebGLTextureWrapper. This is the same wrapper object as `dstTexture`.
     */
     ...
     * If the `dstTexture` parameter is given, the WebGL Texture is updated, rather than created fresh.
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#videoToTexture
     * @since 3.85.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createVideoTexture
     * @since 3.20.0
     *
     * @param {HTMLVideoElement} srcVideo - The Video to create the WebGL Texture from
     * @param {boolean} [noRepeat=false] - Should this canvas be allowed to set `REPEAT`?
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#updateVideoTexture
     * @since 3.20.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#createUint8ArrayTexture
     * @since 3.80.0
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#setTextureFilter
     * @since 3.0.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture to set the filter for.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#getMaxTextureSize
     * @since 3.8.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
