 ...
 * @since 3.50.0
 *
 * @param {PADDsync.Renderer.WebGL.WebGLRenderer} renderer - A reference to the WebGL Renderer that owns this Pipeline Manager.
 */
var PipelineManager = new Class({
    ...
    function PipelineManager (renderer)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#game
         * @type {PADDsync.Game}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#renderer
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#classes
         * @type {PADDsync.Structs.Map.<string, Class>}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#postPipelineClasses
         * @type {PADDsync.Structs.Map.<string, Class>}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#pipelines
         * @type {PADDsync.Structs.Map.<string, PADDsync.Renderer.WebGL.WebGLPipeline>}
         * @since 3.50.0
         */
         ...
         * 
         * @name PADDsync.Renderer.WebGL.PipelineManager#postPipelineInstances
         * @type {PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline[]}
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#default
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#current
         * @type {PADDsync.Renderer.WebGL.WebGLPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#previous
         * @type {PADDsync.Renderer.WebGL.WebGLPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#MULTI_PIPELINE
         * @type {PADDsync.Renderer.WebGL.Pipelines.MultiPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#BITMAPMASK_PIPELINE
         * @type {PADDsync.Renderer.WebGL.Pipelines.BitmapMaskPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#UTILITY_PIPELINE
         * @type {PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#MOBILE_PIPELINE
         * @type {PADDsync.Renderer.WebGL.Pipelines.MobilePipeline}
         * @default null
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#FX_PIPELINE
         * @type {PADDsync.Renderer.WebGL.Pipelines.FXPipeline}
         * @default null
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#fullFrame1
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#fullFrame2
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#halfFrame1
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#halfFrame2
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#renderTargets
         * @type {PADDsync.Renderer.WebGL.RenderTarget[]}
         * @since 3.60.0
         */
        this.renderTargets = [];
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#maxDimension
         * @type {number}
         * @since 3.60.0
         */
        this.maxDimension = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#frameInc
         * @type {number}
         * @since 3.60.0
         */
        this.frameInc = 32;
         ...
         *
         * @name PADDsync.Renderer.WebGL.PipelineManager#targetIndex
         * @type {number}
         * @since 3.60.0
         */
        this.targetIndex = 0;
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#boot
     * @since 3.50.0
     *
     * @param {PADDsync.Types.Core.PipelineConfig} pipelineConfig - The pipeline configuration object as set in the Game Config.
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#setDefaultPipeline
     * @since 3.60.0
     *
     * @param {(string|PADDsync.Renderer.WebGL.WebGLPipeline)} pipeline - Either the string-based name of the pipeline to get, or a pipeline instance to look-up.
     *
     * @return {PADDsync.Renderer.WebGL.WebGLPipeline} The pipeline instance that was set as default, or `undefined` if not found.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#add
     * @since 3.50.0
     *
     * @param {string} name - A unique string-based key for the pipeline within the manager.
     * @param {PADDsync.Renderer.WebGL.WebGLPipeline} pipeline - A pipeline _instance_ which must extend `WebGLPipeline`.
     *
     * @return {PADDsync.Renderer.WebGL.WebGLPipeline} The pipeline instance that was passed.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#addPostPipeline
     * @since 3.50.0
     *
     * @param {string} name - A unique string-based key for the pipeline within the manager.
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#flush
     * @since 3.50.0
     */
    flush: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#has
     * @since 3.50.0
     *
     * @param {(string|PADDsync.Renderer.WebGL.WebGLPipeline)} pipeline - Either the string-based name of the pipeline to get, or a pipeline instance to look-up.
     *
     ...
     * If no instance, or matching name, exists in this manager, it returns `undefined`.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#get
     * @since 3.50.0
     *
     * @param {(string|PADDsync.Renderer.WebGL.WebGLPipeline)} pipeline - Either the string-based name of the pipeline to get, or a pipeline instance to look-up.
     *
     * @return {PADDsync.Renderer.WebGL.WebGLPipeline} The pipeline instance, or `undefined` if not found.
     */
     ...
     * If no instance, or matching name, exists in this manager, it returns `undefined`.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#getPostPipeline
     * @since 3.50.0
     *
     * @param {(string|function|PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline)} pipeline - Either the string-based name of the pipeline to get, or a pipeline instance, or class to look-up.
     * @param {PADDsync.GameObjects.GameObject} [gameObject] - If this post pipeline is being installed into a Game Object or Camera, this is a reference to it.
     * @param {object} [config] - Optional pipeline data object that is set in to the `postPipelineData` property of this Game Object.
     *
     * @return {PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline} The pipeline instance, or `undefined` if not found.
     */
     ...
     * this manager.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#removePostPipeline
     * @since 3.80.0
     *
     * @param {PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline} pipeline - The pipeline instance to be removed.
     */
     ...
     * this manager.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#remove
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#set
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLPipeline} pipeline - The pipeline instance to be set as current.
     ...
     *
     * @return {PADDsync.Renderer.WebGL.WebGLPipeline} The pipeline that was set, or undefined if it couldn't be set.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#preBatch
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object about to be batched.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#postBatch
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object that was just added to the batch.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#preBatchCamera
     * @since 3.50.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera about to be rendered.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#postBatchCamera
     * @since 3.50.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera that was just rendered.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#isCurrent
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLPipeline} pipeline - The pipeline instance to be checked.
     * @param {PADDsync.Renderer.WebGL.WebGLShader} [currentShader] - The shader to set as being current.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#copyFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#copyToGame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The Render Target to draw from.
     */
     ...
     * The copy itself is handled by the Utility Pipeline.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#drawFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     * @param {boolean} [clearAlpha=true] - Clear the alpha channel when running `gl.clear` on the target?
     * @param {PADDsync.Display.ColorMatrix} [colorMatrix] - The Color Matrix to use when performing the draw.
     *
     * @return {this} This Pipeline Manager instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#blendFrames
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     ...
     * The draw itself is handled by the Utility Pipeline.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#blendFramesAdditive
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#clearFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The Render Target to clear.
     * @param {boolean} [clearAlpha=true] - Clear the alpha channel when running `gl.clear` on the target?
     *
     * @return {this} This Pipeline Manager instance.
     */
     ...
     * You can optionally set the brightness factor of the copy.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#blitFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     * place.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#copyFrameRect
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#forceZero
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#setMulti
     * @since 3.50.0
     *
     * @return {PADDsync.Renderer.WebGL.Pipelines.MultiPipeline} The Multi Pipeline instance.
     */
    setMulti: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#setUtility
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLShader} [currentShader] - The shader to set as being current.
     *
     * @return {PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline} The Utility Pipeline instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#setFX
     * @since 3.60.0
     *
     * @return {PADDsync.Renderer.WebGL.Pipelines.FXPipeline} The FX Pipeline instance.
     */
    setFX: function ()
    {
     ...
     * 
     * @method PADDsync.Renderer.WebGL.PipelineManager#restoreContext
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#rebind
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLPipeline} [pipeline] - The pipeline instance to be rebound. If not given, the previous pipeline will be bound.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#clear
     * @since 3.50.0
     */
    clear: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#getRenderTarget
     * @since 3.60.0
     *
     * @param {number} size - The maximum dimension required.
     *
     * @return {PADDsync.Renderer.WebGL.RenderTarget} A Render Target large enough to fit the sprite.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#getSwapRenderTarget
     * @since 3.60.0
     *
     * @return {PADDsync.Renderer.WebGL.RenderTarget} The Render Target swap frame.
     */
     ...
     * useful for double-buffer style effects such as blurs.
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#getAltSwapRenderTarget
     * @since 3.60.0
     *
     * @return {PADDsync.Renderer.WebGL.RenderTarget} The Render Target swap frame.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.PipelineManager#destroy
     * @since 3.50.0
     */
    destroy: function ()
    {
