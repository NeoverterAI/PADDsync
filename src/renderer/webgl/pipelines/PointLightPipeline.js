...
var PointLightPipeline = new Class({
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PointLightPipeline#batchPointLight
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.PointLight} light - The Point Light Game Object.
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The camera rendering the Point Light.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PointLightPipeline#batchLightVert
     * @since 3.50.0
     *
