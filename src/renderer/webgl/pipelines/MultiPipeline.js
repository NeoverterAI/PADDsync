...
var MultiPipeline = new Class({
    ...
    function MultiPipeline (config)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#_tempMatrix1
         * @private
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#_tempMatrix2
         * @private
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @since 3.11.0
         */
         ...
         * A temporary Transform Matrix, re-used internally during batching.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#_tempMatrix3
         * @private
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @since 3.11.0
         */
         ...
         * Shape Game Objects.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#calcMatrix
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @since 3.55.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#tempTriangle
         * @type {array}
         * @private
         * @since 3.55.0
         */
         ...
         * Cached stroke tint.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#strokeTint
         * @type {object}
         * @private
         * @since 3.55.0
         */
         ...
         * Cached fill tint.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#fillTint
         * @type {object}
         * @private
         * @since 3.55.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#currentFrame
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#firstQuad
         * @type {number[]}
         * @private
         * @since 3.55.0
         */
         ...
         * Internal path quad cache.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#prevQuad
         * @type {number[]}
         * @private
         * @since 3.55.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#polygonCache
         * @type {array}
         * @private
         * @since 3.55.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#boot
     * @since 3.50.0
     */
    boot: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchSprite
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchTexture
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchTextureFrame
     * @since 3.12.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchFillRect
     * @since 3.55.0
     *
     ...
     * @param {PADDsync.GameObjects.Components.TransformMatrix} currentMatrix - The current transform.
     * @param {PADDsync.GameObjects.Components.TransformMatrix} parentMatrix - The parent transform.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchFillTriangle
     * @since 3.55.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchStrokeTriangle
     * @since 3.55.0
     *
     * @param {number} x0 - Point 0 x coordinate.
     * @param {number} y0 - Point 0 y coordinate.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchFillPath
     * @since 3.55.0
     *
     * @param {PADDsync.Types.Math.Vector2Like[]} path - Collection of points that represent the path.
     * @param {PADDsync.GameObjects.Components.TransformMatrix} currentMatrix - The current transform.
     * @param {PADDsync.GameObjects.Components.TransformMatrix} parentMatrix - The parent transform.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchStrokePath
     * @since 3.55.0
     *
     * @param {PADDsync.Types.Math.Vector2Like[]} path - Collection of points that represent the path.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#batchLine
     * @since 3.55.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.MultiPipeline#destroy
