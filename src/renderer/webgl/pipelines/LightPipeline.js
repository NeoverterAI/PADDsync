 ...
 *
 * @class LightPipeline
 * @extends PADDsync.Renderer.WebGL.Pipelines.MultiPipeline
...
var LightPipeline = new Class({
    ...
    function LightPipeline (config)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.LightPipeline#inverseRotationMatrix
         * @type {Float32Array}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.LightPipeline#currentNormalMap;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.LightPipeline#lightsActive
         * @type {boolean}
         * @readonly
         * @since 3.53.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.LightPipeline#tempVec2
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.LightPipeline#_tempMatrix
         ...
         * A temporary Transform Matrix used for parent Container calculations without them needing their own local copy.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.LightPipeline#_tempMatrix2
         * @type {PADDsync.GameObjects.Components.TransformMatrix}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#boot
     * @since 3.11.0
     */
    boot: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#onRender
     * @ignore
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#setNormalMapRotation
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#setTexture2D
     * @ignore
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [texture] - Texture that will be assigned to the current batch. If not given uses blankTexture.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#setGameObject
     * @ignore
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object being rendered or added to the batch.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLRenderer#isNewNormalMap
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The diffuse texture.
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} normalMap - The normal map texture.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#getNormalMap
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} [gameObject] - The Game Object to get the normal map from.
     *
     * @return {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The normal map texture.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#batchSprite
     * @since 3.50.0
     *
     * @param {(PADDsync.GameObjects.Image|PADDsync.GameObjects.Sprite)} gameObject - The texture based Game Object to add to the batch.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#batchTexture
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - Source GameObject.
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - Texture associated with the quad.
     ...
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - Current used camera.
     * @param {PADDsync.GameObjects.Components.TransformMatrix} parentTransformMatrix - Parent container.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.LightPipeline#batchTextureFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Textures.Frame} frame - The Texture Frame to be rendered.
     ...
     * @param {PADDsync.GameObjects.Components.TransformMatrix} transformMatrix - The Transform Matrix to use for the texture.
     * @param {PADDsync.GameObjects.Components.TransformMatrix} [parentTransformMatrix] - A parent Transform Matrix.
     */
