...
var ShineFrag = require('../../shaders/FXShine-frag');
...
var ShineFXPipeline = new Class({
    ...
    function ShineFXPipeline (game)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.ShineFXPipeline#speed
         * @type {number}
         * @since 3.60.0
         */
        this.speed = 0.5;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.ShineFXPipeline#lineWidth
         * @type {number}
         * @since 3.60.0
         */
        this.lineWidth = 0.5;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.ShineFXPipeline#gradient
         * @type {number}
         * @since 3.60.0
         */
        this.gradient = 3;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.ShineFXPipeline#reveal
         * @type {boolean}
         * @since 3.60.0
         */
        this.reveal = false;
