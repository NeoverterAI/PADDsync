 ...
 * @extends PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline
 * @memberof PADDsync.Renderer.WebGL.Pipelines.FX
 * @constructor
 * @since 3.60.0
 *
...
var GradientFXPipeline = new Class({
    ...
    function GradientFXPipeline (game)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GradientFXPipeline#alpha
         * @type {number}
         * @since 3.60.0
         */
        this.alpha = 0.2;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GradientFXPipeline#size
         * @type {number}
         * @since 3.60.0
         */
        this.size = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GradientFXPipeline#fromX
         * @type {number}
         * @since 3.60.0
         */
        this.fromX = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GradientFXPipeline#fromY
         * @type {number}
         * @since 3.60.0
         */
        this.fromY = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GradientFXPipeline#toX
         * @type {number}
         * @since 3.60.0
         */
        this.toX = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GradientFXPipeline#toY
         * @type {number}
         * @since 3.60.0
         */
        this.toY = 1;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GradientFXPipeline#glcolor1
         * @type {number[]}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GradientFXPipeline#glcolor2
         * @type {number[]}
         * @since 3.60.0
         */
