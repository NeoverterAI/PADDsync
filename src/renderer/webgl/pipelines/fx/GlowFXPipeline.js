...
var GlowFXPipeline = new Class({
    ...
    function GlowFXPipeline (game, config)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GlowFXPipeline#outerStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GlowFXPipeline#innerStrength
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GlowFXPipeline#knockout
         * @type {number}
         * @since 3.60.0
         */
        this.knockout = false;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.GlowFXPipeline#glcolor
         * @type {number[]}
         * @since 3.60.0
         */
