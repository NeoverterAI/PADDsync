...
var DisplacementFXPipeline = new Class({
    ...
    function DisplacementFXPipeline (game)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.DisplacementFXPipeline#x
         * @type {number}
         * @since 3.60.0
         */
        this.x = 0.005;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.DisplacementFXPipeline#y
         * @type {number}
         * @since 3.60.0
         */
        this.y = 0.005;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.FX.DisplacementFXPipeline#glTexture
