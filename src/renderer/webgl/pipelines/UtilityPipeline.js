...
var UtilityPipeline = new Class({
    ...
    function UtilityPipeline (config)
    {
         ...
         * isn't provided.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#colorMatrix
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#copyShader
         ...
         * This property is set during the `boot` method.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#addShader
         * @type {PADDsync.Renderer.WebGL.WebGLShader}
         * @since 3.50.0
         */
        this.addShader;
         ...
         * This property is set during the `boot` method.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#linearShader
         * @type {PADDsync.Renderer.WebGL.WebGLShader}
         * @since 3.50.0
         */
        this.linearShader;
         ...
         * This property is set during the `boot` method.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#colorMatrixShader
         * @type {PADDsync.Renderer.WebGL.WebGLShader}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#fullFrame1
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#fullFrame2
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
        this.fullFrame2;
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#halfFrame1
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
        this.halfFrame1;
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#halfFrame2
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
        this.halfFrame2;
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#copyFrame
     * @since 3.50.0
     *
     ...
     * You can optionally set the brightness factor of the copy.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#blitFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     * place.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#copyFrameRect
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#copyToGame
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#drawFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#blendFrames
     * @since 3.50.0
     *
     ...
     * @param {boolean} [clearAlpha=true] - Clear the alpha channel when running `gl.clear` on the target?
     * @param {PADDsync.Renderer.WebGL.WebGLShader} [blendShader] - The shader to use during the blend copy.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#blendFramesAdditive
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#clearFrame
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#setUVs
     * @since 3.50.0
     *
     ...
     * Be sure to call `resetUVs` once you have finished manipulating the UV coordinates.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#setTargetUVs
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     * Be sure to call `resetUVs` once you have finished manipulating the UV coordinates.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#flipX
     * @since 3.50.0
     */
    flipX: function ()
    {
     ...
     * Be sure to call `resetUVs` once you have finished manipulating the UV coordinates.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#flipY
     * @since 3.50.0
     */
    flipY: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.UtilityPipeline#resetUVs
     * @since 3.50.0
     */
    resetUVs: function ()
    {
