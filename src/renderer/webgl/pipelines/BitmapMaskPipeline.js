...
var BitmapMaskPipeline = new Class({
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.BitmapMaskPipeline#beginMask
     * @since 3.0.0
     *
     * @param {PADDsync.Display.Masks.BitmapMask} mask - The BitmapMask instance that called beginMask.
     * @param {PADDsync.GameObjects.GameObject} maskedObject - GameObject masked by the mask GameObject.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.BitmapMaskPipeline#endMask
     * @since 3.0.0
     *
     * @param {PADDsync.Display.Masks.BitmapMask} mask - The BitmapMask instance that called endMask.
