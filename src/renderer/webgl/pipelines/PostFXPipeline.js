...
var PostFXPipeline = new Class({
    ...
    function PostFXPipeline (config)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#gameObject
         * @type {(PADDsync.GameObjects.GameObject|PADDsync.Cameras.Scene2D.Camera)}
         * @since 3.50.0
         */
        this.gameObject;
         ...
         * reference to it.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#controller
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#colorMatrix
         * @type {PADDsync.Display.ColorMatrix}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#fullFrame1
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#fullFrame2
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#halfFrame1
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
         ...
         * However, be aware that these targets are shared between all post fx pipelines.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#halfFrame2
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @default null
         * @since 3.50.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#bootFX
     * @since 3.70.0
     */
    bootFX: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#postBatch
     * @since 3.70.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#getController
     * @since 3.60.0
     *
     * @param {PADDsync.FX.Controller} [controller] - An FX Controller, or undefined.
     *
     * @return {PADDsync.FX.Controller|PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline} The FX Controller responsible, or this Pipeline.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#copySprite
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#copyFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#copyToGame
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#drawFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [target] - The target Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#blendFrames
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#blendFramesAdditive
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#clearFrame
     * @since 3.50.0
     *
     ...
     * You can optionally set the brightness factor of the copy.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#blitFrame
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     * place.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#copyFrameRect
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#bindAndDraw
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The Render Target to draw from.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [target] - The Render Target to draw to. If not set, it will pop the fbo from the stack.
     * @param {boolean} [clear=true] - Clear the target before copying? Only used if `target` parameter is set.
     * @param {boolean} [clearAlpha=true] - Clear the alpha channel when running `gl.clear` on the target?
     * @param {PADDsync.Renderer.WebGL.WebGLShader} [currentShader] - The shader to use during the draw.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PostFXPipeline#destroy
     * @since 3.60.0
     *
     * @return {this} This WebGLPipeline instance.
     */
