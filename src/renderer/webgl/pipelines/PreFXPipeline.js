 ...
 *
 * @class PreFXPipeline
 * @extends PADDsync.Renderer.WebGL.WebGLPipeline
 * @memberof PADDsync.Renderer.WebGL.Pipelines
 * @constructor
 * @since 3.60.0
 *
 * @param {PADDsync.Types.Renderer.WebGL.WebGLPipelineConfig} config - The configuration options for this pipeline.
 */
var PreFXPipeline = new Class({
    ...
    function PreFXPipeline (config)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#drawSpriteShader
         ...
         * This property is set during the `boot` method.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#copyShader
         * @type {PADDsync.Renderer.WebGL.WebGLShader}
         * @default null
         * @since 3.60.0
         */
         ...
         * This property is set during the `boot` method.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#gameShader
         * @type {PADDsync.Renderer.WebGL.WebGLShader}
         * @default null
         * @since 3.60.0
         */
         ...
         * This property is set during the `boot` method.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#colorMatrixShader
         * @type {PADDsync.Renderer.WebGL.WebGLShader}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#quadVertexData
         * @type {ArrayBuffer}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#quadVertexBuffer
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#quadVertexViewF32
         * @type {Float32Array}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#spriteBounds
         ...
         * A temporary Rectangle object re-used internally during sprite drawing.
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#targetBounds
         * @type {PADDsync.Geom.Rectangle}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#fsTarget
         ...
         *
         * @name PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#tempSprite
         * @type {PADDsync.GameObjects.Sprite}
         * @private
         * @since 3.60.0
         */
        this.tempSprite;
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#onResize
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#batchQuad
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#onDrawSprite
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.Sprite} gameObject - The Sprite being drawn.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The Render Target the Sprite will be drawn to.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#onCopySprite
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target being copied from.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target that will be copied to.
     * @param {PADDsync.GameObjects.Sprite} gameObject - The Sprite being copied.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#copySprite
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target being copied from.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target that will be copied to.
     ...
     * @param {PADDsync.Display.ColorMatrix} [colorMatrix] - Optional ColorMatrix to use when copying the Sprite.
     * @param {PADDsync.Renderer.WebGL.WebGLShader} [shader] - The shader to use to copy the target. Defaults to the `copyShader`.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#copy
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#blendFrames
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#blendFramesAdditive
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source1 - The first source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source2 - The second source Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#drawToGame
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The Render Target to draw to the game.
     */
     ...
     * This method should be the final thing called in your pipeline.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#copyToGame
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The Render Target to copy to the game.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#bindAndDraw
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The Render Target to draw to the game.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#onDraw
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The Render Target to draw to the game.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [swapTarget] - The Swap Render Target, useful for double-buffer effects.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [altSwapTarget] - The Swap Render Target, useful for double-buffer effects.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#setUVs
     * @since 3.60.0
     *
     ...
     * Be sure to call `resetUVs` once you have finished manipulating the UV coordinates.
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#setTargetUVs
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} source - The source Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} target - The target Render Target.
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#resetUVs
     * @since 3.60.0
     */
    resetUVs: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.Pipelines.PreFXPipeline#destroy
