 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Types.Renderer.WebGL.WebGLPipelineConfig} config - The configuration object for this WebGL Pipeline.
 */
var WebGLPipeline = new Class({
    ...
    function WebGLPipeline (config)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#name
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#game
         * @type {PADDsync.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#renderer
         * @type {PADDsync.Renderer.WebGL.WebGLRenderer}
         * @since 3.0.0
         */
         ...
         * to the manager.
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#manager
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#gl
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#view
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#vertexCount
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#vertexCapacity
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#vertexData
         * @type {ArrayBuffer}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#vertexBuffer
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#activeBuffer
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper}
         * @since 3.60.0
         */
        this.activeBuffer;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#topology
         * @type {GLenum}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#bytes
         * @type {Uint8Array}
         * @since 3.0.0
         */
        this.bytes;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#vertexViewF32
         * @type {Float32Array}
         * @since 3.0.0
         */
        this.vertexViewF32;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#vertexViewU32
         * @type {Uint32Array}
         * @since 3.0.0
         */
        this.vertexViewU32;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#active
         * @type {boolean}
         * @since 3.10.0
         */
        this.active = true;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#forceZero
         * @type {boolean}
         * @since 3.50.0
         */
         ...
         * fully ready.
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#hasBooted
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#isPostFX
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#isPreFX
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#renderTargets
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#currentRenderTarget
         * @type {PADDsync.Renderer.WebGL.RenderTarget}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#shaders
         * @type {PADDsync.Renderer.WebGL.WebGLShader[]}
         * @since 3.50.0
         */
        this.shaders = [];
         ...
         * an array look-up.
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#currentShader
         * @type {PADDsync.Renderer.WebGL.WebGLShader}
         * @since 3.50.0
         */
        this.currentShader;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#projectionMatrix
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#projectionWidth
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#projectionHeight
         * @type {number}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#config
         * @type {PADDsync.Types.Renderer.WebGL.WebGLPipelineConfig}
         * @since 3.50.0
         */
        this.config = config;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#glReset
         * @type {boolean}
         * @since 3.53.0
         */
        this.glReset = false;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#batch
         * @type {PADDsync.Types.Renderer.WebGL.WebGLPipelineBatchEntry[]}
         * @since 3.60.0
         */
        this.batch = [];
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#currentBatch
         * @type {?PADDsync.Types.Renderer.WebGL.WebGLPipelineBatchEntry}
         * @since 3.60.0
         */
         ...
         * Treat this value as read-only.
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#currentTexture
         ...
         * Treat this value as read-only.
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#currentUnit
         * @type {number}
         * @since 3.50.0
         */
        this.currentUnit = 0;
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#activeTextures
         * @type {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper[]}
         * @since 3.60.0
         */
        this.activeTextures = [];
         ...
         *
         * @name PADDsync.Renderer.WebGL.WebGLPipeline#resizeUniform
         * @type {string}
         * @since 3.80.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#boot
     * @fires PADDsync.Renderer.WebGL.Pipelines.Events#BOOT
     * @since 3.11.0
     */
    boot: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onBoot
     * @since 3.50.0
     */
    onBoot: function ()
    {
     ...
     * changes size.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onResize
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setShader
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLShader} shader - The shader to set as being current.
     * @param {boolean} [setAttributes=false] - Should the vertex attribute pointers be set?
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper} [vertexBuffer] - The vertex buffer to be set before the shader is bound. Defaults to the one owned by this pipeline.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#getShaderByName
     * @since 3.50.0
     *
     * @param {string} name - The index of the shader to set.
     *
     * @return {PADDsync.Renderer.WebGL.WebGLShader} The WebGLShader instance, if found.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setShadersFromConfig
     * @since 3.50.0
     *
     * @param {PADDsync.Types.Renderer.WebGL.WebGLPipelineConfig} config - The configuration object for this WebGL Pipeline.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#createBatch
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture assigned to this batch entry.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#addTextureToBatch
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture assigned to this batch entry.
     */
     ...
     * advanced.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#pushBatch
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} texture - The texture assigned to this batch entry.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setGameObject
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object being rendered or added to the batch.
     * @param {PADDsync.Textures.Frame} [frame] - Optional frame to use. Can override that of the Game Object.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#shouldFlush
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#vertexAvailable
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#resize
     * @fires PADDsync.Renderer.WebGL.Pipelines.Events#RESIZE
     * @since 3.0.0
     *
     * @param {number} width - The new width of this WebGL Pipeline.
     * @param {number} height - The new height of this WebGL Pipeline.
     ...
     * This method is called automatically by the renderer during its resize handler.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setProjectionMatrix
     * @since 3.50.0
     *
     * @param {number} width - The new width of this WebGL Pipeline.
     * @param {number} height - The new height of this WebGL Pipeline.
     ...
     * them back again.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#flipProjectionMatrix
     * @since 3.60.0
     *
     ...
     * pipeline is set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#updateProjectionMatrix
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#bind
     * @fires PADDsync.Renderer.WebGL.Pipelines.Events#BIND
     * @since 3.0.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLShader} [currentShader] - The shader to set as being current.
     *
     * @return {this} This WebGLPipeline instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#rebind
     * @fires PADDsync.Renderer.WebGL.Pipelines.Events#REBIND
     * @since 3.0.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLShader} [currentShader] - The shader to set as being current.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#restoreContext
     * @since 3.80.0
     */
     ...
     * binds itself if not.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setVertexBuffer
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper} [buffer] - The Vertex Buffer to be bound. Defaults to the one owned by this pipeline.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#preBatch
     * @since 3.50.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.Cameras.Scene2D.Camera)} [gameObject] - The Game Object or Camera that invoked this pipeline, if any.
     *
     * @return {this} This WebGLPipeline instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#postBatch
     * @since 3.50.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.Cameras.Scene2D.Camera)} [gameObject] - The Game Object or Camera that invoked this pipeline, if any.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onDraw
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} renderTarget - The Render Target.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [swapTarget] - A Swap Render Target, useful for double-buffer effects. Only set by SpriteFX Pipelines.
     */
    onDraw: function ()
    {
    },
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#unbind
     * @since 3.50.0
     */
    unbind: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#flush
     * @fires PADDsync.Renderer.WebGL.Pipelines.Events#BEFORE_FLUSH
     * @fires PADDsync.Renderer.WebGL.Pipelines.Events#AFTER_FLUSH
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onActive
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLShader} currentShader - The shader that was set as current.
     */
    onActive: function ()
    {
    },
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onBind
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} [gameObject] - The Game Object that invoked this pipeline, if any.
     */
    onBind: function ()
    {
    },
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onRebind
     * @since 3.50.0
     */
    onRebind: function ()
    {
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onBatch
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} [gameObject] - The Game Object that invoked this pipeline, if any.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onPreBatch
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} [gameObject] - The Game Object that invoked this pipeline, if any.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onPostBatch
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject} [gameObject] - The Game Object that invoked this pipeline, if any.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onPreRender
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onRender
     * @since 3.50.0
     *
     * @param {PADDsync.Scene} scene - The Scene being rendered.
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Scene Camera being rendered with.
     */
    onRender: function ()
    {
    },
     ...
     * been rendered.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onPostRender
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onBeforeFlush
     * @since 3.50.0
     *
     * @param {boolean} [isPostFlush=false] - Was this flush invoked as part of a post-process, or not?
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#onAfterFlush
     * @since 3.50.0
     *
     * @param {boolean} [isPostFlush=false] - Was this flush invoked as part of a post-process, or not?
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#batchVert
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#batchQuad
     * @since 3.50.0
     *
     * @param {(PADDsync.GameObjects.GameObject|null)} gameObject - The Game Object, if any, drawing this quad.
     ...
     * @param {(number|boolean)} tintEffect - The tint effect for the shader to use.
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [texture] - Texture that will be assigned to the current batch if a flush occurs.
     ...
     * ```
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#batchTri
     * @since 3.50.0
     *
     * @param {(PADDsync.GameObjects.GameObject|null)} gameObject - The Game Object, if any, drawing this quad.
     * @param {number} x1 - The bottom-left x position.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#drawFillRect
     * @since 3.50.0
     *
     ...
     * the unit id.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setTexture2D
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [texture] - Texture that will be assigned to the current batch. If not given uses `whiteTexture`.
     *
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#bindTexture
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} [target] - Texture to activate and bind.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#bindRenderTarget
     * @since 3.50.0
     *
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [target] - The Render Target to activate and bind.
     * @param {number} [unit=0] - The WebGL texture ID to activate. Defaults to `gl.TEXTURE0`.
     *
     * @return {this} This WebGL Pipeline instance.
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setTime
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {PADDsync.Renderer.WebGL.WebGLShader} [shader] - The shader to set the value on. If not given, the `currentShader` is used.
     *
     * @return {this} This WebGLPipeline instance.
     */
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setBoolean
     * @since 3.60.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set1f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set2f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set3f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set4f
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set1fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set2fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set3fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set4fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set1iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set2iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set3iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set4iv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number[]|Float32Array} arr - The new value to be used for the uniform variable.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set1i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set2i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set3i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#set4i
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {number} x - X component of the uniform.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setMatrix2fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setMatrix3fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {boolean} transpose - Whether to transpose the matrix. Should be `false`.
     ...
     * being set.
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#setMatrix4fv
     * @since 3.50.0
     *
     * @param {string} name - The name of the uniform to set.
     * @param {boolean} transpose - Whether to transpose the matrix. Should be `false`.
     ...
     *
     * @method PADDsync.Renderer.WebGL.WebGLPipeline#destroy
     * @fires PADDsync.Renderer.WebGL.Pipelines.Events#DESTROY
     * @since 3.0.0
     *
     * @return {this} This WebGLPipeline instance.
     */
