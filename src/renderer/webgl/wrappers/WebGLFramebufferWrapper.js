...
var WebGLFramebufferWrapper = new Class({
    ...
    function WebGLFramebufferWrapper (gl, width, height, renderTexture, addDepthStencilBuffer)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#webGLFramebuffer
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#gl
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#width
         * @type {number}
         * @since 3.80.0
         */
        this.width = width;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#height
         * @type {number}
         * @since 3.80.0
         */
        this.height = height;
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#renderTexture
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#addDepthStencilBuffer
         * @type {boolean}
         * @default false
         * @since 3.80.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#createResource
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLFramebufferWrapper#destroy
     * @since 3.80.0
     */
    destroy: function ()
    {
