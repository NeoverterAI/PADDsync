 ...
 * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper} program - The WebGLProgram that this location refers to. This must be created first.
...
var WebGLUniformLocationWrapper = new Class({
    ...
    function WebGLUniformLocationWrapper (gl, program, name)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#webGLUniformLocation
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#gl
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#program
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#name
         * @type {string}
         * @since 3.80.0
         */
        this.name = name;
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#createResource
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLUniformLocationWrapper#destroy
     * @since 3.80.0
     */
    destroy: function ()
    {
