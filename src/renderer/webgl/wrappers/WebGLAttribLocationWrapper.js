...
var WebGLAttribLocationWrapper = new Class({
    ...
    function WebGLAttribLocationWrapper (gl, program, name)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#webGLAttribLocation
         * @type {GLint}
         * @default -1
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#gl
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#program
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#name
         * @type {string}
         * @since 3.80.0
         */
        this.name = name;
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#createResource
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLAttribLocationWrapper#destroy
     * @since 3.80.0
     */
    destroy: function ()
    {
