...
var WebGLBufferWrapper = new Class({
    ...
    function WebGLBufferWrapper (gl, initialDataOrSize, bufferType, bufferUsage)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper#webGLBuffer
         * @type {?WebGLBuffer}
         * @default null
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper#gl
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper#initialDataOrSize
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper#bufferType
         * @type {GLenum}
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper#bufferUsage
         * @type {GLenum}
         * @since 3.80.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper#createResource
     * @since 3.80.0
     */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLBufferWrapper#destroy
     * @since 3.80.0
     */
    destroy: function ()
    {
