...
var WebGLProgramWrapper = new Class({
    ...
    function WebGLProgramWrapper (gl, vertexSource, fragmentSource)
    {
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper#webGLProgram
         * @type {?WebGLProgram}
         * @default null
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper#gl
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper#vertexSource
         * @type {string}
         * @since 3.80.0
         */
         ...
         *
         * @name PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper#fragmentSource
         * @type {string}
         * @since 3.80.0
         */
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper#createResource
     ...
     *
     * @method PADDsync.Renderer.WebGL.Wrappers.WebGLProgramWrapper#destroy
     * @since 3.80.0
     */
    destroy: function ()
    {
