/**
 * @typedef {object} PADDsync.Types.Renderer.Snapshot.SnapshotState
 * @since 3.16.1
 *
 * @property {PADDsync.Types.Renderer.Snapshot.SnapshotCallback} callback - The function to call after the snapshot is taken.
