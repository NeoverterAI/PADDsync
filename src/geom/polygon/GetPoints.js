 ...
 *
 * @function PADDsync.Geom.Polygon.GetPoints
 * @since 3.12.0
 *
 * @param {PADDsync.Geom.Polygon} polygon - The Polygon to get the points from.
 ...
 *
 * @return {PADDsync.Geom.Point[]} An array of Point objects pertaining to the points around the perimeter of the Polygon.
 */
