 ...
 *
 * @function PADDsync.Geom.Polygon.ContainsPoint
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Polygon} polygon - The Polygon to check.
 * @param {PADDsync.Geom.Point} point - The Point to check if it's within the Polygon.
 *
