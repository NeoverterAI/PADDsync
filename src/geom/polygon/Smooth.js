 ...
 *
 * @function PADDsync.Geom.Polygon.Smooth
 * @since 3.13.0
 *
 * @generic {PADDsync.Geom.Polygon} O - [polygon,$return]
 *
 * @param {PADDsync.Geom.Polygon} polygon - The polygon to be smoothed. The polygon will be modified in-place and returned.
 *
