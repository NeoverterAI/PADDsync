 ...
 *
 * @function PADDsync.Geom.Triangle.BuildFromPolygon
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Triangle[]} O - [out,$return]
 *
 ...
 * @param {(array|PADDsync.Geom.Triangle[])} [out] - An array to store the resulting Triangle instances in. If not provided, a new array is created.
 *
 * @return {(array|PADDsync.Geom.Triangle[])} An array of Triangle instances, where each triangle is based on the decomposed vertices data.
 */
