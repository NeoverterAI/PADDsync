 ...
 *
 * @function PADDsync.Geom.Triangle.GetPoints
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Point} O - [out,$return]
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to get the points from.
 ...
 * @param {(array|PADDsync.Geom.Point[])} [out] - An array to which the points should be appended.
 *
 * @return {(array|PADDsync.Geom.Point[])} The modified `out` array, or a new array if none was provided.
 */
