 ...
 *
 * @function PADDsync.Geom.Triangle.Centroid
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Point} O - [out,$return]
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to use.
 * @param {(PADDsync.Geom.Point|object)} [out] - An object to store the coordinates in.
 *
 * @return {(PADDsync.Geom.Point|object)} The `out` object with modified `x` and `y` properties, or a new Point if none was provided.
 */
