 ...
 *
 * @function PADDsync.Geom.Triangle.InCenter
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Point} O - [out,$return]
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to find the incenter of.
 * @param {PADDsync.Geom.Point} [out] - An optional Point in which to store the coordinates.
 *
 * @return {PADDsync.Geom.Point} Point (x, y) of the center pixel of the triangle.
 */
