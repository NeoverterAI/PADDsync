 ...
 *
 * @function PADDsync.Geom.Triangle.CircumCenter
 * @since 3.0.0
 *
 * @generic {PADDsync.Math.Vector2} O - [out,$return]
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to get the circumcenter of.
 * @param {PADDsync.Math.Vector2} [out] - The Vector2 object to store the position in. If not given, a new Vector2 instance is created.
 *
 * @return {PADDsync.Math.Vector2} A Vector2 object holding the coordinates of the circumcenter of the Triangle.
 */
