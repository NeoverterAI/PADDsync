 ...
 *
 * @function PADDsync.Geom.Triangle.Random
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Point} O - [out,$return]
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to get a random point from.
 * @param {PADDsync.Geom.Point} [out] - The Point object to store the position in. If not given, a new Point instance is created.
 *
 * @return {PADDsync.Geom.Point} A Point object holding the coordinates of a random position within the Triangle.
 */
