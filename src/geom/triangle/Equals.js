 ...
 *
 * @function PADDsync.Geom.Triangle.Equals
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Triangle} triangle - The first triangle to check.
 * @param {PADDsync.Geom.Triangle} toCompare - The second triangle to check.
 *
