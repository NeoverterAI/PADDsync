 ...
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to return the center coordinates of.
 *
 * @return {PADDsync.Math.Vector2} The center point of the Triangle according to the function.
 */

/**
 * Positions the Triangle so that it is centered on the given coordinates.
 *
 * @function PADDsync.Geom.Triangle.CenterOn
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Triangle} O - [triangle,$return]
 *
 * @param {PADDsync.Geom.Triangle} triangle - The triangle to be positioned.
 ...
 *
 * @return {PADDsync.Geom.Triangle} The Triangle that was centered.
 */
