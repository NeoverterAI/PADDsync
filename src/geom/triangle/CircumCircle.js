 ...
 *
 * @function PADDsync.Geom.Triangle.CircumCircle
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Circle} O - [out,$return]
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to use as input.
 * @param {PADDsync.Geom.Circle} [out] - An optional Circle to store the result in.
 *
 * @return {PADDsync.Geom.Circle} The updated `out` Circle, or a new Circle if none was provided.
 */
