 ...
 *
 * @function PADDsync.Geom.Rectangle.Inflate
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Rectangle} O - [rect,$return]
 *
 * @param {PADDsync.Geom.Rectangle} rect - The Rectangle to inflate.
 ...
 *
 * @return {PADDsync.Geom.Rectangle} The inflated Rectangle.
 */
