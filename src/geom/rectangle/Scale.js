 ...
 *
 * @function PADDsync.Geom.Rectangle.Scale
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Rectangle} O - [rect,$return]
 *
 * @param {PADDsync.Geom.Rectangle} rect - The `Rectangle` object that will be scaled by the specified amount(s).
 ...
 *
 * @return {PADDsync.Geom.Rectangle} The rectangle object with updated `width` and `height` properties as calculated from the scaling factor(s).
 */
