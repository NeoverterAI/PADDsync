 ...
 *
 * @function PADDsync.Geom.Rectangle.MergeXY
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Rectangle} O - [target,$return]
 *
 * @param {PADDsync.Geom.Rectangle} target - The Rectangle which should be merged and modified.
 ...
 *
 * @return {PADDsync.Geom.Rectangle} The modified `target` Rectangle.
 */
