 ...
 *
 * @function PADDsync.Geom.Rectangle.ContainsRect
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Rectangle} rectA - The first rectangle.
 * @param {PADDsync.Geom.Rectangle} rectB - The second rectangle.
 *
