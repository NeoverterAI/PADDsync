 ...
 *
 * @function PADDsync.Geom.Rectangle.FitOutside
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Rectangle} O - [target,$return]
 *
 * @param {PADDsync.Geom.Rectangle} target - The target rectangle to adjust.
 * @param {PADDsync.Geom.Rectangle} source - The source rectangle to envelope the target in.
 *
 * @return {PADDsync.Geom.Rectangle} The modified target rectangle instance.
 */
