 ...
 * ```
 *
 * @function PADDsync.Geom.Rectangle.FromPoints
 * @since 3.0.0
 *
 ...
 * @param {PADDsync.Geom.Rectangle} [out] - Optional Rectangle to adjust.
 *
 * @return {PADDsync.Geom.Rectangle} The adjusted `out` Rectangle, or a new Rectangle if none was provided.
 */
