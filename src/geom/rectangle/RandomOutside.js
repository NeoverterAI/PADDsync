 ...
 *
 * @function PADDsync.Geom.Rectangle.RandomOutside
 * @since 3.10.0
 *
 * @generic {PADDsync.Geom.Point} O - [out,$return]
 *
 * @param {PADDsync.Geom.Rectangle} outer - The outer Rectangle to get the random point within.
 * @param {PADDsync.Geom.Rectangle} inner - The inner Rectangle to exclude from the returned point.
 * @param {PADDsync.Geom.Point} [out] - A Point, or Point-like object to store the result in. If not specified, a new Point will be created.
 *
 * @return {PADDsync.Geom.Point} A Point object containing the random values in its `x` and `y` properties.
 */
