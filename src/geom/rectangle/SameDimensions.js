 ...
 *
 * @function PADDsync.Geom.Rectangle.SameDimensions
 * @since 3.15.0
 *
 * @param {PADDsync.Geom.Rectangle} rect - The first Rectangle object.
 * @param {PADDsync.Geom.Rectangle} toCompare - The second Rectangle object.
 *
