 ...
 *
 * @function PADDsync.Geom.Intersects.PointToLine
 * @since 3.0.0
 *
 * @param {(PADDsync.Geom.Point|any)} point - The point, or point-like object to check.
 * @param {PADDsync.Geom.Line} line - The line segment to test for intersection on.
