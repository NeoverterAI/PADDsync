 ...
 *
 * @function PADDsync.Geom.Intersects.GetTriangleToCircle
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to check for intersection.
 * @param {PADDsync.Geom.Circle} circle - The Circle to check for intersection.
