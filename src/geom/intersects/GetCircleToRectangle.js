 ...
 *
 * @function PADDsync.Geom.Intersects.GetCircleToRectangle
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Circle} circle - The circle to be checked.
 * @param {PADDsync.Geom.Rectangle} rect - The rectangle to be checked.
