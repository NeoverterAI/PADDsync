 ...
 *
 * @function PADDsync.Geom.Intersects.GetRectangleToTriangle
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Rectangle} rect - Rectangle object to test.
 * @param {PADDsync.Geom.Triangle} triangle - Triangle object to test.
