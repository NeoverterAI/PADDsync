 ...
 *
 * @function PADDsync.Geom.Intersects.GetTriangleToTriangle
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Triangle} triangleA - The first Triangle to check for intersection.
 * @param {PADDsync.Geom.Triangle} triangleB - The second Triangle to check for intersection.
