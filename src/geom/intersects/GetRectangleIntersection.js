 ...
 *
 * @function PADDsync.Geom.Intersects.GetRectangleIntersection
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Rectangle} O - [output,$return]
 *
 * @param {PADDsync.Geom.Rectangle} rectA - The first Rectangle object.
 * @param {PADDsync.Geom.Rectangle} rectB - The second Rectangle object.
 * @param {PADDsync.Geom.Rectangle} [output] - Optional Rectangle object. If given, the intersection data will be loaded into it (in case of no intersection, it will be left unchanged). Otherwise, new Rectangle object will be created and returned with either intersection data or empty (all values set to zero), if there is no intersection.
 *
 * @return {PADDsync.Geom.Rectangle} A rectangle object with intersection data.
 */
