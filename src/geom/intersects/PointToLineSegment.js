 ...
 *
 * @function PADDsync.Geom.Intersects.PointToLineSegment
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Point} point - The Point to check for intersection.
 * @param {PADDsync.Geom.Line} line - The line segment to check for intersection.
 *
