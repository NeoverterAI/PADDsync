 ...
 *
 * @function PADDsync.Geom.Intersects.GetRectangleToRectangle
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Rectangle} rectA - The first Rectangle to check for intersection.
 * @param {PADDsync.Geom.Rectangle} rectB - The second Rectangle to check for intersection.
