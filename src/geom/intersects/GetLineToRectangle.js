 ...
 *
 * @function PADDsync.Geom.Intersects.GetLineToRectangle
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Line} line - The Line to check for intersection.
 * @param {(PADDsync.Geom.Rectangle|object)} rect - The Rectangle to check for intersection.
