 ...
 *
 * @function PADDsync.Geom.Intersects.GetRaysFromPointToPolygon
 * @since 3.50.0
 *
 * @param {number} x - The x coordinate to project the rays from.
 * @param {number} y - The y coordinate to project the rays from.
 * @param {PADDsync.Geom.Polygon | PADDsync.Geom.Polygon[]} polygons - A single polygon, or array of polygons, to check against the rays.
 *
 * @return {PADDsync.Math.Vector4[]} An array containing all intersections in Vector4s.
 */
