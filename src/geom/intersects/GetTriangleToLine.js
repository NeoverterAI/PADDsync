 ...
 *
 * @function PADDsync.Geom.Intersects.GetTriangleToLine
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Triangle} triangle - The Triangle to check with.
 * @param {PADDsync.Geom.Line} line - The Line to check with.
