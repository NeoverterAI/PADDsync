 ...
 *
 * @function PADDsync.Geom.Mesh.GenerateGridVerts
 * @since 3.50.0
 *
 * @param {PADDsync.Types.Geom.Mesh.GenerateGridConfig} config - A Grid configuration object.
 *
 * @return {PADDsync.Types.Geom.Mesh.GenerateGridVertsResult} A Grid Result object, containing the generated vertices and indicies.
 */
