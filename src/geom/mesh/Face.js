...
var Face = new Class({
    ...
    function Face (vertex1, vertex2, vertex3)
    {
         ...
         *
         * @name PADDsync.Geom.Mesh.Face#vertex1
         ...
         *
         * @name PADDsync.Geom.Mesh.Face#vertex2
         * @type {PADDsync.Geom.Mesh.Vertex}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Geom.Mesh.Face#vertex3
         * @type {PADDsync.Geom.Mesh.Vertex}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Geom.Mesh.Face#bounds
         ...
         *
         * @name PADDsync.Geom.Mesh.Face#_inCenter
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#getInCenter
     * @since 3.50.0
     *
     * @param {boolean} [local=true] Return the in center from the un-transformed vertex positions (`true`), or transformed? (`false`)
     *
     * @return {PADDsync.Math.Vector2} A Vector2 containing the in center position of this Face.
     */
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#contains
     * @since 3.50.0
     *
     * @param {number} x - The horizontal position to check.
     * @param {number} y - The vertical position to check.
     * @param {PADDsync.GameObjects.Components.TransformMatrix} [calcMatrix] - Optional transform matrix to apply to the vertices before comparison.
     *
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#isCounterClockwise
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#load
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#transformCoordinatesLocal
     * @since 3.50.0
     *
     * @param {PADDsync.Math.Matrix4} transformMatrix - The transform matrix to apply to this vertex.
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#updateBounds
     * @since 3.50.0
     *
     * @return {this} This Face instance.
     */
     ...
     * rectangle.
     *
     * @method PADDsync.Geom.Mesh.Face#isInView
     * @since 3.50.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera to check against.
     ...
     * are updated.
     *
     * @method PADDsync.Geom.Mesh.Face#scrollUV
     * @since 3.60.0
     *
     ...
     * are updated.
     *
     * @method PADDsync.Geom.Mesh.Face#scaleUV
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#setColor
     * @since 3.60.0
     *
     ...
     * with the new translated values, updating their `tx`, `ty` and `ta` properties.
     *
     * @method PADDsync.Geom.Mesh.Face#update
     * @since 3.60.0
     *
     * @param {number} alpha - The alpha of the parent object.
     * @param {number} a - The parent transform matrix data a component.
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#translate
     * @since 3.50.0
     *
     ...
     *
     * @name PADDsync.Geom.Mesh.Face#x
     * @type {number}
     * @since 3.50.0
     */
    x: {
     ...
     *
     * @name PADDsync.Geom.Mesh.Face#y
     * @type {number}
     * @since 3.50.0
     */
    y: {
     ...
     *
     * @name PADDsync.Geom.Mesh.Face#alpha
     * @type {number}
     * @since 3.50.0
     */
    alpha: {
     ...
     *
     * @name PADDsync.Geom.Mesh.Face#depth
     * @type {number}
     * @readonly
     * @since 3.50.0
     */
     ...
     *
     * @method PADDsync.Geom.Mesh.Face#destroy
     * @since 3.50.0
     */
    destroy: function ()
    {
