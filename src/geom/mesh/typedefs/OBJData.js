/**
 * @typedef {object} PADDsync.Types.Geom.Mesh.OBJData
 * @since 3.50.0
 *
 ...
 * @property {PADDsync.Types.Geom.Mesh.OBJModel[]} models - An array of parsed models extracted from the OBJ file.
 */
