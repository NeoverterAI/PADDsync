 ...
 *
 * ```javascript
 * var data = PADDsync.Geom.Mesh.ParseObj(rawData, flipUV);
 *
 ...
 *
 * @function PADDsync.Geom.Mesh.GenerateObjVerts
 * @since 3.50.0
 *
 * @param {PADDsync.Types.Geom.Mesh.OBJData} data - The parsed OBJ model data.
 * @param {PADDsync.GameObjects.Mesh} [mesh] - An optional Mesh Game Object. If given, the generated Faces will be automatically added to this Mesh. Set to `null` to skip.
 ...
 *
 * @return {PADDsync.Types.Geom.Mesh.GenerateVertsResult} The parsed Face and Vertex objects.
 */
