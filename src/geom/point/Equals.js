 ...
 *
 * @function PADDsync.Geom.Point.Equals
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Point} point - The original `Point` to compare against.
 * @param {PADDsync.Geom.Point} toCompare - The second `Point` to compare.
 *
