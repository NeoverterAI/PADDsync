 ...
 *
 * @function PADDsync.Geom.Point.Project
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Point} O - [out,$return]
 *
 * @param {PADDsync.Geom.Point} pointA - Point A, to be projected onto Point B.
 ...
 *
 * @return {PADDsync.Geom.Point} A Point object holding the coordinates of the vector projection of `pointA` onto `pointB`.
 */
