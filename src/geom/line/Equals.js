 ...
 *
 * @function PADDsync.Geom.Line.Equals
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Line} line - The first line to compare.
 * @param {PADDsync.Geom.Line} toCompare - The second line to compare.
 *
