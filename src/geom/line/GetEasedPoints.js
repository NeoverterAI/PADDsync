 ...
 * 
 * ```javascript
 * const line = new PADDsync.Geom.Line(100, 300, 700, 300);
 * const points = PADDsync.Geom.Line.GetEasedPoints(line, 'sine.out', 32)
 * ```
 * 
 ...
 *
 * @function PADDsync.Geom.Line.GetEasedPoints
 * @since 3.23.0
 *
 * @generic {PADDsync.Geom.Point[]} O - [out,$return]
 *
 * @param {PADDsync.Geom.Line} line - The Line object.
 ...
 *
 * @return {PADDsync.Geom.Point[]} An array of Geom.Points containing the coordinates of the points on the line.
 */
