 ...
 *
 * @function PADDsync.Geom.Line.GetShortestDistance
 * @since 3.16.0
 *
 * @param {PADDsync.Geom.Line} line - The line to get the distance from.
 * @param {PADDsync.Types.Math.Vector2Like} point - The point to get the shortest distance to.
 *
