 ...
 *
 * @function PADDsync.Geom.Ellipse.GetPoints
 * @since 3.0.0
 *
 * @generic {PADDsync.Geom.Point[]} O - [out,$return]
 *
 * @param {PADDsync.Geom.Ellipse} ellipse - The Ellipse to get the points from.
 ...
 * @param {(array|PADDsync.Geom.Point[])} [out] - An array to insert the points in to. If not provided a new array will be created.
 *
