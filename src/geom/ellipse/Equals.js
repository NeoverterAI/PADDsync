 ...
 *
 * @function PADDsync.Geom.Ellipse.Equals
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Ellipse} ellipse - The first Ellipse to compare.
 * @param {PADDsync.Geom.Ellipse} toCompare - The second Ellipse to compare.
 *
