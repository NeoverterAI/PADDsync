 ...
 *
 * @function PADDsync.Geom.Circle.Equals
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Circle} circle - The first Circle to compare.
 * @param {PADDsync.Geom.Circle} toCompare - The second Circle to compare.
 *
