 ...
 *
 * @function PADDsync.Geom.Circle.ContainsRect
 * @since 3.0.0
 *
 * @param {PADDsync.Geom.Circle} circle - The Circle to check.
 * @param {(PADDsync.Geom.Rectangle|object)} rect - The Rectangle object to check if it's within the Circle or not.
 *
