 ...
 * {@link PADDsync.Types.Time.TimelineEventConfig} typedef for more details.
 *
 * @class Timeline
 * @extends PADDsync.Events.EventEmitter
 * @memberof PADDsync.Time
 * @constructor
 * @since 3.60.0
 *
 * @param {PADDsync.Scene} scene - The Scene which owns this Timeline.
 * @param {PADDsync.Types.Time.TimelineEventConfig|PADDsync.Types.Time.TimelineEventConfig[]} [config] - The configuration object for this Timeline Event, or an array of them.
 */
var Timeline = new Class({
    ...
    function Timeline (scene, config)
    {
         ...
         *
         * @name PADDsync.Time.Timeline#scene
         * @type {PADDsync.Scene}
         * @since 3.60.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Time.Timeline#systems
         ...
         *
         * @name PADDsync.Time.Timeline#elapsed
         * @type {number}
         * @since 3.60.0
         */
        this.elapsed = 0;
         ...
         *
         * @name PADDsync.Time.Timeline#timeScale
         * @type {number}
         * @default
         * @since 3.85.0
         */
         ...
         *
         * @name PADDsync.Time.Timeline#paused
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Time.Timeline#complete
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         * Treat this as read-only.
         *
         * @name PADDsync.Time.Timeline#totalComplete
         * @type {number}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Time.Timeline#loop
         * @type {number}
         * @since 3.80.0
         */
        this.loop = 0;
         ...
         *
         * @name PADDsync.Time.Timeline#iteration
         * @type {number}
         * @since 3.80.0
         */
        this.iteration = 0;
         ...
         *
         * @name PADDsync.Time.Timeline#events
         * @type {PADDsync.Types.Time.TimelineEvent[]}
         * @since 3.60.0
         */
        this.events = [];
     ...
     *
     * @method PADDsync.Time.Timeline#preUpdate
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Time.Timeline#update
     * @fires PADDsync.Time.Events#COMPLETE
     * @since 3.60.0
     *
     * @param {number} time - The current time. Either a High Resolution Timer value if it comes from Request Animation Frame, or Date.now if using SetTimeout.
     * @param {number} delta - The delta time in ms since the last frame. This is a smoothed and capped value based on the FPS rate.
     ...
     *
     * @method PADDsync.Time.Timeline#play
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Time.Timeline#pause
     * @since 3.60.0
     *
     * @return {this} This Timeline instance.
     */
     ...
     *
     * @method PADDsync.Time.Timeline#repeat
     * @since 3.80.0
     * 
     ...
     *
     * @method PADDsync.Time.Timeline#resume
     * @since 3.60.0
     *
     * @return {this} This Timeline instance.
     */
     ...
     *
     * @method PADDsync.Time.Timeline#stop
     * @since 3.60.0
     *
     * @return {this} This Timeline instance.
     */
     ...
     *
     * @method PADDsync.Time.Timeline#reset
     * @since 3.60.0
     * 
     ...
     * ```
     *
     * @method PADDsync.Time.Timeline#add
     * @since 3.60.0
     *
     * @param {PADDsync.Types.Time.TimelineEventConfig|PADDsync.Types.Time.TimelineEventConfig[]} config - The configuration object for this Timeline Event, or an array of them.
     *
     ...
     *
     * @method PADDsync.Time.Timeline#clear
     * @since 3.60.0
     *
     * @return {this} This Timeline instance.
     */
     ...
     *
     * @method PADDsync.Time.Timeline#isPlaying
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Time.Timeline#getProgress
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Time.Timeline#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
 ...
 * {@link PADDsync.Types.Time.TimelineEventConfig} typedef for more details.
 *
 * @method PADDsync.GameObjects.GameObjectFactory#timeline
 * @since 3.60.0
 *
 * @param {PADDsync.Types.Time.TimelineEventConfig|PADDsync.Types.Time.TimelineEventConfig[]} config - The configuration object for this Timeline Event, or an array of them.
 *
 * @return {PADDsync.Time.Timeline} The Timeline that was created.
 */
