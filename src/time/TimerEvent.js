 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Types.Time.TimerEventConfig} config - The configuration for the Timer Event, including its delay and callback.
 */
var TimerEvent = new Class({
    ...
    function TimerEvent (config)
    {
         ...
         *
         * @name PADDsync.Time.TimerEvent#delay
         * @type {number}
         * @default 0
         * @readonly
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Time.TimerEvent#repeat
         * @type {number}
         * @default 0
         * @readonly
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Time.TimerEvent#repeatCount
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Time.TimerEvent#loop
         * @type {boolean}
         * @default false
         * @readonly
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Time.TimerEvent#callback
         * @type {function}
         * @since 3.0.0
         */
        this.callback;
         ...
         *
         * @name PADDsync.Time.TimerEvent#callbackScope
         * @type {object}
         * @since 3.0.0
         */
        this.callbackScope;
         ...
         *
         * @name PADDsync.Time.TimerEvent#args
         * @type {array}
         * @since 3.0.0
         */
        this.args;
         ...
         *
         * @name PADDsync.Time.TimerEvent#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Time.TimerEvent#startAt
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Time.TimerEvent#elapsed
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Time.TimerEvent#paused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Time.TimerEvent#hasDispatched
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Time.TimerEvent#reset
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Time.TimerEventConfig} config - The new state for the Timer Event.
     *
     * @return {PADDsync.Time.TimerEvent} This TimerEvent object.
     */
     ...
     *
     * @method PADDsync.Time.TimerEvent#getProgress
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Time.TimerEvent#getOverallProgress
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Time.TimerEvent#getRepeatCount
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Time.TimerEvent#getElapsed
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Time.TimerEvent#getElapsedSeconds
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Time.TimerEvent#getRemaining
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Time.TimerEvent#getRemainingSeconds
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Time.TimerEvent#getOverallRemaining
     * @since 3.50.0
     *
     * @return {number} The time interval in milliseconds.
     */
     ...
     *
     * @method PADDsync.Time.TimerEvent#getOverallRemainingSeconds
     * @since 3.50.0
     *
     * @return {number} The time interval in seconds.
     */
     ...
     *
     * @method PADDsync.Time.TimerEvent#remove
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Time.TimerEvent#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
