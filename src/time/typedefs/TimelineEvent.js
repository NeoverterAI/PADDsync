/**
 * @typedef {object} PADDsync.Types.Time.TimelineEvent
 * @since 3.60.0
 *
 ...
 * @property {PADDsync.Types.Tweens.TweenBuilderConfig|PADDsync.Types.Tweens.TweenChainBuilderConfig|PADDsync.Tweens.Tween|PADDsync.Tweens.TweenChain} [tween=null] - Tween configuration object which will be used to create a Tween when the Event fires if set.
 ...
 * @property {PADDsync.Tweens.Tween|PADDsync.Tweens.TweenChain} [tweenInstance=null] - If this Event is using a Tween to manage its actions, this property will contain a reference to it.
 */
