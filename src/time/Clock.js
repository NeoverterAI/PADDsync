 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene which owns this Clock.
 */
var Clock = new Class({
    ...
    function Clock (scene)
    {
         ...
         *
         * @name PADDsync.Time.Clock#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Time.Clock#systems
         ...
         *
         * @name PADDsync.Time.Clock#startTime
         * @type {number}
         * @since 3.60.0
         */
        this.startTime = 0;
         ...
         *
         * @name PADDsync.Time.Clock#timeScale
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Time.Clock#paused
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Time.Clock#_active
         * @type {PADDsync.Time.TimerEvent[]}
         * @private
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Time.Clock#_pendingInsertion
         * @type {PADDsync.Time.TimerEvent[]}
         * @private
         * @default []
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Time.Clock#_pendingRemoval
         * @type {PADDsync.Time.TimerEvent[]}
         * @private
         * @default []
         * @since 3.0.0
     ...
     *
     * @method PADDsync.Time.Clock#boot
     * @private
     * @since 3.5.1
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Time.Clock#start
     * @private
     * @since 3.5.0
     */
    start: function ()
     ...
     *
     * @method PADDsync.Time.Clock#addEvent
     * @since 3.0.0
     *
     * @param {(PADDsync.Time.TimerEvent | PADDsync.Types.Time.TimerEventConfig)} config - The configuration for the Timer Event, or an existing Timer Event object.
     *
     * @return {PADDsync.Time.TimerEvent} The Timer Event which was created, or passed in.
     */
     ...
     *
     * @method PADDsync.Time.Clock#delayedCall
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Time.TimerEvent} The Timer Event which was created.
     */
     ...
     *
     * @method PADDsync.Time.Clock#clearPendingEvents
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Time.Clock#removeEvent
     * @since 3.50.0
     *
     * @param {(PADDsync.Time.TimerEvent | PADDsync.Time.TimerEvent[])} events - The Timer Event, or an array of Timer Events, to remove from this Clock.
     *
     * @return {this} - This Clock instance.
     */
     ...
     *
     * @method PADDsync.Time.Clock#removeAllEvents
     * @since 3.0.0
     *
     * @return {this} - This Clock instance.
     */
     ...
     *
     * @method PADDsync.Time.Clock#preUpdate
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Time.Clock#update
     * @since 3.0.0
     *
     * @param {number} time - The current time. Either a High Resolution Timer value if it comes from Request Animation Frame, or Date.now if using SetTimeout.
     * @param {number} delta - The delta time in ms since the last frame. This is a smoothed and capped value based on the FPS rate.
     ...
     *
     * @method PADDsync.Time.Clock#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.Time.Clock#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function ()
