 ...
 *
 * @function PADDsync.Tilemaps.Parsers.Impact.ParseTileLayers
 * @since 3.0.0
 *
 * @param {object} json - The Impact JSON object.
 * @param {boolean} insertNull - Controls how empty tiles, tiles with an index of -1, in the map
 * data are handled (see {@link PADDsync.Tilemaps.Parsers.Tiled.ParseJSONTiled}).
 *
 * @return {PADDsync.Tilemaps.LayerData[]} - An array of LayerData objects, one for each entry in
