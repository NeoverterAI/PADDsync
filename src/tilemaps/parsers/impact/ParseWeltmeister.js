 ...
 *
 * @function PADDsync.Tilemaps.Parsers.Impact.ParseWeltmeister
 * @since 3.0.0
 *
 ...
 *
 * @return {?PADDsync.Tilemaps.MapData} The created MapData object, or `null` if the data can't be parsed.
 */
