 ...
 *
 * @param {PADDsync.GameObjects.GameObject} value - An object found in the filtered area.
 * @param {number} index - The index of the object within the array.
 * @param {PADDsync.GameObjects.GameObject[]} array - An array of all the objects found.
 *
 ...
 *
 * @param {PADDsync.GameObjects.GameObject} value - An object found.
 * @param {number} index - The index of the object within the array.
 * @param {PADDsync.GameObjects.GameObject[]} array - An array of all the objects found.
 *
 ...
 *
 * @class Tilemap
 * @memberof PADDsync.Tilemaps
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene to which this Tilemap belongs.
 * @param {PADDsync.Tilemaps.MapData} mapData - A MapData instance containing Tilemap data.
 */
var Tilemap = new Class({
    ...
    initialize:
        ...
        {
            /**
             * @name PADDsync.Tilemaps.Tilemap#scene
             * @type {PADDsync.Scene}
             * @since 3.0.0
             */
            this.scene = scene;
             ...
             * width.
             *
             * @name PADDsync.Tilemaps.Tilemap#tileWidth
             * @type {number}
             * @since 3.0.0
             */
             ...
             * tile height.
             *
             * @name PADDsync.Tilemaps.Tilemap#tileHeight
             * @type {number}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#width
             * @type {number}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#height
             * @type {number}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#orientation
             * @type {string}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#renderOrder
             * @type {string}
             * @since 3.12.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#format
             * @type {number}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#version
             * @type {number}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#properties
             * @type {object|object[]}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#widthInPixels
             * @type {number}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#heightInPixels
             * @type {number}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#imageCollections
             * @type {PADDsync.Tilemaps.ImageCollection[]}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#images
             * @type {array}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#layers
             * @type {PADDsync.Tilemaps.LayerData[]}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#tiles
             * @type {array}
             * @since 3.60.0
             * @see PADDsync.Tilemaps.Parsers.Tiled.BuildTilesetIndex
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#tilesets
             * @type {PADDsync.Tilemaps.Tileset[]}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#objects
             * @type {PADDsync.Tilemaps.ObjectLayer[]}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#currentLayerIndex
             * @type {number}
             * @since 3.0.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#hexSideLength
             * @type {number}
             * @since 3.50.0
             */
             ...
             *
             * @name PADDsync.Tilemaps.Tilemap#_convert
             * @private
             * @type {object}
             * @since 3.50.0
             */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#setRenderOrder
     * @since 3.12.0
     *
     ...
     * editor.
     *
     * @method PADDsync.Tilemaps.Tilemap#addTilesetImage
     * @since 3.0.0
     *
     * @param {string} tilesetName - The name of the tileset as specified in the map data.
     * @param {string} [key] - The key of the PADDsync.Cache image used for this tileset. If
     ...
     *
     * @return {?PADDsync.Tilemaps.Tileset} Returns the Tileset object that was created or updated, or null if it
     * failed.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#copy
     * @since 3.0.0
     *
     ...
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#createBlankLayer
     * @since 3.0.0
     *
     * @param {string} name - The name of this layer. Must be unique within the map.
     * @param {(string|string[]|PADDsync.Tilemaps.Tileset|PADDsync.Tilemaps.Tileset[])} tileset - The tileset, or an array of tilesets, used to render this layer. Can be a string or a Tileset object.
     ...
     *
     * @return {?PADDsync.Tilemaps.TilemapLayer} Returns the new layer that was created, or `null` if it failed.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#createLayer
     * @since 3.0.0
     *
     ...
     *
     * @return {?PADDsync.Tilemaps.TilemapLayer} Returns the new layer was created, or null if it failed.
     */
     ...
     *
     * By default this method will convert Objects into {@link PADDsync.GameObjects.Sprite} instances, but you can override
     ...
     * any class type here, but it _must_ extend {@link PADDsync.GameObjects.GameObject} as its base class.
     ...
     * class must have {@link PADDsync.GameObjects.Components.Transform#setPosition setPosition} and
     * {@link PADDsync.GameObjects.Components.Texture#setTexture setTexture} methods.
     *
     ...
     * - on the Game Object's {@link PADDsync.GameObjects.GameObject#data data store} otherwise.
     *
     ...
     *   {
     *     type: 'endzone',
     *     classType: PADDsync.GameObjects.Zone
     *   }
     * ]);
     * ```
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#createFromObjects
     * @since 3.0.0
     *
     * @param {string} objectLayerName - The name of the Tiled object layer to create the Game Objects from.
     * @param {PADDsync.Types.Tilemaps.CreateFromObjectLayerConfig|PADDsync.Types.Tilemaps.CreateFromObjectLayerConfig[]} config - A CreateFromObjects configuration object, or an array of them.
     ...
     *
     * @return {PADDsync.GameObjects.GameObject[]} An array containing the Game Objects that were created. Empty if invalid object layer, or no matching id/gid/name was found.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#createFromTiles
     * @since 3.0.0
     *
     ...
     * @param {PADDsync.Types.GameObjects.Sprite.SpriteConfig} [spriteConfig] - The config object to pass into the Sprite creator (i.e. scene.make.sprite).
     * @param {PADDsync.Scene} [scene] - The Scene to create the Sprites within.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.GameObjects.Sprite[]} Returns an array of Tiles, or null if the layer given was invalid.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#fill
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#filterObjects
     * @since 3.0.0
     *
     * @param {(PADDsync.Tilemaps.ObjectLayer|string)} objectLayer - The name of an object layer (from Tiled) or an ObjectLayer instance.
     ...
     *
     * @return {?PADDsync.Types.Tilemaps.TiledObject[]} An array of object that match the search, or null if the objectLayer given was invalid.
     */
     ...
     * If no layer specified, the map's current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#filterTiles
     * @since 3.0.0
     *
     ...
     * @param {number} [width] - How many tiles wide from the `tileX` index the area will be.
     * @param {number} [height] - How many tiles tall from the `tileY` index the area will be.
     * @param {PADDsync.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Tilemaps.Tile[]} Returns an array of Tiles, or null if the layer given was invalid.
     */
     ...
     * If no layer specified, the map's current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#findByIndex
     * @since 3.0.0
     *
     ...
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Tilemaps.Tile} Returns a Tiles, or null if the layer given was invalid.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#findObject
     * @since 3.0.0
     *
     * @param {(PADDsync.Tilemaps.ObjectLayer|string)} objectLayer - The name of an object layer (from Tiled) or an ObjectLayer instance.
     ...
     * @param {object} [context] - The context under which the callback should be run.
     *
     * @return {?PADDsync.Types.Tilemaps.TiledObject} An object that matches the search, or null if no object found.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#findTile
     * @since 3.0.0
     *
     ...
     * @param {number} [height] - How many tiles tall from the `tileY` index the area will be.
     * @param {PADDsync.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The Tile layer to run the search on. If not provided will use the current layer.
     *
     * @return {?PADDsync.Tilemaps.Tile} Returns a Tiles, or null if the layer given was invalid.
     */
     ...
     * If no layer specified, the map's current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#forEachTile
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getImageIndex
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getImageLayerNames
     * @since 3.21.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getIndex
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getLayer
     * @since 3.0.0
     *
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The name of the layer from Tiled, the index of the layer in the map or Tilemap Layer. If not given will default to the maps current layer index.
     *
     * @return {?PADDsync.Tilemaps.LayerData} The corresponding `LayerData` within `this.layers`, or null.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getObjectLayer
     * @since 3.0.0
     *
     * @param {string} [name] - The name of the object layer from Tiled.
     *
     * @return {?PADDsync.Tilemaps.ObjectLayer} The corresponding `ObjectLayer` within `this.objects`, or null.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getObjectLayerNames
     * @since 3.21.0
     *
     ...
     * `layer` is given.
     *
     * @method PADDsync.Tilemaps.Tilemap#getLayerIndex
     * @since 3.0.0
     *
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The name of the layer from Tiled, the index of the layer in the map or a Tilemap Layer. If not given will default to the map's current layer index.
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getLayerIndexByName
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getTileAt
     * @since 3.0.0
     *
     ...
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Tilemaps.Tile} Returns a Tile, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#getTileAtWorldXY
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getTileLayerNames
     * @since 3.21.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#getTilesWithin
     * @since 3.0.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#getTilesWithinShape
     * @since 3.0.0
     *
     * @param {(PADDsync.Geom.Circle|PADDsync.Geom.Line|PADDsync.Geom.Rectangle|PADDsync.Geom.Triangle)} shape - A shape in world (pixel) coordinates
     * @param {PADDsync.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when factoring in which tiles to return.
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Tilemaps.Tile[]} Returns an array of Tiles, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#getTilesWithinWorldXY
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#getTileset
     * @since 3.14.0
     *
     * @param {string} name - The name of the Tileset to get.
     *
     * @return {?PADDsync.Tilemaps.Tileset} The Tileset, or `null` if no matching named tileset was found.
     */
     ...
     * invalid `name` is given.
     *
     * @method PADDsync.Tilemaps.Tilemap#getTilesetIndex
     * @since 3.0.0
     *
     * @param {string} name - The name of the Tileset to get.
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#hasTileAt
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#hasTileAtWorldXY
     * @since 3.0.0
     *
     ...
     *
     * @name PADDsync.Tilemaps.Tilemap#layer
     * @type {PADDsync.Tilemaps.LayerData}
     * @since 3.0.0
     */
    layer: {
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#putTileAt
     * @since 3.0.0
     *
     * @param {(number|PADDsync.Tilemaps.Tile)} tile - The index of this tile to set or a Tile object.
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {boolean} [recalculateFaces] - `true` if the faces data should be recalculated.
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Tilemaps.Tile} Returns a Tile, or null if the layer given was invalid or the coordinates were out of bounds.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#putTileAtWorldXY
     * @since 3.0.0
     *
     * @param {(number|PADDsync.Tilemaps.Tile)} tile - The index of this tile to set or a Tile object.
     * @param {number} worldX - The x coordinate, in pixels.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#putTilesAt
     * @since 3.0.0
     *
     * @param {(number[]|number[][]|PADDsync.Tilemaps.Tile[]|PADDsync.Tilemaps.Tile[][])} tile - A row (array) or grid (2D array) of Tiles or tile indexes to place.
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {boolean} [recalculateFaces] - `true` if the faces data should be recalculated.
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#randomize
     * @since 3.0.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#calculateFacesAt
     * @since 3.0.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#calculateFacesWithin
     * @since 3.0.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#removeLayer
     * @since 3.17.0
     *
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to be removed.
     *
     * @return {?PADDsync.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#destroyLayer
     * @since 3.17.0
     *
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to be destroyed.
     *
     * @return {?PADDsync.Tilemaps.Tilemap} Returns this, or null if the layer given was invalid.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#removeAllLayers
     * @since 3.0.0
     *
     * @return {this} This Tilemap object.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#removeTile
     * @since 3.17.0
     *
     * @param {(PADDsync.Tilemaps.Tile|PADDsync.Tilemaps.Tile[])} tiles - The Tile to remove, or an array of Tiles.
     ...
     * @param {boolean} [recalculateFaces=true] - `true` if the faces data should be recalculated.
     *
     * @return {PADDsync.Tilemaps.Tile[]} Returns an array of Tiles that were removed.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#removeTileAt
     * @since 3.0.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Tilemaps.Tile} Returns the Tile that was removed, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#removeTileAtWorldXY
     * @since 3.0.0
     *
     * @param {number} worldX - The x coordinate, in pixels.
     * @param {number} worldY - The y coordinate, in pixels.
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#renderDebug
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.Graphics} graphics - The target Graphics object to draw upon.
     * @param {PADDsync.Types.Tilemaps.StyleConfig} [styleConfig] - An object specifying the colors to use for the debug drawing.
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Tilemaps.Tilemap} Return this Tilemap object, or null if the layer given was invalid.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#renderDebugFull
     * @since 3.17.0
     *
     * @param {PADDsync.GameObjects.Graphics} graphics - The target Graphics object to draw upon.
     * @param {PADDsync.Types.Tilemaps.StyleConfig} [styleConfig] - An object specifying the colors to use for the debug drawing.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#replaceByIndex
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#setCollision
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#setCollisionBetween
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#setCollisionByProperty
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#setCollisionByExclusion
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#setCollisionFromCollisionGroup
     * @since 3.0.0
     *
     * @param {boolean} [collides] - If true it will enable collision. If false it will clear collision.
     * @param {boolean} [recalculateFaces] - Whether or not to recalculate the tile faces after the update.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#setTileIndexCallback
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#setTileLocationCallback
     * @since 3.0.0
     *
     * @param {number} tileX - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} tileY - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#setLayer
     * @since 3.0.0
     *
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The name of the layer from Tiled, the index of the layer in the map or a TilemapLayer. If not given will default to the maps current layer index.
     *
     * @return {this} This Tilemap object.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#setBaseTileSize
     * @since 3.0.0
     *
     ...
     * tiles the layer has.
     *
     * @method PADDsync.Tilemaps.Tilemap#setLayerTileSize
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#shuffle
     * @since 3.0.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#swapByIndex
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#tileToWorldX
     * @since 3.0.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#tileToWorldY
     * @since 3.0.0
     *
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#tileToWorldXY
     * @since 3.0.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {PADDsync.Math.Vector2} [vec2] - A Vector2 to store the coordinates in. If not given a new Vector2 is created.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Math.Vector2} Returns a Vector2, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#getTileCorners
     * @since 3.60.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Math.Vector2[]} Returns an array of Vector2s, or null if the layer given was invalid.
     */
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#weightedRandomize
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#worldToTileX
     * @since 3.0.0
     *
     ...
     * should use the `worldToTileXY` method.
     *
     * @method PADDsync.Tilemaps.Tilemap#worldToTileY
     * @since 3.0.0
     *
     ...
     * If no layer is specified, the maps current layer is used.
     *
     * @method PADDsync.Tilemaps.Tilemap#worldToTileXY
     * @since 3.0.0
     *
     * @param {number} worldX - The x coordinate to be converted, in pixels, not tiles.
     * @param {number} worldY - The y coordinate to be converted, in pixels, not tiles.
     ...
     * @param {(string|number|PADDsync.Tilemaps.TilemapLayer)} [layer] - The tile layer to use. If not given the current layer is used.
     *
     * @return {?PADDsync.Math.Vector2} Returns a vec2, or null if the layer given was invalid.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tilemap#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
