...
var ImageCollection = new Class({
    ...
    function ImageCollection (name, firstgid, width, height, margin, spacing, properties)
    {
         ...
         *
         * @name PADDsync.Tilemaps.ImageCollection#name
         * @type {string}
         * @since 3.0.0
        */
        this.name = name;
         ...
         *
         * @name PADDsync.Tilemaps.ImageCollection#firstgid
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ImageCollection#imageWidth
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ImageCollection#imageHeight
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ImageCollection#imageMarge
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         * Use `setSpacing` to change.
         *
         * @name PADDsync.Tilemaps.ImageCollection#imageSpacing
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ImageCollection#properties
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ImageCollection#images
         * @type {array}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ImageCollection#total
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Tilemaps.ImageCollection#containsImageIndex
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.ImageCollection#addImage
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Tilemaps.ImageCollection} This ImageCollection object.
     */
