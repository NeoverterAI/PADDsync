 ...
 *
 * @param {PADDsync.Tilemaps.LayerData} layer - The LayerData object in the Tilemap that this tile belongs to.
...
var Tile = new Class({
    ...
    function Tile (layer, index, x, y, width, height, baseWidth, baseHeight)
    {
         ...
         *
         * @name PADDsync.Tilemaps.Tile#layer
         ...
         *
         * @name PADDsync.Tilemaps.Tile#index
         * @type {number}
         * @since 3.0.0
         */
        this.index = index;
         ...
         *
         * @name PADDsync.Tilemaps.Tile#width
         * @type {number}
         * @since 3.0.0
         */
        this.width = width;
         ...
         *
         * @name PADDsync.Tilemaps.Tile#height
         * @type {number}
         * @since 3.0.0
         */
        this.height = height;
         ...
         *
         * @name PADDsync.Tilemaps.Tile#right
         * @type {number}
         * @since 3.50.0
         */
        this.right;
         ...
         * Set in the `updatePixelXY` method.
         *
         * @name PADDsync.Tilemaps.Tile#bottom
         * @type {number}
         * @since 3.50.0
         */
        this.bottom;
         ...
         *
         * @name PADDsync.Tilemaps.Tile#baseWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         * within one map, but they are still placed at intervals of the base tile size.
         *
         * @name PADDsync.Tilemaps.Tile#baseHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tile#pixelX
         * @type {number}
         * @since 3.0.0
         */
        this.pixelX = 0;
         ...
         * scroll, layer scale or layer position.
         *
         * @name PADDsync.Tilemaps.Tile#pixelY
         * @type {number}
         * @since 3.0.0
         */
        this.pixelY = 0;
         ...
         *
         * @name PADDsync.Tilemaps.Tile#properties
         * @type {any}
         * @since 3.0.0
         */
        this.properties = {};
         ...
         *
         * @name PADDsync.Tilemaps.Tile#rotation
         * @type {number}
         * @since 3.0.0
         */
        this.rotation = 0;
         ...
         * in your own checks.
         *
         * @name PADDsync.Tilemaps.Tile#collideLeft
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         * in your own checks.
         *
         * @name PADDsync.Tilemaps.Tile#collideRight
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         * in your own checks.
         *
         * @name PADDsync.Tilemaps.Tile#collideUp
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         * in your own checks.
         *
         * @name PADDsync.Tilemaps.Tile#collideDown
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tile#faceLeft
         * @type {boolean}
         * @since 3.0.0
         */
        this.faceLeft = false;
         ...
         *
         * @name PADDsync.Tilemaps.Tile#faceRight
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tile#faceTop
         * @type {boolean}
         * @since 3.0.0
         */
        this.faceTop = false;
         ...
         *
         * @name PADDsync.Tilemaps.Tile#faceBottom
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tile#collisionCallback
         * @type {function}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tile#collisionCallbackContext
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tile#tint
         * @type {number}
         * @default
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tile#tintFill
         * @type {boolean}
         * @default
         * @since 3.70.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tile#physics
         * @type {object}
         * @since 3.0.0
         */
        this.physics = {};
     ...
     *
     * @method PADDsync.Tilemaps.Tile#containsPoint
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tile#copy
     * @since 3.0.0
     *
     * @param {PADDsync.Tilemaps.Tile} tile - The tile to copy from.
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tile#getCollisionGroup
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tile#getTileData
     * @since 3.0.0
     *
     ...
     * scale and scroll.
     *
     * @method PADDsync.Tilemaps.Tile#getLeft
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * scale and scroll.
     *
     * @method PADDsync.Tilemaps.Tile#getRight
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * scale and scroll.
     *
     * @method PADDsync.Tilemaps.Tile#getTop
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * @method PADDsync.Tilemaps.Tile#getBottom
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * scale and scroll.
     *
     * @method PADDsync.Tilemaps.Tile#getBounds
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     * @param {PADDsync.Geom.Rectangle} [output] - Optional Rectangle object to store the results in.
     *
     * @return {(PADDsync.Geom.Rectangle|object)} The bounds of this Tile.
     */
     ...
     * scale and scroll.
     *
     * @method PADDsync.Tilemaps.Tile#getCenterX
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * scale and scroll.
     *
     * @method PADDsync.Tilemaps.Tile#getCenterY
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use to perform the check.
     *
     ...
     * layer position.
     *
     * @method PADDsync.Tilemaps.Tile#intersects
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tile#isInteresting
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tile#resetCollision
     * @since 3.0.0
     *
     ...
     * Reset faces.
     *
     * @method PADDsync.Tilemaps.Tile#resetFaces
     * @since 3.0.0
     *
     * @return {this} This Tile object instance.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tile#setCollision
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tile#setCollisionCallback
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tile#setSize
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tile#updatePixelXY
     * @since 3.0.0
     *
     * @return {this} This Tile object instance.
     */
     ...
     * Clean up memory.
     *
     * @method PADDsync.Tilemaps.Tile#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     *
     * @name PADDsync.Tilemaps.Tile#canCollide
     * @type {boolean}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Tilemaps.Tile#collides
     * @type {boolean}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Tilemaps.Tile#hasInterestingFace
     * @type {boolean}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Tilemaps.Tile#tileset
     ...
     *
     * @name PADDsync.Tilemaps.Tile#tilemapLayer
     * @type {?PADDsync.Tilemaps.TilemapLayer}
     * @readonly
     * @since 3.0.0
     */
    tilemapLayer: {
     ...
     *
     * @name PADDsync.Tilemaps.Tile#tilemap
