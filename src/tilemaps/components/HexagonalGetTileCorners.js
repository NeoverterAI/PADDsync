 ...
 *
 * @function PADDsync.Tilemaps.Components.HexagonalGetTileCorners
 * @since 3.60.0
 *
 ...
 *
 * @return {PADDsync.Math.Vector2[]} An array of Vector2s corresponding to the world XY location of each tile corner.
 */
