 ...
 *
 * @function PADDsync.Tilemaps.Components.RenderDebug
 * @since 3.0.0
 *
 * @param {PADDsync.GameObjects.Graphics} graphics - The target Graphics object to draw upon.
 * @param {PADDsync.Types.Tilemaps.DebugStyleOptions} styleConfig - An object specifying the colors to use for the debug drawing.
