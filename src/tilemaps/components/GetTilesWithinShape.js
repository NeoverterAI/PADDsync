 ...
 *
 * @function PADDsync.Tilemaps.Components.GetTilesWithinShape
 * @since 3.0.0
 *
 ...
 * @param {PADDsync.Tilemaps.LayerData} layer - The Tilemap Layer to act upon.
 *
 * @return {PADDsync.Tilemaps.Tile[]} Array of Tile objects.
 */
