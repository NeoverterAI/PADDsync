 ...
 *
 * @function PADDsync.Tilemaps.Components.CullBounds
 * @since 3.50.0
 *
 ...
 *
 * @return {PADDsync.Geom.Rectangle} A rectangle containing the culled bounds. If you wish to retain this object, clone it, as it's recycled internally.
 */
