 ...
 *
 * @param {PADDsync.Tilemaps.Tile} value - The Tile.
 * @param {number} index - The index of the tile.
 * @param {PADDsync.Tilemaps.Tile[]} array - An array of Tile objects.
 *
 ...
 *
 * @function PADDsync.Tilemaps.Components.FindTile
 * @since 3.0.0
 *
 ...
 *
 * @return {?PADDsync.Tilemaps.Tile} A Tile that matches the search, or null if no Tile found
 */
