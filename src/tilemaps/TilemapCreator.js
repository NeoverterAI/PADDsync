 ...
 *
 * @method PADDsync.GameObjects.GameObjectCreator#tilemap
 * @since 3.0.0
 *
 * @param {PADDsync.Types.Tilemaps.TilemapConfig} [config] - The config options for the Tilemap.
 *
 * @return {PADDsync.Tilemaps.Tilemap}
 */
