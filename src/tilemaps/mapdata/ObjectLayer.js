 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Types.Tilemaps.ObjectLayerConfig} [config] - The data for the layer from the Tiled JSON object.
 */
var ObjectLayer = new Class({
    ...
    function ObjectLayer (config)
    {
         ...
         *
         * @name PADDsync.Tilemaps.ObjectLayer#name
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ObjectLayer#id
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ObjectLayer#opacity
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ObjectLayer#properties
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ObjectLayer#propertyTypes
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ObjectLayer#type
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ObjectLayer#visible
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.ObjectLayer#objects
         * @type {PADDsync.Types.Tilemaps.TiledObject[]}
         * @since 3.0.0
         */
