 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Types.Tilemaps.LayerDataConfig} [config] - The Layer Data configuration object.
 */
var LayerData = new Class({
    ...
    function LayerData (config)
    {
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#name
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#id
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#x
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#y
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#width
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#height
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#tileWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#tileHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         * The base tile width.
         *
         * @name PADDsync.Tilemaps.LayerData#baseTileWidth
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#baseTileHeight
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#orientation
         * @type {PADDsync.Tilemaps.OrientationType}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#widthInPixels
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#heightInPixels
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#alpha
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#visible
         * @type {boolean}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#properties
         * @type {object[]}
         * @since 3.0.0
         */
         ...
         * Tile ID index map.
         *
         * @name PADDsync.Tilemaps.LayerData#indexes
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#collideIndexes
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#callbacks
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#bodies
         * @type {array}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#data
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#tilemapLayer
         ...
         *
         * @name PADDsync.Tilemaps.LayerData#hexSideLength
         * @type {number}
         * @since 3.50.0
         */
         ...
         * Only used for hexagonal orientation Tilemaps.
         *
         * @name PADDsync.Tilemaps.LayerData#staggerAxis
         * @type {string}
         * @since 3.60.0
         */
         ...
         * Only used for hexagonal orientation Tilemaps.
         *
         * @name PADDsync.Tilemaps.LayerData#staggerIndex
         * @type {string}
         * @since 3.60.0
         */
