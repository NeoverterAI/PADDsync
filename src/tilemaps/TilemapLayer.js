 ...
 * @extends PADDsync.GameObjects.Components.ComputedSize
 ...
 * @param {PADDsync.Tilemaps.Tilemap} tilemap - The Tilemap this layer is a part of.
...
var TilemapLayer = new Class({
    ...
    function TilemapLayer (scene, tilemap, layerIndex, tileset, x, y)
    {
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#isTilemap
         * @type {boolean}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#tilemap
         * @type {PADDsync.Tilemaps.Tilemap}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#layerIndex
         * @type {number}
         * @since 3.50.0
         */
         ...
         * tilemap layer.
         *
         * @name PADDsync.Tilemaps.TilemapLayer#layer
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#tileset
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#tilesDrawn
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#tilesTotal
         * @type {number}
         * @readonly
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#culledTiles
         * @type {PADDsync.Tilemaps.Tile[]}
         * @since 3.50.0
         */
        this.culledTiles = [];
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#skipCull
         * @type {boolean}
         * @since 3.50.0
         */
        this.skipCull = false;
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#cullPaddingX
         * @type {number}
         * @default 1
         * @since 3.50.0
         */
         ...
         * See the method `setCullPadding` for more details.
         *
         * @name PADDsync.Tilemaps.TilemapLayer#cullPaddingY
         * @type {number}
         * @default 1
         * @since 3.50.0
         */
         ...
         *
         * 1. The PADDsync.Tilemaps.LayerData object for this Layer
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#cullCallback
         * @type {function}
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#_renderOrder
         * @type {number}
         * @default 0
         * @private
         * @since 3.50.0
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#gidMap
         * @type {PADDsync.Tilemaps.Tileset[]}
         * @since 3.50.0
         */
        this.gidMap = [];
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#tempVec
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#collisionCategory
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#collisionMask
         * @type {number}
         * @since 3.70.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#originX
         * @type {number}
         * @default 0
         * @readOnly
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#originY
         * @type {number}
         * @default 0
         * @readOnly
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#displayOriginX
         * @type {number}
         * @default 0
         * @readOnly
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Tilemaps.TilemapLayer#displayOriginY
         * @type {number}
         * @default 0
         * @readOnly
         * @since 3.0.0
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setTilesets
     * @private
     * @since 3.50.0
     *
     * @param {(string|string[]|PADDsync.Tilemaps.Tileset|PADDsync.Tilemaps.Tileset[])} tileset - The tileset, or an array of tilesets, used to render this layer. Can be a string or a Tileset object.
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setRenderOrder
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#calculateFacesAt
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#calculateFacesWithin
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#createFromTiles
     * @since 3.50.0
     *
     ...
     * @param {PADDsync.Types.GameObjects.Sprite.SpriteConfig} [spriteConfig] - The config object to pass into the Sprite creator (i.e.
     * scene.make.sprite).
     * @param {PADDsync.Scene} [scene] - The Scene to create the Sprites within.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when determining the world XY
     *
     * @return {PADDsync.GameObjects.Sprite[]} An array of the Sprites that were created.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#cull
     * @since 3.50.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to run the cull check against.
     *
     * @return {PADDsync.Tilemaps.Tile[]} An array of Tile objects to render.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#copy
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#fill
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#filterTiles
     * @since 3.50.0
     *
     ...
     *
     * @return {PADDsync.Tilemaps.Tile[]} An array of Tile objects.
     */
     ...
     * the top-left.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#findByIndex
     * @since 3.50.0
     *
     ...
     *
     * @return {PADDsync.Tilemaps.Tile} The first matching Tile object.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#findTile
     * @since 3.50.0
     *
     ...
     * @param {PADDsync.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     *
     * @return {?PADDsync.Tilemaps.Tile} The first Tile found at the given location.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#forEachTile
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setTint
     * @webglOnly
     * @since 3.60.0
     *
     ...
     * If a tile already has a tint set then calling this method will override that.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setTintFill
     * @webglOnly
     * @since 3.70.0
     *
     * @param {number} [tint=0xffffff] - The tint color being applied to each tile within the region. Given as a hex value, i.e. `0xff0000` for red. Set to white (`0xffffff`) to reset the tint.
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#getTileAt
     * @since 3.50.0
     *
     ...
     *
     * @return {PADDsync.Tilemaps.Tile} The Tile at the given coordinates or null if no tile was found or the coordinates were invalid.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#getTileAtWorldXY
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#getIsoTileAtWorldXY
     * @since 3.60.0
     *
     * @param {number} worldX - X position to get the tile from (given in pixels)
     * @param {number} worldY - Y position to get the tile from (given in pixels)
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#getTilesWithin
     * @since 3.50.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * @param {PADDsync.Types.Tilemaps.FilteringOptions} [filteringOptions] - Optional filters to apply when getting the tiles.
     *
     * @return {PADDsync.Tilemaps.Tile[]} An array of Tile objects found within the area.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#getTilesWithinShape
     * @since 3.50.0
     *
     ...
     *
     * @return {PADDsync.Tilemaps.Tile[]} An array of Tile objects found within the shape.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#getTilesWithinWorldXY
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#hasTileAt
     * @since 3.50.0
     *
     ...
     * false if there is no tile or if the tile at that location has an index of -1.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#hasTileAtWorldXY
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#putTileAt
     * @since 3.50.0
     *
     ...
     * @param {boolean} [recalculateFaces=true] - `true` if the faces data should be recalculated.
     *
     * @return {PADDsync.Tilemaps.Tile} The Tile object that was inserted at the given coordinates.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#putTileAtWorldXY
     * @since 3.50.0
     *
     * @param {(number|PADDsync.Tilemaps.Tile)} tile - The index of this tile to set or a Tile object.
     * @param {number} worldX - The x coordinate, in pixels.
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#putTilesAt
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#randomize
     * @since 3.50.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#removeTileAt
     * @since 3.50.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     * @param {boolean} [recalculateFaces=true] - `true` if the faces data should be recalculated.
     *
     * @return {PADDsync.Tilemaps.Tile} A Tile object.
     */
     ...
     * collision information.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#removeTileAtWorldXY
     * @since 3.50.0
     *
     * @param {number} worldX - The x coordinate, in pixels.
     * @param {number} worldY - The y coordinate, in pixels.
     ...
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     *
     * @return {PADDsync.Tilemaps.Tile} The Tile object that was removed from the given location.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#renderDebug
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#replaceByIndex
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setSkipCull
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setCullPadding
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setCollision
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setCollisionBetween
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setCollisionByProperty
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setCollisionByExclusion
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setCollisionFromCollisionGroup
     * @since 3.50.0
     *
     * @param {boolean} [collides=true] - If true it will enable collision. If false it will clear collision.
     * @param {boolean} [recalculateFaces=true] - Whether or not to recalculate the tile faces after the update.
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setTileIndexCallback
     * @since 3.50.0
     *
     ...
     * remove it.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#setTileLocationCallback
     * @since 3.50.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * information.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#shuffle
     * @since 3.50.0
     *
     * @param {number} [tileX] - The left most tile index (in tile coordinates) to use as the origin of the area.
     * @param {number} [tileY] - The top most tile index (in tile coordinates) to use as the origin of the area.
     ...
     * information.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#swapByIndex
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#tileToWorldX
     * @since 3.50.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     ...
     * layers position, scale and scroll.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#tileToWorldY
     * @since 3.50.0
     *
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     ...
     * `point` object.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#tileToWorldXY
     * @since 3.50.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     * @param {PADDsync.Math.Vector2} [point] - A Vector2 to store the coordinates in. If not given a new Vector2 is created.
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     *
     * @return {PADDsync.Math.Vector2} A Vector2 containing the world coordinates of the Tile.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#getTileCorners
     * @since 3.60.0
     *
     * @param {number} tileX - The x coordinate, in tiles, not pixels.
     * @param {number} tileY - The y coordinate, in tiles, not pixels.
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#weightedRandomize
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#worldToTileX
     * @since 3.50.0
     *
     ...
     * should use the `worldToTileXY` method.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#worldToTileY
     * @since 3.50.0
     *
     ...
     * `point` object.
     *
     * @method PADDsync.Tilemaps.TilemapLayer#worldToTileXY
     * @since 3.50.0
     *
     * @param {number} worldX - The x coordinate to be converted, in pixels, not tiles.
     * @param {number} worldY - The y coordinate to be converted, in pixels, not tiles.
     ...
     * @param {PADDsync.Cameras.Scene2D.Camera} [camera] - The Camera to use when calculating the tile index from the world values.
     *
     * @return {PADDsync.Math.Vector2} A Vector2 containing the tile coordinates of the world values.
     */
     ...
     *
     * @method PADDsync.Tilemaps.TilemapLayer#destroy
     * @since 3.50.0
     *
