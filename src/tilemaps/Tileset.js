...
var Tileset = new Class({
    ...
    function Tileset (name, firstgid, tileWidth, tileHeight, tileMargin, tileSpacing, tileProperties, tileData, tileOffset)
    {
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#name
         * @type {string}
         * @since 3.0.0
         */
        this.name = name;
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#firstgid
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#tileWidth
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#tileHeight
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#tileMargin
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#tileSpacing
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         * Tileset editor.
         *
         * @name PADDsync.Tilemaps.Tileset#tileProperties
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#tileData
         * @type {object}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#tileOffset
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#image
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#glTexture
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#rows
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#columns
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#total
         * @type {number}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Tilemaps.Tileset#texCoordinates
         * @type {object[]}
         * @readonly
         * @since 3.0.0
        */
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#getTileProperties
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#getTileData
     * @since 3.0.0
     *
     * @param {number} tileIndex - The unique id of the tile across all tilesets in the map.
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#getTileCollisionGroup
     * @since 3.0.0
     *
     * @param {number} tileIndex - The unique id of the tile across all tilesets in the map.
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#containsTileIndex
     * @since 3.0.0
     *
     * @param {number} tileIndex - The unique id of the tile across all tilesets in the map.
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#getTileTextureCoordinates
     * @since 3.0.0
     *
     * @param {number} tileIndex - The unique id of the tile across all tilesets in the map.
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#setImage
     * @since 3.0.0
     *
     * @param {PADDsync.Textures.Texture} texture - The image that contains the tiles.
     *
     * @return {PADDsync.Tilemaps.Tileset} This Tileset object.
     */
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#setTileSize
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#setSpacing
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Tilemaps.Tileset#updateTileData
     * @since 3.0.0
     *
