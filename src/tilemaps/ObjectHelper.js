 ...
 * @since 3.60.0
 *
 * @param {PADDsync.Tilemaps.Tileset[]} tilesets - The backing tileset data.
 */
var ObjectHelper = new Class({
    ...
    function ObjectHelper (tilesets)
    {
         ...
         * The Tile GIDs array.
         *
         * @name PADDsync.Tilemaps.ObjectHelper#gids
         * @type {array}
         * @since 3.60.0
         */
        this.gids = [];
         ...
         * The Tile GIDs array.
         *
         * @name PADDsync.Tilemaps.ObjectHelper#_gids
         * @type {array}
         * @private
         * @since 3.60.0
         */
     ...
     *
     * @name PADDsync.Tilemaps.ObjectHelper#enabled
     * @type {boolean}
     * @since 3.60.0
     */
    enabled: {
     ...
     *
     * @method PADDsync.Tilemaps.ObjectHelper#getTypeIncludingTile
     * @since 3.60.0
     *
     * @param {PADDsync.Types.Tilemaps.TiledObject} obj - The Tiled object to investigate.
     *
     ...
     *
     * @method PADDsync.Tilemaps.ObjectHelper#setTextureAndFrame
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.GameObject} sprite - The Game Object to modify.
     * @param {string|PADDsync.Textures.Texture} [key] - The texture key to set (or else the `obj.gid`'s tile is used if available).
     * @param {string|number|PADDsync.Textures.Frame} [frame] - The frames key to set (or else the `obj.gid`'s tile is used if available).
     * @param {PADDsync.Types.Tilemaps.TiledObject} [obj] - The Tiled object for fallback.
     */
     ...
     *
     * @method PADDsync.Tilemaps.ObjectHelper#setPropertiesFromTiledObject
     * @since 3.60.0
     *
     * @param {PADDsync.GameObjects.GameObject} sprite
     * @param {PADDsync.Types.Tilemaps.TiledObject} obj
     */
     ...
     *
     * @method PADDsync.Tilemaps.ObjectHelper#setFromJSON
     * @since 3.60.0
     * @private
     *
     * @param {PADDsync.GameObjects.GameObject} sprite - The object for which to populate `data`.
