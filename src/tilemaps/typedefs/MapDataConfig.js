/**
 * @typedef {object} PADDsync.Types.Tilemaps.MapDataConfig
 * @since 3.0.0
 * 
 ...
 * @property {(string|PADDsync.Tilemaps.Orientation)} [orientation] - The orientation of the map data (i.e. orthogonal, isometric, hexagonal), default 'orthogonal'.
 ...
 * @property {PADDsync.Tilemaps.LayerData[]} [layers] - The layers of the tilemap.
 ...
 * @property {PADDsync.Tilemaps.Tileset[]} [tilesets] - The tilesets the map uses.
