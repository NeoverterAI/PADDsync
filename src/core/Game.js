...
/**
 * @classdesc
 * The PADDsync.Game instance is the main controller for the entire Phaser game. It is responsible
 * for handling the boot process, parsing the configuration values, creating the renderer,
 * and setting-up all of the global Phaser systems, such as sound and input.
 * Once that is complete it will start the Scene Manager and then begin the main game loop.
 *
 * You should generally avoid accessing any of the systems created by Game, and instead use those
 * made available to you via the PADDsync.Scene Systems class instead.
 *
 * @class Game
 * @memberof PADDsync
 * @constructor
 * @fires PADDsync.Core.Events#BLUR
 * @fires PADDsync.Core.Events#FOCUS
 * @fires PADDsync.Core.Events#HIDDEN
 * @fires PADDsync.Core.Events#VISIBLE
 * @since 3.0.0
 *
...
var Game = new Class({
    ...
    function Game (config)
    {
         ...
         *
         * @name PADDsync.Game#domContainer
         * @type {HTMLDivElement}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.Game#device
         * @type {PADDsync.DeviceConf}
         * @since 3.0.0
         */
        this.device = Device;
         ...
         *
         * @name PADDsync.Game#loop
         * @type {PADDsync.Core.TimeStep}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Game#pendingDestroy
         * @type {boolean}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Game#removeCanvas
         * @type {boolean}
         * @private
         * @since 3.5.0
         */
     ...
     *
     * @method PADDsync.Game#boot
     * @protected
     * @fires PADDsync.Core.Events#BOOT
     * @listens PADDsync.Textures.Events#READY
     * @since 3.0.0
     */
    boot: function ()
    {
     ...
     * default textures.
     *
     * @method PADDsync.Game#texturesReady
     * @private
     * @fires PADDsync.Game#READY
     * @since 3.12.0
     */
     ...
     *
     * @method PADDsync.Game#step
     * @fires PADDsync.Core.Events#PRE_STEP
     * @fires PADDsync.Core.Events#STEP
     * @fires PADDsync.Core.Events#POST_STEP
     * @fires PADDsync.Core.Events#PRE_RENDER
     * @fires PADDsync.Core.Events#POST_RENDER
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Game#headlessStep
     * @fires PADDsync.Game#PRE_RENDER
     * @fires PADDsync.Game#POST_RENDER
     * @since 3.2.0
     *
     * @param {number} time - The current time. Either a High Resolution Timer value if it comes from Request Animation Frame, or Date.now if using SetTimeout.
     * @param {number} delta - The delta time in ms since the last frame. This is a smoothed and capped value based on the FPS rate.
     ...
     *
     * @method PADDsync.Game#onHidden
     * @protected
     * @fires PADDsync.Core.Events#PAUSE
     * @since 3.0.0
     */
    onHidden: function ()
    {
     ...
     *
     * @method PADDsync.Game#onVisible
     * @protected
     * @fires PADDsync.Core.Events#RESUME
     * @since 3.0.0
     */
    onVisible: function ()
    {
     ...
     *
     * @method PADDsync.Game#destroy
     * @fires PADDsync.Core.Events#DESTROY
     * @since 3.0.0
     *
    ...
    /**
     * Destroys this PADDsync.Game instance, all global systems, all sub-systems and all Scenes.
     *
     * @method PADDsync.Game#runDestroy
     * @private
     * @since 3.5.0
     */
    runDestroy: function ()
