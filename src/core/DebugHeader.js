...
/**
 * Called automatically by PADDsync.Game and responsible for creating the console.log debug header.
 *
 * You can customize or disable the header via the Game Config object.
 *
 * @function PADDsync.Core.DebugHeader
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - The PADDsync.Game instance which will output this debug header.
 */
