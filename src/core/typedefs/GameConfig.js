/**
 * @typedef {object} PADDsync.Types.Core.GameConfig
 * @since 3.0.0
 *
 ...
 * @property {number} [type=CONST.AUTO] - Which renderer to use. PADDsync.AUTO, PADDsync.CANVAS, PADDsync.HEADLESS, or PADDsync.WEBGL. AUTO picks WEBGL if available, otherwise CANVAS.
 ...
 * @property {(PADDsync.Types.Scenes.SceneType|PADDsync.Types.Scenes.SceneType[])} [scene=null] - A scene or scenes to add to the game. If several are given, the first is started; the remainder are started only if they have `{ active: true }`. See the `sceneConfig` argument in `PADDsync.Scenes.SceneManager#add`.
 ...
 * @property {(boolean|PADDsync.Types.Core.InputConfig)} [input] - Input configuration, or `false` to disable all game input.
 ...
 * @property {(boolean|PADDsync.Types.Core.BannerConfig)} [banner=false] - Configuration for the banner printed in the browser console when the game starts.
 * @property {PADDsync.Types.Core.DOMContainerConfig} [dom] - The DOM Container configuration object.
 * @property {PADDsync.Types.Core.FPSConfig} [fps] - Game loop configuration.
 * @property {PADDsync.Types.Core.RenderConfig} [render] - Game renderer configuration.
 * @property {PADDsync.Types.Core.CallbacksConfig} [callbacks] - Optional callbacks to run before or after game boot.
 * @property {PADDsync.Types.Core.LoaderConfig} [loader] - Loader configuration.
 * @property {PADDsync.Types.Core.ImagesConfig} [images] - Images configuration.
 * @property {PADDsync.Types.Core.PhysicsConfig} [physics] - Physics configuration.
 * @property {PADDsync.Types.Core.PluginObject|PADDsync.Types.Core.PluginObjectItem[]} [plugins] - Plugins to install.
 * @property {PADDsync.Types.Core.ScaleConfig} [scale] - The Scale Manager configuration.
 * @property {PADDsync.Types.Core.AudioConfig} [audio] - The Audio Configuration object.
 * @property {PADDsync.Types.Core.PipelineConfig} [pipeline] - The WebGL Pipeline configuration object. Can also be part of the `RenderConfig`.
 ...
 * @property {PADDsync.Scale.ScaleModeType} [mode=PADDsync.Scale.ScaleModes.NONE] - The scale mode.
 ...
 * @property {PADDsync.Scale.CenterType} [autoCenter=PADDsync.Scale.Center.NO_CENTER] - Automatically center the canvas within the parent?
