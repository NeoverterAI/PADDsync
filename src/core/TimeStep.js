 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - A reference to the PADDsync.Game instance that owns this Time Step.
 * @param {PADDsync.Types.Core.FPSConfig} config
 */
var TimeStep = new Class({
    ...
    function TimeStep (game, config)
    {
         ...
         *
         * @name PADDsync.Core.TimeStep#game
         * @type {PADDsync.Game}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#raf
         * @type {PADDsync.DOM.RequestAnimationFrame}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#started
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#running
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#minFps
         * @type {number}
         * @default 5
         * @since 3.0.0
         */
         ...
         * the control of PADDsync. Instead, it allows you to determine performance issues and if the Time Step
         * is spiraling out of control.
         *
         * @name PADDsync.Core.TimeStep#targetFps
         * @type {number}
         * @default 60
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#fpsLimit
         * @type {number}
         * @default 0
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#hasFpsLimit
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#_limitRate
         * @type {number}
         * @private
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#_min
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#_target
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#actualFps
         * @type {number}
         * @readonly
         * @default 60
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#nextFpsUpdate
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#framesThisSecond
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#callback
         * @type {PADDsync.Types.Core.TimeStepCallback}
         * @default NOOP
         * @since 3.0.0
         */
        this.callback = NOOP;
         ...
         *
         * @name PADDsync.Core.TimeStep#forceSetTimeOut
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#time
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#startTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#lastTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#frame
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#inFocus
         * @type {boolean}
         * @readonly
         * @default true
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#pauseDuration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.85.0
         ...
         *
         * @name PADDsync.Core.TimeStep#_pauseTime
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#_coolDown
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Core.TimeStep#delta
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#deltaIndex
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#deltaHistory
         * @type {number[]}
         * @since 3.0.0
         */
        this.deltaHistory = [];
         ...
         *
         * @name PADDsync.Core.TimeStep#deltaSmoothingMax
         * @type {number}
         * @default 10
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#panicMax
         * @type {number}
         * @default 120
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#rawDelta
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#now
         * @type {number}
         * @default 0
         * @since 3.18.0
         */
         ...
         *
         * @name PADDsync.Core.TimeStep#smoothStep
         * @type {boolean}
         * @since 3.22.0
         */
     ...
     *
     * @method PADDsync.Core.TimeStep#blur
     * @since 3.0.0
     */
    blur: function ()
    {
     ...
     *
     * @method PADDsync.Core.TimeStep#focus
     * @since 3.0.0
     */
    focus: function ()
    {
     ...
     *
     * @method PADDsync.Core.TimeStep#pause
     * @since 3.0.0
     */
    pause: function ()
    {
     ...
     *
     * @method PADDsync.Core.TimeStep#resume
     * @since 3.0.0
     */
    resume: function ()
    {
     ...
     *
     * @method PADDsync.Core.TimeStep#resetDelta
     * @since 3.0.0
     */
    resetDelta: function ()
    {
     ...
     *
     * @method PADDsync.Core.TimeStep#start
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Core.TimeStepCallback} callback - The callback to be invoked each time the Time Step steps.
     */
     ...
     *
     * @method PADDsync.Core.TimeStep#smoothDelta
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Core.TimeStep#updateFPS
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Core.TimeStep#stepLimitFPS
     * @since 3.60.0
     *
     * @param {number} time - The timestamp passed in from RequestAnimationFrame or setTimeout.
     */
     ...
     * You generally should never call this method directly.
     *
     * @method PADDsync.Core.TimeStep#step
     * @since 3.0.0
     *
     * @param {number} time - The timestamp passed in from RequestAnimationFrame or setTimeout.
     */
     ...
     *
     * @method PADDsync.Core.TimeStep#tick
     * @since 3.0.0
     */
    tick: function ()
    {
     ...
     *
     * @method PADDsync.Core.TimeStep#sleep
     * @since 3.0.0
     */
    sleep: function ()
    {
     ...
     *
     * @method PADDsync.Core.TimeStep#wake
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Core.TimeStep#getDuration
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Core.TimeStep#getDurationMS
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Core.TimeStep#stop
     * @since 3.0.0
     *
     ...
     * any objects.
     *
     * @method PADDsync.Core.TimeStep#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
