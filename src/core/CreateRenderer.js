...
/**
 * Called automatically by PADDsync.Game and responsible for creating the renderer it will use.
 *
 * Relies upon two webpack global flags to be defined: `WEBGL_RENDERER` and `CANVAS_RENDERER` during build time, but not at run-time.
 *
 * @function PADDsync.Core.CreateRenderer
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - The PADDsync.Game instance on which the renderer will be set.
 */
