 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Textures.Texture} texture - The Texture this Frame is a part of.
...
var Frame = new Class({
    ...
    function Frame (texture, name, sourceIndex, x, y, width, height)
    {
         ...
         *
         * @name PADDsync.Textures.Frame#texture
         ...
         *
         * @name PADDsync.Textures.Frame#name
         * @type {string}
         * @since 3.0.0
         */
        this.name = name;
         ...
         *
         * @name PADDsync.Textures.Frame#source
         ...
         *
         * @name PADDsync.Textures.Frame#sourceIndex
         * @type {number}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.Frame#cutX
         * @type {number}
         * @since 3.0.0
         */
        this.cutX;
         ...
         *
         * @name PADDsync.Textures.Frame#cutY
         * @type {number}
         * @since 3.0.0
         */
        this.cutY;
         ...
         *
         * @name PADDsync.Textures.Frame#cutWidth
         * @type {number}
         * @since 3.0.0
         */
        this.cutWidth;
         ...
         *
         * @name PADDsync.Textures.Frame#cutHeight
         * @type {number}
         * @since 3.0.0
         */
        this.cutHeight;
         ...
         *
         * @name PADDsync.Textures.Frame#x
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.Frame#y
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.Frame#width
         * @type {number}
         * @since 3.0.0
         */
        this.width;
         ...
         *
         * @name PADDsync.Textures.Frame#height
         * @type {number}
         * @since 3.0.0
         */
        this.height;
         ...
         *
         * @name PADDsync.Textures.Frame#halfWidth
         * @type {number}
         * @since 3.0.0
         */
        this.halfWidth;
         ...
         * Precalculated for the renderer.
         *
         * @name PADDsync.Textures.Frame#halfHeight
         * @type {number}
         * @since 3.0.0
         */
        this.halfHeight;
         ...
         *
         * @name PADDsync.Textures.Frame#centerX
         * @type {number}
         * @since 3.0.0
         */
        this.centerX;
         ...
         *
         * @name PADDsync.Textures.Frame#centerY
         * @type {number}
         * @since 3.0.0
         */
        this.centerY;
         ...
         *
         * @name PADDsync.Textures.Frame#pivotX
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.Frame#pivotY
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.Frame#customPivot
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.Frame#rotated
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         * 1 = Round
         *
         * @name PADDsync.Textures.Frame#autoRound
         * @type {number}
         * @default -1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.Frame#customData
         * @type {object}
         * @since 3.0.0
         */
        this.customData = {};
         ...
         * WebGL UV u0 value.
         *
         * @name PADDsync.Textures.Frame#u0
         * @type {number}
         * @default 0
         * @since 3.11.0
         */
         ...
         * WebGL UV v0 value.
         *
         * @name PADDsync.Textures.Frame#v0
         * @type {number}
         * @default 0
         * @since 3.11.0
         */
         ...
         * WebGL UV u1 value.
         *
         * @name PADDsync.Textures.Frame#u1
         * @type {number}
         * @default 0
         * @since 3.11.0
         */
         ...
         * WebGL UV v1 value.
         *
         * @name PADDsync.Textures.Frame#v1
         * @type {number}
         * @default 0
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Textures.Frame#data
         * @type {object}
         * @private
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Textures.Frame#setCutPosition
     * @since 3.85.0
     *
     ...
     *
     * @method PADDsync.Textures.Frame#setCutSize
     * @since 3.85.0
     *
     ...
     *
     * @method PADDsync.Textures.Frame#setSize
     * @since 3.7.0
     *
     ...
     *
     * @method PADDsync.Textures.Frame#setTrim
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Textures.Frame#setScale9
     * @since 3.70.0
     *
     ...
     *
     * @method PADDsync.Textures.Frame#setCropUVs
     * @since 3.11.0
     *
     ...
     *
     * @method PADDsync.Textures.Frame#updateCropUVs
     * @since 3.11.0
     *
     * @param {object} crop - The crop data object. This is the `GameObject._crop` property.
     * @param {boolean} flipX - Does the parent Game Object have flipX set?
     ...
     *
     * @method PADDsync.Textures.Frame#setUVs
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Textures.Frame#updateUVs
     * @since 3.0.0
     *
     * @return {this} This Frame object.
     */
     ...
     *
     * @method PADDsync.Textures.Frame#updateUVsInverted
     * @since 3.0.0
     *
     * @return {this} This Frame object.
     */
     ...
     *
     * @method PADDsync.Textures.Frame#clone
     * @since 3.0.0
     *
     * @return {PADDsync.Textures.Frame} A clone of this Frame.
     */
    clone: function ()
    {
     ...
     *
     * @method PADDsync.Textures.Frame#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     * 
     * @name PADDsync.Textures.Frame#glTexture
     ...
     * before being packed.
     *
     * @name PADDsync.Textures.Frame#realWidth
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     * before being packed.
     *
     * @name PADDsync.Textures.Frame#realHeight
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Textures.Frame#radius
     * @type {number}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Textures.Frame#trimmed
     * @type {boolean}
     * @readonly
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Textures.Frame#scale9
     * @type {boolean}
     * @readonly
     * @since 3.70.0
     */
     ...
     *
     * @name PADDsync.Textures.Frame#is3Slice
     * @type {boolean}
     * @readonly
     * @since 3.70.0
     */
     ...
     *
     * @name PADDsync.Textures.Frame#canvasData
     * @type {object}
     * @readonly
     * @since 3.0.0
     */
