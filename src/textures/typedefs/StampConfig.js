 ...
 *
 * @typedef {object} PADDsync.Types.Textures.StampConfig
 * @since 3.60.0
 *
 ...
 * @property {(string|PADDsync.BlendModes|number)} [blendMode=0] - The blend mode used when drawing the stamp. Defaults to 0 (normal).
