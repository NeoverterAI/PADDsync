 ...
 * @extends PADDsync.Textures.Texture
 * @memberof PADDsync.Textures
 * @constructor
 * @since 3.60.0
 *
 * @param {PADDsync.Textures.TextureManager} manager - A reference to the Texture Manager this Texture belongs to.
...
var DynamicTexture = new Class({
    ...
    function DynamicTexture (manager, key, width, height, forceEven)
    {
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#type
         * @type {string}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#renderer
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#width
         * @type {number}
         * @since 3.60.0
         */
        this.width = -1;
         ...
         * Treat this property as read-only. Use the `setSize` method to change the size.
         *
         * @name PADDsync.Textures.DynamicTexture#height
         * @type {number}
         * @since 3.60.0
         */
        this.height = -1;
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#isDrawing
         * @type {boolean}
         * @readonly
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#canvas
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#context
         * @readonly
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#dirty
         * @type {boolean}
         * @since 3.12.0
         */
        this.dirty = false;
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#isSpriteTexture
         * @type {boolean}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#_eraseMode
         * @type {boolean}
         * @private
         * @since 3.16.0
         */
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#camera
         ...
         *
         * @name PADDsync.Textures.DynamicTexture#renderTarget
         ...
         * This property remains `null` under Canvas.
         *
         * @name PADDsync.Textures.DynamicTexture#pipeline
         * @type {PADDsync.Renderer.WebGL.Pipelines.SinglePipeline}
         * @since 3.60.0
         */
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#setSize
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#setFromRenderTarget
     * @since 3.70.0
     *
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#setIsSpriteTexture
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#fill
     * @since 3.2.0
     *
     ...
     * @method PADDsync.Textures.DynamicTexture#clear
     * @since 3.2.0
     *
     * @param {number} [x=0] - The left coordinate of the fill rectangle.
     * @param {number} [y=0] - The top coordinate of the fill rectangle.
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#stamp
     * @since 3.60.0
     *
     ...
     * @param {PADDsync.Types.Textures.StampConfig} [config] - The stamp configuration object, allowing you to set the alpha, tint, angle, scale and origin of the stamp.
     *
     * @return {this} This Dynamic Texture instance.
     */
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#erase
     * @since 3.16.0
     *
     ...
     * calling this method, otherwise you will get vertically inverted frames in WebGL.
     *
     * @method PADDsync.Textures.DynamicTexture#draw
     * @since 3.2.0
     *
     ...
     * calling this method, otherwise you will get vertically inverted frames in WebGL.
     *
     * @method PADDsync.Textures.DynamicTexture#drawFrame
     * @since 3.12.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     * @param {(string|number)} [frame] - The name or index of the frame within the Texture. Set to `null` to skip this argument if not required.
     ...
     * calling this method, otherwise you will get vertically inverted frames in WebGL.
     *
     * @method PADDsync.Textures.DynamicTexture#repeat
     * @since 3.60.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     * @param {(string|number)} [frame] - The name or index of the frame within the Texture. Set to `null` to skip this argument if not required.
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#beginDraw
     * @since 3.50.0
     *
     * @return {this} This Dynamic Texture instance.
     */
     ...
     * Game Objects use their own alpha and tint values when being drawn.
     *
     * @method PADDsync.Textures.DynamicTexture#batchDraw
     * @since 3.50.0
     *
     ...
     * before it is drawn.
     *
     * @method PADDsync.Textures.DynamicTexture#batchDrawFrame
     * @since 3.50.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     ...
     * currently open, or not.
     *
     * @method PADDsync.Textures.DynamicTexture#endDraw
     * @since 3.50.0
     *
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#batchList
     * @private
     * @since 3.12.0
     *
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#batchGroup
     * @private
     * @since 3.12.0
     *
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#batchGameObject
     * @private
     * @since 3.12.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object to draw.
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#batchTextureFrameKey
     * @private
     * @since 3.12.0
     *
     * @param {string} key - The key of the texture to be used, as stored in the Texture Manager.
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#batchTextureFrame
     * @private
     * @since 3.12.0
     *
     * @param {PADDsync.Textures.Frame} textureFrame - The Texture Frame to draw.
     * @param {number} [x=0] - The x position to draw the Frame at.
     * @param {number} [y=0] - The y position to draw the Frame at.
     * @param {number} [alpha=1] -  The alpha value. Only used when drawing Texture Frames to this texture. Game Objects use their own alpha.
     * @param {number} [tint=0xffffff] -  The tint color value. Only used when drawing Texture Frames to this texture. Game Objects use their own tint. WebGL only.
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#snapshotArea
     * @since 3.19.0
     *
     ...
     * the larger the resolution this Dynamic Texture has, so please be careful how you employ this in your game.
     *
     * @method PADDsync.Textures.DynamicTexture#snapshot
     * @since 3.19.0
     *
     * @param {PADDsync.Types.Renderer.Snapshot.SnapshotCallback} callback - The Function to invoke after the snapshot image is created.
     * @param {string} [type='image/png'] - The format of the image to create, usually `image/png` or `image/jpeg`.
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#snapshotPixel
     * @since 3.19.0
     *
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#getWebGLTexture
     * @since 3.60.0
     *
     * @return {?PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} The underlying WebGLTextureWrapper, if not running in Canvas mode.
     */
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#renderWebGL
     * @since 3.60.0
     *
     * @param {PADDsync.Renderer.WebGL.WebGLRenderer} renderer - A reference to the current active WebGL renderer.
     * @param {PADDsync.GameObjects.Image} src - The Game Object being rendered in this call.
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#renderCanvas
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Textures.DynamicTexture#destroy
     * @since 3.60.0
     */
    destroy: function ()
    {
