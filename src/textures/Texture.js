...
var Texture = new Class({
    ...
    function Texture (manager, key, source, width, height)
    {
         ...
         *
         * @name PADDsync.Textures.Texture#manager
         ...
         *
         * @name PADDsync.Textures.Texture#key
         * @type {string}
         * @since 3.0.0
         */
        this.key = key;
         ...
         *
         * @name PADDsync.Textures.Texture#source
         ...
         *
         * @name PADDsync.Textures.Texture#dataSource
         * @type {array}
         * @since 3.0.0
         */
        this.dataSource = [];
         ...
         *
         * @name PADDsync.Textures.Texture#frames
         * @type {object}
         * @since 3.0.0
         */
        this.frames = {};
         ...
         *
         * @name PADDsync.Textures.Texture#customData
         * @type {object}
         * @since 3.0.0
         */
        this.customData = {};
         ...
         *
         * @name PADDsync.Textures.Texture#firstFrame
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.Texture#frameTotal
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
     ...
     *
     * @method PADDsync.Textures.Texture#add
     * @since 3.0.0
     *
     ...
     *
     * @return {?PADDsync.Textures.Frame} The Frame that was added to this Texture, or `null` if the given name already exists.
     */
     ...
     *
     * @method PADDsync.Textures.Texture#remove
     * @since 3.19.0
     *
     ...
     *
     * @method PADDsync.Textures.Texture#has
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Textures.Texture#get
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Textures.Texture#getTextureSourceIndex
     * @since 3.0.0
     *
     * @param {PADDsync.Textures.TextureSource} source - The TextureSource to check.
     *
     ...
     *
     * @method PADDsync.Textures.Texture#getFramesFromTextureSource
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Textures.Frame[]} An array of Texture Frames.
     */
     ...
     *
     * @method PADDsync.Textures.Texture#getFrameBounds
     * @since 3.80.0
     *
     * @param {number} [sourceIndex=0] - The index of the TextureSource to get the Frame bounds from.
     *
     * @return {PADDsync.Types.Math.RectangleLike} An object containing the bounds of the Frames using the given Texture Source Index.
     */
     ...
     *
     * @method PADDsync.Textures.Texture#getFrameNames
     * @since 3.0.0
     *
     * @param {boolean} [includeBase=false] - Include the `__BASE` Frame in the output array?
     *
     ...
     *
     * @method PADDsync.Textures.Texture#getSourceImage
     * @since 3.0.0
     *
     * @param {(string|number)} [name] - The string-based name, or integer based index, of the Frame to get from this Texture.
     *
     * @return {(HTMLImageElement|HTMLCanvasElement|PADDsync.GameObjects.RenderTexture)} The DOM Image, Canvas Element or Render Texture.
     */
     ...
     *
     * @method PADDsync.Textures.Texture#getDataSourceImage
     * @since 3.7.0
     *
     * @param {(string|number)} [name] - The string-based name, or integer based index, of the Frame to get from this Texture.
     *
     ...
     *
     * @method PADDsync.Textures.Texture#setDataSource
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Textures.Texture#setFilter
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Textures.Texture#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
