...
var CanvasTexture = new Class({
    ...
    function CanvasTexture (manager, key, source, width, height)
    {
         ...
         *
         * @name PADDsync.Textures.CanvasTexture#_source
         ...
         *
         * @name PADDsync.Textures.CanvasTexture#canvas
         * @readonly
         ...
         *
         * @name PADDsync.Textures.CanvasTexture#context
         * @readonly
         ...
         *
         * @name PADDsync.Textures.CanvasTexture#width
         * @readonly
         * @type {number}
         * @since 3.7.0
         */
         ...
         * This property is read-only, if you wish to change it use the `setSize` method.
         *
         * @name PADDsync.Textures.CanvasTexture#height
         * @readonly
         * @type {number}
         * @since 3.7.0
         */
         ...
         *
         * @name PADDsync.Textures.CanvasTexture#imageData
         * @type {ImageData}
         * @since 3.13.0
         */
         ...
         *
         * @name PADDsync.Textures.CanvasTexture#data
         ...
         *
         * @name PADDsync.Textures.CanvasTexture#pixels
         * @type {Uint32Array}
         * @since 3.13.0
         */
        this.pixels = null;
         ...
         *
         * @name PADDsync.Textures.CanvasTexture#buffer
         * @type {ArrayBuffer}
         * @since 3.13.0
         */
        this.buffer;
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#update
     * @since 3.13.0
     *
     * @return {PADDsync.Textures.CanvasTexture} This CanvasTexture.
     */
    update: function ()
    {
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#draw
     * @since 3.13.0
     *
     ...
     * ImageData buffer and arrays.
     *
     * @method PADDsync.Textures.CanvasTexture#drawFrame
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#setPixel
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#putData
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#getData
     * @since 3.16.0
     *
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#getPixel
     * @since 3.13.0
     *
     * @param {number} x - The x coordinate of the pixel to get. Must lay within the dimensions of this CanvasTexture and be an integer.
     * @param {number} y - The y coordinate of the pixel to get. Must lay within the dimensions of this CanvasTexture and be an integer.
     * @param {PADDsync.Display.Color} [out] - A Color object to store the pixel values in. If not provided a new Color object will be created.
     *
     * @return {PADDsync.Display.Color} An object with the red, green, blue and alpha values set in the r, g, b and a properties.
     */
     ...
     * otherwise this may return out of date color values, or worse - throw a run-time error as it tries to access an array element that doesn't exist.
     *
     * @method PADDsync.Textures.CanvasTexture#getPixels
     * @since 3.16.0
     *
     ...
     *
     * @return {PADDsync.Types.Textures.PixelConfig[][]} A 2d array of Pixel objects.
     */
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#getIndex
     * @since 3.16.0
     *
     * @param {number} x - The x coordinate of the pixel to get. Must lay within the dimensions of this CanvasTexture and be an integer.
     * @param {number} y - The y coordinate of the pixel to get. Must lay within the dimensions of this CanvasTexture and be an integer.
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#refresh
     * @since 3.7.0
     *
     * @return {PADDsync.Textures.CanvasTexture} This CanvasTexture.
     */
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#getCanvas
     * @since 3.7.0
     *
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#getContext
     * @since 3.7.0
     *
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#clear
     * @since 3.7.0
     *
     ...
     * @param {boolean} [update=true] - Update the internal ImageData buffer and arrays.
     *
     * @return {PADDsync.Textures.CanvasTexture} The Canvas Texture.
     */
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#setSize
     * @since 3.7.0
     *
     ...
     *
     * @method PADDsync.Textures.CanvasTexture#destroy
     * @since 3.16.0
     */
    destroy: function ()
    {
