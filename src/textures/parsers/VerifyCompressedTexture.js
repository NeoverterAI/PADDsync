 ...
 *
 * @function PADDsync.Textures.Parsers.verifyCompressedTexture
 * @param {PADDsync.Types.Textures.CompressedTextureData} data - The compressed texture data to verify.
 * @since 3.80.0
