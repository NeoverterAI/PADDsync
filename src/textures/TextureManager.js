 ...
 *
 * @param {PADDsync.Textures.Texture} texture - Each texture in Texture Manager.
 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - The PADDsync.Game instance this Texture Manager belongs to.
 */
var TextureManager = new Class({
    ...
    function TextureManager (game)
    {
         ...
         *
         * @name PADDsync.Textures.TextureManager#game
         * @type {PADDsync.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name PADDsync.Textures.TextureManager#name
         * @type {string}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.TextureManager#list
         * @type {object}
         * @default {}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Textures.TextureManager#_tempCanvas
         ...
         *
         * @name PADDsync.Textures.TextureManager#_tempContext
         ...
         *
         * @name PADDsync.Textures.TextureManager#_pending
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Textures.TextureManager#stamp
         * @type {PADDsync.GameObjects.Image}
         * @readonly
         * @since 3.60.0
         */
        this.stamp;
         ...
         *
         * @name PADDsync.Textures.TextureManager#stampCrop
         ...
         *
         * @name PADDsync.Textures.TextureManager#silentWarnings
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
    ...
    /**
     * The Boot Handler called by PADDsync.Game when it first starts up.
     *
     * @method PADDsync.Textures.TextureManager#boot
     * @private
     * @since 3.0.0
     */
    boot: function ()
     ...
     *
     * @method PADDsync.Textures.TextureManager#updatePending
     * @private
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#checkKey
     * @since 3.7.0
     *
     ...
     *
     * @method PADDsync.Textures.TextureManager#remove
     * @fires PADDsync.Textures.Events#REMOVE
     * @since 3.7.0
     *
     * @param {(string|PADDsync.Textures.Texture)} key - The key of the Texture to remove, or a reference to it.
     *
     * @return {PADDsync.Textures.TextureManager} The Texture Manager.
     */
    remove: function (key)
    {
     ...
     *
     * @method PADDsync.Textures.TextureManager#removeKey
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Textures.TextureManager#addBase64
     * @fires PADDsync.Textures.Events#ADD
     * @fires PADDsync.Textures.Events#ERROR
     * @fires PADDsync.Textures.Events#LOAD
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Textures.TextureManager#getBase64
     * @since 3.12.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @method PADDsync.Textures.TextureManager#addImage
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @return {?PADDsync.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#addGLTexture
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.19.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper} glTexture - The source Render Texture.
     *
     * @return {?PADDsync.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#addCompressedTexture
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.60.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {PADDsync.Types.Textures.CompressedTextureData} textureData - The Compressed Texture data object.
     ...
     *
     * @method PADDsync.Textures.TextureManager#addRenderTexture
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.12.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {PADDsync.GameObjects.RenderTexture} renderTexture - The source Render Texture.
     *
     * @return {?PADDsync.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#generate
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {PADDsync.Types.Create.GenerateTextureConfig} config - The configuration object needed to generate the texture.
     *
     * @return {?PADDsync.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#createCanvas
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @return {?PADDsync.Textures.CanvasTexture} The Canvas Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#addCanvas
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @method PADDsync.Textures.TextureManager#addDynamicTexture
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.60.0
     *
     * @param {(string|PADDsync.Textures.DynamicTexture)} key - The string-based key of this Texture. Must be unique within the Texture Manager. Or, a DynamicTexture instance.
     ...
     *
     * @return {?PADDsync.Textures.DynamicTexture} The Dynamic Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#addAtlas
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(HTMLImageElement|HTMLImageElement[]|PADDsync.Textures.Texture)} source - The source Image element/s, or a Phaser Texture.
     ...
     * As of Phaser 3.60 you can use this method to add a atlas data to an existing Phaser Texture.
     *
     * @method PADDsync.Textures.TextureManager#addAtlasJSONArray
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     * As of Phaser 3.60 you can use this method to add a atlas data to an existing Phaser Texture.
     *
     * @method PADDsync.Textures.TextureManager#addAtlasJSONHash
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     * As of Phaser 3.60 you can use this method to add a atlas data to an existing Phaser Texture.
     *
     * @method PADDsync.Textures.TextureManager#addAtlasXML
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.7.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(HTMLImageElement|PADDsync.Textures.Texture)} source - The source Image element, or a Phaser Texture.
     ...
     * As of Phaser 3.60 you can use this method to add a atlas data to an existing Phaser Texture.
     *
     * @method PADDsync.Textures.TextureManager#addUnityAtlas
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @method PADDsync.Textures.TextureManager#addSpriteSheet
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.0.0
     *
     ...
     * @param {(HTMLImageElement|PADDsync.Textures.Texture)} source - The source Image element, or a Phaser Texture.
     * @param {PADDsync.Types.Textures.SpriteSheetConfig} config - The configuration object for this Sprite Sheet.
     * @param {HTMLImageElement|HTMLCanvasElement} [dataSource] - An optional data Image element.
     *
     * @return {?PADDsync.Textures.Texture} The Texture that was created or updated, or `null` if the key is already in use.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#addSpriteSheetFromAtlas
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {PADDsync.Types.Textures.SpriteSheetFromAtlasConfig} config - The configuration object for this Sprite Sheet.
     *
     * @return {?PADDsync.Textures.Texture} The Texture that was created, or `null` if the key is already in use.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#addUint8Array
     * @fires PADDsync.Textures.Events#ADD
     * @since 3.80.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     ...
     *
     * @method PADDsync.Textures.TextureManager#create
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(HTMLImageElement|HTMLCanvasElement|HTMLImageElement[]|HTMLCanvasElement[]|PADDsync.Renderer.WebGL.Wrappers.WebGLTextureWrapper)} source - An array of sources that are used to create the texture. Usually Images, but can also be a Canvas.
     ...
     *
     * @method PADDsync.Textures.TextureManager#exists
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     *
     ...
     *
     * @method PADDsync.Textures.TextureManager#get
     * @since 3.0.0
     *
     * @param {(string|PADDsync.Textures.Texture|PADDsync.Textures.Frame)} key - The unique string-based key of the Texture, or a Texture, or Frame instance.
     *
     * @return {PADDsync.Textures.Texture} The Texture matching the given key.
     */
    get: function (key)
    {
     ...
     *
     * @method PADDsync.Textures.TextureManager#cloneFrame
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(string|number)} frame - The string or index of the Frame to be cloned.
     *
     * @return {PADDsync.Textures.Frame} A Clone of the given Frame.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#getFrame
     * @since 3.0.0
     *
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(string|number)} [frame] - The string-based name, or integer based index, of the Frame to get from the Texture.
     *
     * @return {PADDsync.Textures.Frame} A Texture Frame object.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#parseFrame
     * @since 3.60.0
     *
     * @param {(string|array|object|PADDsync.Textures.Texture|PADDsync.Textures.Frame)} key - The key to be parsed.
     *
     * @return {PADDsync.Textures.Frame} A Texture Frame object, if found, or undefined if not.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#getTextureKeys
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Textures.TextureManager#getPixel
     * @since 3.0.0
     *
     ...
     *
     * @return {?PADDsync.Display.Color} A Color object populated with the color values of the requested pixel,
     ...
     *
     * @method PADDsync.Textures.TextureManager#getPixelAlpha
     * @since 3.10.0
     *
     * @param {number} x - The x coordinate of the pixel within the Texture.
     * @param {number} y - The y coordinate of the pixel within the Texture.
     ...
     *
     * @method PADDsync.Textures.TextureManager#setTexture
     * @since 3.0.0
     *
     * @param {PADDsync.GameObjects.GameObject} gameObject - The Game Object the texture would be set on.
     * @param {string} key - The unique string-based key of the Texture.
     * @param {(string|number)} [frame] - The string or index of the Frame.
     *
     * @return {PADDsync.GameObjects.GameObject} The Game Object the texture was set on.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#renameTexture
     * @since 3.12.0
     *
     ...
     *
     * @method PADDsync.Textures.TextureManager#each
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Textures.TextureManager#resetStamp
     * @since 3.60.0
     *
     * @param {number} [alpha=1] - The alpha to use.
     * @param {number} [tint=0xffffff] - WebGL only. The tint color to use.
     *
     * @return {PADDsync.GameObjects.Image} A reference to the Stamp Game Object.
     */
     ...
     *
     * @method PADDsync.Textures.TextureManager#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
