 ...
 * @memberof PADDsync.Sound
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - Reference to the current game instance.
 *
 * @see PADDsync.Sound.HTML5AudioSoundManager
 * @see PADDsync.Sound.NoAudioSoundManager
 * @see PADDsync.Sound.WebAudioSoundManager
 */
var BaseSoundManager = new Class({
    ...
    function BaseSoundManager (game)
    {
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#game
         * @type {PADDsync.Game}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#jsonCache
         * @type {PADDsync.Cache.BaseCache}
         * @readonly
         * @since 3.7.0
         */
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#sounds
         * @type {PADDsync.Sound.BaseSound[]}
         * @default []
         * @private
         * @since 3.0.0
         */
         ...
         * Global mute setting.
         *
         * @name PADDsync.Sound.BaseSoundManager#mute
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#volume
         * @type {number}
         * @default 1
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#pauseOnBlur
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#_rate
         * @type {number}
         * @private
         * @default 1
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#_detune
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#locked
         * @type {boolean}
         * @readonly
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#unlocked
         * @type {boolean}
         * @default false
         * @private
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#gameLostFocus
         * @type {boolean}
         * @default false
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Sound.BaseSoundManager#listenerPosition
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#add
     * @override
     * @since 3.0.0
     *
     * @param {string} key - Asset key for the sound.
     * @param {PADDsync.Types.Sound.SoundConfig} [config] - An optional config object containing default sound settings.
     *
     * @return {PADDsync.Sound.BaseSound} The new sound instance.
     */
    add: NOOP,
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#addAudioSprite
     * @since 3.0.0
     *
     * @param {string} key - Asset key for the sound.
     * @param {PADDsync.Types.Sound.SoundConfig} [config] - An optional config object containing default sound settings.
     *
     * @return {(PADDsync.Sound.NoAudioSound|PADDsync.Sound.HTML5AudioSound|PADDsync.Sound.WebAudioSound)} The new audio sprite sound instance.
     */
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#get
     * @since 3.23.0
     *
     * @generic {PADDsync.Sound.BaseSound} T
     * @genericUse {T} - [$return]
     *
     * @param {string} key - Sound asset key.
     *
     * @return {?PADDsync.Sound.BaseSound} - The sound, or null.
     */
    get: function (key)
    {
     ...
     * will be returned.
     *
     * @method PADDsync.Sound.BaseSoundManager#getAll
     * @since 3.23.0
     *
     * @generic {PADDsync.Sound.BaseSound} T
     * @genericUse {T[]} - [$return]
     ...
     *
     * @return {PADDsync.Sound.BaseSound[]} - The sounds, or an empty array.
     */
    getAll: function (key)
    {
        if (key)
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#getAllPlaying
     * @since 3.60.0
     *
     * @generic {PADDsync.Sound.BaseSound} T
     * @genericUse {T[]} - [$return]
     *
     * @return {PADDsync.Sound.BaseSound[]} - All currently playing sounds, or an empty array.
     */
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#play
     * @listens PADDsync.Sound.Events#COMPLETE
     * @since 3.0.0
     *
     * @param {string} key - Asset key for the sound.
     * @param {(PADDsync.Types.Sound.SoundConfig|PADDsync.Types.Sound.SoundMarker)} [extra] - An optional additional object containing settings to be applied to the sound. It could be either config or marker object.
     *
     ...
     * This lets you play a new sound on the fly without the need to keep a reference to it.
     *
     * @method PADDsync.Sound.BaseSoundManager#playAudioSprite
     * @listens PADDsync.Sound.Events#COMPLETE
     * @since 3.0.0
     *
     * @param {string} key - Asset key for the sound.
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#remove
     * @since 3.0.0
     *
     * @param {PADDsync.Sound.BaseSound} sound - The sound object to remove.
     *
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#removeAll
     * @since 3.23.0
     */
    removeAll: function ()
    {
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#removeByKey
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#pauseAll
     * @fires PADDsync.Sound.Events#PAUSE_ALL
     * @since 3.0.0
     */
    pauseAll: function ()
    {
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#resumeAll
     * @fires PADDsync.Sound.Events#RESUME_ALL
     * @since 3.0.0
     */
    resumeAll: function ()
    {
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#setListenerPosition
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#stopAll
     * @fires PADDsync.Sound.Events#STOP_ALL
     * @since 3.0.0
     */
    stopAll: function ()
    {
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#stopByKey
     * @since 3.23.0
     *
     * @param {string} key - Sound asset key.
     *
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#isPlaying
     * @since 3.85.0
     *
     * @param {?string} key - Sound asset key.
     *
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#unlock
     * @override
     * @protected
     * @since 3.0.0
     */
     ...
     * PADDsync.Sound.BaseSoundManager#pauseOnBlur is set to true.
     *
     * @method PADDsync.Sound.BaseSoundManager#onBlur
     * @override
     * @protected
     * @since 3.0.0
     */
     ...
     * PADDsync.Sound.BaseSoundManager#pauseOnBlur is set to true.
     *
     * @method PADDsync.Sound.BaseSoundManager#onFocus
     * @override
     * @protected
     * @since 3.0.0
     */
    ...
    /**
     * Internal handler for PADDsync.Core.Events#BLUR.
     *
     * @method PADDsync.Sound.BaseSoundManager#onGameBlur
     * @private
     * @since 3.23.0
     */
    onGameBlur: function ()
    ...
    /**
     * Internal handler for PADDsync.Core.Events#FOCUS.
     *
     * @method PADDsync.Sound.BaseSoundManager#onGameFocus
     * @private
     * @since 3.23.0
     */
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#update
     * @protected
     * @fires PADDsync.Sound.Events#UNLOCKED
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#forEachActiveSound
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.Types.Sound.EachActiveSoundCallback} callback - Callback function. (manager: PADDsync.Sound.BaseSoundManager, sound: PADDsync.Sound.BaseSound, index: number, sounds: PADDsync.Manager.BaseSound[]) => void
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#setRate
     * @fires PADDsync.Sound.Events#GLOBAL_RATE
     * @since 3.3.0
     *
     ...
     *
     * @name PADDsync.Sound.BaseSoundManager#rate
     * @type {number}
     * @default 1
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Sound.BaseSoundManager#setDetune
     * @fires PADDsync.Sound.Events#GLOBAL_DETUNE
     * @since 3.3.0
     *
     ...
     * The range of the value is -1200 to 1200, but we recommend setting it to [50](https://en.wikipedia.org/wiki/50_Cent).
     *
     * @name PADDsync.Sound.BaseSoundManager#detune
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
