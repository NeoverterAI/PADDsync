...
var WebAudioSoundManager = new Class({
    ...
    function WebAudioSoundManager (game)
    {
         ...
         *
         * @name PADDsync.Sound.WebAudioSoundManager#context
         * @type {AudioContext}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSoundManager#masterMuteNode
         * @type {GainNode}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSoundManager#masterVolumeNode
         * @type {GainNode}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSoundManager#destination
         * @type {AudioNode}
         * @since 3.0.0
         */
    ...
    /**
     * Internal handler for PADDsync.Core.Events#VISIBLE.
     * 
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#onGameVisible
     * @private
     * @since 3.88.0
     */
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#createAudioContext
     * @since 3.0.0
     *
     * @param {PADDsync.Game} game - Reference to the current game instance.
     *
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#setAudioContext
     * @since 3.21.0
     *
     ...
     *
     * Instead of passing a single entry you can instead pass an array of `PADDsync.Types.Sound.DecodeAudioConfig`
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#decodeAudio
     * @fires PADDsync.Sound.Events#DECODED
     * @fires PADDsync.Sound.Events#DECODED_ALL
     * @since 3.18.0
     *
     * @param {(PADDsync.Types.Sound.DecodeAudioConfig[]|string)} [audioKey] - The string-based key to be used to reference the decoded audio in the audio cache, or an array of audio config objects.
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#setListenerPosition
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#unlock
     * @since 3.0.0
     */
    unlock: function ()
    {
     ...
     * PADDsync.Sound.WebAudioSoundManager#pauseOnBlur is set to true.
     *
     * @method PADDsync.Sound.WebAudioSoundManager#onBlur
     * @protected
     * @since 3.0.0
     */
    onBlur: function ()
     ...
     * PADDsync.Sound.WebAudioSoundManager#pauseOnBlur is set to true.
     *
     * @method PADDsync.Sound.WebAudioSoundManager#onFocus
     * @protected
     * @since 3.0.0
     */
    onFocus: function ()
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#update
     * @protected
    ...
    /**
     * Calls PADDsync.Sound.BaseSoundManager#destroy method
     * and cleans up all Web Audio API related stuff.
     *
     * @method PADDsync.Sound.WebAudioSoundManager#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#setMute
     * @fires PADDsync.Sound.Events#GLOBAL_MUTE
     * @since 3.3.0
     *
     * @param {boolean} value - `true` to mute all sounds, `false` to unmute them.
     *
     * @return {PADDsync.Sound.WebAudioSoundManager} This Sound Manager.
     */
    ...
    /**
     * @name PADDsync.Sound.WebAudioSoundManager#mute
     * @type {boolean}
     * @fires PADDsync.Sound.Events#GLOBAL_MUTE
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Sound.WebAudioSoundManager#setVolume
     * @fires PADDsync.Sound.Events#GLOBAL_VOLUME
     * @since 3.3.0
     *
    ...
    /**
     * @name PADDsync.Sound.WebAudioSoundManager#volume
     * @type {number}
     * @fires PADDsync.Sound.Events#GLOBAL_VOLUME
     * @since 3.0.0
     */
