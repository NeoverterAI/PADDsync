 ...
 *
 * @class WebAudioSound
 * @extends PADDsync.Sound.BaseSound
 * @memberof PADDsync.Sound
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Sound.WebAudioSoundManager} manager - Reference to the WebAudio Sound Manager that owns this Sound instance.
...
var WebAudioSound = new Class({
    ...
    function WebAudioSound (manager, key, config)
    {
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#audioBuffer
         * @type {AudioBuffer}
         * @since 3.0.0
         */
         ...
         * audio data stored in PADDsync.Sound.WebAudioSound#audioBuffer.
         *
         * @name PADDsync.Sound.WebAudioSound#source
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#loopSource
         * @type {AudioBufferSourceNode}
         * @default null
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#muteNode
         * @type {GainNode}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#volumeNode
         * @type {GainNode}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#pannerNode
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#spatialNode
         * @type {PannerNode}
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#spatialSource
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#playTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * Based on `BaseAudioContext.currentTime` value.
         *
         * @name PADDsync.Sound.WebAudioSound#startTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         * Based on `BaseAudioContext.currentTime` value.
         *
         * @name PADDsync.Sound.WebAudioSound#loopTime
         * @type {number}
         * @default 0
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#rateUpdates
         * @type {array}
         * @default []
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Sound.WebAudioSound#hasEnded
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
         ...
         * so its state can be updated accordingly.
         *
         * @name PADDsync.Sound.WebAudioSound#hasLooped
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.0.0
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#play
     * @fires PADDsync.Sound.Events#PLAY
     * @since 3.0.0
     *
     * @param {(string|PADDsync.Types.Sound.SoundConfig)} [markerName=''] - If you want to play a marker then provide the marker name here. Alternatively, this parameter can be a SoundConfig object.
     * @param {PADDsync.Types.Sound.SoundConfig} [config] - Optional sound config object to be applied to this marker or entire sound if no marker name is provided. It gets memorized for future plays of current section of the sound.
     *
     ...
     * Pauses the sound.
     *
     * @method PADDsync.Sound.WebAudioSound#pause
     * @fires PADDsync.Sound.Events#PAUSE
     * @since 3.0.0
     *
     ...
     * Resumes the sound.
     *
     * @method PADDsync.Sound.WebAudioSound#resume
     * @fires PADDsync.Sound.Events#RESUME
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#stop
     * @fires PADDsync.Sound.Events#STOP
     * @since 3.0.0
     *
     ...
     * Used internally.
     *
     * @method PADDsync.Sound.WebAudioSound#createAndStartBufferSource
     * @private
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#createAndStartLoopBufferSource
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#createBufferSource
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#stopAndRemoveBufferSource
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#stopAndRemoveLoopBufferSource
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#applyConfig
     * @since 3.0.0
     */
     ...
     * the spatial sound.
     *
     * @name PADDsync.Sound.WebAudioSound#x
     * @type {number}
     * @since 3.60.0
     */
    x: {
     ...
     * the spatial sound.
     *
     * @name PADDsync.Sound.WebAudioSound#y
     * @type {number}
     * @since 3.60.0
     */
    y: {
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#update
     * @fires PADDsync.Sound.Events#COMPLETE
     * @fires PADDsync.Sound.Events#LOOPED
     * @since 3.0.0
     */
    update: function ()
    {
    ...
    /**
     * Calls PADDsync.Sound.BaseSound#destroy method
     * and cleans up all Web Audio API related stuff.
     *
     * @method PADDsync.Sound.WebAudioSound#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#calculateRate
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#getCurrentTime
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#getLoopTime
     * @since 3.0.0
     */
     ...
     *
     * @name PADDsync.Sound.WebAudioSound#rate
     * @type {number}
     * @default 1
     * @fires PADDsync.Sound.Events#RATE
     * @since 3.0.0
     */
    rate: {
     ...
     * and 2.0 doubles the audios playback speed.
     *
     * @method PADDsync.Sound.WebAudioSound#setRate
     * @fires PADDsync.Sound.Events#RATE
     * @since 3.3.0
     *
     ...
     *
     * @name PADDsync.Sound.WebAudioSound#detune
     * @type {number}
     * @default 0
     * @fires PADDsync.Sound.Events#DETUNE
     * @since 3.0.0
     */
    detune: {
     ...
     * The range of the value is -1200 to 1200, but we recommend setting it to [50](https://en.wikipedia.org/wiki/50_Cent).
     *
     * @method PADDsync.Sound.WebAudioSound#setDetune
     * @fires PADDsync.Sound.Events#DETUNE
     * @since 3.3.0
     *
     ...
     *
     * @name PADDsync.Sound.WebAudioSound#mute
     * @type {boolean}
     * @default false
     * @fires PADDsync.Sound.Events#MUTE
     * @since 3.0.0
     */
    mute: {
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#setMute
     * @fires PADDsync.Sound.Events#MUTE
     * @since 3.4.0
     *
     ...
     *
     * @name PADDsync.Sound.WebAudioSound#volume
     * @type {number}
     * @default 1
     * @fires PADDsync.Sound.Events#VOLUME
     * @since 3.0.0
     */
    volume: {
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#setVolume
     * @fires PADDsync.Sound.Events#VOLUME
     * @since 3.4.0
     *
     ...
     *
     * @name PADDsync.Sound.WebAudioSound#seek
     * @type {number}
     * @fires PADDsync.Sound.Events#SEEK
     * @since 3.0.0
     */
    seek: {
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#setSeek
     * @fires PADDsync.Sound.Events#SEEK
     * @since 3.4.0
     *
     ...
     *
     * @name PADDsync.Sound.WebAudioSound#loop
     * @type {boolean}
     * @default false
     * @fires PADDsync.Sound.Events#LOOP
     * @since 3.0.0
     */
    loop: {
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#setLoop
     * @fires PADDsync.Sound.Events#LOOP
     * @since 3.4.0
     *
     ...
     *
     * @name PADDsync.Sound.WebAudioSound#pan
     * @type {number}
     * @default 0
     * @fires PADDsync.Sound.Events#PAN
     * @since 3.50.0
     */
    pan: {
     ...
     *
     * @method PADDsync.Sound.WebAudioSound#setPan
     * @fires PADDsync.Sound.Events#PAN
     * @since 3.50.0
     *
