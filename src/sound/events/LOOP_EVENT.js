 ...
 * ```
 *
 * This is not to be confused with the [LOOPED]{@linkcode PADDsync.Sound.Events#event:LOOPED} event, which emits each time a Sound loops during playback.
 *
 * @event PADDsync.Sound.Events#LOOP
 * @type {string}
 * @since 3.0.0
 *
