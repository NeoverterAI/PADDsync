 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene that this ScenePlugin belongs to.
 */
var ScenePlugin = new Class({
    ...
    function ScenePlugin (scene)
    {
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#systems
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#settings
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#key
         * @type {string}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#manager
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#transitionProgress
         * @type {number}
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#_elapsed
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         * Transition elapsed timer.
         *
         * @name PADDsync.Scenes.ScenePlugin#_target
         * @type {?PADDsync.Scene}
         * @private
         * @since 3.5.0
         */
         ...
         * Transition duration.
         *
         * @name PADDsync.Scenes.ScenePlugin#_duration
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         * Transition callback.
         *
         * @name PADDsync.Scenes.ScenePlugin#_onUpdate
         * @type {function}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#_onUpdateScope
         * @type {object}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#_willSleep
         * @type {boolean}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Scenes.ScenePlugin#_willRemove
         * @type {boolean}
         * @private
         * @since 3.5.0
         */
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#boot
     * @private
     * @since 3.0.0
     */
    boot: function ()
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Scenes.ScenePlugin#pluginStart
     * @private
     * @since 3.5.0
     */
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#start
     * @since 3.0.0
     *
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method PADDsync.Scenes.ScenePlugin#restart
     * @since 3.4.0
     *
     * @param {object} [data] - The Scene data. If no value is given it will not overwrite any previous data that may exist.
     *
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#transition
     * @fires PADDsync.Scenes.Events#TRANSITION_OUT
     * @since 3.5.0
     *
     * @param {PADDsync.Types.Scenes.SceneTransitionConfig} config - The transition configuration object.
     *
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#checkValidTransition
     * @private
     * @since 3.5.0
     *
     * @param {PADDsync.Scene} target - The Scene to test against.
     *
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#step
     * @private
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#transitionComplete
     * @private
     * @fires PADDsync.Scenes.Events#TRANSITION_COMPLETE
     * @since 3.5.0
     */
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#add
     * @since 3.0.0
     *
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method PADDsync.Scenes.ScenePlugin#launch
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to launch.
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#run
     * @since 3.10.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method PADDsync.Scenes.ScenePlugin#pause
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method PADDsync.Scenes.ScenePlugin#resume
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method PADDsync.Scenes.ScenePlugin#sleep
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method PADDsync.Scenes.ScenePlugin#wake
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * This will happen at the next Scene Manager update, not immediately.
     *
     * @method PADDsync.Scenes.ScenePlugin#switch
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#stop
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#setActive
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * @param {(string|PADDsync.Scene)} [key] - The Scene to set the active state of.
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#setVisible
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * @param {(string|PADDsync.Scene)} [key] - The Scene to set the visible state for.
     *
     * @return {this} This Scene Plugin instance.
     */
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#isSleeping
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#isActive
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#isPaused
     * @since 3.17.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#isVisible
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#swapPosition
     * @since 3.2.0
     *
     * @generic {PADDsync.Scene} T
     ...
     * @param {(string|PADDsync.Scene)} [keyB] - The second Scene to swap. If none is given it defaults to this Scene.
     *
     * @return {this} This Scene Plugin instance.
     */
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#moveAbove
     * @since 3.2.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|PADDsync.Scene)} keyA - The Scene that Scene B will be moved to be above.
     * @param {(string|PADDsync.Scene)} [keyB] - The Scene to be moved. If none is given it defaults to this Scene.
     *
     * @return {this} This Scene Plugin instance.
     */
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#moveBelow
     * @since 3.2.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|PADDsync.Scene)} keyA - The Scene that Scene B will be moved to be below.
     * @param {(string|PADDsync.Scene)} [keyB] - The Scene to be moved. If none is given it defaults to this Scene.
     *
     * @return {this} This Scene Plugin instance.
     */
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#remove
     * @since 3.2.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} [key] - The Scene to be removed.
     *
     * @return {this} This Scene Plugin instance.
     */
    remove: function (key)
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#moveUp
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#moveDown
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#bringToTop
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#sendToBack
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     * @genericUse {T} - [$return]
     *
     * @method PADDsync.Scenes.ScenePlugin#get
     * @since 3.0.0
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to retrieve.
     *
     * @return {PADDsync.Scene} The Scene.
     */
    get: function (key)
    {
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#getStatus
     * @since 3.60.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to get the status from.
     *
     * @return {number} The Scene status. This maps to the `PADDsync.Scene` constants, such as `PADDsync.Scene.LOADING`.
     */
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#getIndex
     * @since 3.7.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} [key] - The Scene to get the index of.
     *
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.Scenes.ScenePlugin#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function ()
