 ...
 *
 * @class SceneManager
 * @memberof PADDsync.Scenes
 * @constructor
 * @since 3.0.0
 *
 * @param {PADDsync.Game} game - The PADDsync.Game instance this Scene Manager belongs to.
...
var SceneManager = new Class({
    ...
    function SceneManager (game, sceneConfig)
    {
         ...
         *
         * @name PADDsync.Scenes.SceneManager#game
         * @type {PADDsync.Game}
         * @since 3.0.0
         */
        this.game = game;
         ...
         *
         * @name PADDsync.Scenes.SceneManager#keys
         * @type {Record<string, PADDsync.Scene>}
         * @since 3.0.0
         */
        this.keys = {};
         ...
         *
         * @name PADDsync.Scenes.SceneManager#scenes
         * @type {PADDsync.Scene[]}
         * @since 3.0.0
         */
        this.scenes = [];
         ...
         *
         * @name PADDsync.Scenes.SceneManager#_pending
         * @type {array}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Scenes.SceneManager#_start
         * @type {array}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Scenes.SceneManager#_queue
         * @type {array}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Scenes.SceneManager#_data
         * @type {object}
         * @private
         * @since 3.4.0
         */
         ...
         *
         * @name PADDsync.Scenes.SceneManager#isProcessing
         * @type {boolean}
         * @default false
         * @readonly
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Scenes.SceneManager#isBooted
         * @type {boolean}
         * @default false
         * @readonly
         * @since 3.4.0
         ...
         *
         * @name PADDsync.Scenes.SceneManager#customViewports
         * @type {number}
         * @default 0
         * @since 3.12.0
         */
         ...
         * being tied to one.
         *
         * @name PADDsync.Scenes.SceneManager#systemScene
         * @type {PADDsync.Scene}
         * @since 3.60.0
         */
        this.systemScene;
     ...
     *
     * @method PADDsync.Scenes.SceneManager#bootQueue
     * @private
     * @fires PADDsync.Core.Events#SYSTEM_READY
     * @since 3.2.0
     */
    bootQueue: function ()
    {
     ...
     *
     * @method PADDsync.Scenes.SceneManager#processQueue
     * @since 3.0.0
     */
     ...
     *
     * * A `PADDsync.Scene` object, or an object that extends it.
     * * A plain JavaScript object
     * * A JavaScript ES6 Class that extends `PADDsync.Scene`
     * * A JavaScript ES5 prototype based Class
     * * A JavaScript function
     *
     * If a function is given then a new Scene will be created by calling it.
     *
     * @method PADDsync.Scenes.SceneManager#add
     * @since 3.0.0
     *
     * @param {string} key - A unique key used to reference the Scene, i.e. `MainMenu` or `Level1`.
     * @param {(PADDsync.Types.Scenes.SceneType)} sceneConfig - The config for the Scene
     ...
     *
     * @return {?PADDsync.Scene} The added Scene, if it was added immediately, otherwise `null`.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#remove
     * @since 3.2.0
     *
     * @param {string} key - A unique key used to reference the Scene, i.e. `MainMenu` or `Level1`.
     *
     ...
     *
     * @method PADDsync.Scenes.SceneManager#bootScene
     * @private
     * @fires PADDsync.Scenes.Events#TRANSITION_INIT
     * @since 3.0.0
     *
     * @param {PADDsync.Scene} scene - The Scene to boot.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#loadComplete
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.Loader.LoaderPlugin} loader - The loader that has completed loading.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#payloadComplete
     * @private
     * @since 3.0.0
     *
     * @param {PADDsync.Loader.LoaderPlugin} loader - The loader that has completed loading its Scene's payload.
     */
     ...
     * Updates the Scenes.
     *
     * @method PADDsync.Scenes.SceneManager#update
     * @since 3.0.0
     *
     ...
     * Renders the Scenes.
     *
     * @method PADDsync.Scenes.SceneManager#render
     * @since 3.0.0
     *
     * @param {(PADDsync.Renderer.Canvas.CanvasRenderer|PADDsync.Renderer.WebGL.WebGLRenderer)} renderer - The renderer to use.
     */
    ...
    /**
     * Calls the given Scene's {@link PADDsync.Scene#create} method and updates its status.
     *
     * @method PADDsync.Scenes.SceneManager#create
     * @private
     * @fires PADDsync.Scenes.Events#CREATE
     * @fires PADDsync.Scenes.Events#TRANSITION_INIT
     * @since 3.0.0
     *
     * @param {PADDsync.Scene} scene - The Scene to create.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#createSceneFromFunction
     * @private
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Scene} The created Scene.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#createSceneFromInstance
     * @private
     * @since 3.0.0
     *
     * @param {string} key - The key of the Scene.
     * @param {PADDsync.Scene} newScene - The Scene instance.
     *
     * @return {PADDsync.Scene} The created Scene.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#createSceneFromObject
     * @private
     * @since 3.0.0
     *
     * @param {string} key - The key of the Scene.
     * @param {(string|PADDsync.Types.Scenes.SettingsConfig|PADDsync.Types.Scenes.CreateSceneFromObjectConfig)} sceneConfig - The Scene config.
     *
     * @return {PADDsync.Scene} The created Scene.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#getKey
     * @private
     * @since 3.0.0
     *
     * @param {string} key - The key to check in the Scene config.
     * @param {(PADDsync.Scene|PADDsync.Types.Scenes.SettingsConfig|function)} sceneConfig - The Scene config.
     *
     ...
     *
     * @method PADDsync.Scenes.SceneManager#getScenes
     * @since 3.16.0
     *
     * @generic {PADDsync.Scene[]} T - [$return]
     * @genericUse {T} - [$return]
     *
     ...
     *
     * @return {PADDsync.Scene[]} An array containing all of the Scenes in the Scene Manager.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#getScene
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     * @genericUse {T} - [$return]
     *
     * @param {(string|PADDsync.Scene)} key - The key of the Scene to retrieve.
     *
     * @return {?PADDsync.Scene} The Scene, or `null` if no matching Scene was found.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#isActive
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to check.
     *
     ...
     *
     * @method PADDsync.Scenes.SceneManager#isPaused
     * @since 3.17.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.SceneManager#isVisible
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.SceneManager#isSleeping
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.SceneManager#pause
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to pause.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#resume
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to resume.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#sleep
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to put to sleep.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#wake
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to wake up.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#run
     * @since 3.10.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to run.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#start
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to start.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#stop
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to stop.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#switch
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [from,to]
     *
     * @param {(string|PADDsync.Scene)} from - The Scene to sleep.
     * @param {(string|PADDsync.Scene)} to - The Scene to start.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#getAt
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {T} - [$return]
     ...
     *
     * @return {(PADDsync.Scene|undefined)} The Scene.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#getIndex
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The key of the Scene.
     *
     ...
     *
     * @method PADDsync.Scenes.SceneManager#bringToTop
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     *
     * @param {(string|PADDsync.Scene)} key - The Scene to move.
     *
     * @return {this} This Scene Manager instance.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#sendToBack
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.SceneManager#moveDown
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.SceneManager#moveUp
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [key]
     ...
     *
     * @method PADDsync.Scenes.SceneManager#moveAbove
     * @since 3.2.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|PADDsync.Scene)} keyA - The Scene that Scene B will be moved above.
     * @param {(string|PADDsync.Scene)} keyB - The Scene to be moved.
     *
     * @return {this} This Scene Manager instance.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#moveBelow
     * @since 3.2.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|PADDsync.Scene)} keyA - The Scene that Scene B will be moved below.
     * @param {(string|PADDsync.Scene)} keyB - The Scene to be moved.
     *
     * @return {this} This Scene Manager instance.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#queueOp
     * @private
     * @since 3.0.0
     *
     * @param {string} op - The operation to perform.
     * @param {(string|PADDsync.Scene)} keyA - Scene A.
     * @param {(any|string|PADDsync.Scene)} [keyB] - Scene B, or a data object.
     ...
     *
     * @method PADDsync.Scenes.SceneManager#swapPosition
     * @since 3.0.0
     *
     * @generic {PADDsync.Scene} T
     * @genericUse {(T|string)} - [keyA,keyB]
     *
     * @param {(string|PADDsync.Scene)} keyA - The first Scene to swap.
     * @param {(string|PADDsync.Scene)} keyB - The second Scene to swap.
     *
     * @return {this} This Scene Manager instance.
     */
     ...
     *
     * @method PADDsync.Scenes.SceneManager#dump
     * @since 3.2.0
     */
    dump: function ()
    {
     ...
     *
     * @method PADDsync.Scenes.SceneManager#destroy
     * @since 3.0.0
     */
    destroy: function ()
    {
