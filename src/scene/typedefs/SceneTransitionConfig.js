/**
 * @typedef {object} PADDsync.Types.Scenes.SceneTransitionConfig
 * @since 3.5.0
 *
 ...
 * @property {PADDsync.Types.Scenes.SceneTransitionOnStartCallback} [onStart] - This callback is invoked when transition starting.
