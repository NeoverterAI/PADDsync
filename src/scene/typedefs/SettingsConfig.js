/**
 * @typedef {object} PADDsync.Types.Scenes.SettingsConfig
 * @since 3.0.0
 *
 ...
 * @property {(false|PADDsync.Types.Loader.FileTypes.PackFileSection)} [pack=false] - Files to be loaded before the Scene begins.
 * @property {?(PADDsync.Types.Cameras.Scene2D.CameraConfig|PADDsync.Types.Cameras.Scene2D.CameraConfig[])} [cameras=null] - An optional Camera configuration object.
