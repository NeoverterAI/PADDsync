 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene that owns this Systems instance.
 * @param {(string|PADDsync.Types.Scenes.SettingsConfig)} config - Scene specific configuration settings.
 */
var Systems = new Class({
    ...
    function Systems (scene, config)
    {
         ...
         *
         * @name PADDsync.Scenes.Systems#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Scenes.Systems#game
         * @type {PADDsync.Game}
         * @since 3.0.0
         */
        this.game;
         ...
         *
         * @name PADDsync.Scenes.Systems#renderer
        ...
        if (typeof PLUGIN_FBINSTANT)
        {
             ...
             *
             * @name PADDsync.Scenes.Systems#facebook
         ...
         *
         * @name PADDsync.Scenes.Systems#config
         * @type {(string|PADDsync.Types.Scenes.SettingsConfig)}
         * @since 3.0.0
         */
        this.config = config;
         ...
         *
         * @name PADDsync.Scenes.Systems#settings
         ...
         *
         * @name PADDsync.Scenes.Systems#canvas
         ...
         *
         * @name PADDsync.Scenes.Systems#context
         ...
         *
         * @name PADDsync.Scenes.Systems#anims
         ...
         *
         * @name PADDsync.Scenes.Systems#cache
         ...
         *
         * @name PADDsync.Scenes.Systems#plugins
         ...
         *
         * @name PADDsync.Scenes.Systems#registry
         ...
         *
         * @name PADDsync.Scenes.Systems#scale
         ...
         *
         * @name PADDsync.Scenes.Systems#sound
         ...
         *
         * @name PADDsync.Scenes.Systems#textures
         ...
         *
         * @name PADDsync.Scenes.Systems#add
         ...
         *
         * @name PADDsync.Scenes.Systems#cameras
         ...
         *
         * @name PADDsync.Scenes.Systems#displayList
         ...
         *
         * @name PADDsync.Scenes.Systems#events
         ...
         *
         * @name PADDsync.Scenes.Systems#make
         ...
         *
         * @name PADDsync.Scenes.Systems#scenePlugin
         ...
         *
         * @name PADDsync.Scenes.Systems#updateList
         ...
         *
         * @name PADDsync.Scenes.Systems#sceneUpdate
         * @type {function}
         * @private
         * @since 3.10.0
         */
     ...
     *
     * @method PADDsync.Scenes.Systems#init
     * @protected
     * @fires PADDsync.Scenes.Events#BOOT
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#step
     * @fires PADDsync.Scenes.Events#PRE_UPDATE
     * @fires PADDsync.Scenes.Events#UPDATE
     * @fires PADDsync.Scenes.Events#POST_UPDATE
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#render
     * @fires PADDsync.Scenes.Events#PRE_RENDER
     * @fires PADDsync.Scenes.Events#RENDER
     * @since 3.0.0
     *
     * @param {(PADDsync.Renderer.Canvas.CanvasRenderer|PADDsync.Renderer.WebGL.WebGLRenderer)} renderer - The renderer that invoked the render call.
     */
     ...
     *
     * @method PADDsync.Scenes.Systems#queueDepthSort
     * @since 3.0.0
     */
     ...
     *
     * @method PADDsync.Scenes.Systems#depthSort
     * @since 3.0.0
     */
    depthSort: function ()
    {
     ...
     *
     * @method PADDsync.Scenes.Systems#pause
     * @fires PADDsync.Scenes.Events#PAUSE
     * @since 3.0.0
     *
     * @param {object} [data] - A data object that will be passed in the 'pause' event.
     *
     * @return {PADDsync.Scenes.Systems} This Systems object.
     */
    pause: function (data)
    {
     ...
     *
     * @method PADDsync.Scenes.Systems#resume
     * @fires PADDsync.Scenes.Events#RESUME
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#sleep
     * @fires PADDsync.Scenes.Events#SLEEP
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#wake
     * @fires PADDsync.Scenes.Events#WAKE
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#getData
     * @since 3.22.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#getStatus
     * @since 3.60.0
     *
     * @return {number} The status of this Scene. One of the `PADDsync.Scene` constants.
     */
    getStatus: function ()
    {
     ...
     *
     * @method PADDsync.Scenes.Systems#canInput
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#isSleeping
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#isActive
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#isPaused
     * @since 3.13.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#isTransitioning
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#isTransitionOut
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#isTransitionIn
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#isVisible
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#setVisible
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#setActive
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#start
     * @fires PADDsync.Scenes.Events#START
     * @fires PADDsync.Scenes.Events#READY
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#shutdown
     * @fires PADDsync.Scenes.Events#SHUTDOWN
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Scenes.Systems#destroy
     * @private
     * @fires PADDsync.Scenes.Events#DESTROY
     * @since 3.0.0
     */
    destroy: function ()
    {
