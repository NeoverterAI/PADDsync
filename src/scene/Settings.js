...
/**
 * @namespace PADDsync.Scenes.Settings
 */
...
var Settings = {
     ...
     *
     * @function PADDsync.Scenes.Settings.create
     * @since 3.0.0
     *
     * @param {(string|PADDsync.Types.Scenes.SettingsConfig)} config - The Scene configuration object used to create this Scene Settings.
     *
     * @return {PADDsync.Types.Scenes.SettingsObject} The Scene Settings object created as a result of the config and default settings.
     */
