/**
 * @typedef {object} PADDsync.Types.Cameras.Scene2D.JSONCamera
 * @since 3.0.0
 *
 ...
 * @property {(PADDsync.Types.Cameras.Scene2D.JSONCameraBounds|undefined)} [bounds] - The bounds of camera
 */
