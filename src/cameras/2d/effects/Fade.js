 ...
 *
 * @class Fade
 * @memberof PADDsync.Cameras.Scene2D.Effects
 * @constructor
 * @since 3.5.0
 *
 * @param {PADDsync.Cameras.Scene2D.Camera} camera - The camera this effect is acting upon.
 */
var Fade = new Class({
    ...
    function Fade (camera)
    {
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#camera
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#isRunning
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.5.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#isComplete
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.5.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#direction
         * @type {boolean}
         * @readonly
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#duration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.5.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#red
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         * A value between 0 and 255.
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#green
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         * A value between 0 and 255.
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#blue
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#alpha
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#progress
         * @type {number}
         * @since 3.5.0
         */
        this.progress = 0;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#_elapsed
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#_onUpdate
         * @type {?PADDsync.Types.Cameras.Scene2D.CameraFadeCallback}
         * @private
         * @default null
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Fade#_onUpdateScope
         * @type {any}
         * @private
         * @since 3.5.0
         */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Fade#start
     ...
     * @param {PADDsync.Types.Cameras.Scene2D.CameraFadeCallback} [callback] - This callback will be invoked every frame for the duration of the effect.
     * It is sent two arguments: A reference to the camera and a progress amount between 0 and 1 indicating how complete the effect is.
     * @param {any} [context] - The context in which the callback is invoked. Defaults to the Scene to which the Camera belongs.
     *
     * @return {PADDsync.Cameras.Scene2D.Camera} The Camera on which the effect was started.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Fade#update
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Fade#postRenderCanvas
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Fade#postRenderWebGL
     * @since 3.5.0
     *
     * @param {PADDsync.Renderer.WebGL.Pipelines.MultiPipeline} pipeline - The WebGL Pipeline to render to. Must provide the `drawFillRect` method.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Fade#effectComplete
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Fade#reset
     * @since 3.5.0
     */
    reset: function ()
    {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Fade#destroy
     * @since 3.5.0
     */
    destroy: function ()
    {
