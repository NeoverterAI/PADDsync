...
var Pan = new Class({
    ...
    function Pan (camera)
    {
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#camera
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#isRunning
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.11.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#duration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.11.0
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#source
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#current
         * @type {PADDsync.Math.Vector2}
         * @since 3.11.0
         */
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#destination
         * @type {PADDsync.Math.Vector2}
         * @since 3.11.0
         */
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#ease
         * @type {function}
         * @since 3.11.0
         */
        this.ease;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#progress
         * @type {number}
         * @since 3.11.0
         */
        this.progress = 0;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#_elapsed
         * @type {number}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#_onUpdate
         * @type {?PADDsync.Types.Cameras.Scene2D.CameraPanCallback}
         * @private
         * @default null
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Pan#_onUpdateScope
         * @type {any}
         * @private
         * @since 3.11.0
         */
     ...
     * over the duration and with the ease specified.
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Pan#start
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Pan#update
     * @since 3.11.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Pan#effectComplete
     * @fires PADDsync.Cameras.Scene2D.Events#PAN_COMPLETE
     * @since 3.11.0
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Pan#reset
     * @since 3.11.0
     */
    reset: function ()
    {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Pan#destroy
     * @since 3.11.0
     */
    destroy: function ()
    {
