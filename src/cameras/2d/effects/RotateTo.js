...
var RotateTo = new Class({
    ...
    function RotateTo (camera)
    {
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#camera
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#isRunning
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.23.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#duration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.23.0
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#source
         * @type {number}
         * @since 3.23.0
         */
        this.source = 0;
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#current
         * @type {number}
         * @since 3.23.0
         */
        this.current = 0;
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#destination
         * @type {number}
         * @since 3.23.0
         */
        this.destination = 0;
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#ease
         * @type {function}
         * @since 3.23.0
         */
        this.ease;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#progress
         * @type {number}
         * @since 3.23.0
         */
        this.progress = 0;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#_elapsed
         * @type {number}
         * @private
         * @since 3.23.0
         */
         ...
         *
         * @param {PADDsync.Cameras.Scene2D.Camera} camera - The camera on which the effect is running.
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#_onUpdate
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#_onUpdateScope
         * @type {any}
         * @private
         * @since 3.23.0
         */
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#clockwise
         * @type {boolean}
         * @since 3.23.0
         */
        this.clockwise = true;
         ...
         * 
         * @name PADDsync.Cameras.Scene2D.Effects.RotateTo#shortestPath
         * @type {boolean}
         * @since 3.23.0
         */
     ...
     * over the duration and with the ease specified.
     *
     * @method PADDsync.Cameras.Scene2D.Effects.RotateTo#start
     * @fires PADDsync.Cameras.Scene2D.Events#ROTATE_START
     * @fires PADDsync.Cameras.Scene2D.Events#ROTATE_COMPLETE
     * @since 3.23.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.RotateTo#update
     * @since 3.23.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.RotateTo#effectComplete
     * @since 3.23.0
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.RotateTo#reset
     * @since 3.23.0
     */
    reset: function ()
    {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.RotateTo#destroy
     * @since 3.23.0
     */
    destroy: function ()
    {
