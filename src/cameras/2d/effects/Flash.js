...
var Flash = new Class({
    ...
    function Flash (camera)
    {
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#camera
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#isRunning
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.5.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#duration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.5.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#red
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         * A value between 0 and 255.
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#green
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         * A value between 0 and 255.
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#blue
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#alpha
         * @type {number}
         * @since 3.5.0
         */
        this.alpha = 1;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#progress
         * @type {number}
         * @since 3.5.0
         */
        this.progress = 0;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#_elapsed
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#_alpha
         * @type {number}
         * @private
         * @readonly
         * @since 3.60.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#_onUpdate
         * @type {?PADDsync.Types.Cameras.Scene2D.CameraFlashCallback}
         * @private
         * @default null
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Flash#_onUpdateScope
         * @type {any}
         * @private
         * @since 3.5.0
         */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Flash#start
     ...
     * @param {PADDsync.Types.Cameras.Scene2D.CameraFlashCallback} [callback] - This callback will be invoked every frame for the duration of the effect.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Flash#update
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Flash#postRenderCanvas
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Flash#postRenderWebGL
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Flash#effectComplete
     * @fires PADDsync.Cameras.Scene2D.Events#FLASH_COMPLETE
     * @since 3.5.0
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Flash#reset
     * @since 3.5.0
     */
    reset: function ()
    {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Flash#destroy
     * @since 3.5.0
     */
    destroy: function ()
    {
