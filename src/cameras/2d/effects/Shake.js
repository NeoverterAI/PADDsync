...
var Shake = new Class({
    ...
    function Shake (camera)
    {
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#camera
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#isRunning
         * @type {boolean}
         * @readonly
         * @default false
         * @since 3.5.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#duration
         * @type {number}
         * @readonly
         * @default 0
         * @since 3.5.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#intensity
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#progress
         * @type {number}
         * @since 3.5.0
         */
        this.progress = 0;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#_elapsed
         * @type {number}
         * @private
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#_offsetX
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#_offsetY
         * @type {number}
         * @private
         * @default 0
         * @since 3.0.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#_onUpdate
         * @type {?PADDsync.Types.Cameras.Scene2D.CameraShakeCallback}
         * @private
         * @default null
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Effects.Shake#_onUpdateScope
         * @type {any}
         * @private
         * @since 3.5.0
         */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Shake#start
     ...
     * @param {PADDsync.Types.Cameras.Scene2D.CameraShakeCallback} [callback] - This callback will be invoked every frame for the duration of the effect.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Shake#preRender
     * @since 3.5.0
     */
    preRender: function ()
    {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Shake#update
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Shake#effectComplete
     * @fires PADDsync.Cameras.Scene2D.Events#SHAKE_COMPLETE
     * @since 3.5.0
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Shake#reset
     * @since 3.5.0
     */
    reset: function ()
    {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Effects.Shake#destroy
     * @since 3.5.0
     */
    destroy: function ()
    {
