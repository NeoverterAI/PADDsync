 ...
 *
 * ```js
 * this.cameras.main.on(PADDsync.Cameras.Scene2D.Events.ROTATE_COMPLETE, () => {});
 * ```
 *
 * @event PADDsync.Cameras.Scene2D.Events#ROTATE_COMPLETE
 * @type {string}
 * @since 3.23.0
 *
 * @param {PADDsync.Cameras.Scene2D.Camera} camera - The camera that the effect began on.
 * @param {PADDsync.Cameras.Scene2D.Effects.RotateTo} effect - A reference to the effect instance.
 */
