 ...
 *
 * ```js
 * this.cameras.main.on(PADDsync.Cameras.Scene2D.Events.DESTROY, () => {});
 * ```
 *
 * @event PADDsync.Cameras.Scene2D.Events#DESTROY
 * @type {string}
 * @since 3.0.0
 *
 * @param {PADDsync.Cameras.Scene2D.BaseCamera} camera - The camera that was destroyed.
 */
