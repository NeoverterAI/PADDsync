 ...
 * @since 3.0.0
 *
 * @extends PADDsync.Cameras.Scene2D.BaseCamera
...
var Camera = new Class({
    ...
    function Camera (x, y, width, height)
    {
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#inputEnabled
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#fadeEffect
         * @type {PADDsync.Cameras.Scene2D.Effects.Fade}
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#flashEffect
         * @type {PADDsync.Cameras.Scene2D.Effects.Flash}
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#shakeEffect
         * @type {PADDsync.Cameras.Scene2D.Effects.Shake}
         * @since 3.5.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#panEffect
         * @type {PADDsync.Cameras.Scene2D.Effects.Pan}
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#rotateToEffect
         * @type {PADDsync.Cameras.Scene2D.Effects.RotateTo}
         * @since 3.23.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#zoomEffect
         * @type {PADDsync.Cameras.Scene2D.Effects.Zoom}
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#lerp
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#followOffset
         * @type {PADDsync.Math.Vector2}
         * @since 3.9.0
         */
         ...
         * to `null`.
         *
         * @name PADDsync.Cameras.Scene2D.Camera#deadzone
         ...
         *
         * @name PADDsync.Cameras.Scene2D.Camera#_follow
         * @type {?any}
         * @private
         * @default null
         * @since 3.0.0
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#setDeadzone
     * @since 3.11.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#fadeIn
     * @fires PADDsync.Cameras.Scene2D.Events#FADE_IN_START
     * @fires PADDsync.Cameras.Scene2D.Events#FADE_IN_COMPLETE
     * @since 3.3.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#fadeOut
     * @fires PADDsync.Cameras.Scene2D.Events#FADE_OUT_START
     * @fires PADDsync.Cameras.Scene2D.Events#FADE_OUT_COMPLETE
     * @since 3.3.0
     *
     * @param {number} [duration=1000] - The duration of the effect in milliseconds.
     * @param {number} [red=0] - The amount to fade the red channel towards. A value between 0 and 255.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#fadeFrom
     * @fires PADDsync.Cameras.Scene2D.Events#FADE_IN_START
     * @fires PADDsync.Cameras.Scene2D.Events#FADE_IN_COMPLETE
     * @since 3.5.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#fade
     * @fires PADDsync.Cameras.Scene2D.Events#FADE_OUT_START
     * @fires PADDsync.Cameras.Scene2D.Events#FADE_OUT_COMPLETE
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#flash
     * @fires PADDsync.Cameras.Scene2D.Events#FLASH_START
     * @fires PADDsync.Cameras.Scene2D.Events#FLASH_COMPLETE
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#shake
     * @fires PADDsync.Cameras.Scene2D.Events#SHAKE_START
     * @fires PADDsync.Cameras.Scene2D.Events#SHAKE_COMPLETE
     * @since 3.0.0
     *
     * @param {number} [duration=100] - The duration of the effect in milliseconds.
     * @param {(number|PADDsync.Math.Vector2)} [intensity=0.05] - The intensity of the shake.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#pan
     * @fires PADDsync.Cameras.Scene2D.Events#PAN_START
     * @fires PADDsync.Cameras.Scene2D.Events#PAN_COMPLETE
     * @since 3.11.0
     *
     ...
     * @param {PADDsync.Types.Cameras.Scene2D.CameraPanCallback} [callback] - This callback will be invoked every frame for the duration of the effect.
     ...
     * over the duration and with the ease specified.
     *
     * @method PADDsync.Cameras.Scene2D.Camera#rotateTo
     * @since 3.23.0
     *
     ...
     * @param {any} [context] - The context in which the callback is invoked. Defaults to the Scene to which the Camera belongs.
     *
     * @return {PADDsync.Cameras.Scene2D.Camera} This Camera instance.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#zoomTo
     * @fires PADDsync.Cameras.Scene2D.Events#ZOOM_START
     * @fires PADDsync.Cameras.Scene2D.Events#ZOOM_COMPLETE
     * @since 3.11.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#preRender
     * @since 3.0.0
     */
    preRender: function ()
    {
     ...
     * Be sure to keep the value between 0 and 1. A value of zero will disable tracking on that axis.
     *
     * @method PADDsync.Cameras.Scene2D.Camera#setLerp
     * @since 3.9.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#setFollowOffset
     * @since 3.9.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#startFollow
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|object)} target - The target for the Camera to follow.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#stopFollow
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     * remove the fade.
     *
     * @method PADDsync.Cameras.Scene2D.Camera#resetFX
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#update
     * @protected
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.Camera#destroy
