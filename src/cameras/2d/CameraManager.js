 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene that owns the Camera Manager plugin.
 */
var CameraManager = new Class({
    ...
    function CameraManager (scene)
    {
         ...
         *
         * @name PADDsync.Cameras.Scene2D.CameraManager#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene = scene;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.CameraManager#systems
         ...
         *
         * @name PADDsync.Cameras.Scene2D.CameraManager#roundPixels
         * @type {boolean}
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.CameraManager#cameras
         ...
         *
         * @name PADDsync.Cameras.Scene2D.CameraManager#main
         * @type {PADDsync.Cameras.Scene2D.Camera}
         * @since 3.0.0
         */
        this.main;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.CameraManager#default
         * @type {PADDsync.Cameras.Scene2D.Camera}
         * @since 3.17.0
         */
        this.default;
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#boot
     * @private
     * @listens PADDsync.Scenes.Events#DESTROY
     * @since 3.5.1
     */
    boot: function ()
    {
     ...
     * Do not invoke it directly.
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#start
     * @private
     * @listens PADDsync.Scenes.Events#UPDATE
     * @listens PADDsync.Scenes.Events#SHUTDOWN
     * @since 3.5.0
     */
    start: function ()
    {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#add
     * @since 3.0.0
     *
     ...
     *
     * @return {PADDsync.Cameras.Scene2D.Camera} The newly created Camera.
     */
     ...
     *
     * The Camera should either be a `PADDsync.Cameras.Scene2D.Camera` instance, or a class that extends from it.
     *
     * The Camera will have its `roundPixels` property set to whatever `CameraManager.roundPixels` is. You can change
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#addExisting
     * @since 3.0.0
     *
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera to be added to the Camera Manager.
     * @param {boolean} [makeMain=false] - Set this Camera as being the 'main' camera. This just makes the property `main` a reference to it.
     *
     * @return {?PADDsync.Cameras.Scene2D.Camera} The Camera that was added to the Camera Manager, or `null` if it couldn't be added.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#getNextID
     * @private
     * @since 3.11.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#getTotal
     * @since 3.11.0
     *
     ...
     *
     * See the `PADDsync.Types.Cameras.Scene2D.CameraConfig` documentation for details of the object structure.
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#fromJSON
     * @since 3.0.0
     *
     * @param {(PADDsync.Types.Cameras.Scene2D.CameraConfig|PADDsync.Types.Cameras.Scene2D.CameraConfig[])} config - A Camera configuration object, or an array of them, to be added to this Camera Manager.
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#getCamera
     * @since 3.0.0
     *
     * @param {string} name - The name of the Camera.
     *
     * @return {?PADDsync.Cameras.Scene2D.Camera} The first Camera with a name matching the given string, otherwise `null`.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#getCamerasBelowPointer
     * @since 3.10.0
     *
     * @param {PADDsync.Input.Pointer} pointer - The Pointer to check against.
     *
     * @return {PADDsync.Cameras.Scene2D.Camera[]} An array of cameras below the Pointer.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#remove
     * @since 3.0.0
     *
     * @param {(PADDsync.Cameras.Scene2D.Camera|PADDsync.Cameras.Scene2D.Camera[])} camera - The Camera, or an array of Cameras, to be removed from this Camera Manager.
     ...
     * an alpha level > 0.
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#render
     * @protected
     * @since 3.0.0
     *
     * @param {(PADDsync.Renderer.Canvas.CanvasRenderer|PADDsync.Renderer.WebGL.WebGLRenderer)} renderer - The Renderer that will render the children to this camera.
     * @param {PADDsync.GameObjects.DisplayList} displayList - The Display List for the Scene.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#getVisibleChildren
     * @since 3.50.0
     *
     * @param {PADDsync.GameObjects.GameObject[]} children - An array of Game Objects to be checked against the camera.
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The camera to filter the Game Objects against.
     *
     * @return {PADDsync.GameObjects.GameObject[]} A filtered list of only Game Objects within the Scene that will render against the given Camera.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#resetAll
     * @since 3.0.0
     *
     * @return {PADDsync.Cameras.Scene2D.Camera} The freshly created main Camera.
     */
    resetAll: function ()
    {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#update
     * @protected
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#onResize
     * @since 3.18.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#resize
     * @since 3.2.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#shutdown
     * @private
     * @since 3.0.0
     */
    shutdown: function ()
     ...
     *
     * @method PADDsync.Cameras.Scene2D.CameraManager#destroy
     * @private
     * @since 3.0.0
     */
    destroy: function ()
