 ...
 * A Base Camera class.
 *
 * The Camera is the way in which all games are rendered in PADDsync. They provide a view into your game world,
 ...
 *
 * @class BaseCamera
 * @memberof PADDsync.Cameras.Scene2D
 * @constructor
 * @since 3.12.0
 *
...
var BaseCamera = new Class({
    ...
    function BaseCamera (x, y, width, height)
    {
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#scene
         * @type {PADDsync.Scene}
         * @since 3.0.0
         */
        this.scene;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#sceneManager
         * @type {PADDsync.Scenes.SceneManager}
         * @since 3.12.0
         */
        this.sceneManager;
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#scaleManager
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#cameraManager
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#id
         * @type {number}
         * @readonly
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#name
         * @type {string}
         * @default ''
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#roundPixels
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#visible
         * @type {boolean}
         * @default true
         * @since 3.10.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#useBounds
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#worldView
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#dirty
         * @type {boolean}
         * @default true
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_x
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_y
         * @type {number}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_width
         * @type {number}
         * @private
         * @since 3.11.0
         */
         ...
         * not restrict where the Camera can scroll to.
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_height
         * @type {number}
         * @private
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_bounds
         * @type {PADDsync.Geom.Rectangle}
         * @private
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_scrollX
         * @type {number}
         * @private
         * @default 0
         * @since 3.11.0
         ...
         * You can set the bounds within which the Camera can scroll via the `setBounds` method.
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_scrollY
         * @type {number}
         * @private
         * @default 0
         * @since 3.11.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_zoomX
         * @type {number}
         * @private
         * @default 1
         * @since 3.50.0
         ...
         * Be careful to never set this value to zero.
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_zoomY
         * @type {number}
         * @private
         * @default 1
         * @since 3.50.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_rotation
         * @type {number}
         * @private
         * @default 0
         * @since 3.11.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#matrix
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#transparent
         * @type {boolean}
         * @default true
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#backgroundColor
         * @type {PADDsync.Display.Color}
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#alpha
         * @type {number}
         * @default 1
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#disableCull
         * @type {boolean}
         * @default false
         * @since 3.0.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#culledObjects
         ...
         * have been processed.
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#midPoint
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#originX
         * @type {number}
         * @default 0.5
         * @since 3.11.0
         */
         ...
         * See `setOrigin` to set both origins in a single, chainable call.
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#originY
         * @type {number}
         * @default 0.5
         * @since 3.11.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_customViewport
         * @type {boolean}
         * @private
         * @default false
         * @since 3.12.0
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#mask
         ...
         * to itself.
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#_maskCamera
         * @type {?PADDsync.Cameras.Scene2D.BaseCamera}
         * @private
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#renderList
         * @type {PADDsync.GameObjects.GameObject[]}
         * @since 3.52.0
         */
        this.renderList = [];
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#isSceneCamera
         * @type {boolean}
         * @default true
         * @since 3.60.0
         */
         ...
         *
         * @name PADDsync.Cameras.Scene2D.BaseCamera#renderRoundPixels
         * @type {boolean}
         * @readonly
         * @default true
         * @since 3.86.0
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#addToRenderList
     * @since 3.52.0
     *
     * @param {PADDsync.GameObjects.GameObject} child - The Game Object to add to the render list.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setAlpha
     * @since 3.11.0
     *
     ...
     * A value of 0 would rotate from the top-left of the viewport. A value of 1 from the bottom right.
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setOrigin
     * @since 3.11.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#getScroll
     * @since 3.11.0
     *
     * @param {number} x - The horizontal coordinate to center on.
     * @param {number} y - The vertical coordinate to center on.
     * @param {PADDsync.Math.Vector2} [out] - A Vector2 to store the values in. If not given a new Vector2 is created.
     *
     * @return {PADDsync.Math.Vector2} The scroll coordinates stored in the `x` and `y` properties.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#centerOnX
     * @since 3.16.0
     *
     * @param {number} x - The horizontal coordinate to center on.
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#centerOnY
     * @since 3.16.0
     *
     * @param {number} y - The vertical coordinate to center on.
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#centerOn
     * @since 3.11.0
     *
     * @param {number} x - The horizontal coordinate to center on.
     * @param {number} y - The vertical coordinate to center on.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#centerToBounds
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#centerToSize
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#cull
     * @since 3.0.0
     *
     * @generic {PADDsync.GameObjects.GameObject[]} G - [renderableObjects,$return]
     *
     * @param {PADDsync.GameObjects.GameObject[]} renderableObjects - An array of Game Objects to cull.
     *
     * @return {PADDsync.GameObjects.GameObject[]} An array of Game Objects visible to this Camera.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#getWorldPoint
     * @since 3.0.0
     *
     ...
     * @param {(object|PADDsync.Math.Vector2)} [output] - An optional object to store the results in. If not provided a new Vector2 will be created.
     *
     * @return {PADDsync.Math.Vector2} An object holding the converted values in its `x` and `y` properties.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#ignore
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.GameObjects.GameObject[]|PADDsync.GameObjects.Group|PADDsync.GameObjects.Layer|PADDsync.GameObjects.Layer[])} entries - The Game Object, or array of Game Objects, to be ignored by this Camera.
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#clampX
     * @since 3.11.0
     *
     ...
     * Do not call this method if you are not using camera bounds.
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#clampY
     * @since 3.11.0
     *
    ...
    */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#removeBounds
     * @since 3.0.0
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setAngle
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setBackgroundColor
     * @since 3.0.0
     *
     * @param {(string|number|PADDsync.Types.Display.InputColorObject)} [color='rgba(0,0,0,0)'] - The color value. In CSS, hex or numeric color notation.
     *
     * @return {this} This Camera instance.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setBounds
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#getBounds
     * @since 3.16.0
     *
     * @param {PADDsync.Geom.Rectangle} [out] - An optional Rectangle to store the bounds in. If not given, a new Rectangle will be created.
     *
     * @return {PADDsync.Geom.Rectangle} A rectangle containing the bounds of this Camera.
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setName
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setPosition
     * @since 3.0.0
     *
     ...
     * Rotating a camera does not rotate the viewport itself, it is applied during rendering.
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setRotation
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setRoundPixels
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setScene
     * @since 3.0.0
     *
     * @param {PADDsync.Scene} scene - The Scene the camera is bound to.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setScroll
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setSize
     * @since 3.0.0
     *
     ...
     * viewport within your game.
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setViewport
     * @since 3.0.0
     *
     * @param {number} x - The top-left x coordinate of the Camera viewport.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setZoom
     * @since 3.0.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setMask
     * @since 3.17.0
     *
     * @param {(PADDsync.Display.Masks.BitmapMask|PADDsync.Display.Masks.GeometryMask)} mask - The mask this Camera will use when rendering.
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#clearMask
     * @since 3.17.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setVisible
     * @since 3.10.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#toJSON
     * @since 3.0.0
     *
     * @return {PADDsync.Types.Cameras.Scene2D.JSONCamera} A well-formed object suitable for conversion to JSON.
     */
    toJSON: function ()
    {
        var output = {
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#update
     * @protected
     * @since 3.0.0
     *
     ...
     * Camera.
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#setIsSceneCamera
     * @since 3.60.0
     *
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#updateSystem
     * @private
     * @since 3.12.0
     */
     ...
     *
     * @method PADDsync.Cameras.Scene2D.BaseCamera#destroy
     * @fires PADDsync.Cameras.Scene2D.Events#DESTROY
     * @since 3.0.0
     */
    destroy: function ()
    {
     ...
     * To adjust the position the camera is looking at in the game world, see the `scrollX` value.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#x
     * @type {number}
     * @since 3.0.0
     */
    x: {
     ...
     * To adjust the position the camera is looking at in the game world, see the `scrollY` value.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#y
     * @type {number}
     * @since 3.0.0
     */
    y: {
     ...
     * not restrict where the Camera can scroll to.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#width
     * @type {number}
     * @since 3.0.0
     */
    width: {
     ...
     * not restrict where the Camera can scroll to.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#height
     * @type {number}
     * @since 3.0.0
     */
    height: {
     ...
     * You can set the bounds within which the Camera can scroll via the `setBounds` method.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#scrollX
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     * You can set the bounds within which the Camera can scroll via the `setBounds` method.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#scrollY
     * @type {number}
     * @default 0
     * @since 3.0.0
     */
     ...
     * Be careful to never set this value to zero.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#zoom
     * @type {number}
     * @default 1
     * @since 3.0.0
     */
     ...
     * Be careful to never set this value to zero.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#zoomX
     * @type {number}
     * @default 1
     * @since 3.50.0
     */
     ...
     * Be careful to never set this value to zero.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#zoomY
     * @type {number}
     * @default 1
     * @since 3.50.0
     */
     ...
     * rotate the Camera viewport itself, which always remains an axis-aligned rectangle.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#rotation
     * @type {number}
     * @private
     * @default 0
     * @since 3.11.0
     ...
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#centerX
     * @type {number}
     * @readonly
     * @since 3.10.0
     */
     ...
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#centerY
     * @type {number}
     * @readonly
     * @since 3.10.0
     */
     ...
     * of 400 pixels.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#displayWidth
     * @type {number}
     * @readonly
     * @since 3.11.0
     */
     ...
     * of 300 pixels.
     *
     * @name PADDsync.Cameras.Scene2D.BaseCamera#displayHeight
     * @type {number}
     * @readonly
     * @since 3.11.0
     */
