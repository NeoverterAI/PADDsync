...
var BaseShader = new Class({
    ...
    function BaseShader (key, fragmentSrc, vertexSrc, uniforms)
    {
         ...
         *
         * @name PADDsync.Display.BaseShader#key
         * @type {string}
         * @since 3.17.0
         */
        this.key = key;
         ...
         *
         * @name PADDsync.Display.BaseShader#fragmentSrc
         * @type {string}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.Display.BaseShader#vertexSrc
         * @type {string}
         * @since 3.17.0
         */
         ...
         *
         * @name PADDsync.Display.BaseShader#uniforms
         * @type {?any}
         * @since 3.17.0
         */
