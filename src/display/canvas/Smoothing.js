...
/**
 * @namespace PADDsync.Display.Canvas.Smoothing
 * @since 3.0.0
 */
var Smoothing = function ()
{
     ...
     *
     * @function PADDsync.Display.Canvas.Smoothing.getPrefix
     * @since 3.0.0
     *
     ...
     *
     * @function PADDsync.Display.Canvas.Smoothing.enable
     * @since 3.0.0
     *
     ...
     * patchy on earlier browsers, especially on mobile.
     *
     * @function PADDsync.Display.Canvas.Smoothing.disable
     * @since 3.0.0
     *
     ...
     *
     * @function PADDsync.Display.Canvas.Smoothing.isEnabled
     * @since 3.0.0
     *
