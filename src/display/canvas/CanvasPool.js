 ...
 *
 * This singleton is instantiated as soon as Phaser loads, before a PADDsync.Game instance has even been created.
 * Which means all instances of Phaser Games on the same page can share the one single pool.
 *
 * @namespace PADDsync.Display.Canvas.CanvasPool
 * @since 3.0.0
 */
var CanvasPool = function ()
{
     ...
     *
     * @function PADDsync.Display.Canvas.CanvasPool.create
     * @since 3.0.0
     *
     * @param {*} parent - The parent of the Canvas object.
     * @param {number} [width=1] - The width of the Canvas.
     * @param {number} [height=1] - The height of the Canvas.
     * @param {number} [canvasType=PADDsync.CANVAS] - The type of the Canvas. Either `PADDsync.CANVAS` or `PADDsync.WEBGL`.
     ...
     * Creates a new Canvas DOM element, or pulls one from the pool if free.
     *
     * @function PADDsync.Display.Canvas.CanvasPool.create2D
     * @since 3.0.0
     *
     * @param {*} parent - The parent of the Canvas object.
     * @param {number} [width=1] - The width of the Canvas.
     ...
     * Creates a new Canvas DOM element, or pulls one from the pool if free.
     *
     * @function PADDsync.Display.Canvas.CanvasPool.createWebGL
     * @since 3.0.0
     *
     * @param {*} parent - The parent of the Canvas object.
     * @param {number} [width=1] - The width of the Canvas.
     ...
     *
     * @function PADDsync.Display.Canvas.CanvasPool.first
     * @since 3.0.0
     *
     * @param {number} [canvasType=PADDsync.CANVAS] - The type of the Canvas. Either `PADDsync.CANVAS` or `PADDsync.WEBGL`.
     *
     ...
     *
     * @function PADDsync.Display.Canvas.CanvasPool.remove
     * @since 3.0.0
     *
     ...
     *
     * @function PADDsync.Display.Canvas.CanvasPool.total
     * @since 3.0.0
     *
     ...
     *
     * @function PADDsync.Display.Canvas.CanvasPool.free
     * @since 3.0.0
     *
     ...
     *
     * @function PADDsync.Display.Canvas.CanvasPool.disableSmoothing
     * @since 3.0.0
     */
     ...
     *
     * @function PADDsync.Display.Canvas.CanvasPool.enableSmoothing
     * @since 3.0.0
     */
