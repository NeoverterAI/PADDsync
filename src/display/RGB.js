...
var RGB = new Class({
    ...
    function RGB (red, green, blue)
    {
         ...
         * Cached RGB values.
         *
         * @name PADDsync.Display.RGB#_rgb
         * @type {number[]}
         * @private
         * @since 3.50.0
         */
         ...
         *
         * @name PADDsync.Display.RGB#onChangeCallback
         * @type {function}
         * @since 3.50.0
         */
         ...
         * Is this color dirty?
         *
         * @name PADDsync.Display.RGB#dirty
         * @type {boolean}
         * @since 3.50.0
         */
        this.dirty = false;
     ...
     *
     * @method PADDsync.Display.RGB#set
     * @since 3.50.0
     *
     * @param {number} [red=0] - The red color value. A number between 0 and 1.
     * @param {number} [green=0] - The green color value. A number between 0 and 1.
     ...
     *
     * @method PADDsync.Display.RGB#equals
     * @since 3.50.0
     *
     ...
     * new RGB values.
     *
     * @method PADDsync.Display.RGB#onChange
     * @since 3.50.0
     */
    onChange: function ()
    {
     ...
     *
     * @method PADDsync.Display.RGB#destroy
     * @since 3.50.0
     */
    destroy: function ()
    {
