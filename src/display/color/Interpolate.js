...
/**
 * @namespace PADDsync.Display.Color.Interpolate
 * @memberof PADDsync.Display.Color
 * @since 3.0.0
 */
 ...
 *
 * @function PADDsync.Display.Color.Interpolate.RGBWithRGB
 * @memberof PADDsync.Display.Color.Interpolate
 * @static
 * @since 3.0.0
 *
 ...
 *
 * @return {PADDsync.Types.Display.ColorObject} An object containing the interpolated color values.
 */
 ...
 *
 * @function PADDsync.Display.Color.Interpolate.ColorWithColor
 * @memberof PADDsync.Display.Color.Interpolate
 * @static
 * @since 3.0.0
 *
 * @param {PADDsync.Display.Color} color1 - The first Color object.
 * @param {PADDsync.Display.Color} color2 - The second Color object.
 * @param {number} [length=100] - Distance to interpolate over.
 * @param {number} [index=0] - Index to start from.
 *
 * @return {PADDsync.Types.Display.ColorObject} An object containing the interpolated color values.
 ...
 *
 * @function PADDsync.Display.Color.Interpolate.ColorWithRGB
 * @memberof PADDsync.Display.Color.Interpolate
 * @static
 * @since 3.0.0
 *
