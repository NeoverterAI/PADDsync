 ...
 *
 * @function PADDsync.Display.Color.HSVToRGB
 * @since 3.0.0
 *
 ...
 * @param {(PADDsync.Types.Display.ColorObject|PADDsync.Display.Color)} [out] - A Color object to store the results in. If not given a new ColorObject will be created.
 *
 * @return {(PADDsync.Types.Display.ColorObject|PADDsync.Display.Color)} An object with the red, green and blue values set in the r, g and b properties.
 */
