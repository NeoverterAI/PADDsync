 ...
 * @since 3.0.0
 *
 * @param {PADDsync.Scene} scene - The Scene to which this mask is being added.
 * @param {(PADDsync.GameObjects.GameObject|PADDsync.Textures.DynamicTexture)} [maskObject] - The Game Object or Dynamic Texture that will be used as the mask. If `null` it will generate an Image Game Object using the rest of the arguments.
 ...
 * @param {(string|PADDsync.Textures.Texture)} [texture] - If creating a Game Object, the key, or instance of the Texture it will use to render with, as stored in the Texture Manager.
 * @param {(string|number|PADDsync.Textures.Frame)} [frame] - If creating a Game Object, an optional frame from the Texture this Game Object is rendering with.
 */
var BitmapMask = new Class({
    ...
    function BitmapMask (scene, maskObject, x, y, texture, frame)
    {
         ...
         * @type {(PADDsync.GameObjects.GameObject|PADDsync.Textures.DynamicTexture)}
         * @since 3.0.0
         */
     ...
     * @since 3.0.0
     *
     * @param {(PADDsync.GameObjects.GameObject|PADDsync.Textures.DynamicTexture)} maskObject - The Game Object or Dynamic Texture that will be used as the mask. If a Game Object, it must have a texture, such as a Sprite.
     */
     ...
     * @param {PADDsync.Cameras.Scene2D.Camera} camera - The Camera to render to.
     * @param {PADDsync.Renderer.WebGL.RenderTarget} [renderTarget] - Optional WebGL RenderTarget.
     */
 ...
 * render as a normal Game Object and will also serve as a mask.
 *
 * @method PADDsync.GameObjects.GameObjectFactory#bitmapMask
 * @since 3.60.0
 *
 * @param {(PADDsync.GameObjects.GameObject|PADDsync.Textures.DynamicTexture)} [maskObject] - The Game Object or Texture that will be used as the mask. If `null` it will generate an Image Game Object using the rest of the arguments.
 * @param {number} [x] - If creating a Game Object, the horizontal position in the world.
 * @param {number} [y] - If creating a Game Object, the vertical position in the world.
 * @param {(string|PADDsync.Textures.Texture)} [texture] - If creating a Game Object, the key, or instance of the Texture it will use to render with, as stored in the Texture Manager.
 * @param {(string|number|PADDsync.Textures.Frame)} [frame] - If creating a Game Object, an optional frame from the Texture this Game Object is rendering with.
 *
 * @return {PADDsync.Display.Masks.BitmapMask} The Bitmap Mask that was created.
 */
